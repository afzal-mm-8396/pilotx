(function (global, factory) {
  ...
  _exports.cubehelix = cubehelix$2;
  _exports.curveBumpX = bumpX;
  _exports.curveBumpY = bumpY;
  ...
  _exports.interpolateArray = array$2;
  ...
  _exports.interpolateZoom = _exports.interpolateTransformSvg = _exports.interpolateTransformCss = void 0;
  ...
  _exports.link = link$1;
  _exports.linkHorizontal = linkHorizontal;
  _exports.linkRadial = linkRadial;
  ...
  function selectAll(selector) {
    return typeof selector === "string" ? new Selection$1([document.querySelectorAll(selector)], [document.documentElement]) : new Selection$1([array$3(selector)], root$1);
  }
  ...
  var cubehelix$1 = _exports.interpolateCubehelix = cubehelix(hue$1);
  var cubehelixLong = _exports.interpolateCubehelixLong = cubehelix(nogamma);
  ...
  var BumpRadial = /*#__PURE__*/function () {
    ...
    return _createClass(BumpRadial, [{
      key: "lineStart",
      value: function lineStart() {
        this._point = 0;
      }
      ...
      value: function point(x, y) {
        ...
        if (this._point === 0) {
          ...
          var _p2 = pointRadial(this._x0, this._y0);
          var p1 = pointRadial(this._x0, this._y0 = (this._y0 + y) / 2);
          var p2 = pointRadial(x, this._y0);
          var p3 = pointRadial(x, y);
          (_this$_context = this._context).moveTo.apply(_this$_context, _toConsumableArray(_p2));
  ...
  treeProto.x = tree_x;
  treeProto.y = tree_y;
  var version = _exports.version = "3.1.0";
});
