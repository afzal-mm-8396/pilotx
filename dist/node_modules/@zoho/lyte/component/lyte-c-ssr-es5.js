...
(function (window) {
    ...
    */
    ...
    document._addShadowForGlobalRegistry = function (shadow) {
        for (var _i3 = 0; _i3 < globalDOMEvents.length; _i3++) {
            var evnt = globalDOMEvents[_i3];
    ...
    function onDomContentForLyte() {
        ...
        for (var _i4 = 0; _i4 < bodyEvents.length; _i4++) {
            var evnt = bodyEvents[_i4];
    ...
    var changeEventHandler = function changeEventHandler(event1) {
        ...
        var saveAttr = _LC.directive.save.getAttr(target._specialAttributeDetails);
        ...
        if (saveAttr) {
            _LC.directive.save.triggerAllListeners(self, saveAttr.hookName, target, true);
            return;
        }
        if (target) {
    ...
    var LyteYield = function (_HTMLElement3) {
        ...
        _createClass(LyteYield, [{
            ...
            value: function _disconnectedCallback() {
                ...
                if (_LyteComponent.shouldIgnoreDisconnect() || this._deleted) {
                    return;
                }
                this._deleted = true;
                if (!this._properties) {
                ...
                for (var _i5 = 0; _i5 < this._helpers.length; _i5++) {
                    node._callee.removeHelpers(this._helpers[_i5]);
                }
                this._helpers = [];
            ...
            value: function getProperty(key) {
                ...
                for (var _i6 = 1; _i6 < arr.length; _i6++) {
                    if (arr[_i6].startsWith("'") || arr[_i6].startsWith('"')) {
                        //added check
                        arr[_i6] = arr[_i6].substring(1, arr[_i6].length - 1);
                    }
                    if (!property[arr[_i6]]) {
                        property[arr[_i6]] = {};
                        defProp(property[arr[_i6]], '_path', { enumerable: false, value: property._path + "." + arr[_i6] });
                    }
                    property = property[arr[_i6]];
                }
                return property;
            }
        }]);
    ...
    var customElementPrototype = function (_elementPrototype) {
        ...
        _createClass(customElementPrototype, [{
            ...
            value: function afterConnected(fastRenderProp, ssrBind) {
                ...
                for (var _i7 = 0; _i7 < obsattr.length; _i7++) {
                    var _key8 = obsattr[_i7];
                ...
                if (this._initProperties) {
                    ...
                    for (var _key9 in initProperties) {
                        var actVal = void 0;
                        var _field = compInstance.__data[_key9];
                        if (_field && _field.type !== _LC.getDataType(initProperties[_key9]) && (initProperties[_key9] !== undefined || _field.type === "boolean")) {
                        ...
                        if (!error) {
                            ...
                            if (_field && /^(object|array)$/.test(_field.type) && _field.watch || customDtype) {
                                Lyte.establishObjectBinding(compData, _key9, undefined, undefined, undefined, _field.watch ? true : undefined);
                            }
                        }
                        // }
                    }
                ...
                //ssrcode_end
                if (!unboundBeta) {
                    content = this.renderNodes(compConstr._template, compConstr._dynamicNodes, undefined, undefined, undefined, undefined, compConstr._tC);
                } else {
            ...
            value: function renderComponent(dynNode, preDefObj) {
                ...
                for (var _key12 in data) {
                    cmpData[_key12] = data[_key12][def];
                }
                cmpData.errors = {};
                ...
                if (initProperties) {
                    for (var _key13 in initProperties) {
                        ...
                        var error = _LC.handleValidation(cmpData, _key13, actVal, component);
                        if (!error) {
                            cmpData[_key13] = actVal;
                        }
                    }
                }
                if (true) {
                    ...
                    if (compConstr._callBacks && (initCallbacks = compConstr._callBacks.init)) {
                        for (var _i8 = 0; _i8 < initCallbacks.length; _i8++) {
                            initCallbacks[_i8].value.apply(component);
                        }
                    }
                                ...
                                case "attr":
                                    {
                                        ...
                                        var actionObj = {};
                                        for (var _key15 in attr) {
                                            if (attr[_key15].dynamicValue) {
                                                // let nodeValue = this.get(attr[key].dynamicValue);
                                                var _nodeValue = attr[_key15].newDynamicValue ? _LC.getDD(compData, attr[_key15].newDynamicValue) : this.get(attr[_key15].dynamicValue);

                                                if (fastRenderProp) {
                                                    fastRenderProp.data[attr[_key15].camelCase] = _nodeValue;
                                                    if (typeof _nodeValue == "string" && setAttr) {
                                                        _nodeValue = this.formatValue(_key15, _nodeValue);
                                                        str = str + _nodeValue + " ";
                                                    }
                                                } else {
                                                    _nodeValue = this.formatValue(_key15, _nodeValue);
                                            ...
                                            } else if (attr[_key15].helperInfo) {
                                                if (attr[_key15].helperInfo.name === "action") {
                                                    var actionName = attr[_key15].helperInfo.args[0];
                                                    ...
                                                    var actArgs = this.processArgs(this, attr[_key15], [], "__lyteEvent__", "__lyteNode__");
                                                    var actualAttrName = attr[_key15].globalEvent ? attr[_key15].name : attr[_key15].name.indexOf("-") !== -1 ? attr[_key15].name : attr[_key15].name.substr(2);
                                                    actionObj[actualAttrName] = { "name": boundName, "args": attr[_key15].helperInfo.args, "actArgs": actArgs, "globalEvent": attr[_key15].globalEvent ? true : false, "skipArgProcessing": true };
                                                } else if (attr[_key15].helperInfo.name === "method") {
                                                    ...
                                                    if (fastRenderProp) {
                                                        ...
                                                        (function () {
                                                            ...
                                                            var actArgs = _this8.processArgs(_this8, attr[_key15], [], "__lyteEvent__", "__lyteNode__");
                                                            ...
                                                            methods[attr[_key15].camelCase] = methodFunc;
                                                        })();
                                                    }
                                                } else {
                                                    var _nodeValue2 = this.processHelper({ name: attr[_key15].helperInfo.name, args: this.processArgs(this, attr[_key15], [], undefined, undefined, true) }, undefined);
                                                    if (fastRenderProp) {
                                                        fastRenderProp.data[attr[_key15].camelCase] = _nodeValue2;
                                                        if (typeof _nodeValue2 == "string" && setAttr) {
                                                            _nodeValue2 = this.formatValue(_key15, _nodeValue2);
                                                            str = str + _nodeValue2 + " ";
                                                        }
                                                    } else {
                                                        _nodeValue2 = this.formatValue(_key15, _nodeValue2);
                                ...
                                case "insertYield":
                                    {
                                        ...
                                        if (yieldObj) {
                                            ...
                                            for (var _key16 in contextSwitch) {
                                                psCmpData[_key16] = contextSwitch[_key16];
                                            }
                                            if (yieldObj._cx) {
            ...
            value: function bindServerData() {
                ...
                for (var _i9 = 0; _i9 < bindIds.length; _i9++) {
                    var prop = bindIds[_i9],
                        node = void 0,
                        _obj4 = void 0;
                    console.log(_i9, prop);
                    // if(!dynamicNodes){
            ...
            value: function bindServerIf(prop, dynamicNode, node, pbind) {
                ...
                if (!pbind[prop.id]) {
                    ...
                    if (childNodes.length != 0) {
                        ...
                        //     firstnode.remove();
                        // }
                        for (var _i10 = 0; _i10 < childNodes.length; _i10++) {
                            var te = childNodes[_i10];
                            if (te.localName == "text") {
                                if (te.getAttribute("pbindid")) {
                                    if (!te.getAttribute("placeholderid")) {
                                        te = childNodes[_i10].nextSibling;
                                        if (te.nodeType == 3) {
                                            newChildNodes.push(te);
                                            if (!childNodes[_i10].hasAttribute("bindid") && !childNodes[_i10].hasAttribute("placeholderid")) {
                                                childNodes[_i10].remove();
                                            }
                                            continue;
                                        }
                                    }
            ...
            key: 'renderNodes',
            value: function renderNodes(toAppend, dynamicNodes, helperNode, options, establishBindings, returnVal, templateContent, yieldComp) {
                var _this9 = this;
                ...
                var _loop = function _loop(_i12) {
                    ...
                    if (!dynamicNodes._cache && !(_this9.registeredProp && _this9.registeredProp.length)) {
                        dynamicNodes._cache = {};
                    }
                    if (type === "componentDynamic") {
                        ...
                        if (_this9._ssrBind) {
                            var id = void 0,
                                _type = _this9.getssrType(type);
                            if (dynamicN.hasAttribute("bindId")) {
                                id = dynamicN.getAttribute("bindId");
                            } else {
                                id = _this9.getRandomId(_type + "_"); //type + Math.floor( Math.random() * 1000 );
                                // dynamicN.setAttribute( "helperId", id );
                                dynamicN.setAttribute("bindId", id);
                            }
                            var _obj6 = { id: id, type: _type, idx: _i12 };
                            cmpData.bindIds.push(_obj6); //    
                            if (helperNode) {
                                _obj6._helperId = helperNode.getAttribute("bindid");
                                if (/^(for|forIn)$/.test(helperNode.getAttribute("is"))) {
                                    _obj6._forType = _this9.getssrType(helperNode.getAttribute("is"));
                                    _obj6._forIndex = dynamicN._cx.itemIndex;
                                }
                            }
                        }
                        //ssrcode_end          
                    } else if (type === "text") {
                        _this9.bindNode(dynamicN, undefined, helperNode, options, dynamicNodes[_i12], processLast, establishBindings, undefined, dynamicNodes._cache, type, undefined, toBeInsMap);
                    } else if (type === "attr") {
                        dynamicN._attributeDetails = info.attr;
                        if (dynamicN.nodeName === "LYTE-YIELD") {
                            dynamicN._callee = _this9;
                            dynamicN.component = {};
                        ...
                        for (var _key17 in info.attr) {
                            ...
                            if (_attr && (_attr.dynamicValue || _attr.helperInfo)) {
                                ...
                                if (_attr.helperInfo && _attr.helperInfo.name === "action") {
                                    ...
                                    if (_this9._ssrBind) {
                                        var helpId = void 0;
                                        dynamicN.setAttribute(_id, _id);
                                        _this9.component.data.bindIds.__actions = _this9.component.data.bindIds.__actions ? _this9.component.data.bindIds.__actions : [];
                                        var _obj7 = { id: _id, type: "A1", args: _attr.helperInfo.args, "event": _attr.name, actionName: actualAttrName, idx: _i12, "boundName": boundName };
                                        if (helperNode) {
                                            helpId = helperNode.getAttribute("bindId");
                                            _obj7._helperId = helpId;
                                            if (/^(for|forIn)$/.test(helperNode.getAttribute("is"))) {
                                                _obj7._forType = _this9.getssrType(helperNode.getAttribute("is"));
                                                _obj7._forIndex = dynamicN._cx.itemIndex;
                                            }
                                        }
                                        //this.component.data.bindIds.__actions.push( obj );
                                        _this9.component.data.bindIds.push(_obj7);
                                    }
                                    //ssrcode_end                       
                                }
                                if (!_attr.globalEvent) {
                                    ...
                                    node = _this9.bindNode(dynamicN.attributes.getNamedItem(attrName), toBeRemoved, helperNode, options, _attr, undefined, establishBindings, undefined, dynamicNodes._cache, type, _i12);
                        ...
                        var _self6 = _this9;
                        processDirectiveLazy.forEach(function (obj) {
                            //eslint-disable-line no-loop-func
                            var attr = obj.attr;
                            var node = obj.node;
                            ...
                            if (attr.hookNode) {
                                _LC.directive.infoA(_self6, info, dynamicN, helperNode, attr, yieldComp, options);
                                if (attr.hookName == "prop" || attr.hookName == "data") {
                                    ...
                                    _LC.directive.save.addData(dynamicN, attr);
                                    if (attr.hookName == "data") {
                                        gonnaSave = dynamicN.$data;
                                    }
                                    _LC.directive.save.addNode(_self6, attr, dynamicN, gonnaSave, node, staticProp, helperNode, options, dynamicNodes);
                                }
                            }
                        });
                        //Added now
                        ...
                        switch (type) {
                            case "for":
                                ...
                                _returnVal = _this9.updateForHelper(dynamicN, { "type": "default" }, options.node ? options : undefined, establishBindings, info._sta);
                                break;
                            case "forIn":
                                dynamicN._ht = info._ht;
                                _returnVal = _this9.updateForInHelper(dynamicN, { "type": "default" }, options.node ? options : undefined, establishBindings);
                                break;
                            case "component":
                                _returnVal = _this9.updateDynamicComponent(dynamicN, false, options.node ? options : undefined, establishBindings, _i12, helperNode);
                        }
                        if (_returnVal) {
                        ...
                        var _id2 = void 0;
                        //ssrcode_start
                        if (!_LC.unbound && (_this9._ssrBind || _this9._callee && _this9._callee._ssrBind)) {
                            var _type2 = _this9.getssrType(type);
                            if (dynamicN.hasAttribute("bindId")) {
                                _id2 = dynamicN.getAttribute("bindId");
                            } else {
                                _id2 = _this9.getRandomId(_type2 + "_");
                                dynamicN.setAttribute("helperId", _id2);
                                dynamicN.setAttribute("bindId", _id2);
                            }
                            var _obj8 = { id: _id2, type: _type2, case: type == "if" ? dynamicN._attributes.value ? true : false : dynamicN._attributes.value, idx: _i12 },
                                _helpId = void 0;
                            if (helperNode) {
                                ...
                                if (/^(for|forIn)$/.test(helperNode.getAttribute("is"))) {
                                    _obj8._forType = _this9.getssrType(helperNode.getAttribute("is"));
                                    _obj8._forIndex = dynamicN._cx.itemIndex;
                                }
                            }
                            _this9.component.data.bindIds.push(_obj8);
                        }
                        //ssrcode_end

                        var _returnVal2 = _this9.updateSwitchHelper(type, dynamicN, options.node ? options : undefined, undefined, establishBindings, yieldComp, _id2, toBeInsMap);
                        if (_returnVal2) {
                        ...
                        //ssrcode_start
                        if (!_LC.unbound && _this9._ssrBind) {
                            //to bind registerYield in ssr components
                            var _id3 = void 0,
                                _type3 = _this9.getssrType(type);
                            if (dynamicN.hasAttribute("bindId")) {
                                _id3 = dynamicN.getAttribute("bindId");
                            } else {
                                _id3 = _this9.getRandomId(_type3 + "_"); //type + Math.floor( Math.random() * 1000 );
                                dynamicN.setAttribute("helperId", _id3);
                                dynamicN.setAttribute("bindId", _id3);
                            }
                            var _obj9 = { id: _id3, type: _type3, idx: _i12 };
                            if (helperNode && helperNode.getAttribute("bindId")) {
                                _obj9._helperId = helperNode.getAttribute("bindId");
                                if (helperNode && helperNode.getAttribute("bindId")) {
                                    _obj9._helperId = helperNode.getAttribute("bindId");
                                    if (/^(for|forIn)$/.test(helperNode.getAttribute("is"))) {
                                        _obj9._forType = _this9.getssrType(helperNode.getAttribute("is"));
                                        _obj9._forIndex = dynamicN._cx.itemIndex;
                                    }
                                }
                            }
                            _this9.component.data.bindIds.push(_obj9);
                        }
                        //ssrcode_end
                        dynamicN._dynamicNodes = info.dynamicNodes;
                        ...
                        if (!_LC.unbound && _this9._ssrBind) {
                            var _id4 = void 0,
                                _type4 = _this9.getssrType(type);
                            if (dynamicN.hasAttribute("bindId")) {
                                _id4 = dynamicN.getAttribute("bindId");
                            } else {
                                _id4 = _this9.getRandomId(_type4 + "_"); //type + Math.floor( Math.random() * 1000 );
                                dynamicN.setAttribute("helperId", _id4);
                                dynamicN.setAttribute("bindId", _id4);
                            }
                            var _obj10 = { id: _id4, type: _type4, idx: _i12 };
                            if (helperNode && helperNode.getAttribute("bindId")) {
                                _obj10._helperId = helperNode.getAttribute("bindId");
                                if (/^(for|forIn)$/.test(helperNode.getAttribute("is"))) {
                                    _obj10._forType = _this9.getssrType(helperNode.getAttribute("is"));
                                    _obj10._forIndex = dynamicN._cx.itemIndex;
                                }
                            }
                            //obj.data  = dynamicN.component;
                            _obj10.properties = dynamicN._properties;
                            _this9.component.data.bindIds.push(_obj10);
                        }
                        //ssrcode_end
                        dynamicN.component = dynamicN.component || { "data": {} };
                        dynamicN._properties = dynamicN._properties || {};
                        var dData = LyteComponent.getCmpData(dynamicN.component.data);
                        ...
                        _this9.updateYield(dynamicN, false, options.node ? options : undefined);
                    }
                };

                for (var _i12 = 0; _i12 < dynamicNodes.length; _i12++) {
                    var def;

                    var _ret3 = _loop(_i12);

                    if (_ret3 === 'break') break;
                }
                dynamicNodes._cache = undefined;
                for (var _i13 = 0; _i13 < processLast.length; _i13++) {
                    var dynamicPosition = processLast[_i13].dynamicPositions;
                    ...
                    processLast[_i13].dynamicPositions = { startingNode: startingNode, length: childLen };
                }
                if (toBeInsMap.size) {
            ...
            value: function executeBlockHelpers(updateHelpers, node) {
                for (var _i14 = 0; _i14 < updateHelpers.length; _i14++) {
                    var lastNode = updateHelpers[_i14].lastNode;
                    ...
                    _insertBefore(parentNode, updateHelpers[_i14].toAppendMain, lastNode);
                    updateHelpers[_i14] = updateHelpers[_i14].lastNode;
            ...
            value: function updateBlockHelpers(updateHelpers, contextSwitchInfo) {
                for (var _i15 = 0; _i15 < updateHelpers.length; _i15++) {
                    switch (updateHelpers[_i15].getAttribute('is')) {
                        case "for":
                            this.updateForHelper(updateHelpers[_i15], { "type": "default" }, contextSwitchInfo);
                            break;
                        case "if":
                            this.updateSwitchHelper("if", updateHelpers[_i15], contextSwitchInfo);
                            break;
                        case "forIn":
                            this.updateForInHelper(updateHelpers[_i15], { "type": "default" }, contextSwitchInfo);
                            break;
                        case "switch":
                            this.updateSwitchHelper("switch", updateHelpers[_i15], contextSwitchInfo);
                            break;
                        case "component":
                            this.updateDynamicComponent(updateHelpers[_i15], false, contextSwitchInfo);
                            break;
                        case "insertYield":
                        ...
                        case "registerYield":
                            if (contextSwitchInfo) {
                                updateHelpers[_i15]._cx = contextSwitchInfo;
                            }
                            break;
                        default:
                            if (updateHelpers[_i15].tagName === "LYTE-YIELD") {
                                this.updateYield(updateHelpers[_i15], false, contextSwitchInfo);
                            }
            ...
            value: function removeHelpersSpecificIndex(node, index) {
                ...
                if (node._forContent[index]) {
                    for (var _i16 = 0; _i16 < node._forContent[index].length; _i16++) {
                        node._forContent[index][_i16].remove();
                    }
                    var self = this;
                ...
                if (node._specialNodes && node._specialNodes.length) {
                    _LC.directive.save.removeAllNode(this, node._specialNodes[index]);
            ...
            value: function removeHelpers(node, update, direct) {
                ...
                if (node._forContent) {
                    if (node.getAttribute("is") === "for") {
                        if (node._helpers) {
                            for (var _i17 = 0; _i17 < node._helpers.length; _i17++) {
                                for (var j = 0; j < node._helpers[_i17].length; j++) {
                                    this.removeHelpers(node._helpers[_i17][j]);
                                }
                                node._helpers[_i17] = [];
                            }
                        }
                        for (var _s = 0; _s < node._forContent.length; _s++) {
                            for (var _i18 = 0; _i18 < node._forContent[_s].length; _i18++) {
                                node._forContent[_s][_i18].remove();
                            }
                        }
                        if (node._specialNodes && node._specialNodes.length) {
                            _LC.directive.save.removeAllNode(this, node._specialNodes);
                            node._specialNodes = [];
                        }
                        var _key19 = node.getAttribute("item");
                        if (node._items.length) {
                            var prop = node._items[0].itemProperty;
                            for (var _i19 = 0; _i19 < node._items.length; _i19++) {
                                var dynProp = node._items[_i19]._dynamicProperty;
                            ...
                            if (prop) {
                                for (var _i20 = 0; _i20 < node._items.length; _i20++) {
                                    this.removeBindings(_defineProperty({}, _key19, node._items[_i20].itemProperty), _defineProperty({}, _key19, node._attributes.items[_i20]));
                                }
                            }
                        }
                        if (!update) {
                        ...
                        if (node._helpers) {
                            ...
                            for (var _i21 = 0; _i21 < keys.length; _i21++) {
                                for (var _j = 0; _j < node._helpers[keys[_i21]].length; _j++) {
                                    this.removeHelpers(node._helpers[keys[_i21]][_j]);
                                }
                                node._helpers[keys[_i21]] = [];
                            }
                        }
                        for (var ind in node._forContent) {
                            for (var _i22 = 0; _i22 < node._forContent[ind].length; _i22++) {
                                node._forContent[ind][_i22].remove();
                            }
                        }
                    ...
                    if (node._caseContent) {
                        for (var _i23 = 0; _i23 < node._caseContent.length; _i23++) {
                            node._caseContent[_i23].remove();
                        }
                        ...
                        for (var _i24 = 0; _i24 < node._yieldContent.length; _i24++) {
                            node._yieldContent[_i24].remove();
                        }
                        node._dynamicProperty = {};
                    }
                    ...
                    for (var _key22 in node._renderedComponent) {
                        var comp = node._renderedComponent[_key22];
                        if (comp) {
            ...
            value: function updateDynamicComponent(node, update, contextSwitchInfo, establishBindings, idx, helperNode) {
                ...
                if (update) {
                    if (keepAlive) {
                        _LyteComponent.setIgnoreDisconnect(true);
                    }
                    ...
                    _LyteComponent.setIgnoreDisconnect(false);
                    if (!keepAlive) {
                        node._dynamicProperty = {};
                    }
                ...
                if (newComponent) {
                    //          let componentData = {};
                    for (var _i25 = 0; _i25 < node.attributes.length; _i25++) {
                        if (node.attributes[_i25].name !== "is" && node.attributes[_i25].name !== "component-name" && node.attributes[_i25].name !== "lyte-keep-alive") {
                            component.setAttribute(node.attributes[_i25].name, node.attributes[_i25].value);
                        }
                    }
            ...
            key: 'updateForHelper',
            value: function updateForHelper(node, options, contextSwitchInfo, establishBindings, staticTempArr, yieldComp) {
                var _this10 = this;
                        ...
                        case "remove":
                            {
                                ...
                                for (var _i26 = firstIndex, v = secondIndex; v > 0; v--, _i26++) {
                                ...
                                for (var _i27 = firstIndex + secondIndex; _i27 < node._items.length; _i27++) {
                                    node._items[_i27]._cx.itemIndex = node._items[_i27]._cx.itemIndex - secondIndex;
                                }
                        ...
                        case "replace":
                            {
                                ...
                                for (var _i29 = firstIndex + secondIndex; _i29 < node._items.length; _i29++) {
                                    node._items[_i29]._cx.itemIndex = node._items[_i29]._cx.itemIndex + secondIndex - 1;
                                }
                        ...
                        case "splice":
                            {
                                ...
                                lastIndexForIteration = secondIndex;
                                indexPropertyStartIndex = firstIndex + secondIndex;
                                for (var _i30 = thirdIndex, j = 0; _i30 > 0; _i30--, j++) {
                                ...
                                //                      forItem.itemIndex = forItem.itemIndex + secondIndex - 1 ;
                                //                  }
                                for (var _i31 = firstIndex + secondIndex; _i31 < node._items.length; _i31++) {
                                    node._items[_i31]._cx.itemIndex = node._items[_i31]._cx.itemIndex + secondIndex - thirdIndex;
                                }
                        ...
                        case "update":
                            {
                                ...
                                for (var _i32 = 0; _i32 < node._items.length; _i32++) {
                                    this.removeHelpersSpecificIndex(node, _i32);
                                }
                ...
                if (options.type !== "remove") {
                    ...
                    var _loop2 = function _loop2(_k7, _v4) {
                        node._helpers[_k7] = [];
                        node._specialNodes[_k7] = [];
                        node._items[_k7] = { "_dynamicProperty": {}, "itemProperty": {}, "indexProperty": {}, "propProperty": {}, "propNodes": {} };
                        ...
                        var toAppend = void 0;
                        if (node._fRender) {
                            var str = _this10.renderFast(dynamicNodes, node._sta, _this10.component);
                            ...
                            toAppend = _this10.renderNodes(trueNode.hasAttribute("depth") && trueNode._depthTemp ? trueNode._depthTemp : trueNode, dynamicNodes, node, optns, establishBindings, breakCheck, node._tC, yieldComp);
                        }
                        ...
                        if (_this10._ssrBind) {
                            ...
                            _this10.component.data.bindIds.push(_obj13);
                            newFrag = document.createDocumentFragment();

                            for (var _i33 = 0; _i33 < _childNodes.length; _i33++) {
                                // if( childNodes[ i ].nodeType == 3 ){
                                //     let textEle = document.createElement( "text" );
                                //     textEle.innerText = "";
                                //     childNodes[ i ] = textEle;
                                // }
                                if (_childNodes[_i33].nodeType == 3) {
                                    if (_childNodes[_i33 - 1] && _childNodes[_i33 - 1].localName == "text") {
                                        _childNodes[_i33 - 1].setAttribute("forId", id);
                                    } else if (_childNodes[_i33].nodeValue != "" && _childNodes[_i33].nodeValue != " ") {
                                    ...
                                    // childNodes[ i ] = textEle;
                                } else if (_childNodes[_i33].localName !== "textend") {
                                    _childNodes[_i33].setAttribute("forId", id);
                                }
                                if (_childNodes[_i33].localName !== "textend") {
                                    newFrag.appendChild(_childNodes[_i33]);
                                }
                            }
                            toAppend = newFrag;
                        }
                        ...
                        node._items[_k7].itemProperty = _this10.getProperty(itemValue);
                        node._items[_k7].indexProperty = _this10.getProperty(indexValue);
                        ...
                        _this10.executeBlockHelpers(node._helpers[_k7], node);
                        if (!node._fRender) {
                        ...
                        var propArr = Object.keys(node._items[_k7].propProperty);
                        if (propArr.length) {
                            var _self7 = _this10;
                            propArr.forEach(function (propValue) {
                                //eslint-disable-line no-loop-func
                                _self7.afterUpdateFor(_self7, node, propValue, optns);
                            });
                        }
                    };
                ...
                if (updateIndexProperty) {
                    for (var _i34 = indexPropertyStartIndex; _i34 < node._items.length; _i34++) {
                        if (node._items[_i34].indexProperty) {
                            _LC.affectChanges(node._items[_i34].indexProperty);
                        }
                    }
                }
                ...
                for (var _key25 in node._propNodes) {
                    this.setData(_key25, node._propNodes[_key25]);
                    var cxObj = node._cx;
                    if (cxObj) {
                        // if(cxObj.type == "for"){
                        // let newArr = [];
                        while (cxObj) {
                            if (cxObj.type == "for" || cxObj.type == "forIn") {
                                var parentPropNodes = cxObj.node._propNodes[_key25];
                                if (!cxObj.node._propNodes[_key25]) {
                                    parentPropNodes = cxObj.node._propNodes[_key25] = [];
                                }
                                parentPropNodes[cxObj.itemIndex] = node._propNodes[_key25];
                                // cxObj.node._propNodes[key] = newArr;
                                if (!cxObj.node._childProp) {
                                    cxObj.node._childProp = [_key25];
                                } else if (cxObj.node._childProp.indexOf[_key25] == -1) {
                                    cxObj.node._childProp.push(_key25);
                                }
                                this.beforeUpdateFor(this, cxObj.node, _key25, cxObj.itemIndex);
                                cxObj = null;
                            } else {
                        ...
                        // _LC.affectChanges(this.getProperty(key));
                        console.log("Dummy");
                    }
                }
                node._currentItems = items;
            ...
            value: function renderPromiseNodes(trueNode, dynamicNodes, node, optns, establishBindings, returnVal, templateContent, yieldComp, toAppendMain) {
                ...
                for (var _i35 = 0; _i35 < contentArr.length; _i35++) {
                    if (contentArr[_i35].nodeType == 11) {
                        node._promiseContent = node._promiseContent.concat(Array.from(contentArr[_i35].childNodes));
                    } else {
                        node._promiseContent.push(contentArr[_i35]);
                    }
                    toAppendMain.append(contentArr[_i35]);
                }
            }
            ...
            value: function updateForInHelper(node, options, contextSwitchInfo, establishBindings, yieldComp) {
                var hasChild = node.hasAttribute("has-child");
                if (!node._specialNodes) {
                    node._specialNodes = [];
                }
                ...
                if (object && options.type !== "remove") {
                    ...
                    keysArray.forEach(function (itemKey, index, array) {
                        ...
                        node._items[itemKey] = { "_dynamicProperty": {}, "itemProperty": {}, "propProperty": {}, "propNodes": {} };
                        cmpData[key] = itemKey;
                        ...
                        if (this._ssrBind) {
                            ...
                            for (var _i36 = 0; _i36 < childNodes.length; _i36++) {
                                // if( childNodes[ i ].nodeType == 3 ){
                                //     let textEle = document.createElement( "text" );
                                //     textEle.innerText = "";
                                //     childNodes[ i ] = textEle;
                                // }
                                if (childNodes[_i36].nodeType == 3) {
                                    if (childNodes[_i36 - 1] && childNodes[_i36 - 1].localName == "text") {
                                        childNodes[_i36 - 1].setAttribute("forId", id);
                                    } else if (childNodes[_i36].nodeValue != "" && childNodes[_i36].nodeValue != " ") {
                                        var textEle = document.createElement("text");
                                        textEle.innerText = "";
                                        textEle.setAttribute("forId", id);
                                        newFrag.appendChild(textEle);
                                    ...
                                    // toBeInsMap.set(textEle, {pN: childNodes[ i ].parentNode, cN: childNodes[ i ]});
                                    // childNodes[ i ] = textEle;
                                } else if (childNodes[_i36].localName !== "textend") {
                                    childNodes[_i36].setAttribute("forId", id);
                                }
                                if (childNodes[_i36].localName !== "textend") {
                                    newFrag.appendChild(childNodes[_i36]);
                                }
                            }
                            toAppend = newFrag;
                        }
                        //ssrcode_end
                        var propArr = Object.keys(node._items[itemKey].propProperty);
                        if (propArr.length) {
                            var _self8 = this;
                            propArr.forEach(function (propValue) {
                                _self8.afterUpdateFor(_self8, node, propValue, optns);
                            });
                        }
                        toAppendMain.appendChild(toAppend);
                    }, this);
                ...
                for (var _key26 in node._propNodes) {
                    this.setData(_key26, node._propNodes[_key26]);
                    var cxObj = node._cx;
                    if (cxObj) {
                        // if(cxObj.type == "forIn"){
                        // let newArr = [];
                        while (cxObj) {
                            if (cxObj.type == "for" || cxObj.type == "forIn") {
                                var parentPropNodes = cxObj.node._propNodes[_key26];
                                if (!cxObj.node._propNodes[_key26]) {
                                    parentPropNodes = cxObj.node._propNodes[_key26] = [];
                                }
                                parentPropNodes[cxObj.itemIndex] = node._propNodes[_key26];
                                // cxObj.node._propNodes[key] = newArr;
                                if (!cxObj.node._childProp) {
                                    cxObj.node._childProp = [_key26];
                                } else if (cxObj.node._childProp.indexOf[_key26] == -1) {
                                    cxObj.node._childProp.push(_key26);
                                }
                                this.beforeUpdateFor(this, cxObj.node, _key26, cxObj.itemIndex);
                                cxObj = null;
                            } else {
                                cxObj = cxObj.node._cx;
                            }
                        ...
                        _LC.affectChanges(this.getProperty(_key26));
                    }
                }
                node._currentObject = object;
                return returnVal;
            ...
            value: function updateSwitchHelper(type, node, contextSwitchInfo, update, establishBindings, yieldComp, id, toBeInsMap) {
                        ...
                        for (var _i37 = 0; _i37 < childNodes.length; _i37++) {
                            if (childNodes[_i37].nodeType == 3) {
                                if (childNodes[_i37 - 1] && childNodes[_i37 - 1].localName == "text") {
                                    childNodes[_i37 - 1].setAttribute("pbindid", id);
                                ...
                                childNodes[_i37].setAttribute("pBindId", id);
                            }
                ...
                node._caseContent = [];
                var toAppendMain = createDocFragment();;
                for (var _i38 = 0; _i38 < contentArr.length; _i38++) {
                    if (contentArr[_i38].nodeType == 11) {
                        //                for(let j=0;j<contentArr[i].childNodes.length;j++) {
                        //                    node._caseContent.push(contentArr[i].childNodes[j]);
                        //                }
                        node._caseContent = node._caseContent.concat(Array.from(contentArr[_i38].childNodes));
                    } else {
                        node._caseContent.push(contentArr[_i38]);
                    }
                    toAppendMain.append(contentArr[_i38]);
            ...
            value: function callObservers(boundValue, key) {
                ...
                if (observers) {
                    for (var _i39 = 0; _i39 < observers.length; _i39++) {
                        if (key.indexOf('.') === -1 || observers[_i39].path === key) {
                            this["_" + observers[_i39].functionName].apply(this);
                        }
                    }
                }
            }
            ...
            value: function getProperty(key) {
                ...
                defProp(property, '_path', { enumerable: false, value: arr[0] });
                for (var _i40 = 1; _i40 < arr.length; _i40++) {
                    if (arr[_i40].startsWith("'") || arr[_i40].startsWith('"')) {
                        //added check
                        arr[_i40] = arr[_i40].substring(1, arr[_i40].length - 1);
                    }
                    if (!property[arr[_i40]]) {
                        property[arr[_i40]] = {};
                        defProp(property[arr[_i40]], '_path', { enumerable: false, value: property._path + "." + arr[_i40] });
                    }
                    property = property[arr[_i40]];
                }
                return property;
            }
            //updN
            ...
            value: function updateNode(node, updatePath, options) {
                                ...
                                if (nodes.length === 0) {
                                    if (helperNode.getAttribute("is") === "if") {
                                        ...
                                        if (helperNode._items) {
                                            ...
                                            for (var _i41 = 0; _i41 < helperNode._items.length; _i41++) {
                                                if (helperNode._items[_i41]._dynamicProperty && helperNode._items[_i41]._dynamicProperty[multipleProp.actProp._path]) {
                                                    removeHelper = false;
                                                    break;
                                                }
                                            }
                ...
                if (isDirectiveNode) {
                    ...
                    if (node._saveNode) {
                        _LC.directive.save.updateNode(this, node, nodeValue);
                    }
                } else if (node.nodeType === 2) {
                    var parentNodes = [];
                    ...
                    parentNodes.push(pN);
                    for (var _i42 = 0; _i42 < parentNodes.length; _i42++) {
                        var parentNode = parentNodes[_i42];
                        if (parentNode.set) {
                ...
                if (node.ownerElement && node.ownerElement._hooksPresent) {
                    var saveAttr = _LC.directive.save.getAttr(node.ownerElement._specialAttributeDetails);
                    if (saveAttr) {
                        _LC.directive.save.triggerAllListeners(this, saveAttr, node.ownerElement);
                    }
                }
                if (contextSwitchInfo) {
            ...
            value: function handleBreak(contextSwitchInfo, options) {
                if (contextSwitchInfo) {
                    ...
                    for (var j = breakIndex; j < endIndex; j++) {
                        ...
                        for (var _i43 = 0; _i43 < currentForContent.length; _i43++) {
                            currentForContent[_i43].remove();
                            if (currentForContent[_i43]._forContent || currentForContent[_i43]._caseContent) {
                                this.removeHelpers(currentForContent[_i43]);
                            }
                        }
                        forContent[j] = [];
            ...
            value: function processArgs(scope, dynN, dynamicValues, event, node, newCompile, cache) {
                ...
                for (var _i44 = 0; _i44 < args.length; _i44++) {
                    if (args[_i44] && args[_i44].type) {
                        this.internalHelpers(scope, args, _i44, dynamicValues, event, node, newCompile, cache);
                    } else {
                        if (!this.isEmptyString(args[_i44])) {
                            if (args[_i44].startsWith("'") && args[_i44].endsWith("'")) {
                                args[_i44] = args[_i44].substr(1, args[_i44].length - 2);
                            } else {
                                args[_i44] = args[_i44].trim();
                                var dynamicVals = [];
                                if (args[_i44] === "event" && event) {
                                    args[_i44] = widget && widgetMap.has(widget) ? widgetMap.get(widget).getClone(event) : event;
                                } else if (args[_i44] === "this" && node) {
                                    var thisNode = node.nodeType === 2 ? node.ownerElement : node;
                                    args[_i44] = widget && widgetMap.has(widget) ? widgetMap.get(widget).getClone(thisNode) : thisNode;
                                } else {
                                    args[_i44] = _LC.get(scope.component.data, args[_i44], dynamicVals, cache);
                                }
                                dynamicValues.push(dynamicVals);
                            }
                        } else if (newCompile) {
                            if (args[_i44] instanceof Array) {
                                args[_i44] = _LC.getDD(scpData, args[_i44]);
                            }
                        }
                    }
                }
            ...
            value: function getArgValues(argNames, properties) {
                var argValueArray = [];
                for (var _i45 = 0; _i45 < argNames.length; _i45++) {
                    argValueArray.push(properties[argNames[_i45]].value);
                }
            ...
            value: function registerYields() {
                ...
                var lazyYields = [];
                for (var _i46 = 0; _i46 < yields.length; _i46++) {
                    while (yields[_i46].hasChildNodes()) {
                        yields[_i46].content.appendChild(yields[_i46].childNodes[0]);
                    }
                    if (yields[_i46].hasAttribute("from-parent") && this._callee) {
                        if (this._callee._yields) {
                            this.registerParentYield(yields[_i46].getAttribute("yield-name"));
                        } else {
                            lazyYields.push(yields[_i46]);
                        }
                    } else {
                        this._yields[yields[_i46].getAttribute("yield-name")] = yields[_i46];
                    }
                }
            ...
            value: function actualConnectedCallback() {
                ...
                if (templateAttributes && templateAttributes.attr) {
                    for (var _key27 in templateAttributes.attr) {
                        //        		let attr = templateAttributes.attr[i];
                        var attr = templateAttributes.attr[_key27];
                        if (!this.hasAttribute(attr.name) && !compData.hasOwnProperty(attr.name) || attr.globalEvent) {
                            ...
                            if (!attr.globalEvent) {
                                attr.from = "component";
                                if (attr.staticValue) {
                                    this.setAttribute(templateAttributes.attr[_key27].name, attr.staticValue);
                                } else {
                                    this.setAttribute(templateAttributes.attr[_key27].name, "{{dummy}}");
                                    this.bindNode(this.attributes.getNamedItem(templateAttributes.attr[_key27].name), [], undefined, {}, templateAttributes.attr[_key27], undefined, undefined, true);
                                }
                            }
                        }
                    }
                }
                for (var _key28 in this._toRegEvnts) {
                    this.addEventListener(_key28, this._toRegEvnts[_key28].listener);
                    if (this.hasAttribute(_key28)) {
                        this.setAttribute(_key28, this.getAttribute(_key28) + " ; " + this._toRegEvnts[_key28].attrVal);
                    } else {
                        this.setAttribute(_key28, this._toRegEvnts[_key28].attrVal);
                    }
                }
                this._toRegEvnts = {};
                var initialUnbound = _LC.unbound;
                ...
                this.__lyteIgnore = true;
                for (var _i47 = attributes.length - 1; _i47 > -1; _i47--) {
                    var camelCase = LyteComponent.String.toCamelCase(attributes[_i47].nodeName);
                    if (dataDef[camelCase] && dataDef[camelCase].hideAttr) {
                        this.removeAttribute(attributes[_i47].nodeName);
                    }
                }
                ...
                if (this._triggerOnInit) {
                    var triggerOnInit = this._triggerOnInit;
                    var _self9 = this;
                    triggerOnInit.forEach(function (obj) {
                        Lyte.Component.set(obj.scope.$data, obj.value, obj.name == "data" ? _self9.$data : _self9, { force: true });
                    });
                    this._triggerOnInit = undefined;
                }
                if (this.__updateProp) {
                    if (this._cx) {
                        var forNode = this._cx.node;
                        if (this._cx.type == "for" || this._cx.type == "forIn") {
                            var ind = this._cx.itemIndex;
                            if (this.__updateProp.data) {
                                var _self10 = this;
                                this.__updateProp.data.forEach(function (propVal) {
                                    if (forNode._propNodes[propVal]) {
                                        addBindings(_self10.$data, forNode._items[ind].propProperty[propVal]); //added so that child will listn and update parent
                                        Lyte.Component.set(forNode._propNodes[propVal], ind, _self10.$data, { force: true });
                                        _LC.affectChanges(forNode._items[ind].propProperty[propVal]);
                                        _LC.establishBindings(forNode._items[ind].propProperty[propVal], forNode._propNodes[propVal][ind]);

                                        // Lyte.Component.set(forNode._propNodes[propVal][ind], self.$data);
                                        // remove __lyteDirective
                                    }
                                });
                            } else if (this.__updateProp.prop) {
                                var _self11 = this;
                                this.__updateProp.prop.forEach(function (propVal) {
                                    if (forNode._propNodes[propVal]) {
                                        Lyte.Component.set(forNode._propNodes[propVal][ind], "$data", _self11.$data, { force: true });
                                    }
                                });
                            }
                        }
                        ...
                        if (this.__updateProp.data) {
                            var _self12 = this;
                            this.__updateProp.data.forEach(function (propVal) {
                                Lyte.Component.set(_self12._callee.component.data, propVal, _self12.$data, { force: true });

                                // Lyte.Component.set(self._callee.component.data[propVal], self.$data);
                            });
                        } else if (this.__updateProp.prop) {
                            var _self13 = this;
                            this.__updateProp.prop.forEach(function (propVal) {
                                Lyte.Component.set(_self13._callee.component.data, propVal, _self13, { force: true });
                            });
                        }
                    }
                }
                ...
                if (_Lyte.isWidgetBuild && this.hasAttribute("comp-in-parent")) {
                    var _self14 = this;
                    setTimeout(function () {
                        DataBindingLayer.sendDataUpdateToFrame(_self14, _self14.component.data);
                    }, 0);
                }
            ...
            value: function onCallBack(name) {
                ...
                if (callbacks) {
                    for (var _i48 = 0; _i48 < callbacks.length; _i48++) {
                        try {
                            callbacks[_i48].value.call(this.component);
                        } catch (e) {
                            _Lyte.error(e);
                        }
                    }
            ...
            value: function establishObserverBindings() {
                ...
                for (var _i49 = 0; _i49 < observers.length; _i49++) {
                    var props = observers[_i49].properties;
                    for (var j = 0; j < props.length; j++) {
                        var actProp = void 0;
                        var isArrayObserver = false;
                        if (props[j].indexOf('.[]') !== -1) {
                        ...
                        actProp._observers.add({ callee: this, observer: observers[_i49], isArrayObserver: isArrayObserver });
                    }
                }
            }
        }, {
            ...
            value: function removeBindings(properties, actualData) {
                var del = "delete";
                for (var _i50 in properties) {
                    var actData = actualData[_i50];
                    if (actData && actData._bindings) {
                        actData._bindings[del](properties[_i50]);
                    ...
                    if (_typeof(properties[_i50]) === "object" && actData) {
                        this.removeBindings(properties[_i50], actData);
                    }
                }
            }
        }, {
                    ...
                    for (key in self.__dc) {
                        ...
                        if (helper.hasAttribute("lyte-keep-alive")) {
                            ...
                            for (var j = 0; j < objKeys.length; j++) {
                                var _key29 = objKeys[j];
                                if (_key29 !== helper._currentComponent) {
                                    // Will remove from hDiv.
                                    var comp = helper._renderedComponent[_key29];
                                    comp.constructor.prototype._disconnectedCallback.call(comp);
                                    comp.remove();
                                }
                            }
            ...
            value: function _disconnectedCallback() {
                ...
                if (_LyteComponent.shouldIgnoreDisconnect() || !this.component || this.__lyteIgnore) {
                    return;
                }
                /*disable async function*/
                var widget = this.constructor.__widgetName;
                ...
                if (pve.length) {
                    for (var _i51 = 0; _i51 < pve.length; _i51++) {
                        var actTemp = _LC.getActViewPortTemplate(pve[_i51]);
                ...
                for (var _key30 in this._properties) {
                    this._properties[_key30] = {};
                }
            ...
            value: function dasherizeObservedAttributes() {
                var newArr = [];
                for (var _i52 = 0; _i52 < this._observedAttributes.length; _i52++) {
                    newArr[_i52] = _LC.String.dasherize(this._observedAttributes[_i52]);
                }
            ...
            value: function updateValue(property, path, value) {
                ...
                for (var _i53 = 0; _i53 < pathVals.length - 1; _i53++) {
                    context = context[pathVals[_i53]];
                }
            ...
            value: function _registerComponent(a, b, widget) {
                ...
                var origTemplateValue = this.component._template;
                var clonedDummyTemp;
                if (this.component._template && typeof this.component._template === "string") {
                    ...
                    var _temp;
                    if (widget) {
                        var styleTags = document.createElement("template");
                    }
                ...
                var hasUnbound = this.component._observedAttributes.indexOf("lyteUnbound") !== -1;
                var s = _Lyte._ie ? this.component._template : this.component._template.content; //)?this._template.content:document.createDocumentFragment(this._template);
                ...
                if (this.component._dynamicNodes) {
                    doCompile(s, this.component._dynamicNodes, a, this, newCompile ? _Lyte._ie ? newCompile : newCompile.content : undefined);
                    if (_Lyte._ed) {
                        this._tC = this.component._template.outerHTML;
                    } else if (_Lyte._ie) {
                        this._tC = s.outerHTML;
                    }
                    this.component._templateAttributes = this.component._templateAttributes || { type: "attr", "attr": {}, position: [] };
                    var ta = [this.component._templateAttributes];
                    doCompile(this.component._template, ta, a, this);
                    ...
                    if (this.component._templateAttributes && this.component._templateAttributes.attr) {
                        ...
                        try {
                            for (var _i55 = 0; _i55 < attributesT.length; _i55++) {
                                var attrName = attributesT[_i55].name;
                                if (!this.component._templateAttributes.attr[attrName] && attrName !== "tag-name" && attrName !== "use-strict") {
                                    this.component._templateAttributes.attr[attrName] = { "name": attrName, "staticValue": attributesT[_i55].value };
            ...
            value: function splitTextNodes(node) {
                if (node && node.childNodes && node.childNodes.length) {
                    for (var _i56 = node.childNodes.length - 1; _i56 >= 0; _i56--) {
                        this.splitTextNodes(node.childNodes[_i56]);
                    }
                }
                ...
                if (node.nodeType === node.TEXT_NODE) {
                    ...
                    if (_nodeValue4) {
                        ...
                        var newNodeArray = [];
                        for (var _i57 = 0; _i57 < mustacheValues.length; _i57++) {
                            var mustacheStartIndex = _nodeValue4.indexOf(mustacheValues[_i57]);
                            var mustacheEndIndex = mustacheStartIndex + mustacheValues[_i57].length;
                        ...
                        if (_Lyte._rwpf && node.parentNode.nodeName === "#document-fragment") {
                            for (var _i58 = 0; _i58 < newNodeArray.length; _i58++) {
                                _insertBefore(node.parentNode, newNodeArray[_i58], node);
                            }
                            node.remove();
                        } else {
    ...
    var LyteComponent = (_LyteComponent2 = {
        ...
        for (var _key31 in def) {
            if (def[_key31] && def[_key31].type === "observer") {
                def[_key31].fnName = _key31;
                customCrmComponent.component._observers.push(def[_key31]);
            } else if (def[_key31] && def[_key31].type === "callBack") {
                var props = def[_key31].properties;
                for (var k = 0; k < props.length; k++) {
                    if (!customCrmComponent.component._callBacks[props[k]]) {
                        customCrmComponent.component._callBacks[props[k]] = [];
                    }
                    def[_key31].fnName = _key31;
                    customCrmComponent.component._callBacks[props[k]].push(def[_key31]);
                }
                if (def[_key31].observes) {
                    def[_key31].observes.fnName = _key31;
                    customCrmComponent.component._observers.push(def[_key31].observes);
                }
            } else {
                customCrmComponent.component.prototype[_key31] = def[_key31];
            }
        }
        return def;
        ...
        for (var _i59 = 0; _i59 < mixinslen; _i59++) {
            for (var item in mixinsToBeUsed[_i59]) {
                if (item === "actions") {
                    Object.assign(actionsFromMixin, mixinsToBeUsed[_i59][item]);
                } else if (item === "methods") {
                    Object.assign(methodsFromMixin, mixinsToBeUsed[_i59][item]);
                } else {
                    newDefinition[item] = mixinsToBeUsed[_i59][item];
                }
            }
        }
        ...
        var customArgs = [];
        if (arguments.length > 1) {
            for (var _i60 = 1; _i60 < arguments.length; _i60++) {
                customArgs.push(arguments[_i60]);
            }
        }
        //wait for release
        ...
        */
        ...
        if (actObj) {
            ...
            if (actionsObj[actObj.name]) {
                if (!isCustom) {
                    ...
                    var _context = this._callee.component;
                    if (this.__lyteWidget && widgetMap.has(this.__lyteWidget)) {
                        _context = widgetMap.get(this.__lyteWidget).getClone(this._callee.component);
                    }
            ...
            if (eventsObj) {
                ...
                var _context2 = scopeS;
                if (this.__lyteWidget && widgetMap.has(this.__lyteWidget)) {
                    _context2 = widgetMap.get(this.__lyteWidget).getClone(scopeS);
                }
                var _val2 = eventsObj.apply(_context2, args);
    ...
    }), _defineProperty(_LyteComponent2, "componentSet", function componentSet(key, value, options, forceExecute, fromParent) {
    ...
    }), _defineProperty(_LyteComponent2, "nodeSet", function nodeSet(key, value, options, fromParent) {
        ...
        comp.__h[id] = node;
        node.__lyteId = id;
    }), _defineProperty(_LyteComponent2, "update", function update(object, property, value, options, fromStore, oldValue, setterScope, actualProperty, fromParent, storeRecord) {
        ...
        if (!oldValue) {
            ...
            if (fromComponent && fromComponent.tagName !== "LYTE-YIELD") {
                ...
                if (!options || (window.isLyteWidget || window.__lyteEnablePromise) && (typeof options === 'undefined' ? 'undefined' : _typeof(options)) == "object" && options.skipValidation != true) {
            ...
            if (!object.hasOwnProperty(property) && !Array.isArray(object)) {
                ...
                } else if (Lyte.isWidgetBuild && object.__component__ && object.__component__.hasAttribute("comp-in-parent")) {
        ...
        if (value && typeof value !== "string" && typeof value !== "boolean" && typeof value !== "number") {
            ...
            if (oldValue && (typeof oldValue === 'undefined' ? 'undefined' : _typeof(oldValue)) === "object" && oldValue._bindings) {
                ...
                if (fromComponent && fcmpData === object && property.indexOf('.') === -1 && !window.isLyteWidget) {
                    ...
                    if (object._bindings) {
                        ...
                        for (var _i61 = 0; _i61 < oldbind.length; _i61++) {
                            var _item = oldbind[_i61][property];
                            if (_item) {
                                this.removeSelectedBindingDeep(_item, oldValue);
                                addBindings(value, _item);
                                ...
                                this.affectChanges(_item, undefined, oldValue, setterScope, object[property], undefined, options);
                            }
                        }
                    }
                }
                ...
                if (object._bindings) {
                    ...
                    for (var _i62 = 0; _i62 < objbind.length; _i62++) {
                        var _item2 = objbind[_i62];
                        if (_item2[property]) {
                            addBindings(value, _item2[property]);
                            this.establishBindings(_item2[property], value);
                            this.affectChanges(_item2[property], undefined, oldValue, setterScope, object[property], undefined, options);
                        }
                    }
                }
            }
            ...
            if (oldValue && (typeof oldValue === 'undefined' ? 'undefined' : _typeof(oldValue)) === "object" && oldValue._bindings && object._bindings) {
                ...
                for (var _i63 = 0; _i63 < _objbind.length; _i63++) {
                    var _item3 = _objbind[_i63];
                    if (_item3[property]) {
            ...
            if (object._bindings) {
                ...
                for (var _i64 = 0; _i64 < _objbind2.length; _i64++) {
                    var _item4 = _objbind2[_i64];
                    if (_item4[property]) {
                        this.affectChanges(_item4[property], undefined, oldValue, setterScope, object[property], undefined, options);
                    }
                }
            }
        }
    ...
    }), _defineProperty(_LyteComponent2, "set", function set(object, property, value, options, fromStore, fromParent) {
        var lastIndex = -1;
        var s_rec,
            check = {},
            recDottedProp;
        ...
        if ((typeof property === 'undefined' ? 'undefined' : _typeof(property)) === "object") {
            if (_Lyte.isRecord(object) && !fromStore && !object.$.isCloned) {
                ...
                for (var _key32 in property) {
                    var locValue = property[_key32];
                    var dataType = object.$.model.fieldList[_key32];
                    ...
                    if (dataType && (locValue !== undefined || dataType === "boolean") && dataType !== _LC.getDataType(locValue)) {
                        property[_key32] = _LC.typeCast(locValue, dataType);
                    }
                }
        ...
        var commands = [];
        for (var _i66 = 0; _i66 < arrayB.length; _i66++) {
            // var targetIndex = arrayA.findIndex((element) => element === arrayB[i]);
            var arrBi = arrayB[_i66];
            if (arrayB[_i66] && arrayB[_i66].__target__) {
                arrBi = arrayB[_i66].__target__;
            }
        ...
        for (var _i67 = arrayA.length - 1; _i67 >= arrayB.length; _i67--) {
            commands.push({
                type: 'Remove',
                element: arrayA[_i67]
            });
            arrayA.splice(_i67, 1);
        }
        ...
        if (bindings) {
            ...
            for (var _i68 = 0; _i68 < bind.length; _i68++) {
                var binding = bind[_i68];
                        ...
                        for (var _i69 = 0; _i69 < objbind.length; _i69++) {
                            ...
                            if (item._forHelpers) {
                                ...
                                for (var _j4 = 0; _j4 < helperbind.length; _j4++) {
                                    ...
                                    for (var _i70 = index, _j5 = 0; _i70 < finalIndex; _i70++, _j5++) {
                                        _LC.removeSelectedBindingDeep(_defineProperty({}, itemValue, helper._items[_i70].itemProperty), _defineProperty({}, itemValue, deletedItems[_j5]));
                                    }
                                    var contextSwitchArray = [];
                            ...
                            for (var _key34 in item) {
                                ...
                                if (!isNaN(parsedKey) && _cond) {
                                    ...
                                    this.removeSelectedBindingDeep(item[_key34], _oldObject);
                                    if (item[_key34]._forHelpers) {
                                        var bindfor = item[_key34]._forHelpers.toArrayLyte();
                                    ...
                                    if (array[parsedKey] && _typeof(array[parsedKey]) === "object") {
                                        ...
                                        this.establishBindings({ "dummy": item[_key34] }, { "dummy": array[parsedKey] });
                                    }
                                    this.affectChanges(item[_key34], undefined, _oldObject, undefined, array[parsedKey]);
                                    if (options.secondIndex == 1) {
                                        break;
                                    }
                                }
            ...
            case "splice":
                {
                    ...
                    if (array._bindings) {
                        ...
                        for (var _i71 = 0; _i71 < _objbind3.length; _i71++) {
                            var _item5 = _objbind3[_i71];
                            if (_item5._forHelpers) {
                                ...
                                for (var _j6 = 0; _j6 < _helperbind.length; _j6++) {
                                    ...
                                    for (var _i72 = _index3, _j7 = 0; _i72 < _finalIndex; _i72++, _j7++) {
                                        _LC.removeSelectedBindingDeep(_defineProperty({}, _itemValue, _helper._items[_i72].itemProperty), _defineProperty({}, _itemValue, _deletedItems[_j7]));
                                    }
                            ...
                            for (var _key35 in _item5) {
                                var _parsedKey = parseInt(_key35);
                                var cond = _options.secondIndex == _options.thirdIndex ? _key35 >= _options.firstIndex && _key35 < _options.firstIndex + _options.secondIndex : _parsedKey >= _options.firstIndex;
                                if (!isNaN(_parsedKey) && cond) {
                                    ...
                                    this.removeSelectedBindingDeep(_item5[_key35], _oldObject2);
                                    if (_item5[_key35]._forHelpers) {
                                        var _bindfor = _item5[_key35]._forHelpers.toArrayLyte();
                                    ...
                                    if (array[_parsedKey] && _typeof(array[_parsedKey]) === "object") {
                                        ...
                                        this.establishBindings({ "dummy": _item5[_key35] }, { "dummy": array[_parsedKey] });
                                    }
                                    this.affectChanges(_item5[_key35], undefined, _oldObject2, undefined, array[_parsedKey]);
                                }
                            }
                        }
                    }
            ...
            case "remove":
                {
                    ...
                    if (array._bindings) {
                        ...
                        for (var _i73 = 0; _i73 < _objbind4.length; _i73++) {
                            var _item7 = _objbind4[_i73];
                            if (_item7._forHelpers) {
                                ...
                                for (var _j8 = 0; _j8 < _helperbind2.length; _j8++) {
                                    ...
                                    for (var _i74 = _index4, _j9 = 0; _i74 < _finalIndex2; _i74++, _j9++) {
                                        _LC.removeSelectedBindingDeep(_defineProperty({}, _itemValue2, _helper2._items[_i74].itemProperty), _defineProperty({}, _itemValue2, _deletedItems2[_j9]));
                                    }
                            ...
                            for (var _key36 in _item7) {
                                var _parsedKey2 = parseInt(_key36);
                                if (!isNaN(_parsedKey2) && _parsedKey2 >= _options2.firstIndex) {
                                    ...
                                    this.removeSelectedBindingDeep(_item7[_key36], _oldObject3);
                                    if (_item7[_key36]._forHelpers) {
                                        var _bindfor2 = _item7[_key36]._forHelpers.toArrayLyte();
                                    ...
                                    if (array[_parsedKey2] && _typeof(array[_parsedKey2]) === "object") {
                                        ...
                                        this.establishBindings({ "dummy": _item7[_key36] }, { "dummy": array[_parsedKey2] });
                                    }
                                    this.affectChanges(_item7[_key36], undefined, _oldObject3, undefined, array[_parsedKey2]);
                                }
                            }
                        }
                    }
            ...
            case "insertAt":
                {
                    ...
                    for (var _i75 = _index5; _i75 > array.length; _i75--) {
                    ...
                    if (array._bindings) {
                        ...
                        for (var _i76 = 0; _i76 < arrbind.length; _i76++) {
                            var _item9 = arrbind[_i76];
                            ...
                            for (var _key37 in _item9) {
                                var _parsedKey3 = parseInt(_key37);
                                if (!isNaN(_parsedKey3) && _parsedKey3 >= _options3.firstIndex) {
                                    this.removeSelectedBindingDeep(_item9[_key37], array[_parsedKey3 + _options3.secondIndex]);
                                    if (_item9[_key37]._forHelpers) {
                                        var _bindfor3 = _item9[_key37]._forHelpers.toArrayLyte();
                                    ...
                                    if (array[_parsedKey3] && _typeof(array[_parsedKey3]) === "object") {
                                        ...
                                        this.establishBindings({ "dummy": _item9[_key37] }, { "dummy": array[_parsedKey3] });
                                    }
                                    this.affectChanges(_item9[_key37], undefined, array[_parsedKey3 + _options3.secondIndex], undefined, array[_parsedKey3]);
                                }
                            }
                        }
                    }
            ...
            case "sort":
                {
                    ...
                    if (array._bindings) {
                        ...
                        for (var _i77 = 0; _i77 < _arrbind.length; _i77++) {
                            var _item11 = _arrbind[_i77];
        ...
        if (array._bindings) {
            ...
            for (var _i78 = 0; _i78 < objbind.length; _i78++) {
                var binding = objbind[_i78];
                var path = objbind[_i78]._path;
        ...
        for (var _i80 = 0; _i80 < props.length; _i80++) {
            ...
            currentProp = currentProp[props[_i80 + 1]];
            currentValue = currentValue[props[_i80 + 1]];
        }
        ...
        if (properties._helperNodes) {
            ...
            for (var _s3 = 0; _s3 < arr.length; _s3++) {
                var nodes = arr[_s3]._dynamicProperty ? arr[_s3]._dynamicProperty[path] : undefined;
                if (nodes) {
                    for (var j = 0; j < nodes.length; j++) {
                        ...
                        if (helper && helper.tagName === "TEMPLATE" && helper.getAttribute("is") === "for") {
                            if (helper._items) {
                                ...
                                for (var _i81 = 0; _i81 < helper._items.length; _i81++) {
                                    var data = actualData[_i81];
                                    var _item12 = helper.getAttribute("item");
                                    if (data) {
                                        if (_typeof(helper._items[_i81]) === "object") {
                                            this.establishBindings(helper._items[_i81].itemProperty, _defineProperty({}, _item12, data));
                                        }
                                    }
                                }
                            }
        ...
        for (var _i82 in properties) {
            var actData = actualData[_i82];
            if (!actData || typeof actData === "string" || typeof actData === "number" || typeof actData === "boolean") {
                ...
                // }
                addBindings(actData, properties[_i82]);
                if (_typeof(properties[_i82]) === "object") {
                    this.establishBindings(properties[_i82], actData);
                }
            }
        }
        ...
        for (var _i83 in binding) {
            var actData = void 0;
            if (actualData) {
                actData = actualData[_i83];
            }
            if (actData && actData._bindings) {
                deleteBindingCheckSize(actData, "_bindings", binding[_i83]);
            }
            if (_typeof(binding[_i83]) === "object") {
                this.removeSelectedBindingDeep(binding[_i83], actData, fromDisConnect);
            }
        }
        if (fromDisConnect) {
        ...
        if (binding && binding._forHelpers) {
            ...
            for (var _i84 = 0; _i84 < objbind.length; _i84++) {
                var fH = objbind[_i84];
                if (fH.getAttribute("is") === "for") {
                    var item = fH.getAttribute("item");
                    var items = fH._attributes.items;
                    var itemCases = fH._items;
                    for (var _i85 = 0; _i85 < itemCases.length; _i85++) {
                        this.removeSelectedBindingDeep(itemCases[_i85].itemProperty, items[_i85], fromDisConnect);
                    }
                } else {
        ...
        var del = "delete";
        for (var _key38 in properties) {
            if (data[_key38] && data[_key38]._bindings) {
                //                    data[key]._bindings[del](properties[key]);
                //                    if(!data[key]._bindings.size) {
                //                        delete data[key]._bindings;
                //                    }
                deleteBindingCheckSize(data[_key38], "_bindings", properties[_key38]);
            }
            if (data[_key38] && typeof data[_key38] !== "string") {
                _LC.removeAllBindings(properties[_key38], data[_key38]);
            }
        }
        ...
        if (item._dynamicNodes) {
            for (var _i86 = 0; _i86 < item._dynamicNodes.length; _i86++) {
                item._dynamicNodes[_i86]._callee.updateNode(item._dynamicNodes[_i86], item._path, options);
            }
        }
        ...
        if (item._helperNodes) {
            ...
            for (var _s4 = 0; _s4 < itemHelperNodes.length; _s4++) {
                ...
                if (itemHelperNodes[_s4].getAttribute("is") === "for" && itemHelperNodes[_s4]._items) {
                    ...
                    for (var _i87 = 0; _i87 < itemHelperNodes[_s4]._items.length; _i87++) {
                        cmpData[itemValue] = items[_i87];
                        cmpData[indexValue] = _i87;
                        callee._properties[itemValue] = itemHelperNodes[_s4]._items[_i87].itemProperty;
                        if (itemHelperNodes[_s4]._items[_i87]._dynamicProperty[propPath]) {
                            nodes = itemHelperNodes[_s4]._items[_i87]._dynamicProperty[propPath];
                            for (var _i88 = 0; _i88 < nodes.length; _i88++) {
                                nodes[_i88]._callee.updateNode(nodes[_i88], propPath, options);
                            }
                        }
                    }
                    cmpData[itemValue] = initialItemValue;
                    ...
                    for (var _key39 in itemHelperNodes[_s4]._items) {
                        _cmpData4[_itemValue4] = object[_key39];
                        _cmpData4[_indexValue] = _key39;
                        _callee5._properties[_itemValue4] = itemHelperNodes[_s4]._items[_key39].itemProperty;
                        if (itemHelperNodes[_s4]._items[_key39]._dynamicProperty[propPath]) {
                            nodes = itemHelperNodes[_s4]._items[_key39]._dynamicProperty[propPath];
                    ...
                    if (nodes.length) {
                        ...
                        for (var _i90 = 0; _i90 < nodes.length; _i90++) {
                            nodes[_i90]._callee.updateNode(nodes[_i90], item._path, options);
                        }
        ...
        if (item._observers) {
            ...
            if (cond) {
                for (var _i91 = 0; _i91 < objbind.length; _i91++) {
                    var observer = objbind[_i91];
        ...
        if (Array.isArray(item)) {
            for (var i = 0; i < item.length; i++) {
                for (var _key40 in item[i]) {
                    this.affectChanges(item[i][_key40], true, oldValue ? oldValue[i] ? oldValue[i][_key40] : oldValue[i] : oldValue, setterScope, newValue ? newValue[i] ? newValue[i][_key40] : newValue[i] : newValue);
                }
            }
        } else {
            for (var _key41 in item) {
                var oldV = oldValue ? oldValue[_key41] : oldValue,
                    newV = newValue ? newValue[_key41] : newValue;
                if (_key41 == "*" && item[_key41].hasOwnProperty("_observers")) {
                    oldV = oldValue;
                    newV = newValue;
                }
                this.affectChanges(item[_key41], true, oldV, setterScope, newV);
            }
        }
        ...
        if (context != undefined) {
            if (window.isLyteWidget || window.__lyteEnablePromise) {
                var ctxVal = context[val];
                if (context && (typeof context === 'undefined' ? 'undefined' : _typeof(context)) == "object" && !Array.isArray(context) && context.localName && context.tagName && _LC.isCustomElement(context) || ctxVal && ctxVal.__lyteDirective) {
                    console.log("Dummy");
                    // let ctxDir = ctxVal.__lyteDirective;
                    // if(ctxDir){
                    //     let dNode = ctxDir.node;
                    //     dNode._triggerOnInit = context._triggerOnInit || [];
                    //     if(ctxDir.name == "data" && !dNode.hasAttribute("lyte-rendered")){
                    //         dNode._triggerOnInit.push({name : ctxDir.name , value : ctxDir.value, scope : self});
                    //     }
                    //     else if(ctxDir.name == "prop" && !dNode.hasAttribute("lyte-rendered")){
                    //         dNode._triggerOnInit.push({name : ctxDir.name , value : ctxDir.value, scope : self});
                    //     }

                    // }
                } else if (context && context[val] instanceof Promise && !context[val].__lyte) {
        ...
        if (cache && cache.hasOwnProperty(path)) {
            ...
            try {
                ...
                for (var _i92 = 1; _i92 < arr.length; _i92++) {
                    var locVal = arr[_i92];
        ...
        if (typeof arg0 === "string") {
            ...
            for (var _key42 in arg0) {
                this.set(_key42, arg0[_key42], arg1);
            }
        }
        ...
        if (node) {
            if (typeof arg0 === "string") {
                ...
                for (var _key44 in arg0) {
                    node._methods[_key44] = arg0[_key44];
                }
            }
        }
        ...
        "attachEvents": function attachEvents(thisRef) {
            ...
            for (var _i93 = 0; _i93 < len; _i93++) {
                thisRef.addEventListener(toAddEvents[_i93].eventName, toAddEvents[_i93].listener, toAddEvents[_i93].options);
            }
            //lbind event
        ...
        "save": {
            ...
            addNode: function addNode(self, attr, dynamicN, gonnaSave, node, staticProp, helperNode, options, dynamicNodes) {
                ...
                if (nodeVal) {
                    ...
                    // if(beforeProp){
                    //     _LC.affectChanges(beforeProp);
                    // }
                    if (!dynamicN.__updateProp) {
                        dynamicN.__updateProp = {};
                    }
                    if (!dynamicN.__updateProp[attr.hookName]) {
                        dynamicN.__updateProp[attr.hookName] = [];
                    }
                    ...
                    if (staticProp && forHelperNode) {
                        dynamicN._helperNode = forHelperNode;
                        if (options) {
                            var _type8 = cxObj.type;
                                ...
                                case "for":
                                    {
                                            ...
                                            if (helperNode._dirObj) {
                                                if (helperNode._dirObj.prop) {
                                                    if (helperNode._dirObj.prop.indexOf(nodeVal) != -1) {
                                                        helperNode._items[ind].propProperty[nodeVal] = beforeProp;
                                                        // if(establishBindings || estuh) {
                                                        // _LC.establishSelectedBinding(beforeProp, self.component.data[nodeVal],self );
                                                        _LC.establishBindings(_defineProperty({}, nodeVal, self.getProperty(nodeVal)), self.component.data);
                                                        self._properties[nodeVal] = null;
                                                        // }
                                                    }
                                                }
                                        ...
                                        self.beforeUpdateFor(self, forHelperNode, nodeVal, ind);
                                        if (!forHelperNode._currentProp) {
                                            forHelperNode._currentProp = [];
                                        }
                                        if (forHelperNode._currentProp.indexOf(nodeVal) == -1) {
                                            forHelperNode._currentProp.push(nodeVal);
                                        }
                                        if (!forHelperNode._propNodes[nodeVal]) {
                                            forHelperNode._propNodes[nodeVal] = [];
                                        }
                                        forHelperNode._propNodes[nodeVal][ind] = gonnaSave;
                                    }
                            }
                        }
                    }
            ...
            addData: function addData(element, attr) {
                if (!element.$data) {
                    ...
                    if (listenerArr) {
                        ...
                        element.$data = {};
                        for (var _attr2 in element.attribute) {
                            var name = _LC.String.toCamelCase(_attr2.nodeName);
                            if (!element.$data[name]) {
                                element.$data[name] = _attr2.nodeValue;
                            }
                        }
                    }
                }
            },
            updateNode: function updateNode(self, node, nodeValue) {
            ...
            removeAllNode: function removeAllNode(self, spNodes) {
                if (spNodes) {
                    spNodes.forEach(function (dynamicN) {
                        if (Array.isArray(dynamicN)) {
                            dynamicN.forEach(function (dynN) {
                                _LC.directive.save.removeNode(self, dynN);
                                // dynN._specialNodes = [];
                            });
                        } else {
                            _LC.directive.save.removeNode(self, dynamicN);
                            // dynamicN._specialNodes = [];
                        }
                    });
                }
            },
            ...
            triggerListeners: function triggerListeners(self, saveAttr, eleProp) {
                var prop = self._properties;
                if (saveAttr) {
                    if (saveAttr.stringValue) {
                        if (prop[saveAttr.stringValue] && prop[saveAttr.stringValue].$data[eleProp]) {
                            _LC.affectChanges(prop[saveAttr.stringValue].$data[eleProp]);
                        }
                    } else if (saveAttr.dynamicValue) {
                        if (prop[saveAttr._saveNode] && prop[saveAttr._saveNode].$data[eleProp]) {
                            _LC.affectChanges(prop[saveAttr._saveNode].$data[eleProp]);
                        }
                    }
                }
            },
            triggerAllListeners: function triggerAllListeners(self, directiveName, target, switchContext) {
                ...
                var listenerArr = _LC.directive.save.triggerMap[saveNodeName];
                if (listenerArr) {
                    listenerArr.forEach(function (prop) {
                        _LC.directive.save.triggerData(prop, target);
                    });
                    if (switchContext) {
                        var propName = target.hasAttribute("lyte-directive-prop") ? target.getAttribute("lyte-directive-prop") : target.getAttribute("lyte-directive-data");
                        var contextSwitchArray = [];
                        _LC.adCx(target, contextSwitchArray);
                        if (contextSwitchArray.length) {
                            _LC.affectChanges(self.getProperty(propName));
                            for (var _i94 = contextSwitchArray.length - 1; _i94 >= 0; _i94--) {
                                _LC.rmCx(target, [contextSwitchArray[_i94]], true);
                                _LC.affectChanges(self.getProperty(propName));
                            }
                        }
                    }
            ...
            triggerData: function triggerData(eleProp, target) {
    ...
    _LyteComponent.defineData = function (def) {
        ...
        dataNames.forEach( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(name) {
            return regeneratorRuntime.wrap(function _callee6$(_context3) {
                while (1) {
                ...
                case "attr":
                    {
                        ...
                        for (var _i95 = 0; _i95 < node.attributes.length; _i95++) {
                            if (node.attributes[_i95].nodeValue.indexOf("{{") !== -1) {
                                var val = node.attributes[_i95].nodeValue;
                                ...
                                if (actObj && (actObj.name === "action" || actObj.name === "method") && /^(onfocus|onfocusin|onfocusout|onresize|onscroll|onclick|ondblclick|onmousedown|onmouseup|onmousemove|onmouseover|onmouseout|onchange|onselect|onsubmit|onkeydown|onkeypress|onkeyup|oncontextmenu|__focus|__focusin|__focusout|__resize|__scroll|__click|__dblclick|__mousedown|__mouseup|__mousemove|__mouseover|__mouseout|__change|__select|__submit|__keydown|__keypress|__keyup|__contextmenu)$/.test(node.attributes[_i95].name)) {
                                    attr[node.attributes[_i95].name.substr(2)] = { name: node.attributes[_i95].name.substr(2), camelCase: _LC.String.toCamelCase(node.attributes[_i95].name.substr(2)), helperInfo: actObj, newHelperInfo: Lyte.Compile.getHelper(actValue, true), globalEvent: true };

                                    var actArgs = _Lyte.deepCopyObject(actObj.args);
                                    var actName = actArgs.splice(0, 1)[0];
                                    actName = actName.startsWith("'") ? actName.replace(/'/g, '') : actName;
                                    var actString = getArgString(actName, actArgs);
                                    node.setAttribute(node.attributes[_i95].name.substr(2), componentName + " => " + actString);
                                    if (dynNewCompile) {
                                        dynNewCompile.setAttribute(node.attributes[_i95].name.substr(2), componentName + " => " + actString);
                                    }
                                    toBeRemoved.push(node.attributes[_i95].name);
                                } else {
                                    if (actObj || actValue) {
                                        var _attrToPush = {};

                                        if (node.attributes[_i95].name.startsWith("lbind:")) {
                                            toBeRemoved.push(node.attributes[_i95].name);
                                            toBeAdded.push({ "name": node.attributes[_i95].name.substring(6), "value": node.attributes[_i95].nodeValue });
                                            _attrToPush.isLbind = true;
                                            _attrToPush.name = node.attributes[_i95].name.substring(6);
                                            _attrToPush.camelCase = _LC.String.toCamelCase(_attrToPush.name);
                                        } else {
                                            _attrToPush.name = node.attributes[_i95].name;
                                            _attrToPush.camelCase = _LC.String.toCamelCase(_attrToPush.name);
                                        }
                                        if (actObj) {
                            ...
                            if (node.attributes[_i95].name.startsWith("@")) {
                                var rt = _LC.directive.compileNode(node, attr, toBeRemoved, toBeAdded, _i95, componentName);
                                add = rt.add;
                                attrToPush = rt.attrToPush;
                            }
                        }
                        if (toBeRemoved.length) {
                            for (var _i96 = 0; _i96 < toBeRemoved.length; _i96++) {
                                node.removeAttribute(toBeRemoved[_i96]);
                                if (dynNewCompile) {
                                    dynNewCompile.removeAttribute(toBeRemoved[_i96]);
                                }
                            }
                        }
                        if (dynNewCompile) {
                            for (var _key45 in attr) {
                                dynNewCompile.removeAttribute(_key45);
                            }
                            dynNewCompile.setAttribute("_lyteAttr", "__**--Lyte" + j + "__**", "");
                        }
                        if (toBeAdded.length) {
                            for (var _i97 = 0; _i97 < toBeAdded.length; _i97++) {
                                node.setAttribute(toBeAdded[_i97].name, toBeAdded[_i97].value);
                            }
                        }
                    }
                    break;
                ...
                case "component":
                    {
                        ...
                        if ((window.isLyteWidget || window.__lyteEnablePromise) && dynN.hasAttribute("has-child")) {
                            ...
                            for (var _key46 in info.cases) {
                                var contentNewCompile = void 0;
                                content = _LC.getContentForIE(actualTemplate.querySelector("[case='" + _LC.cssEscape(_key46) + "']"), undefined, true);

                                setHT(content, info.cases[_key46], contentNewCompile, constr);
                                doCompile(content.tagName === "TEMPLATE" ? content.content : content, info.cases[_key46].dynamicNodes, componentName, constr, contentNewCompile);
                                if (info.cases[_key46]._ht) {
                                    info.cases[_key46]._ht = content.cloneNode(true);
                                    constr._helperTemplate.content.append(info.cases[_key46]._ht);
                                    content.innerHTML = "";
                                }
                            }
                        } else {
                ...
                case "switch":
                    {
                        ...
                        if (_Lyte._ms) {
                            ...
                            for (var _key47 in info.cases) {
                                var _contentNewCompile = void 0;
                                content = _LC.getContentForIE(cases[_key47], undefined, true);
                                if (actualTemplateNewCompile) {
                                    _contentNewCompile = _LC.getContentForIE(actualTemplateNewCompile.querySelector("[case='" + LyteComponent.cssEscape(_key47) + "']"));
                                }
                                setHT(content, info.cases[_key47], _contentNewCompile, constr);
                                doCompile(content, info.cases[_key47].dynamicNodes, componentName, constr, _contentNewCompile ? _LC.getContentForIE(_contentNewCompile) : undefined);

                                cases[_key47].remove();
                                if (actualTemplateNewCompile) {
                                    info.cases[_key47]._sta = _LC.processStatic(_contentNewCompile);
                                }
                                info.cases[_key47].templateContent = cases[_key47].outerHTML;
                            }
                            if (info[def].dynamicNodes) {
                                ...
                                doCompile(content, info[def].dynamicNodes, componentName, constr, _contentNewCompile2 ? _LC.getContentForIE(_contentNewCompile2) : undefined);
                            ...
                            for (var _key48 in info.cases) {
                                ...
                                if (actualTemplateNewCompile) {
                                    _contentNewCompile3 = _LC.getContentForIE(actualTemplateNewCompile.querySelector("[case='" + LyteComponent.cssEscape(_key48) + "']"));
                                }
                                content = _LC.getContentForIE(dynNContent.querySelector("[case='" + _LC.cssEscape(_key48) + "']"), undefined, true);

                                setHT(content, info.cases[_key48], _contentNewCompile3, constr);
                                doCompile(content.tagName === "TEMPLATE" ? content.content : content, info.cases[_key48].dynamicNodes, componentName, constr, _contentNewCompile3);
                                if (actualTemplateNewCompile) {
                                    info.cases[_key48]._sta = _LC.processStatic(_contentNewCompile3);
                                }
                            ...
                            if (info[def].dynamicNodes) {
                                ...
                                doCompile(content.tagName === "TEMPLATE" ? content.content : content, info[def].dynamicNodes, componentName, constr, _contentNewCompile4);
                                if (actualTemplateNewCompile) {
    ...
    function getArgString(name, array) {
        ...
        for (var _i98 = 0; _i98 < array.length; _i98++) {
            if (array[_i98] && _typeof(array[_i98]) === "object") {
                array[_i98] = getArgString(array[_i98].value.name, array[_i98].value.args);
            }
        }
        if (name) {
    ...
    defProp(HTMLElement.prototype, 'setData', {
        ...
        value: function value(arg0, arg1) {
            ...
            if (typeof arg0 === "string") {
                ...
                for (var _key49 in arg0) {
                    this._initProperties[_key49] = arg0[_key49];
                }
            }
        }
    });
    ...
    defProp(HTMLElement.prototype, 'setMethods', {
        ...
        value: function value(arg0, arg1) {
            ...
            if (typeof arg0 === "string") {
                ...
                for (var _key50 in arg0) {
                    this._initMethods[_key50] = arg0[_key50];
                }
            }
        }
    });
    ...
    _LyteComponent.setIgnoreDisconnect = function (val) {
    ...
    Lyte.Compile.getTrimmedContent = function (content, position, node) {
        ...
        for (var _i99 = 0; _i99 < position.length; _i99++) {
            for (var j = content.childNodes.length - 1; j > position[_i99]; j--) {
                content.childNodes[j].remove();
            }
            content = content.childNodes[position[_i99]];
        }
        return dummyContent;
    };
    Lyte.Compile.getArrayIndex = function (array, value) {
        for (var _i100 = 0; _i100 < array.length; _i100++) {
            if (array[_i100] === value) {
                return _i100;
            };
        }
    };
    ...
    Lyte.Compile.getHelperArgs = function (str, newCompile) {
        ...
        for (var _i101 = 0; _i101 < str.length; _i101++) {
            if (!stack.length && str.charAt(_i101) === ",") {
                var _toPush2 = str.substr(from, _i101 - from);
                ...
                args.push(_toPush2);
                from = _i101 + 1;
            } else if (str.charAt(_i101) === "(") {
                if (stack[stack.length - 1] != "'" && stack[stack.length - 1] != "\"") {
                    stack.push(str.charAt(_i101));
                    lastPushed = str.charAt(_i101);
                }
            } else if (str.charAt(_i101) === ")") {
                if (stack[stack.length - 1] === "(") {
                    stack.pop();
                }
            } else if (str.charAt(_i101) === "'" && str.charAt(_i101 - 1) !== "\\") {
                if (stack[stack.length - 1] === "'") {
                    stack.pop();
    ...
    LyteComponent.isInViewPort = function (el, lazy) {
        ...
        return (rect.top >= 0 && rect.top <= (window.innerHeight || document.documentElement.clientHeight) || rect.bottom >= 0 && rect.bottom <= (window.innerHeight || document.documentElement.clientHeight)) && (rect.left >= 0 && rect.left <= (window.innerWidth || document.documentElement.clientWidth) || rect.right >= 0 && rect.right <= (window.innerWidth || document.documentElement.clientWidth));
    };
    _LC._doneRaf = {};
                    ...
                    setTimeout(function () {
                        ...
                        for (var i = arr.length - 1; i >= 0; i--) {
                            ...
                            if (_LC.isViewPortTemplate(_temp2) && !_temp2._callee._destroyed) {
                                var _obj19 = {};
                                if (_LC._isInViewPort(actTemp, actTemp._callee, beforeRemoveHook, undefined, _obj19)) {
                                    var nd = pve.splice(i, 1)[0];
                                    _temp2._inPve = false;
                                    _temp2._viewPortRendered = true;
                                    !_obj19.beforeRemoveHook && inViewTemplates.push(nd);
                                }
                                actTemp._inPve = _temp2._inPve;
                                actTemp._viewPortRendered = _temp2._viewPortRendered;
                            }
                        }
                        for (var _i102 = 0; _i102 < beforeRemoveHook.length; _i102++) {
                            beforeRemoveHook[_i102].viewOutIns.beforeRemove.apply(beforeRemoveHook[_i102].viewOutIns, beforeRemoveHook[_i102].arg);
                            _LC.waitingForResolve.push(beforeRemoveHook[_i102].node._renderPromise);
                        }
                        for (var _i103 = 0; _i103 < inViewTemplates.length; _i103++) {
                            _LC._executeIfTemplates(inViewTemplates[_i103]);
                        }
        ...
        if (LyteComponent.pendingViewPortElements) {
            requestAnimationFrame(function () {
                setTimeout(function () {
                    ...
                    for (var _key51 in _LC._doneRaf) {
                        if (_LC._doneRaf[_key51]) {
    ...
    LyteComponent.executePendingViewPort = function (options) {
        ...
        if (!options || !options.force) {
            ...
            for (var _i104 = 0; _i104 < beforeRemoveHook.length; _i104++) {
                beforeRemoveHook[_i104].viewOutIns.beforeRemove.apply(beforeRemoveHook[_i104].viewOutIns, beforeRemoveHook[_i104].arg);
            }
        } else {
