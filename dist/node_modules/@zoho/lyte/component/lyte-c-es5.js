...
(function (window) {
    ...
    */
        ...
        _createClass(customElementPrototype, [{
                    ...
                    for (var _key3 in data) {
                        ...
                        if (obj.initialize) {
                            if (typeof obj.initialize == "function") {
                                ...
                                if (promise) {
                                    compData[_key3] = promise;
                                } else {
                                    _Lyte.error("LC011", _key3, self.tagName);
                                }
                            }
                        }
                        var customDtype;
                        ...
                        if (obj.hasOwnProperty("hideAttr")) {
                            this._hideAttr[_key3] = obj.hideAttr;
                        }
                    }
                    this.$data = compData;
            ...
            value: function renderComponent(dynNode, preDefObj) {
                ...
                if (initProperties) {
                    for (var _key9 in initProperties) {
                        ...
                        var error = _LC.handleValidation(cmpData, _key9, actVal, component);
                        if (!error) {
                            cmpData[_key9] = actVal;
                        }
                    }
                }
                if (true) {
                                ...
                                case "attr":
                                    {
                                        ...
                                        var actionObj = {};
                                        for (var _key11 in attr) {
                                            if (attr[_key11].dynamicValue) {
                                                // let nodeValue = this.get(attr[key].dynamicValue);
                                                var _nodeValue = attr[_key11].newDynamicValue ? _LC.getDD(compData, attr[_key11].newDynamicValue) : this.get(attr[_key11].dynamicValue);

                                                if (fastRenderProp) {
                                                    fastRenderProp.data[attr[_key11].camelCase] = _nodeValue;
                                                    if (typeof _nodeValue == "string" && setAttr) {
                                                        _nodeValue = this.formatValue(_key11, _nodeValue);
                                                        str = str + _nodeValue + " ";
                                                    }
                                                } else {
                                                    _nodeValue = this.formatValue(_key11, _nodeValue);
                                            ...
                                            } else if (attr[_key11].helperInfo) {
                                                if (attr[_key11].helperInfo.name === "action") {
                                                    var actionName = attr[_key11].helperInfo.args[0];
                                                    ...
                                                    var actArgs = this.processArgs(this, attr[_key11], [], "__lyteEvent__", "__lyteNode__");
                                                    var actualAttrName = attr[_key11].globalEvent ? attr[_key11].name : attr[_key11].name.indexOf("-") !== -1 ? attr[_key11].name : attr[_key11].name.substr(2);
                                                    actionObj[actualAttrName] = { "name": boundName, "args": attr[_key11].helperInfo.args, "actArgs": actArgs, "globalEvent": attr[_key11].globalEvent ? true : false, "skipArgProcessing": true };
                                                } else if (attr[_key11].helperInfo.name === "method") {
                                                    ...
                                                    if (fastRenderProp) {
                                                        ...
                                                        (function () {
                                                            ...
                                                            var actArgs = _this8.processArgs(_this8, attr[_key11], [], "__lyteEvent__", "__lyteNode__");
                                                            ...
                                                            methods[attr[_key11].camelCase] = methodFunc;
                                                        })();
                                                    }
                                                } else {
                                                    var _nodeValue2 = this.processHelper({ name: attr[_key11].helperInfo.name, args: this.processArgs(this, attr[_key11], [], undefined, undefined, true) }, undefined);
                                                    if (fastRenderProp) {
                                                        fastRenderProp.data[attr[_key11].camelCase] = _nodeValue2;
                                                        if (typeof _nodeValue2 == "string" && setAttr) {
                                                            _nodeValue2 = this.formatValue(_key11, _nodeValue2);
                                                            str = str + _nodeValue2 + " ";
                                                        }
                                                    } else {
                                                        _nodeValue2 = this.formatValue(_key11, _nodeValue2);
                                ...
                                case "insertYield":
                                    {
                                        ...
                                        if (yieldObj) {
                                            ...
                                            for (var _key12 in contextSwitch) {
                                                psCmpData[_key12] = contextSwitch[_key12];
                                            }
                                            if (yieldObj._cx) {
            ...
            value: function renderNodes(toAppend, dynamicNodes, helperNode, options, establishBindings, returnVal, templateContent, yieldComp) {
                ...
                var _loop = function _loop(_i9) {
                    ...
                    if (type === "componentDynamic") {
                        ...
                        _this9.bindNode(dynamicN, undefined, helperNode, options, dynamicNodes[_i9], processLast, establishBindings, undefined, dynamicNodes._cache, type, undefined, toBeInsMap);
                    } else if (type === "attr") {
                        ...
                        for (var _key13 in info.attr) {
                            var _attr = info.attr[_key13];
                            ...
                            if (_attr && (_attr.dynamicValue || _attr.helperInfo)) {
                                ...
                                if (!_attr.globalEvent) {
                                    ...
                                    node = _this9.bindNode(dynamicN.attributes.getNamedItem(attrName), toBeRemoved, helperNode, options, _attr, undefined, establishBindings, undefined, dynamicNodes._cache, type, _i9);
                        ...
                        switch (type) {
                            ...
                            case "forIn":
                                ...
                                break;
                            case "component":
                                _returnVal = _this9.updateDynamicComponent(dynamicN, false, options.node ? options : undefined, establishBindings, _i9, helperNode);
                        }
                        if (_returnVal) {
                        ...
                        var _returnVal2 = _this9.updateSwitchHelper(type, dynamicN, options.node ? options : undefined, undefined, establishBindings, yieldComp, _id, toBeInsMap);
                        if (_returnVal2) {
                ...
                for (var _i9 = 0; _i9 < dynamicNodes.length; _i9++) {
                    var def;
                ...
                for (var _i10 = 0; _i10 < processLast.length; _i10++) {
                    var dynamicPosition = processLast[_i10].dynamicPositions;
                    ...
                    processLast[_i10].dynamicPositions = { startingNode: startingNode, length: childLen };
                }
                if (toBeInsMap.size) {
            ...
            value: function executeBlockHelpers(updateHelpers, node) {
                for (var _i11 = 0; _i11 < updateHelpers.length; _i11++) {
                    var lastNode = updateHelpers[_i11].lastNode;
                    ...
                    _insertBefore(parentNode, updateHelpers[_i11].toAppendMain, lastNode);
                    updateHelpers[_i11] = updateHelpers[_i11].lastNode;
            ...
            value: function updateBlockHelpers(updateHelpers, contextSwitchInfo) {
                for (var _i12 = 0; _i12 < updateHelpers.length; _i12++) {
                    switch (updateHelpers[_i12].getAttribute('is')) {
                        case "for":
                            this.updateForHelper(updateHelpers[_i12], { "type": "default" }, contextSwitchInfo);
                            break;
                        case "if":
                            this.updateSwitchHelper("if", updateHelpers[_i12], contextSwitchInfo);
                            break;
                        case "forIn":
                            this.updateForInHelper(updateHelpers[_i12], { "type": "default" }, contextSwitchInfo);
                            break;
                        case "switch":
                            this.updateSwitchHelper("switch", updateHelpers[_i12], contextSwitchInfo);
                            break;
                        case "component":
                            this.updateDynamicComponent(updateHelpers[_i12], false, contextSwitchInfo);
                            break;
                        case "insertYield":
                        ...
                        case "registerYield":
                            if (contextSwitchInfo) {
                                updateHelpers[_i12]._cx = contextSwitchInfo;
                            }
                            break;
                        default:
                            if (updateHelpers[_i12].tagName === "LYTE-YIELD") {
                                this.updateYield(updateHelpers[_i12], false, contextSwitchInfo);
                            }
            ...
            value: function _attributeChangedCallback(attr, oldValue, newValue) {
                ...
                if (isCustomProp !== -1) {
                    ...
                    if (lyteProps) {
                        try {
                            ...
                            for (var _key14 in lyteProps) {
                                var actKey = propValue + _LC.String.upperCaseFirstLetter(_key14);
                                this.set(actKey, lyteProps[_key14]);
                            }
                        } catch (e) {
                ...
                if (dataDef && dataDef.type) {
                    ...
                    if (dataType !== "string") {
                        var _obj4 = { "attr": attr, "tagName": this.tagName };
                        newValue = _LC.typeCast(newValue, dataType, _obj4);
                        if (_obj4.isError) {
            ...
            value: function removeHelpersSpecificIndex(node, index) {
                ...
                if (node._forContent[index]) {
                    for (var _i13 = 0; _i13 < node._forContent[index].length; _i13++) {
                        node._forContent[index][_i13].remove();
                    }
                    var self = this;
            ...
            value: function removeHelpers(node, update, direct) {
                ...
                if (node._forContent) {
                    if (node.getAttribute("is") === "for") {
                        if (node._helpers) {
                            for (var _i14 = 0; _i14 < node._helpers.length; _i14++) {
                                for (var j = 0; j < node._helpers[_i14].length; j++) {
                                    this.removeHelpers(node._helpers[_i14][j]);
                                }
                                node._helpers[_i14] = [];
                            }
                        }
                        for (var _s = 0; _s < node._forContent.length; _s++) {
                            for (var _i15 = 0; _i15 < node._forContent[_s].length; _i15++) {
                                node._forContent[_s][_i15].remove();
                            }
                        }
                        if (node._specialNodes && node._specialNodes.length) {
                        ...
                        if (node._items.length) {
                            ...
                            for (var _i16 = 0; _i16 < node._items.length; _i16++) {
                                var dynProp = node._items[_i16]._dynamicProperty;
                            ...
                            if (prop) {
                                for (var _i17 = 0; _i17 < node._items.length; _i17++) {
                                    this.removeBindings(_defineProperty({}, _key15, node._items[_i17].itemProperty), _defineProperty({}, _key15, node._attributes.items[_i17]));
                                }
                            }
                        }
                        if (!update) {
                        ...
                        if (node._helpers) {
                            ...
                            for (var _i18 = 0; _i18 < keys.length; _i18++) {
                                for (var _j = 0; _j < node._helpers[keys[_i18]].length; _j++) {
                                    this.removeHelpers(node._helpers[keys[_i18]][_j]);
                                }
                                node._helpers[keys[_i18]] = [];
                            }
                        }
                        for (var ind in node._forContent) {
                            for (var _i19 = 0; _i19 < node._forContent[ind].length; _i19++) {
                                node._forContent[ind][_i19].remove();
                            }
                        }
                        var items = node._items;
                        var _key16 = node.getAttribute("key");
                        for (var index in items) {
                            ...
                            if (_prop) {
                                this.removeBindings(_defineProperty({}, _key16, node._items[index].itemProperty), _defineProperty({}, _key16, node._attributes.object[index]));
                            }
                        }
                        if (!update) {
                            if (node._actualBinding) {
                    ...
                    if (node._caseContent) {
                        for (var _i20 = 0; _i20 < node._caseContent.length; _i20++) {
                            node._caseContent[_i20].remove();
                        }
                        for (var _key17 in node._dynamicProperty) {
                            if (node._dynamicProperty[_key17].isActualNode) {
                                node._dynamicProperty[_key17].isActualNode._helperNodes[del](node);
                            } else {
                                var helperNodes = this.getProperty(_key17)._helperNodes;
                                if (helperNodes) {
                        ...
                        for (var _i21 = 0; _i21 < node._yieldContent.length; _i21++) {
                            node._yieldContent[_i21].remove();
                        }
                        node._dynamicProperty = {};
                    }
                    ...
                    for (var _key18 in node._renderedComponent) {
                        var comp = node._renderedComponent[_key18];
                        if (comp) {
                            comp.constructor.prototype._disconnectedCallback.call(comp);
                            comp.remove();
                            node._renderedComponent[_key18] = null;
                        }
                    }
                }
            ...
            value: function updateDynamicComponent(node, update, contextSwitchInfo, establishBindings, idx, helperNode) {
                ...
                if (newComponent) {
                    //          let componentData = {};
                    for (var _i22 = 0; _i22 < node.attributes.length; _i22++) {
                        if (node.attributes[_i22].name !== "is" && node.attributes[_i22].name !== "component-name" && node.attributes[_i22].name !== "lyte-keep-alive") {
                            component.setAttribute(node.attributes[_i22].name, node.attributes[_i22].value);
                        }
                    }
            ...
            value: function updateForHelper(node, options, contextSwitchInfo, establishBindings, staticTempArr, yieldComp) {
                        ...
                        case "remove":
                            {
                                ...
                                for (var _i23 = firstIndex, v = secondIndex; v > 0; v--, _i23++) {
                                    this.removeHelpersSpecificIndex(node, _i23);
                                }
                                //ln
                        ...
                        case "insert":
                            {
                                ...
                                for (var _i25 = firstIndex + secondIndex; _i25 < node._items.length; _i25++) {
                                    node._items[_i25]._cx.itemIndex = node._items[_i25]._cx.itemIndex + secondIndex;
                                }
                        ...
                        case "replace":
                            {
                                ...
                                for (var _i26 = firstIndex + secondIndex; _i26 < node._items.length; _i26++) {
                                    node._items[_i26]._cx.itemIndex = node._items[_i26]._cx.itemIndex + secondIndex - 1;
                                }
                        ...
                        case "splice":
                            {
                                ...
                                lastIndexForIteration = secondIndex;
                                indexPropertyStartIndex = firstIndex + secondIndex;
                                for (var _i27 = thirdIndex, j = 0; _i27 > 0; _i27--, j++) {
                                ...
                                for (var _i28 = firstIndex + secondIndex; _i28 < node._items.length; _i28++) {
                                    node._items[_i28]._cx.itemIndex = node._items[_i28]._cx.itemIndex + secondIndex - thirdIndex;
                                }
                        ...
                        case "update":
                            {
                                ...
                                for (var _i29 = 0; _i29 < node._items.length; _i29++) {
                                    this.removeHelpersSpecificIndex(node, _i29);
                                }
                ...
                if (options.type !== "remove") {
                    ...
                    var _loop2 = function _loop2(_k5, _v4) {
                        node._helpers[_k5] = [];
                        node._specialNodes[_k5] = [];
                        node._items[_k5] = { "_dynamicProperty": {}, "itemProperty": {}, "indexProperty": {}, "propProperty": {}, "propNodes": {} };
                        cmpData[itemValue] = items[_k5];
                        cmpData[indexValue] = _k5;
                        cacheData = {};
                        ...
                        for (var d = 0; d < dynProps.length; d++) {
                            var _key20 = dynProps[d];
                            node._dynProps[_key20] ? node._dynProps[_key20]++ : node._dynProps[_key20] = 1;
                        }
                        node._items[_k5].itemProperty = _this10.getProperty(itemValue);
                        node._items[_k5].indexProperty = _this10.getProperty(indexValue);
                        ...
                        _this10.executeBlockHelpers(node._helpers[_k5], node);
                        if (!node._fRender) {
                        ...
                        var propArr = Object.keys(node._items[_k5].propProperty);
                        if (propArr.length) {
                            var _self7 = _this10;
                ...
                if (updateIndexProperty) {
                    for (var _i30 = indexPropertyStartIndex; _i30 < node._items.length; _i30++) {
                        if (node._items[_i30].indexProperty) {
                            _LC.affectChanges(node._items[_i30].indexProperty);
                        }
                    }
                }
                ...
                for (var _key21 in node._propNodes) {
                    this.setData(_key21, node._propNodes[_key21]);
                    var cxObj = node._cx;
                    if (cxObj) {
                        // if(cxObj.type == "for"){
                        // let newArr = [];
                        while (cxObj) {
                            if (cxObj.type == "for" || cxObj.type == "forIn") {
                                var parentPropNodes = cxObj.node._propNodes[_key21];
                                if (!cxObj.node._propNodes[_key21]) {
                                    parentPropNodes = cxObj.node._propNodes[_key21] = [];
                                }
                                parentPropNodes[cxObj.itemIndex] = node._propNodes[_key21];
                                // cxObj.node._propNodes[key] = newArr;
                                if (!cxObj.node._childProp) {
                                    cxObj.node._childProp = [_key21];
                                } else if (cxObj.node._childProp.indexOf[_key21] == -1) {
                                    cxObj.node._childProp.push(_key21);
                                }
                                this.beforeUpdateFor(this, cxObj.node, _key21, cxObj.itemIndex);
                                cxObj = null;
                            } else {
            ...
            value: function renderPromiseNodes(trueNode, dynamicNodes, node, optns, establishBindings, returnVal, templateContent, yieldComp, toAppendMain) {
                ...
                for (var _i31 = 0; _i31 < contentArr.length; _i31++) {
                    if (contentArr[_i31].nodeType == 11) {
                        node._promiseContent = node._promiseContent.concat(Array.from(contentArr[_i31].childNodes));
                    } else {
                        node._promiseContent.push(contentArr[_i31]);
                    }
                    toAppendMain.append(contentArr[_i31]);
                }
            }
            ...
            value: function updateForInHelper(node, options, contextSwitchInfo, establishBindings, yieldComp) {
                ...
                for (var _key22 in node._propNodes) {
                    this.setData(_key22, node._propNodes[_key22]);
                    var cxObj = node._cx;
                    if (cxObj) {
                        // if(cxObj.type == "forIn"){
                        // let newArr = [];
                        while (cxObj) {
                            if (cxObj.type == "for" || cxObj.type == "forIn") {
                                var parentPropNodes = cxObj.node._propNodes[_key22];
                                if (!cxObj.node._propNodes[_key22]) {
                                    parentPropNodes = cxObj.node._propNodes[_key22] = [];
                                }
                                parentPropNodes[cxObj.itemIndex] = node._propNodes[_key22];
                                // cxObj.node._propNodes[key] = newArr;
                                if (!cxObj.node._childProp) {
                                    cxObj.node._childProp = [_key22];
                                } else if (cxObj.node._childProp.indexOf[_key22] == -1) {
                                    cxObj.node._childProp.push(_key22);
                                }
                                this.beforeUpdateFor(this, cxObj.node, _key22, cxObj.itemIndex);
                                cxObj = null;
                            } else {
                                cxObj = cxObj.node._cx;
                            }
                        ...
                        _LC.affectChanges(this.getProperty(_key22));
                    }
                }
                node._currentObject = object;
                return returnVal;
            ...
            value: function updateSwitchHelper(type, node, contextSwitchInfo, update, establishBindings, yieldComp, id, toBeInsMap) {
                ...
                node._caseContent = [];
                var toAppendMain = createDocFragment();;
                for (var _i32 = 0; _i32 < contentArr.length; _i32++) {
                    if (contentArr[_i32].nodeType == 11) {
                        //                for(let j=0;j<contentArr[i].childNodes.length;j++) {
                        //                    node._caseContent.push(contentArr[i].childNodes[j]);
                        //                }
                        node._caseContent = node._caseContent.concat(Array.from(contentArr[_i32].childNodes));
                    } else {
                        node._caseContent.push(contentArr[_i32]);
                    }
                    toAppendMain.append(contentArr[_i32]);
            ...
            value: function callObservers(boundValue, key) {
                ...
                if (observers) {
                    for (var _i33 = 0; _i33 < observers.length; _i33++) {
                        if (key.indexOf('.') === -1 || observers[_i33].path === key) {
                            this["_" + observers[_i33].functionName].apply(this);
                        }
                    }
                }
            }
            ...
            value: function bindNode(node, toBeRemoved, helperNode, options, nodeInfo, processLast, establishBindings, isTemplate, cache, type, idx, toBeInsMap) {
                ...
                if (!directiveValue && helperFunc && Object.keys(helperFunc).length) {
                    ...
                    if (helperFunc.name === "unescape") {
                        ...
                        var _obj5 = { initialNode: node, dynamicNodeValue: nodeValue };
                        node = { dynamicPositions: _obj5, "_callee": node._callee, helperValue: node.helperValue };
                        nodeValue = undefined;
            ...
            value: function getProperty(key) {
                ...
                defProp(property, '_path', { enumerable: false, value: arr[0] });
                for (var _i34 = 1; _i34 < arr.length; _i34++) {
                    if (arr[_i34].startsWith("'") || arr[_i34].startsWith('"')) {
                        //added check
                        arr[_i34] = arr[_i34].substring(1, arr[_i34].length - 1);
                    }
                    if (!property[arr[_i34]]) {
                        property[arr[_i34]] = {};
                        defProp(property[arr[_i34]], '_path', { enumerable: false, value: property._path + "." + arr[_i34] });
                    }
                    property = property[arr[_i34]];
                }
                return property;
            }
            //updN
            ...
            value: function updateNode(node, updatePath, options) {
                                ...
                                if (nodes.length === 0) {
                                    if (helperNode.getAttribute("is") === "if") {
                                        ...
                                        if (helperNode._items) {
                                            ...
                                            for (var _i35 = 0; _i35 < helperNode._items.length; _i35++) {
                                                if (helperNode._items[_i35]._dynamicProperty && helperNode._items[_i35]._dynamicProperty[multipleProp.actProp._path]) {
                                                    removeHelper = false;
                                                    break;
                                                }
                                            }
                ...
                if (node.helperValue) {
                    ...
                    if (helperFunc.name === "unescape") {
                        ...
                        var _obj7 = { startingNode: startingNode, length: childLen };
                        node.dynamicPositions = _obj7;
                        nodeValue = undefined;
                    }
                } else {
                ...
                if (isDirectiveNode) {
                    ...
                    parentNodes.push(pN);
                    for (var _i36 = 0; _i36 < parentNodes.length; _i36++) {
                        var parentNode = parentNodes[_i36];
                        if (parentNode.set) {
            ...
            value: function handleBreak(contextSwitchInfo, options) {
                if (contextSwitchInfo) {
                    ...
                    for (var j = breakIndex; j < endIndex; j++) {
                        ...
                        for (var _i37 = 0; _i37 < currentForContent.length; _i37++) {
                            currentForContent[_i37].remove();
                            if (currentForContent[_i37]._forContent || currentForContent[_i37]._caseContent) {
                                this.removeHelpers(currentForContent[_i37]);
                            }
                        }
                        forContent[j] = [];
            ...
            value: function processArgs(scope, dynN, dynamicValues, event, node, newCompile, cache) {
                ...
                for (var _i38 = 0; _i38 < args.length; _i38++) {
                    if (args[_i38] && args[_i38].type) {
                        this.internalHelpers(scope, args, _i38, dynamicValues, event, node, newCompile, cache);
                    } else {
                        if (!this.isEmptyString(args[_i38])) {
                            if (args[_i38].startsWith("'") && args[_i38].endsWith("'")) {
                                args[_i38] = args[_i38].substr(1, args[_i38].length - 2);
                            } else {
                                args[_i38] = args[_i38].trim();
                                var dynamicVals = [];
                                if (args[_i38] === "event" && event) {
                                    args[_i38] = widget && widgetMap.has(widget) ? widgetMap.get(widget).getClone(event) : event;
                                } else if (args[_i38] === "this" && node) {
                                    var thisNode = node.nodeType === 2 ? node.ownerElement : node;
                                    args[_i38] = widget && widgetMap.has(widget) ? widgetMap.get(widget).getClone(thisNode) : thisNode;
                                } else {
                                    args[_i38] = _LC.get(scope.component.data, args[_i38], dynamicVals, cache);
                                }
                                dynamicValues.push(dynamicVals);
                            }
                        } else if (newCompile) {
                            if (args[_i38] instanceof Array) {
                                args[_i38] = _LC.getDD(scpData, args[_i38]);
                            }
                        }
                    }
                }
            ...
            value: function getArgValues(argNames, properties) {
                var argValueArray = [];
                for (var _i39 = 0; _i39 < argNames.length; _i39++) {
                    argValueArray.push(properties[argNames[_i39]].value);
                }
            ...
            value: function registerYields() {
                ...
                var lazyYields = [];
                for (var _i40 = 0; _i40 < yields.length; _i40++) {
                    while (yields[_i40].hasChildNodes()) {
                        yields[_i40].content.appendChild(yields[_i40].childNodes[0]);
                    }
                    if (yields[_i40].hasAttribute("from-parent") && this._callee) {
                        if (this._callee._yields) {
                            this.registerParentYield(yields[_i40].getAttribute("yield-name"));
                        } else {
                            lazyYields.push(yields[_i40]);
                        }
                    } else {
                        this._yields[yields[_i40].getAttribute("yield-name")] = yields[_i40];
                    }
                }
            ...
            value: function actualConnectedCallback() {
                ...
                if (templateAttributes && templateAttributes.attr) {
                    for (var _key23 in templateAttributes.attr) {
                        //        		let attr = templateAttributes.attr[i];
                        var attr = templateAttributes.attr[_key23];
                        if (!this.hasAttribute(attr.name) && !compData.hasOwnProperty(attr.name) || attr.globalEvent) {
                            ...
                            if (!attr.globalEvent) {
                                attr.from = "component";
                                if (attr.staticValue) {
                                    this.setAttribute(templateAttributes.attr[_key23].name, attr.staticValue);
                                } else {
                                    this.setAttribute(templateAttributes.attr[_key23].name, "{{dummy}}");
                                    this.bindNode(this.attributes.getNamedItem(templateAttributes.attr[_key23].name), [], undefined, {}, templateAttributes.attr[_key23], undefined, undefined, true);
                                }
                            }
                        }
                    }
                }
                for (var _key24 in this._toRegEvnts) {
                    this.addEventListener(_key24, this._toRegEvnts[_key24].listener);
                    if (this.hasAttribute(_key24)) {
                        this.setAttribute(_key24, this.getAttribute(_key24) + " ; " + this._toRegEvnts[_key24].attrVal);
                    } else {
                        this.setAttribute(_key24, this._toRegEvnts[_key24].attrVal);
                    }
                }
                this._toRegEvnts = {};
                var initialUnbound = _LC.unbound;
                ...
                this.__lyteIgnore = true;
                for (var _i41 = attributes.length - 1; _i41 > -1; _i41--) {
                    var camelCase = LyteComponent.String.toCamelCase(attributes[_i41].nodeName);
                    if (dataDef[camelCase] && dataDef[camelCase].hideAttr) {
                        this.removeAttribute(attributes[_i41].nodeName);
                    }
                }
            ...
            value: function onCallBack(name) {
                ...
                if (callbacks) {
                    for (var _i42 = 0; _i42 < callbacks.length; _i42++) {
                        try {
                            callbacks[_i42].value.call(this.component);
                        } catch (e) {
                            _Lyte.error(e);
                        }
                    }
            ...
            value: function establishObserverBindings() {
                ...
                for (var _i43 = 0; _i43 < observers.length; _i43++) {
                    var props = observers[_i43].properties;
                    for (var j = 0; j < props.length; j++) {
                        var actProp = void 0;
                        var isArrayObserver = false;
                        if (props[j].indexOf('.[]') !== -1) {
                        ...
                        actProp._observers.add({ callee: this, observer: observers[_i43], isArrayObserver: isArrayObserver });
                    }
                }
            }
        }, {
            ...
            value: function removeBindings(properties, actualData) {
                var del = "delete";
                for (var _i44 in properties) {
                    var actData = actualData[_i44];
                    if (actData && actData._bindings) {
                        actData._bindings[del](properties[_i44]);
                    ...
                    if (_typeof(properties[_i44]) === "object" && actData) {
                        this.removeBindings(properties[_i44], actData);
                    }
                }
            }
        }, {
                    ...
                    for (key in self.__dc) {
                        ...
                        if (helper.hasAttribute("lyte-keep-alive")) {
                            ...
                            for (var j = 0; j < objKeys.length; j++) {
                                var _key25 = objKeys[j];
                                if (_key25 !== helper._currentComponent) {
                                    // Will remove from hDiv.
                                    var comp = helper._renderedComponent[_key25];
                                    comp.constructor.prototype._disconnectedCallback.call(comp);
                                    comp.remove();
                                }
                            }
            ...
            value: function _disconnectedCallback() {
                ...
                if (pve.length) {
                    for (var _i45 = 0; _i45 < pve.length; _i45++) {
                        var actTemp = _LC.getActViewPortTemplate(pve[_i45]);
                ...
                for (var _key26 in this._properties) {
                    this._properties[_key26] = {};
                }
            ...
            value: function dasherizeObservedAttributes() {
                ...
                for (var _i46 = 0; _i46 < this._observedAttributes.length; _i46++) {
                    newArr[_i46] = _LC.String.dasherize(this._observedAttributes[_i46]);
                }
            ...
            value: function updateValue(property, path, value) {
                ...
                for (var _i47 = 0; _i47 < pathVals.length - 1; _i47++) {
                    context = context[pathVals[_i47]];
                }
            ...
            value: function _registerComponent(a, b, widget) {
                ...
                if (this.component._dynamicNodes) {
                    ...
                    if (this.component._templateAttributes && this.component._templateAttributes.attr) {
                        ...
                        try {
                            for (var _i49 = 0; _i49 < attributesT.length; _i49++) {
                                var attrName = attributesT[_i49].name;
                                if (!this.component._templateAttributes.attr[attrName] && attrName !== "tag-name" && attrName !== "use-strict") {
                                    this.component._templateAttributes.attr[attrName] = { "name": attrName, "staticValue": attributesT[_i49].value };
            ...
            value: function splitTextNodes(node) {
                if (node && node.childNodes && node.childNodes.length) {
                    for (var _i50 = node.childNodes.length - 1; _i50 >= 0; _i50--) {
                        this.splitTextNodes(node.childNodes[_i50]);
                    }
                }
                ...
                if (node.nodeType === node.TEXT_NODE) {
                    ...
                    if (_nodeValue4) {
                        ...
                        var newNodeArray = [];
                        for (var _i51 = 0; _i51 < mustacheValues.length; _i51++) {
                            var mustacheStartIndex = _nodeValue4.indexOf(mustacheValues[_i51]);
                            var mustacheEndIndex = mustacheStartIndex + mustacheValues[_i51].length;
                        ...
                        if (_Lyte._rwpf && node.parentNode.nodeName === "#document-fragment") {
                            for (var _i52 = 0; _i52 < newNodeArray.length; _i52++) {
                                _insertBefore(node.parentNode, newNodeArray[_i52], node);
                            }
                            node.remove();
                        } else {
    ...
    var LyteComponent = (_LyteComponent2 = {
        ...
        for (var _key27 in def) {
            if (def[_key27] && def[_key27].type === "observer") {
                def[_key27].fnName = _key27;
                customCrmComponent.component._observers.push(def[_key27]);
            } else if (def[_key27] && def[_key27].type === "callBack") {
                var props = def[_key27].properties;
                for (var k = 0; k < props.length; k++) {
                    if (!customCrmComponent.component._callBacks[props[k]]) {
                        customCrmComponent.component._callBacks[props[k]] = [];
                    }
                    def[_key27].fnName = _key27;
                    customCrmComponent.component._callBacks[props[k]].push(def[_key27]);
                }
                if (def[_key27].observes) {
                    def[_key27].observes.fnName = _key27;
                    customCrmComponent.component._observers.push(def[_key27].observes);
                }
            } else {
                customCrmComponent.component.prototype[_key27] = def[_key27];
            }
        }
        return def;
        ...
        for (var _i53 = 0; _i53 < mixinslen; _i53++) {
            for (var item in mixinsToBeUsed[_i53]) {
                if (item === "actions") {
                    Object.assign(actionsFromMixin, mixinsToBeUsed[_i53][item]);
                } else if (item === "methods") {
                    Object.assign(methodsFromMixin, mixinsToBeUsed[_i53][item]);
                } else {
                    newDefinition[item] = mixinsToBeUsed[_i53][item];
                }
            }
        }
        ...
        var customArgs = [];
        if (arguments.length > 1) {
            for (var _i54 = 1; _i54 < arguments.length; _i54++) {
                customArgs.push(arguments[_i54]);
            }
        }
        //wait for release
        ...
        */
        ...
        if (actObj) {
            ...
            if (eventsObj) {
                ...
                var _val = eventsObj.apply(_context2, args);
        ...
        if (value && typeof value !== "string" && typeof value !== "boolean" && typeof value !== "number") {
            ...
            if (oldValue && (typeof oldValue === 'undefined' ? 'undefined' : _typeof(oldValue)) === "object" && oldValue._bindings) {
                ...
                if (fromComponent && fcmpData === object && property.indexOf('.') === -1 && !window.isLyteWidget) {
                    ...
                    if (object._bindings) {
                        ...
                        for (var _i55 = 0; _i55 < oldbind.length; _i55++) {
                            var _item = oldbind[_i55][property];
                            if (_item) {
            ...
            if (oldValue && (typeof oldValue === 'undefined' ? 'undefined' : _typeof(oldValue)) === "object" && oldValue._bindings && object._bindings) {
                ...
                for (var _i57 = 0; _i57 < _objbind.length; _i57++) {
                    var _item3 = _objbind[_i57];
                    if (_item3[property]) {
            ...
            if (object._bindings) {
                ...
                for (var _i58 = 0; _i58 < _objbind2.length; _i58++) {
                    var _item4 = _objbind2[_i58];
                    if (_item4[property]) {
        ...
        if (toBeExecuted && !fromParent && fromComponent._attributeDetails && fromComponent._callee) {
            ...
            if (syntaxValue) {
                ...
                var _obj8 = _LC.getNew(fclData, syntaxValue);
                if (!_obj8.context) {
                    return;
                }
                var exec = false;
                if (_obj8.context === fclData) {
                    if (fromComponent._callee._properties[_obj8.lastKey] && fromComponent._callee._properties[_obj8.lastKey].__fromComponent) {
                        exec = true;
                    }
                } else {
                    exec = true;
                ...
                if (exec) {
                    var lastKeyIndex = +_obj8.lastKey;
                    if (Array.isArray(_obj8.context) && typeof lastKeyIndex == "number") {
                        var callReplaceAt = lastKeyIndex < _obj8.context.length;
                        if (_obj8.context[lastKeyIndex] !== value || !callReplaceAt) {
                            _LC.aF(_obj8.context, callReplaceAt ? "replaceAt" : "insertAt", lastKeyIndex, value);
                        }
                    } else {
                        _LC.set(_obj8.context, _obj8.lastKey, value, options);
                    }
                }
        ...
        if ((typeof property === 'undefined' ? 'undefined' : _typeof(property)) === "object") {
            if (_Lyte.isRecord(object) && !fromStore && !object.$.isCloned) {
                ...
                for (var _key28 in property) {
                    var locValue = property[_key28];
                    var dataType = object.$.model.fieldList[_key28];
                    ...
                    if (dataType && (locValue !== undefined || dataType === "boolean") && dataType !== _LC.getDataType(locValue)) {
                        property[_key28] = _LC.typeCast(locValue, dataType);
                    }
                }
                ...
                for (var _key29 in property) {
                    ...
                    _LC.set(object, _key29, property[_key29], value, fromStore, fromParent);
                }
            }
        } else {
        ...
        var commands = [];
        for (var _i59 = 0; _i59 < arrayB.length; _i59++) {
            // var targetIndex = arrayA.findIndex((element) => element === arrayB[i]);
            var arrBi = arrayB[_i59];
            if (arrayB[_i59] && arrayB[_i59].__target__) {
                arrBi = arrayB[_i59].__target__;
            }
        ...
        for (var _i60 = arrayA.length - 1; _i60 >= arrayB.length; _i60--) {
            commands.push({
                type: 'Remove',
                element: arrayA[_i60]
            });
            arrayA.splice(_i60, 1);
        }
        ...
        if (bindings) {
            ...
            for (var _i61 = 0; _i61 < bind.length; _i61++) {
                var binding = bind[_i61];
                        ...
                        for (var _i62 = 0; _i62 < objbind.length; _i62++) {
                            ...
                            if (item._forHelpers) {
                                ...
                                for (var _j4 = 0; _j4 < helperbind.length; _j4++) {
                                    ...
                                    for (var _i63 = index, _j5 = 0; _i63 < finalIndex; _i63++, _j5++) {
                                        _LC.removeSelectedBindingDeep(_defineProperty({}, itemValue, helper._items[_i63].itemProperty), _defineProperty({}, itemValue, deletedItems[_j5]));
                                    }
                                    var contextSwitchArray = [];
                            ...
                            for (var _key30 in item) {
                                ...
                                if (!isNaN(parsedKey) && _cond) {
                                    ...
                                    this.removeSelectedBindingDeep(item[_key30], _oldObject);
                                    if (item[_key30]._forHelpers) {
                                        var bindfor = item[_key30]._forHelpers.toArrayLyte();
                                    ...
                                    if (array[parsedKey] && _typeof(array[parsedKey]) === "object") {
                                        ...
                                        this.establishBindings({ "dummy": item[_key30] }, { "dummy": array[parsedKey] });
                                    }
                                    this.affectChanges(item[_key30], undefined, _oldObject, undefined, array[parsedKey]);
                                    if (options.secondIndex == 1) {
                                        break;
                                    }
                                }
            ...
            case "splice":
                {
                    ...
                    if (array._bindings) {
                        ...
                        for (var _i64 = 0; _i64 < _objbind3.length; _i64++) {
                            var _item5 = _objbind3[_i64];
                            if (_item5._forHelpers) {
                                ...
                                for (var _j6 = 0; _j6 < _helperbind.length; _j6++) {
                                    ...
                                    for (var _i66 = _index2, _j7 = 0; _i66 < _finalIndex; _i66++, _j7++) {
                                        _LC.removeSelectedBindingDeep(_defineProperty({}, _itemValue, _helper._items[_i66].itemProperty), _defineProperty({}, _itemValue, _deletedItems[_j7]));
                                    }
                            ...
                            for (var _key31 in _item5) {
                                var _parsedKey = parseInt(_key31);
                                var cond = _options.secondIndex == _options.thirdIndex ? _key31 >= _options.firstIndex && _key31 < _options.firstIndex + _options.secondIndex : _parsedKey >= _options.firstIndex;
                                if (!isNaN(_parsedKey) && cond) {
                                    ...
                                    this.removeSelectedBindingDeep(_item5[_key31], _oldObject2);
                                    if (_item5[_key31]._forHelpers) {
                                        var _bindfor = _item5[_key31]._forHelpers.toArrayLyte();
                                    ...
                                    if (array[_parsedKey] && _typeof(array[_parsedKey]) === "object") {
                                        ...
                                        this.establishBindings({ "dummy": _item5[_key31] }, { "dummy": array[_parsedKey] });
                                    }
                                    this.affectChanges(_item5[_key31], undefined, _oldObject2, undefined, array[_parsedKey]);
                                }
                            }
                        }
                    }
            ...
            case "remove":
                {
                    ...
                    if (array._bindings) {
                        ...
                        for (var _i67 = 0; _i67 < _objbind4.length; _i67++) {
                            var _item7 = _objbind4[_i67];
                            if (_item7._forHelpers) {
                                ...
                                for (var _j8 = 0; _j8 < _helperbind2.length; _j8++) {
                                    ...
                                    for (var _i68 = _index3, _j9 = 0; _i68 < _finalIndex2; _i68++, _j9++) {
                                        _LC.removeSelectedBindingDeep(_defineProperty({}, _itemValue2, _helper2._items[_i68].itemProperty), _defineProperty({}, _itemValue2, _deletedItems2[_j9]));
                                    }
                            ...
                            for (var _key32 in _item7) {
                                var _parsedKey2 = parseInt(_key32);
                                if (!isNaN(_parsedKey2) && _parsedKey2 >= _options2.firstIndex) {
                                    ...
                                    this.removeSelectedBindingDeep(_item7[_key32], _oldObject3);
                                    if (_item7[_key32]._forHelpers) {
                                        var _bindfor2 = _item7[_key32]._forHelpers.toArrayLyte();
                                    ...
                                    if (array[_parsedKey2] && _typeof(array[_parsedKey2]) === "object") {
                                        ...
                                        this.establishBindings({ "dummy": _item7[_key32] }, { "dummy": array[_parsedKey2] });
                                    }
                                    this.affectChanges(_item7[_key32], undefined, _oldObject3, undefined, array[_parsedKey2]);
                                }
                            }
                        }
                    }
            ...
            case "insertAt":
                {
                    ...
                    for (var _i69 = _index4; _i69 > array.length; _i69--) {
                    ...
                    if (array._bindings) {
                        ...
                        for (var _i70 = 0; _i70 < arrbind.length; _i70++) {
                            var _item9 = arrbind[_i70];
                            ...
                            for (var _key33 in _item9) {
                                var _parsedKey3 = parseInt(_key33);
                                if (!isNaN(_parsedKey3) && _parsedKey3 >= _options3.firstIndex) {
                                    this.removeSelectedBindingDeep(_item9[_key33], array[_parsedKey3 + _options3.secondIndex]);
                                    if (_item9[_key33]._forHelpers) {
                                        var _bindfor3 = _item9[_key33]._forHelpers.toArrayLyte();
                                    ...
                                    if (array[_parsedKey3] && _typeof(array[_parsedKey3]) === "object") {
                                        ...
                                        this.establishBindings({ "dummy": _item9[_key33] }, { "dummy": array[_parsedKey3] });
                                    }
                                    this.affectChanges(_item9[_key33], undefined, array[_parsedKey3 + _options3.secondIndex], undefined, array[_parsedKey3]);
                                }
                            }
                        }
                    }
            ...
            case "sort":
                {
                    ...
                    if (array._bindings) {
                        ...
                        for (var _i71 = 0; _i71 < _arrbind.length; _i71++) {
                            var _item11 = _arrbind[_i71];
        ...
        if (array._bindings) {
            var objbind = array._bindings.toArrayLyte();
            for (var _i72 = 0; _i72 < objbind.length; _i72++) {
                var binding = objbind[_i72];
                var path = objbind[_i72]._path;
        ...
        for (var _i74 = 0; _i74 < props.length; _i74++) {
            ...
            currentProp = currentProp[props[_i74 + 1]];
            currentValue = currentValue[props[_i74 + 1]];
        }
                    ...
                    for (var j = 0; j < nodes.length; j++) {
                        ...
                        if (helper && helper.tagName === "TEMPLATE" && helper.getAttribute("is") === "for") {
                            if (helper._items) {
                                ...
                                for (var _i75 = 0; _i75 < helper._items.length; _i75++) {
                                    var data = actualData[_i75];
                                    var _item12 = helper.getAttribute("item");
                                    if (data) {
                                        if (_typeof(helper._items[_i75]) === "object") {
                                            this.establishBindings(helper._items[_i75].itemProperty, _defineProperty({}, _item12, data));
                                        }
                                    }
                                }
                            }
        ...
        for (var _i76 in properties) {
            var actData = actualData[_i76];
            if (!actData || typeof actData === "string" || typeof actData === "number" || typeof actData === "boolean") {
                ...
                // }
                addBindings(actData, properties[_i76]);
                if (_typeof(properties[_i76]) === "object") {
                    this.establishBindings(properties[_i76], actData);
                }
            }
        }
        ...
        for (var _i77 in binding) {
            var actData = void 0;
            if (actualData) {
                actData = actualData[_i77];
            }
            if (actData && actData._bindings) {
                deleteBindingCheckSize(actData, "_bindings", binding[_i77]);
            }
            if (_typeof(binding[_i77]) === "object") {
                this.removeSelectedBindingDeep(binding[_i77], actData, fromDisConnect);
            }
        }
        if (fromDisConnect) {
        ...
        if (binding && binding._forHelpers) {
            ...
            for (var _i78 = 0; _i78 < objbind.length; _i78++) {
                ...
                if (fH.getAttribute("is") === "for") {
                    ...
                    for (var _i79 = 0; _i79 < itemCases.length; _i79++) {
                        this.removeSelectedBindingDeep(itemCases[_i79].itemProperty, items[_i79], fromDisConnect);
                    }
                } else {
        ...
        var del = "delete";
        for (var _key34 in properties) {
            if (data[_key34] && data[_key34]._bindings) {
                //                    data[key]._bindings[del](properties[key]);
                //                    if(!data[key]._bindings.size) {
                //                        delete data[key]._bindings;
                //                    }
                deleteBindingCheckSize(data[_key34], "_bindings", properties[_key34]);
            }
            if (data[_key34] && typeof data[_key34] !== "string") {
                _LC.removeAllBindings(properties[_key34], data[_key34]);
            }
        }
        ...
        if (item._dynamicNodes) {
            for (var _i80 = 0; _i80 < item._dynamicNodes.length; _i80++) {
                item._dynamicNodes[_i80]._callee.updateNode(item._dynamicNodes[_i80], item._path, options);
            }
        }
        ...
        if (item._helperNodes) {
            ...
            for (var _s4 = 0; _s4 < itemHelperNodes.length; _s4++) {
                ...
                if (itemHelperNodes[_s4].getAttribute("is") === "for" && itemHelperNodes[_s4]._items) {
                    ...
                    for (var _i81 = 0; _i81 < itemHelperNodes[_s4]._items.length; _i81++) {
                        cmpData[itemValue] = items[_i81];
                        cmpData[indexValue] = _i81;
                        callee._properties[itemValue] = itemHelperNodes[_s4]._items[_i81].itemProperty;
                        if (itemHelperNodes[_s4]._items[_i81]._dynamicProperty[propPath]) {
                            nodes = itemHelperNodes[_s4]._items[_i81]._dynamicProperty[propPath];
                            for (var _i82 = 0; _i82 < nodes.length; _i82++) {
                                nodes[_i82]._callee.updateNode(nodes[_i82], propPath, options);
                            }
                        }
                    }
                    cmpData[itemValue] = initialItemValue;
                    ...
                    for (var _key35 in itemHelperNodes[_s4]._items) {
                        _cmpData4[_itemValue4] = object[_key35];
                        _cmpData4[_indexValue] = _key35;
                        _callee5._properties[_itemValue4] = itemHelperNodes[_s4]._items[_key35].itemProperty;
                        if (itemHelperNodes[_s4]._items[_key35]._dynamicProperty[propPath]) {
                            nodes = itemHelperNodes[_s4]._items[_key35]._dynamicProperty[propPath];
                            for (var _i83 = 0; _i83 < nodes.length; _i83++) {
                                nodes[_i83]._callee.updateNode(nodes[_i83], propPath, options);
                            }
                        }
                    }
                    ...
                    if (nodes.length) {
                        ...
                        for (var _i84 = 0; _i84 < nodes.length; _i84++) {
                            nodes[_i84]._callee.updateNode(nodes[_i84], item._path, options);
                        }
        ...
        if (Array.isArray(item)) {
            for (var i = 0; i < item.length; i++) {
                for (var _key36 in item[i]) {
                    this.affectChanges(item[i][_key36], true, oldValue ? oldValue[i] ? oldValue[i][_key36] : oldValue[i] : oldValue, setterScope, newValue ? newValue[i] ? newValue[i][_key36] : newValue[i] : newValue);
                }
            }
        } else {
            for (var _key37 in item) {
                var oldV = oldValue ? oldValue[_key37] : oldValue,
                    newV = newValue ? newValue[_key37] : newValue;
                if (_key37 == "*" && item[_key37].hasOwnProperty("_observers")) {
                    oldV = oldValue;
                    newV = newValue;
                }
                this.affectChanges(item[_key37], true, oldV, setterScope, newV);
            }
        }
        ...
        if (cache && cache.hasOwnProperty(path)) {
            ...
            try {
                ...
                for (var _k6 = 0; _k6 < locArr.length; _k6++) {
                    context = _LC.getCtxVal(context, locArr[_k6], comp);
                }
                for (var _i86 = 1; _i86 < arr.length; _i86++) {
                    var locVal = arr[_i86];
                    ...
                    if (locVal.startsWith(".")) {
                        ...
                        for (var _k7 = 0; _k7 < _locArr.length; _k7++) {
                            context = _LC.getCtxVal(context, _locArr[_k7], comp);
                        }
        ...
        if (typeof arg0 === "string") {
            ...
            for (var _key38 in arg0) {
                this.set(_key38, arg0[_key38], arg1);
            }
        }
        ...
        if (node) {
            if (typeof arg0 === "string") {
                ...
                for (var _key40 in arg0) {
                    node._methods[_key40] = arg0[_key40];
                }
            }
        }
        ...
        "attachEvents": function attachEvents(thisRef) {
            ...
            for (var _i87 = 0; _i87 < len; _i87++) {
                thisRef.addEventListener(toAddEvents[_i87].eventName, toAddEvents[_i87].listener, toAddEvents[_i87].options);
            }
            //lbind event
                ...
                if (listenerArr) {
                    ...
                    if (switchContext) {
                        ...
                        if (contextSwitchArray.length) {
                            ...
                            for (var _i88 = contextSwitchArray.length - 1; _i88 >= 0; _i88--) {
                                _LC.rmCx(target, [contextSwitchArray[_i88]], true);
                                _LC.affectChanges(self.getProperty(propName));
                            }
                        }
                    }
                ...
                case "attr":
                    {
                        ...
                        for (var _i89 = 0; _i89 < node.attributes.length; _i89++) {
                            if (node.attributes[_i89].nodeValue.indexOf("{{") !== -1) {
                                var val = node.attributes[_i89].nodeValue;
                                ...
                                if (actObj && (actObj.name === "action" || actObj.name === "method") && /^(onfocus|onfocusin|onfocusout|onresize|onscroll|onclick|ondblclick|onmousedown|onmouseup|onmousemove|onmouseover|onmouseout|onchange|onselect|onsubmit|onkeydown|onkeypress|onkeyup|oncontextmenu|__focus|__focusin|__focusout|__resize|__scroll|__click|__dblclick|__mousedown|__mouseup|__mousemove|__mouseover|__mouseout|__change|__select|__submit|__keydown|__keypress|__keyup|__contextmenu)$/.test(node.attributes[_i89].name)) {
                                    attr[node.attributes[_i89].name.substr(2)] = { name: node.attributes[_i89].name.substr(2), camelCase: _LC.String.toCamelCase(node.attributes[_i89].name.substr(2)), helperInfo: actObj, newHelperInfo: Lyte.Compile.getHelper(actValue, true), globalEvent: true };

                                    var actArgs = _Lyte.deepCopyObject(actObj.args);
                                    var actName = actArgs.splice(0, 1)[0];
                                    actName = actName.startsWith("'") ? actName.replace(/'/g, '') : actName;
                                    var actString = getArgString(actName, actArgs);
                                    node.setAttribute(node.attributes[_i89].name.substr(2), componentName + " => " + actString);
                                    if (dynNewCompile) {
                                        dynNewCompile.setAttribute(node.attributes[_i89].name.substr(2), componentName + " => " + actString);
                                    }
                                    toBeRemoved.push(node.attributes[_i89].name);
                                } else {
                                    if (actObj || actValue) {
                                        var _attrToPush = {};

                                        if (node.attributes[_i89].name.startsWith("lbind:")) {
                                            toBeRemoved.push(node.attributes[_i89].name);
                                            toBeAdded.push({ "name": node.attributes[_i89].name.substring(6), "value": node.attributes[_i89].nodeValue });
                                            _attrToPush.isLbind = true;
                                            _attrToPush.name = node.attributes[_i89].name.substring(6);
                                            _attrToPush.camelCase = _LC.String.toCamelCase(_attrToPush.name);
                                        } else {
                                            _attrToPush.name = node.attributes[_i89].name;
                                            _attrToPush.camelCase = _LC.String.toCamelCase(_attrToPush.name);
                                        }
                                        if (actObj) {
                            ...
                            if (node.attributes[_i89].name.startsWith("@")) {
                                var rt = _LC.directive.compileNode(node, attr, toBeRemoved, toBeAdded, _i89, componentName);
                                add = rt.add;
                                attrToPush = rt.attrToPush;
                            }
                        }
                        if (toBeRemoved.length) {
                            for (var _i90 = 0; _i90 < toBeRemoved.length; _i90++) {
                                node.removeAttribute(toBeRemoved[_i90]);
                                if (dynNewCompile) {
                                    dynNewCompile.removeAttribute(toBeRemoved[_i90]);
                                }
                            }
                        }
                        if (dynNewCompile) {
                            for (var _key41 in attr) {
                                dynNewCompile.removeAttribute(_key41);
                            }
                            dynNewCompile.setAttribute("_lyteAttr", "__**--Lyte" + j + "__**", "");
                        }
                        if (toBeAdded.length) {
                            for (var _i91 = 0; _i91 < toBeAdded.length; _i91++) {
                                node.setAttribute(toBeAdded[_i91].name, toBeAdded[_i91].value);
                            }
                        }
                    }
                    break;
                ...
                case "component":
                    {
                        ...
                        if ((window.isLyteWidget || window.__lyteEnablePromise) && dynN.hasAttribute("has-child")) {
                            ...
                            for (var _key42 in info.cases) {
                                ...
                                content = _LC.getContentForIE(actualTemplate.querySelector("[case='" + _LC.cssEscape(_key42) + "']"), undefined, true);

                                setHT(content, info.cases[_key42], contentNewCompile, constr);
                                doCompile(content.tagName === "TEMPLATE" ? content.content : content, info.cases[_key42].dynamicNodes, componentName, constr, contentNewCompile);
                ...
                case "switch":
                    {
                        ...
                        if (_Lyte._ms) {
                            ...
                            for (var _key43 in info.cases) {
                                ...
                                content = _LC.getContentForIE(cases[_key43], undefined, true);
                                if (actualTemplateNewCompile) {
                                    _contentNewCompile = _LC.getContentForIE(actualTemplateNewCompile.querySelector("[case='" + LyteComponent.cssEscape(_key43) + "']"));
                                }
                                setHT(content, info.cases[_key43], _contentNewCompile, constr);
                                doCompile(content, info.cases[_key43].dynamicNodes, componentName, constr, _contentNewCompile ? _LC.getContentForIE(_contentNewCompile) : undefined);

                                cases[_key43].remove();
                                if (actualTemplateNewCompile) {
                                    info.cases[_key43]._sta = _LC.processStatic(_contentNewCompile);
                                }
                                info.cases[_key43].templateContent = cases[_key43].outerHTML;
                            }
                            ...
                            for (var _key44 in info.cases) {
                                var _contentNewCompile3 = void 0;
                                if (actualTemplateNewCompile) {
                                    _contentNewCompile3 = _LC.getContentForIE(actualTemplateNewCompile.querySelector("[case='" + LyteComponent.cssEscape(_key44) + "']"));
                                }
                                content = _LC.getContentForIE(dynNContent.querySelector("[case='" + _LC.cssEscape(_key44) + "']"), undefined, true);

                                setHT(content, info.cases[_key44], _contentNewCompile3, constr);
                                doCompile(content.tagName === "TEMPLATE" ? content.content : content, info.cases[_key44].dynamicNodes, componentName, constr, _contentNewCompile3);
                                if (actualTemplateNewCompile) {
                                    info.cases[_key44]._sta = _LC.processStatic(_contentNewCompile3);
                                }
                                if (info.cases[_key44]._ht) {
                                    info.cases[_key44]._ht = content.cloneNode(true);
                                    constr._helperTemplate.content.append(info.cases[_key44]._ht);
                                    content.innerHTML = "";
                                }
                            }
                            if (info[def].dynamicNodes) {
    ...
    function getArgString(name, array) {
        ...
        for (var _i92 = 0; _i92 < array.length; _i92++) {
            if (array[_i92] && _typeof(array[_i92]) === "object") {
                array[_i92] = getArgString(array[_i92].value.name, array[_i92].value.args);
            }
        }
        if (name) {
        ...
        value: function value(arg0, arg1) {
            ...
            if (typeof arg0 === "string") {
                ...
                for (var _key45 in arg0) {
                    this._initProperties[_key45] = arg0[_key45];
                }
            }
        }
    });
    ...
    defProp(HTMLElement.prototype, 'setMethods', {
        ...
        value: function value(arg0, arg1) {
            ...
            if (typeof arg0 === "string") {
                ...
                for (var _key46 in arg0) {
                    this._initMethods[_key46] = arg0[_key46];
                }
            }
        }
    });
    ...
    Lyte.Compile.getTrimmedContent = function (content, position, node) {
        ...
        for (var _i93 = 0; _i93 < position.length; _i93++) {
            for (var j = content.childNodes.length - 1; j > position[_i93]; j--) {
                content.childNodes[j].remove();
            }
            content = content.childNodes[position[_i93]];
        }
        return dummyContent;
    };
    Lyte.Compile.getArrayIndex = function (array, value) {
        for (var _i94 = 0; _i94 < array.length; _i94++) {
            if (array[_i94] === value) {
                return _i94;
            };
        }
    ...
    Lyte.Compile.getHelperArgs = function (str, newCompile) {
        ...
        for (var _i95 = 0; _i95 < str.length; _i95++) {
            if (!stack.length && str.charAt(_i95) === ",") {
                var _toPush2 = str.substr(from, _i95 - from);
                ...
                args.push(_toPush2);
                from = _i95 + 1;
            } else if (str.charAt(_i95) === "(") {
                if (stack[stack.length - 1] != "'" && stack[stack.length - 1] != "\"") {
                    stack.push(str.charAt(_i95));
                    lastPushed = str.charAt(_i95);
                }
            } else if (str.charAt(_i95) === ")") {
                if (stack[stack.length - 1] === "(") {
                    stack.pop();
                }
            } else if (str.charAt(_i95) === "'" && str.charAt(_i95 - 1) !== "\\") {
                if (stack[stack.length - 1] === "'") {
                    stack.pop();
                    ...
                    setTimeout(function () {
                        ...
                        for (var i = arr.length - 1; i >= 0; i--) {
                            ...
                            if (_LC.isViewPortTemplate(_temp2) && !_temp2._callee._destroyed) {
                                var _obj9 = {};
                                if (_LC._isInViewPort(actTemp, actTemp._callee, beforeRemoveHook, undefined, _obj9)) {
                                    var nd = pve.splice(i, 1)[0];
                                    _temp2._inPve = false;
                                    _temp2._viewPortRendered = true;
                                    !_obj9.beforeRemoveHook && inViewTemplates.push(nd);
                                }
                                actTemp._inPve = _temp2._inPve;
                                actTemp._viewPortRendered = _temp2._viewPortRendered;
                            }
                        }
                        for (var _i96 = 0; _i96 < beforeRemoveHook.length; _i96++) {
                            beforeRemoveHook[_i96].viewOutIns.beforeRemove.apply(beforeRemoveHook[_i96].viewOutIns, beforeRemoveHook[_i96].arg);
                            _LC.waitingForResolve.push(beforeRemoveHook[_i96].node._renderPromise);
                        }
                        for (var _i97 = 0; _i97 < inViewTemplates.length; _i97++) {
                            _LC._executeIfTemplates(inViewTemplates[_i97]);
                        }
        ...
        if (LyteComponent.pendingViewPortElements) {
            requestAnimationFrame(function () {
                setTimeout(function () {
                    ...
                    for (var _key47 in _LC._doneRaf) {
                        if (_LC._doneRaf[_key47]) {
    ...
    LyteComponent.executePendingViewPort = function (options) {
        ...
        if (!options || !options.force) {
            ...
            for (var _i98 = 0; _i98 < beforeRemoveHook.length; _i98++) {
                beforeRemoveHook[_i98].viewOutIns.beforeRemove.apply(beforeRemoveHook[_i98].viewOutIns, beforeRemoveHook[_i98].arg);
            }
        } else {
