...
var lyte_security_html_sanitizer = readFileSync("node_modules/@zoho/SecurityJS/dist/security-html-sanitizer.min.js");
var lyte_security_encoder = readFileSync("node_modules/@zoho/SecurityJS/dist/security-encoder.min.js");
lyte_security_hold_dompurify = "window.DOMPurifyCopy = window.DOMPurify ? window.DOMPurify : undefined;"
lyte_security_save_dompurify = ";if(window.DOMPurifyCopy) { window.DOMPurify = window.DOMPurifyCopy; window.DOMPurifyCopy = undefined; };";
var lyte_security =  lyte_security_hold_dompurify + lyte_security_html_sanitizer + lyte_security_save_dompurify + lyte_security_encoder + "window.ZSEC = window.ZWAF;";
