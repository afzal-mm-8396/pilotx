( function( window ) {
	...
	Object.defineProperty( $L._lyteDomObj.prototype, 'e', {
		get: function() {
	...
	$L._lyteDomObj.prototype.iterator = function( fn ) {
	...
	$L._lyteDomObj.prototype.insertBefore = function( node ) {
	...
	$L._lyteDomObj.prototype.insertAfter = function( node ) {
	...
	$L._lyteDomObj.prototype.html = function( data ) {
	...
	$L._lyteDomObj.prototype.append = function( node ) {
	...
	$L._lyteDomObj.prototype.replace = function( node ) {
		this.iterator( function( item ) {
			item.parentElement.replaceChild( node, item );
		} );
	}

	$L._lyteDomObj.prototype.empty = function() {
	...
	$L._lyteDomObj.prototype.bind = function( eventName, fn ) {
	...
	$L._lyteDomObj.prototype.unbind = function( eventName, fn ) {
	...
	if( !$L._lyteDomObj.prototype.hide ) {
		$L._lyteDomObj.prototype.hide = function( node ) {
	...
	if( !$L._lyteDomObj.prototype.show ) {
		$L._lyteDomObj.prototype.show = function( node ) {
