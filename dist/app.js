    ...
    async function callCRMFunction(prompt, history) {
        ...
        try {
            if (isInIframe && typeof ZOHO !== 'undefined' && ZOHO.CRM && ZOHO.CRM.HTTP && typeof ZOHO.CRM.HTTP.post === 'function') {
                ...
                var apiUrl = "http://10.59.1.82:8000/chat";
