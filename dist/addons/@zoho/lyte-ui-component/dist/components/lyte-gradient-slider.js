...
_observedAttributesType :["boolean","number","number","number","boolean","string","string","array","boolean"],

	_lyteUtilFunctions : [ "insertHandler", "removeHandler", "updateHandler", "getHandler", "focus" ],
	init : function(){
