...
_template:"<template tag-name=\"lyte-dropdown\" lyte-dropdown=\"\"> <template is=\"if\" value=\"{{ltPropLabel}}\"><template case=\"true\"> <div class=\"lyteDropdownFieldLabel {{ltPropLabelClass}}\" id=\"{{lyteUiGetDropdownLabelId()}}\">{{ltPropLabel}}</div> </template></template> <template is=\"if\" value=\"{{expHandlers(ltPropHover,'==',true)}}\"><template case=\"true\"> <template is=\"if\" value=\"{{expHandlers(multiple,'==',true)}}\"><template case=\"true\"> <template is=\"if\" value=\"{{expHandlers(search,'==',true)}}\"><template case=\"true\"> <template is=\"if\" value=\"{{expHandlers(drophead,'==','noyield')}}\"><template case=\"true\"> <lyte-drop-button role=\"combobox\" aria-expanded=\"{{if(ltPropIsOpen,'true','false')}}\" aria-haspopup=\"listbox\"> <div class=\"lyteMultiselect\"> <ul class=\"lyteMultipleSelect\"> <template is=\"for\" items=\"{{ltPropSelectedList}}\" item=\"item\" index=\"indexVal\"> <li data-value=\"{{lyteUiReturnValueBy(item,sysValue)}}\"> <span class=\"lyteDropdownVisible\" onmouseenter=\"{{action('toolTipConfig',this,'selToolTip')}}\" lt-prop-title=\"{{if(selToolTip,lyteUiReturnValueBy(item,userValue),'')}}\" lt-prop-tooltip-config=\"{{ltPropTooltip}}\" lt-prop-tooltip-class=\"{{ltPropTooltipClass}}\">{{lyteUiReturnValueBy(item,userValue)}}</span> <lyte-drop-remove class=\"lyteCloseIcon\"></lyte-drop-remove> </li> </template> <li class=\"lyteMultiselectInput\"> <input disabled=\"{{ltPropDisabled}}\" readonly=\"{{ltPropReadOnly}}\" onkeydown=\"{{action('preventDefault',event)}}\" type=\"text\" placeholder=\"{{ltPropPlaceholder}}\" class=\"lyteDropdownTextField\" autocomplete=\"off\" tabindex=\"{{ltPropTabindex}}\" lyte-focus-name=\"{{ltPropFocusName}}\" lyte-bfocus-name=\"{{ltPropBfocusName}}\" lyte-nfocus-name=\"{{ltPropNfocusName}}\" data-tabindex=\"{{ltPropDataTabindex}}\" onclick=\"{{action('showHide',event)}}\" onfocus=\"{{action('addFocusClass',event)}}\" onblur=\"{{action('removeFocusClass',event)}}\"> </li> </ul> </div> <template is=\"if\" value=\"{{shouldDisplayIcon}}\"><template case=\"true\"> <lyte-icon class=\"{{ltPropIconClass}}\"></lyte-icon> </template></template> </lyte-drop-button> </template><template case=\"false\"> </template></template> </template><template case=\"false\"> <template is=\"if\" value=\"{{expHandlers(drophead,'==',&quot;noyield&quot;)}}\"><template case=\"true\"> <div class=\"lyteDummyEventContainer\" role=\"combobox\" aria-haspopup=\"listbox\" aria-expanded=\"{{if(ltPropIsOpen,'true','false')}}\" onclick=\"{{action('showHide',event)}}\" onkeyup=\"{{action('checkKey',event)}}\" tabindex=\"{{ltPropTabindex}}\" lyte-focus-name=\"{{ltPropFocusName}}\" lyte-bfocus-name=\"{{ltPropBfocusName}}\" lyte-nfocus-name=\"{{ltPropNfocusName}}\" data-tabindex=\"{{ltPropDataTabindex}}\"> <lyte-drop-button> <template is=\"if\" value=\"{{expHandlers(expHandlers(ltPropSelectedList.length,'==',0),'&amp;&amp;',expHandlers(ltPropForcePlaceholder,'!'))}}\"><template case=\"true\"> <span class=\"lyteDropPlaceholderMultiple\">{{ltPropPlaceholder}}</span> </template></template> <ul class=\"lyteMultipleSelect\"> <template is=\"for\" items=\"{{ltPropSelectedList}}\" item=\"item\" index=\"indexVal\"> <li data-value=\"{{lyteUiReturnValueBy(item,sysValue)}}\"> <span class=\"lyteDropdownVisible\" onmouseenter=\"{{action('toolTipConfig',this,'selToolTip')}}\" lt-prop-title=\"{{if(selToolTip,lyteUiReturnValueBy(item,userValue),'')}}\" lt-prop-tooltip-config=\"{{ltPropTooltip}}\" lt-prop-tooltip-class=\"{{ltPropTooltipClass}}\">{{lyteUiReturnValueBy(item,userValue)}}</span> <lyte-drop-remove class=\"lyteCloseIcon\"></lyte-drop-remove> </li> </template> </ul> <template is=\"if\" value=\"{{ltPropForcePlaceholder}}\"><template case=\"true\"> <span class=\"lyteDropPlaceholderMultiple\">{{ltPropPlaceholder}}</span> </template></template> <template is=\"if\" value=\"{{shouldDisplayIcon}}\"><template case=\"true\"> <lyte-icon class=\"{{ltPropIconClass}}\"></lyte-icon> </template></template> </lyte-drop-button> </div> </template><template case=\"false\"> </template></template> </template></template> </template><template case=\"false\"> <div onmouseenter=\"{{action('showHide',event,'enter')}}\" role=\"combobox\" aria-haspopup=\"listbox\" aria-expanded=\"{{if(ltPropIsOpen,'true','false')}}\" onmouseleave=\"{{action('closeIt',event)}}\" class=\"lyteDummyEventContainer\" tabindex=\"{{ltPropTabindex}}\" lyte-focus-name=\"{{ltPropFocusName}}\" lyte-bfocus-name=\"{{ltPropBfocusName}}\" lyte-nfocus-name=\"{{ltPropNfocusName}}\" data-tabindex=\"{{ltPropDataTabindex}}\" style=\"\"> <template is=\"if\" value=\"{{expHandlers(drophead,'==',&quot;noyield&quot;)}}\"><template case=\"true\"> <lyte-drop-button> <template is=\"if\" value=\"{{ltPropDisplayValue}}\"><template case=\"true\"> <span class=\"lyteMarginRight lyteDropdownLabel\" onmouseenter=\"{{action('toolTipConfig',this,'showToolTip')}}\" lt-prop-title=\"{{if(showToolTip,ltPropDisplayValue,'')}}\" lt-prop-tooltip-config=\"{{ltPropTooltip}}\" lt-prop-tooltip-class=\"{{ltPropTooltipClass}}\">{{ltPropDisplayValue}}</span> </template><template case=\"false\"><template is=\"if\" value=\"{{expHandlers(expHandlers(ltPropSelected,'!'),'&amp;&amp;',expHandlers(ltPropDisplayValue,'!'))}}\"><template case=\"true\"> <span class=\"lyteDropPlaceholderNormal\">{{ltPropPlaceholder}}</span> </template></template></template></template> <template is=\"if\" value=\"{{expHandlers(ltPropSelected,'&amp;&amp;',ltPropShowRemoveIcon)}}\"><template case=\"true\"> <lyte-drop-remove class=\"lyteDropdownDeselectIcon\"></lyte-drop-remove> </template></template> <lyte-icon class=\"{{ltPropIconClass}}\"></lyte-icon> </lyte-drop-button> </template><template case=\"false\"><template is=\"if\" value=\"{{expHandlers(drophead,'==',&quot;yield&quot;)}}\"><template case=\"true\"> </template></template></template></template> </div> </template></template> </template><template case=\"false\"> <template is=\"if\" value=\"{{expHandlers(multiple,'==',true)}}\"><template case=\"true\"> <template is=\"if\" value=\"{{expHandlers(search,'==',true)}}\"><template case=\"true\"> <template is=\"if\" value=\"{{expHandlers(drophead,'==','noyield')}}\"><template case=\"true\"> <lyte-drop-button onclick=\"{{action('showHide',event)}}\" role=\"combobox\" aria-haspopup=\"listbox\" aria-expanded=\"{{if(ltPropIsOpen,'true','false')}}\"> <div class=\"lyteMultiselect\"> <ul class=\"lyteMultipleSelect\"> <template is=\"for\" items=\"{{ltPropSelectedList}}\" item=\"item\" index=\"indexVal\"> <li data-value=\"{{lyteUiReturnValueBy(item,sysValue)}}\"> <span class=\"lyteDropdownVisible\" onmouseenter=\"{{action('toolTipConfig',this,'selToolTip')}}\" lt-prop-title=\"{{if(selToolTip,lyteUiReturnValueBy(item,userValue),'')}}\" lt-prop-tooltip-config=\"{{ltPropTooltip}}\" lt-prop-tooltip-class=\"{{ltPropTooltipClass}}\">{{lyteUiReturnValueBy(item,userValue)}}</span> <lyte-drop-remove class=\"lyteCloseIcon\"></lyte-drop-remove> </li> </template> <li class=\"lyteMultiselectInput\"> <input disabled=\"{{ltPropDisabled}}\" readonly=\"{{ltPropReadOnly}}\" onkeydown=\"{{action('preventDefault',event)}}\" type=\"text\" placeholder=\"{{ltPropPlaceholder}}\" class=\"lyteDropdownTextField\" autocomplete=\"off\" tabindex=\"{{ltPropTabindex}}\" lyte-focus-name=\"{{ltPropFocusName}}\" lyte-bfocus-name=\"{{ltPropBfocusName}}\" lyte-nfocus-name=\"{{ltPropNfocusName}}\" data-tabindex=\"{{ltPropDataTabindex}}\" onfocus=\"{{action('addFocusClass',event)}}\" onblur=\"{{action('removeFocusClass',event)}}\"> </li> </ul> </div> <template is=\"if\" value=\"{{shouldDisplayIcon}}\"><template case=\"true\"> <lyte-icon class=\"{{ltPropIconClass}}\"></lyte-icon> </template></template> </lyte-drop-button> </template><template case=\"false\"> <div class=\"lyteDummyEventContainer\" style=\"\" onclick=\"{{action('showHide',event)}}\" role=\"combobox\" aria-haspopup=\"listbox\" aria-expanded=\"{{if(ltPropIsOpen,'true','false')}}\"> </div> </template></template> </template><template case=\"false\"> <div class=\"lyteDummyEventContainer\" onclick=\"{{action('showHide',event)}}\" tabindex=\"{{ltPropTabindex}}\" lyte-focus-name=\"{{ltPropFocusName}}\" lyte-bfocus-name=\"{{ltPropBfocusName}}\" lyte-nfocus-name=\"{{ltPropNfocusName}}\" data-tabindex=\"{{ltPropDataTabindex}}\" role=\"combobox\" aria-haspopup=\"listbox\" aria-expanded=\"{{if(ltPropIsOpen,'true','false')}}\"> <template is=\"if\" value=\"{{expHandlers(drophead,'==',&quot;noyield&quot;)}}\"><template case=\"true\"> <lyte-drop-button> <template is=\"if\" value=\"{{expHandlers(expHandlers(ltPropSelectedList.length,'==',0),'&amp;&amp;',expHandlers(ltPropForcePlaceholder,'!'))}}\"><template case=\"true\"> <span class=\"lyteDropPlaceholderMultiple\">{{ltPropPlaceholder}}</span> </template></template> <ul class=\"lyteMultipleSelect\"> <template is=\"for\" items=\"{{ltPropSelectedList}}\" item=\"item\" index=\"indexVal\"> <li data-value=\"{{lyteUiReturnValueBy(item,sysValue)}}\"> <span class=\"lyteDropdownVisible\" onmouseenter=\"{{action('toolTipConfig',this,'selToolTip')}}\" lt-prop-title=\"{{if(selToolTip,lyteUiReturnValueBy(item,userValue),'')}}\" lt-prop-tooltip-config=\"{{ltPropTooltip}}\" lt-prop-tooltip-class=\"{{ltPropTooltipClass}}\">{{lyteUiReturnValueBy(item,userValue)}}</span> <lyte-drop-remove class=\"lyteCloseIcon\"></lyte-drop-remove> </li> </template> </ul> <template is=\"if\" value=\"{{ltPropForcePlaceholder}}\"><template case=\"true\"> <span class=\"lyteDropPlaceholderMultiple\">{{ltPropPlaceholder}}</span> </template></template> <template is=\"if\" value=\"{{shouldDisplayIcon}}\"><template case=\"true\"> <lyte-icon class=\"{{ltPropIconClass}}\"></lyte-icon> </template></template> </lyte-drop-button> </template><template case=\"false\"> </template></template> </div> </template></template> </template><template case=\"false\"> <div onclick=\"{{action('showHide',event)}}\" class=\"lyteDummyEventContainer\" tabindex=\"{{ltPropTabindex}}\" lyte-focus-name=\"{{ltPropFocusName}}\" lyte-bfocus-name=\"{{ltPropBfocusName}}\" lyte-nfocus-name=\"{{ltPropNfocusName}}\" data-tabindex=\"{{ltPropDataTabindex}}\" style=\"\" role=\"combobox\" aria-haspopup=\"listbox\" aria-expanded=\"{{if(ltPropIsOpen,'true','false')}}\"> <template is=\"if\" value=\"{{expHandlers(drophead,'==',&quot;noyield&quot;)}}\"><template case=\"true\"> <lyte-drop-button> <template is=\"if\" value=\"{{ltPropDisplayValue}}\"><template case=\"true\"> <span onmouseenter=\"{{action('toolTipConfig',this,'showToolTip')}}\" lt-prop-tooltip-config=\"{{ltPropTooltip}}\" lt-prop-tooltip-class=\"{{ltPropTooltipClass}}\" lt-prop-title=\"{{if(showToolTip,ltPropDisplayValue,'')}}\" class=\"lyteMarginRight lyteDropdownLabel\">{{ltPropDisplayValue}}</span> </template><template case=\"false\"><template is=\"if\" value=\"{{expHandlers(expHandlers(ltPropSelected,'!'),'&amp;&amp;',expHandlers(ltPropDisplayValue,'!'))}}\"><template case=\"true\"> <span class=\"lyteDropPlaceholderNormal\">{{ltPropPlaceholder}}</span> </template></template></template></template> <template is=\"if\" value=\"{{expHandlers(ltPropSelected,'&amp;&amp;',ltPropShowRemoveIcon)}}\"><template case=\"true\"> <lyte-drop-remove class=\"lyteDropdownDeselectIcon\"></lyte-drop-remove> </template></template> <lyte-icon class=\"{{ltPropIconClass}}\"></lyte-icon> </lyte-drop-button> </template><template case=\"false\"><template is=\"if\" value=\"{{expHandlers(drophead,'==',&quot;yield&quot;)}}\"><template case=\"true\"> </template></template></template></template> </div> </template></template> </template></template> <template is=\"if\" value=\"{{expHandlers(ltPropHover,'==',false)}}\"><template case=\"true\"> <template is=\"if\" value=\"{{expHandlers(dropbody,'==',&quot;noyield&quot;)}}\"><template case=\"true\"> <lyte-drop-box lyte-dropdown=\"\" class=\"lyteDropdownHidden\"> <lyte-drop-body> <template is=\"for\" items=\"{{ltPropOptions}}\" item=\"item\" index=\"indexVal\"><template is=\"if\" value=\"{{lyteUiOptGroupCheck(item)}}\"><template case=\"true\"> <lyte-drop-group> <lyte-drop-label>{{lyteUiReturnOnlyKey(item)}}</lyte-drop-label> <template is=\"for\" items=\"{{lyteUiReturnValueBy(item,lyteUiReturnOnlyKey(item))}}\" item=\"subitem\" index=\"indexval\"> <template is=\"if\" value=\"{{lyteUiIsObject(subitem)}}\"><template case=\"true\"> <lyte-drop-item data-value=\"{{subitem[ltPropSystemValue]}}\" disabled=\"{{lyteUiCheckDisabled(ltPropDisabledList,subitem[ltPropSystemValue])}}\">{{subitem[ltPropUserValue]}}</lyte-drop-item> </template><template case=\"false\"> <lyte-drop-item data-value=\"{{subitem}}\" disabled=\"{{lyteUiCheckDisabled(ltPropDisabledList,subitem)}}\">{{subitem}}</lyte-drop-item> </template></template> </template> </lyte-drop-group> </template><template case=\"false\"> <template is=\"if\" value=\"{{lyteUiIsObject(item)}}\"><template case=\"true\"> <lyte-drop-item data-value=\"{{item[ltPropSystemValue]}}\" disabled=\"{{lyteUiCheckDisabled(ltPropDisabledList,item[ltPropSystemValue])}}\">{{item[ltPropUserValue]}}</lyte-drop-item> </template><template case=\"false\"> <lyte-drop-item data-value=\"{{item}}\" disabled=\"{{lyteUiCheckDisabled(ltPropDisabledList,item)}}\">{{item}}</lyte-drop-item> </template></template> </template></template> </template> </lyte-drop-body> </lyte-drop-box> </template><template case=\"false\"> </template></template> <div class=\"lyteLoadMsg\" style=\"display:none;\">Loading</div> </template><template case=\"false\"> <template is=\"if\" value=\"{{expHandlers(dropbody,'==',&quot;noyield&quot;)}}\"><template case=\"true\"> <lyte-drop-box lyte-dropdown=\"\" class=\"lyteDropdownHidden\"> <lyte-drop-body> <template is=\"for\" items=\"{{ltPropOptions}}\" item=\"item\" index=\"indexVal\"><template is=\"if\" value=\"{{lyteUiOptGroupCheck(item)}}\"><template case=\"true\"> <lyte-drop-group> <lyte-drop-label>{{lyteUiReturnOnlyKey(item)}}</lyte-drop-label> <template is=\"for\" items=\"{{lyteUiReturnValueBy(item,lyteUiReturnOnlyKey(item))}}\" item=\"subitem\" index=\"indexval\"> <template is=\"if\" value=\"{{lyteUiIsObject(subitem)}}\"><template case=\"true\"> <lyte-drop-item data-value=\"{{subitem[ltPropSystemValue]}}\" disabled=\"{{lyteUiCheckDisabled(ltPropDisabledList,subitem[ltPropSystemValue])}}\">{{subitem[ltPropUserValue]}}</lyte-drop-item> </template><template case=\"false\"> <lyte-drop-item data-value=\"{{subitem}}\" disabled=\"{{lyteUiCheckDisabled(ltPropDisabledList,subitem)}}\">{{subitem}}</lyte-drop-item> </template></template> </template> </lyte-drop-group> </template><template case=\"false\"> <template is=\"if\" value=\"{{lyteUiIsObject(item)}}\"><template case=\"true\"> <lyte-drop-item data-value=\"{{item[ltPropSystemValue]}}\" disabled=\"{{lyteUiCheckDisabled(ltPropDisabledList,item[ltPropSystemValue])}}\">{{item[ltPropUserValue]}}</lyte-drop-item> </template><template case=\"false\"> <lyte-drop-item data-value=\"{{item}}\" disabled=\"{{lyteUiCheckDisabled(ltPropDisabledList,item)}}\">{{item}}</lyte-drop-item> </template></template> </template></template> </template> </lyte-drop-body> </lyte-drop-box> </template><template case=\"false\"> </template></template> <div class=\"lyteLoadMsg\" style=\"display:none;\">Loading</div> </template></template> <lyte-yield yield-name=\"yield\" style=\"display: none;\" lyte-options=\"{{ltPropOptions}}\"></lyte-yield> </template>",
_dynamicNodes : [{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,0]}]}},"default":{}},{"type":"attr","position":[3]},{"type":"if","position":[3],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,1,1,1]},{"type":"for","position":[1,1,1,1],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,1]},{"type":"text","position":[1,1,0]},{"type":"componentDynamic","position":[1,3]}]},{"type":"attr","position":[1,1,1,3,1]},{"type":"attr","position":[1,3]},{"type":"if","position":[1,3],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"componentDynamic","position":[1]}]}},"default":{}},{"type":"componentDynamic","position":[1]}]},"false":{"dynamicNodes":[]}},"default":{}}]},"false":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,1,1]},{"type":"if","position":[1,1,1],"cases":{"true":{"dynamicNodes":[{"type":"text","position":[1,0]}]}},"default":{}},{"type":"attr","position":[1,1,3,1]},{"type":"for","position":[1,1,3,1],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,1]},{"type":"text","position":[1,1,0]},{"type":"componentDynamic","position":[1,3]}]},{"type":"attr","position":[1,1,5]},{"type":"if","position":[1,1,5],"cases":{"true":{"dynamicNodes":[{"type":"text","position":[1,0]}]}},"default":{}},{"type":"attr","position":[1,1,7]},{"type":"if","position":[1,1,7],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"componentDynamic","position":[1]}]}},"default":{}},{"type":"componentDynamic","position":[1,1]}]},"false":{"dynamicNodes":[]}},"default":{}}]}},"default":{}}]},"false":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,1]},{"type":"if","position":[1,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1,1]},{"type":"if","position":[1,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,0]}]},"false":{"dynamicNodes":[{"type":"attr","position":[0]},{"type":"if","position":[0],"cases":{"true":{"dynamicNodes":[{"type":"text","position":[1,0]}]}},"default":{}}]}},"default":{}},{"type":"attr","position":[1,3]},{"type":"if","position":[1,3],"cases":{"true":{"dynamicNodes":[{"type":"componentDynamic","position":[1]}]}},"default":{}},{"type":"attr","position":[1,5]},{"type":"componentDynamic","position":[1,5]},{"type":"componentDynamic","position":[1]}]},"false":{"dynamicNodes":[{"type":"attr","position":[0]},{"type":"if","position":[0],"cases":{"true":{"dynamicNodes":[]}},"default":{}}]}},"default":{}}]}},"default":{}}]},"false":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,1,1,1]},{"type":"for","position":[1,1,1,1],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,1]},{"type":"text","position":[1,1,0]},{"type":"componentDynamic","position":[1,3]}]},{"type":"attr","position":[1,1,1,3,1]},{"type":"attr","position":[1,3]},{"type":"if","position":[1,3],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"componentDynamic","position":[1]}]}},"default":{}},{"type":"componentDynamic","position":[1]}]},"false":{"dynamicNodes":[{"type":"attr","position":[1]}]}},"default":{}}]},"false":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,1]},{"type":"if","position":[1,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1,1]},{"type":"if","position":[1,1],"cases":{"true":{"dynamicNodes":[{"type":"text","position":[1,0]}]}},"default":{}},{"type":"attr","position":[1,3,1]},{"type":"for","position":[1,3,1],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,1]},{"type":"text","position":[1,1,0]},{"type":"componentDynamic","position":[1,3]}]},{"type":"attr","position":[1,5]},{"type":"if","position":[1,5],"cases":{"true":{"dynamicNodes":[{"type":"text","position":[1,0]}]}},"default":{}},{"type":"attr","position":[1,7]},{"type":"if","position":[1,7],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"componentDynamic","position":[1]}]}},"default":{}},{"type":"componentDynamic","position":[1]}]},"false":{"dynamicNodes":[]}},"default":{}}]}},"default":{}}]},"false":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,1]},{"type":"if","position":[1,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1,1]},{"type":"if","position":[1,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,0]}]},"false":{"dynamicNodes":[{"type":"attr","position":[0]},{"type":"if","position":[0],"cases":{"true":{"dynamicNodes":[{"type":"text","position":[1,0]}]}},"default":{}}]}},"default":{}},{"type":"attr","position":[1,3]},{"type":"if","position":[1,3],"cases":{"true":{"dynamicNodes":[{"type":"componentDynamic","position":[1]}]}},"default":{}},{"type":"attr","position":[1,5]},{"type":"componentDynamic","position":[1,5]},{"type":"componentDynamic","position":[1]}]},"false":{"dynamicNodes":[{"type":"attr","position":[0]},{"type":"if","position":[0],"cases":{"true":{"dynamicNodes":[]}},"default":{}}]}},"default":{}}]}},"default":{}}]}},"default":{}},{"type":"attr","position":[5]},{"type":"if","position":[5],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1,1,1]},{"type":"for","position":[1,1,1],"dynamicNodes":[{"type":"attr","position":[0]},{"type":"if","position":[0],"cases":{"true":{"dynamicNodes":[{"type":"text","position":[1,1,0]},{"type":"componentDynamic","position":[1,1]},{"type":"attr","position":[1,3]},{"type":"for","position":[1,3],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,0]},{"type":"componentDynamic","position":[1]}]},"false":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,0]},{"type":"componentDynamic","position":[1]}]}},"default":{}}]},{"type":"componentDynamic","position":[1]}]},"false":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,0]},{"type":"componentDynamic","position":[1]}]},"false":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,0]},{"type":"componentDynamic","position":[1]}]}},"default":{}}]}},"default":{}}]},{"type":"componentDynamic","position":[1,1]},{"type":"componentDynamic","position":[1]}]},"false":{"dynamicNodes":[]}},"default":{}}]},"false":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1,1,1]},{"type":"for","position":[1,1,1],"dynamicNodes":[{"type":"attr","position":[0]},{"type":"if","position":[0],"cases":{"true":{"dynamicNodes":[{"type":"text","position":[1,1,0]},{"type":"componentDynamic","position":[1,1]},{"type":"attr","position":[1,3]},{"type":"for","position":[1,3],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,0]},{"type":"componentDynamic","position":[1]}]},"false":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,0]},{"type":"componentDynamic","position":[1]}]}},"default":{}}]},{"type":"componentDynamic","position":[1]}]},"false":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,0]},{"type":"componentDynamic","position":[1]}]},"false":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,0]},{"type":"componentDynamic","position":[1]}]}},"default":{}}]}},"default":{}}]},{"type":"componentDynamic","position":[1,1]},{"type":"componentDynamic","position":[1]}]},"false":{"dynamicNodes":[]}},"default":{}}]}},"default":{}},{"type":"attr","position":[7]},{"type":"insertYield","position":[7]}],
_observedAttributes :["shouldDisplayIcon","changeItToInvoke","dummy1","dummy2","savedPositions","ltPropRemoveMultiple","ltPropYield","ltPropType","ltPropTabindex","ltPropShow","ltPropFreeze","ltPropOptions","ltPropUserValue","ltPropSystemValue","ltPropPosition","ltPropIconClass","ltPropSelected","ltPropCallout","ltPropPlaceholder","ltPropDisabled","ltPropHover","ltPropNoResult","ltPropMaxCount","ltPropInputClass","ltPropBoundary","pos","secondaryPosition","firePos","ltPropAjaxRequest","firstRequest","userValue","sysValue","ltPropDisplayValue","ltPropDisabledList","ltPropAnimate","ltPropSetPos","ltPropTooltip","ltPropBoxClass","ltPropIsOpen","ltPropFocus","ltPropFixPositionOnOpen","ltPropForcePlaceholder","ltPropShowEmptyMessage","ltPropBoxButtonWidth","ltPropPreventScroll","ltPropScope","ltPropAnimateBox","ltPropTooltipClass","ltPropDisplayList","ltPropSelectedList","ltPropItemSearchType","ltPropFocusOnClose","ltPropButtonClass","ltPropDisableItemTooltip","ltPropPreventParentScroll","ltPropShowRemoveIcon","ltPropAriaButton","ltPropAriaBox","ltPropAriaBody","ltPropReadOnly","ltPropActiveElement","ltPropAllowFocusableElements","ltPropDataTabindex","ltPropPreventNavigation","ltPropTrimSearchText","ltPropNoResultYield","ltPropIncludeButtonInFocusLoop","ltPropForceCalculateWidth","ltPropSetAriaOnActiveElement","ltPropCaseSensitive","ltPropSearchMethod","ltPropLabel","ltPropLabelClass","ltPropDirection","ltPropFocusName","ltPropBfocusName","ltPropNfocusName","ltPropUseItemOffsetForScroll","ltPropReduceHeightOfBody","ltPropAlignCalloutToIcon","ltPropEnableCyclicNavigation","ltPropNonRemovableItems","ltPropFocusOnRemove"],
_observedAttributesType :["boolean","number","boolean","boolean","object","boolean","boolean","string","number","boolean","boolean","array","string","string","string","string","string","boolean","string","boolean","boolean","string","number","string","object","string","string","number","object","boolean","string","string","string","array","boolean","boolean","object","string","boolean","boolean","boolean","boolean","boolean","string","string","string","boolean","string","array","array","string","boolean","string","boolean","boolean","boolean","object","object","object","boolean","string","boolean","string","boolean","boolean","boolean","boolean","boolean","boolean","boolean","string","string","string","string","string","string","string","boolean","boolean","boolean","boolean","array","boolean"],

	_lyteUtilFunctions: ['toggle', 'resetPosition', 'open', 'close'],
	init: function () {
	...
	createFreezeLayer: function() {
		...
		_lyteUiUtils.appendChild( document.body, freezeLayer, { referenceNode : this.$node } );
	},
	...
	prerequisites: function () {
		...
		if (this.getData('call')) {
			this.childComp.removeAttribute('lyte-drop-hidden');
		}
	...
	fireOnShow: function () {
		...
		if (this.getData('call') && this.getMethods('onShow')) {
			...
			/**
			 * This callback is fired when a dropdown is opened
			 * @method onShow
	...
	fireAfterRender: function() {
		if( this.getMethods( 'onAfterRender' ) ) {
			/**
			 * This callback is fired after the dropdown is rendered
	...
	highlightDropItemsOnHover: function( event ) {
		...
		cur = _lyteDropdown.traverse(cur, ['LYTE-DROP-ITEM', 'LYTE-DROP-BOX']);
	...
	selectItemOfMultiSelect: function (event, elm, oldSelected) {
		...
		if (this.getMethods('onAdd')) {
			/**
			 * This callback is fired when an item is added into the selectedList of the multiselect dropdown
			 * @method onAdd
			 * @author ananthapadmanaban.n@zohocorp.com
			 * @condition ltPropType multiple, multisearch
			 * @param { object } event
			 * @param { string } selectedItemsValue
			 * @param { string } selectedList
			 * @param { object } dropdownContext
	...
	closeDrop1: function (link, event, freeze) {
		...
		if (link) {
			...
			link.style.bottom = '';
			link.style.right = '';
			if( this.data.ltPropReduceHeightOfBody ){
				this.getDropBody( link ).style.height = "";
			}
		}
		...
		if (this.getMethods('onHide')) {
			/**
			 * This callback is fired when a dropdown is closed
			 * @method onHide
			 * @author ananthapadmanaban.n@zohocorp.com
			 * @param { object } event
			 * @param { object } dropdownContext
		...
		_lyteUiUtils.dispatchEvent('onhide', this.$node);
	...
	callOnScroll: function (event) {
		...
		if (this.getMethods('onScroll')) {
			/**
			 * This callback is fired when the drop body is scrolled
			 * @method onScroll
			 * @author ananthapadmanaban.n@zohocorp.com
			 * @param { object } event
			 * @param { object } dropdownContext
	...
	fireScrollEnd: function( event ) {
		if( this.getMethods( 'onScrollEnd' ) ) {
			/**
			 * This callback is fired when the end of the drop body is reached while scrolling
			 * @method onScrollEnd
			 * @condition ltPropType multiple, multisearch
			 * @author ananthapadmanaban.n@zohocorp.com
			 * @param { object } event
	...
	firePosCallBack: function () {
		...
		if (pos !== '') {
			...
			if (this.getMethods('onPositionChanged')) {
				/**
				 * This callback is fired when the position of drop box is changed
	...
	*/
	...
	scrollSel: function () {
		...
		var sel = this.getData('ltPropSelected'),
			...
			useOffset = this.getData( 'ltPropUseItemOffsetForScroll' ),
		...
		if (node) {
			body.scrollTop = ( useOffset ? node.offsetTop : ( this.isFirstItem( node ) ? 0 : node.offsetTop ) );
		}
		else {
			body.scrollTop = 0;
		}
	...
	*/
	...
	setVerticalCalloutPosition: function( width, offsets, doesBoxAndButtonLeftAlign ) {
		var alignToIcon = this.getData( 'ltPropAlignCalloutToIcon' );

		if( alignToIcon ) {
			this.alignToIcon( width, offsets, doesBoxAndButtonLeftAlign );
		}
		else {
			this.alignToCenter( width, offsets, doesBoxAndButtonLeftAlign );
		}
	},

	alignToIcon: function( width, offsets, doesBoxAndButtonLeftAlign ) {
		var iconCls = this.getData( 'ltPropIconClass' ),
		icon = this.$node.querySelector( '.' + iconCls ),
		iconDimensions = icon.getBoundingClientRect(),
		iconCenter = iconDimensions.left + iconDimensions.width / 2,
		link = this.childComp,
		arrow = link.querySelector( '.lyteArrow' ),
		iconCenterRelativeToBox = doesBoxAndButtonLeftAlign ? iconCenter - offsets.left : width - ( offsets.right - iconCenter );

		arrow.style.left = ( iconCenterRelativeToBox / width ) * 100 + '%';

	},

	alignToCenter: function( width, offsets, doesBoxAndButtonLeftAlign ) {
		var link = this.childComp,
		arrow = link.querySelector( '.lyteArrow' ),
	...
	clearPositionValues: function() {
		...
		if( window.isLyteWidget ) {
			// Since there is no resize now we are just not clearing anything
			return ;
		}
	...
	findPrimaryVerticalPosition: function( preferredPosition, offsets, drop, scopeBoundary ) {
		...
		if( this.exceedsTopBoundary( offsets, drop, scopeBoundary ) && this.exceedsBottomBoundary( preferredPosition, offsets, drop, scopeBoundary ) ) {
			var positionWithHigherSpace = this.getPositionWithHigherSpace( offsets, drop, scopeBoundary );

			if( preferredPosition === 'down' ) {
				return positionWithHigherSpace === 'down' ? true : false;
			}
			else {
				return positionWithHigherSpace === 'up' ? true : false;
			}
		}
	...
	getPositionWithHigherSpace: function( offsets, drop, scopeBoundary ) {
		var spaceBelow = Math.abs( scopeBoundary.bottom - offsets.top - offsets.height ),
		spaceAbove = Math.abs( offsets.top - scopeBoundary.top );
	...
	reduceHeightOfBody: function( preferredPosition, offsets, drop, scopeBoundary, footer_bcr, header_bcr ) {
		var reduceHeight = this.getData( 'ltPropReduceHeightOfBody' ),
		body = this.getDropBody( this.childComp );

		if( reduceHeight ) {
			if( this.exceedsBottomBoundary( preferredPosition, offsets, drop, scopeBoundary ) && this.exceedsTopBoundary( offsets, drop, scopeBoundary ) ) {
				var positionWithHigherSpace = this.getPositionWithHigherSpace( offsets, drop, scopeBoundary ),
				combined_extra_height = footer_bcr.height + header_bcr.height;

				if( positionWithHigherSpace === 'down' ) {
					body.style.height = scopeBoundary.bottom - offsets.top - offsets.height - combined_extra_height + 'px';
				}
				else {
					body.style.height = offsets.top - scopeBoundary.top - combined_extra_height - this.getVerticalPaddingOfBody() + 'px';
				}
			}
	...
	getVerticalPaddingOfBody: function() {
		var body = this.getDropBody( this.childComp ),
	...
	setCss: function (onlyScroll, useSave) {
		...
		var save = this.getData('savedPositions'),
			...
			__footer = body.querySelector( 'lyte-drop-footer' ),
			__header = body.querySelector( 'lyte-drop-header' ),
			footer_bcr = __footer ? __footer.getBoundingClientRect() : { height: 0 },
			header_bcr = __header ? __header.getBoundingClientRect() : { height: 0 };
		...
		if (position === 'down') {
			...
			this.reduceHeightOfBody( 'down', offsets, drop, scopeBoundary, footer_bcr, header_bcr );
			...
			$L(this.$node.querySelector('.lyteDropdownTextField')).search({
				...
				onSearch: function (res, event, value) {
					...
					if (that.getMethods('onSearch')) {
						/**
						 * This callback is fired when a search is performed on the multiselect dropdown
						 * @method onSearch
						 * @condition ltPropType multisearch
						 * @author ananthapadmanaban.n@zohocorp.com
						 * @param { array } arrayOfMatchingItems
						 * @param { object } event
						 * @param { string } valueThatWasSearched
						 * @param { object } dropdownContext
						 */
	...
	beforeShow: function (event, fromTg, first) {
		...
		/**
		 * This callback is fired just before the dropdown is shown
		 * @method onBeforeShow
		 * @author ananthapadmanaban.n@zohocorp.com
		 * @param { object } event
		 * @param { object } dropdownContext
		...
		if (res && res.then) {
			...
			res
				...
				.catch(function (err) {
					that.setData('blockShowHide', false);
					link.removeAttribute('lyte-drop-hidden');
					console.error(err);
				});
		}
		else if (res !== false) {
	...
	removeMarked: function (sel, nodes, head, link) {
		...
		for (i = 0; i < len; i++) {
			for (j = 0; j < all.length; j++) {
				if (typeof all[j] === 'string' && all[j] === nodes[i].getAttribute('data-value')) {
					Lyte.arrayUtils(all, 'removeAt', j);
					break;
				}
				else if (('' + all[j][sysValue]) == nodes[i].getAttribute('data-value')) {
					Lyte.arrayUtils(all, 'removeAt', j);
					break;
				}
			}
	...
	removeAll: function (event) {
		...
		if (this.getMethods('onRemove')) {
			/**
			 * This callback is fired when items are removed from the multiselect dropdown
			 * @method onRemove
			 * @condition ltPropType multiple, multisearch
			 * @author ananthapadmanaban.n@zohocorp.com
			 * @param { object } event
			 * @param { array | string} removedItem
			 * @param { string } ltPropSelected
			 * @param { object } dropdownContext
			 * @param { string } methodByWhichItemWasRemoved
			 * @param { array | string } removedItem
			 */
	...
	shade: function (node) {
		var front, iterator,
			...
			nonRemovableItems = this.getData( 'ltPropNonRemovableItems' ) || [];
		...
		do {
			if( nonRemovableItems.indexOf( node.getAttribute( 'data-value' ) ) === -1 ) {
	...
	fireOnChange: function (oldValue, event, item) {
		...
		if (this.hasValueChanged(oldValue) && this.getMethods('onChange')) {
			/**
			 * This callback is fired when dropdown's selected value changes
			 * @method onChange
			 * @author ananthapadmanaban.n@zohocorp.com
			 * @param { object } event
			 * @param { string } newSelectedValue
			 * @param { object } dropdownContext
			 * @param { object } itemThatWasSelected
			 */
	...
	mark: function (node, shift, single) {
		...
		var curValue = node.getAttribute( 'data-value' ),
		nonRemovableItems = this.getData( 'ltPropNonRemovableItems' ) || [];

		if( !!~nonRemovableItems.indexOf( curValue ) ) {
			return ;
		}
	...
	beforeSelect: function (event, item) {
		...
		if (this.getMethods('beforeSelect')) {
			/**
			 * This callback is fired just before an item is selected
			 * @method beforeSelect
			 ...
			 * @param { object } dropdownContext
			 * @param { object } itemThatWasSelected
			 * @param { string } valueOfItemThatWasSelected
			 * 
			 */
	...
	beforeRemove: function (event, src, proper, node) {
		...
		if (this.getMethods('onBeforeRemove')) {
			/**
			 * This callback is fired just an as item is removed from the selected list in multiselect dropdown
			 * @method onBeforeRemove
			 * @condition ltPropType multiple, multisearch
			 * @author ananthapadmanaban.n@zohocorp.com
			 * @param { object } event
			 * @param { string } removedItemsValue
			 * @param { string } ltPropSelected
			 * @param { object } dropdownContext
			 * @param { string } methodByWhichItemWasRemoved
			 * @param { object } nodeThatGotRemoved
			 */
	...
	beforeAdd: function (event, elm, src) {
		...
		if (this.getMethods('onBeforeAdd')) {
			/**
			 * This callback is fired just before an item is added into the list
			 * @method onBeforeAdd
			 * @condition ltPropType multiple, multisearch
			 * @author ananthapadmanaban.n@zohocorp.com
			 * @param { object } event
			 * @param { object } dataValueOfTheItem
			 * @param { string } ltPropSelected
			 * @param { object } dropdownContext
			 * @param { Element } elementThatWasSelected
			 */
	...
	beforeHide: function (link, event, freeze) {
		...
		if (this.getMethods('onBeforeHide')) {
			/**
			 * This callback is fired just before the dropdown was hidden
			 * @method onBeforeHide
			 * @author ananthapadmanaban.n@zohocorp.com
			 * @param { object } event
			 * @param { object } dropdownContext
	...
	optCall: function (event, sel, elm) {
		if (this.getMethods('onOptionSelected')) {
			/**
			 * This callback is fired when an item is selected
			 * @method onOptionSelected
			 * @condition ltPropType default
			 * @author ananthapadmanaban.n@zohocorp.com
			 * @param { object } event
			 * @param { string } currentSelectedValue
			 * @param { object } dropdownContext
			 * @param { Element } elementThatWasSelected
			 */
	...
	isPresentInList: function (sel) {
		...
		for (var i = 0; i < list.length; i++) {
			if (typeof list[i] === 'string' && list[i] === sel) {
				return true
			}
			else if (('' + list[i][sysValue]) === sel) {
				return true;
			}
		}
	...
	buildWithOptions: function (selected) {
		...
		while (i < options.length && !selectedObj) {
			if (this.isOptGroup(options[i])) {
				...
				if (typeof options[i] === 'string' && (options[i] === selected)) {
	...
	showHide: function (event, eventtype, fromTg) {
		...
		if (!show) {
			...
			if (this.childComp) {
				this.childComp.setAttribute('lyte-drop-hidden', '');
			}
			...
			link.setAttribute('lyte-drop-hidden', '');
	...
	removeIconClicked: function( event, value ) {
		if( this.getMethods( 'onRemoveIconClicked' ) ) {
			/**
			 * This callback is fired when the remove icon is clicked in single select dropdown
			 * @method onRemoveIconClicked
			 * @condition ltPropType default
			 * @condition ltPropShowRemoveIcon true
			 * @author ananthapadmanaban.n@zohocorp.com
			 * @param { object } event
	...
	data: function () {
		return {
			...
			'ltPropRemoveMultiple': Lyte.attr('boolean', { 
				'default': _lyteUiUtils.resolveDefaultValue( 'lyte-dropdown', 'removeMultiple', false ),
				'input': true 
			} ),
			//For builder
			/**
            ...
            */
			...
			'ltPropFreeze': Lyte.attr("boolean", { 
				"default": _lyteUiUtils.resolveDefaultValue('lyte-dropdown', 'freeze', true),
				'input': true 
			} ),
			...
			'ltPropPosition': Lyte.attr("string", { 
				"default": _lyteUiUtils.resolveDefaultValue('lyte-dropdown', 'position', 'down'),
				'input': true 
			} ),
			...
			'ltPropIconClass': Lyte.attr("string", { 
				"default": _lyteUiUtils.resolveDefaultValue('lyte-dropdown', 'iconClass', 'dropdown'),
				'input': true 
			} ),
			...
			'ltPropCallout': Lyte.attr("boolean", { 
				"default": _lyteUiUtils.resolveDefaultValue('lyte-dropdown', 'callout', false),
				'input': true 
			} ),
			...
			'ltPropPlaceholder': Lyte.attr("string", { 
				"default": _lyteUiUtils.resolveDefaultValue('lyte-dropdown', 'placeholder', ''),
				'input': true 
			} ),
			...
			'ltPropNoResult': Lyte.attr("string", { 
				"default": _lyteUiUtils.resolveDefaultValue('lyte-dropdown', 'noResult', _lyteUiUtils.i18n('no.results.found')),
				'input': true 
			} ),
			...
			ltPropAnimate: Lyte.attr('boolean', { 
				default: _lyteUiUtils.resolveDefaultValue('lyte-dropdown', 'animate', false),
				'input': true 
			} ),
			...
			'ltPropBoxClass': Lyte.attr('string', { 
				'default': _lyteUiUtils.resolveDefaultValue('lyte-dropdown', 'boxClass', ''),
				'input': true 
			} ),
			...
			'ltPropFixPositionOnOpen': Lyte.attr('boolean', { 
				'default': _lyteUiUtils.resolveDefaultValue('lyte-dropdown', 'fixPositionOnOpen', false),
				'input': true 
			}),
			...
			/**
			 * @componentProperty {array} ltPropSelectedList
			 * @default []
			 * @condition ltPropType multiple, multisearch
			 * @output
			 * @input
			...
			'ltPropSelectedList': Lyte.attr('array', { 
				'default': _lyteUiUtils.resolveDefaultValue('lyte-dropdown', 'selectedList', []),
				'input': true,
				'output': true  
			}),
			...
			/**
			 * @componentProperty {boolean} ltPropShowRemoveIcon
			 * @default false
			 * @condition ltPropType default
			 * @input
			 */

			'ltPropShowRemoveIcon': Lyte.attr('boolean', { 'default': false, 'input': true  }),
			...
			'ltPropAriaButton': Lyte.attr('object', { 'default': {}, watch: true, 'input': true  }),

			/**
			 * @componentProperty {object} ltPropAriaBox
			 * @default {}
			 * @input
			 */

			// Keeping this property hidden for now because we don't know if we need it.
			'ltPropAriaBox': Lyte.attr('object', { 'default': {}, watch: true, 'input': true  }),

			/**
			 * @componentProperty {object} ltPropAriaBody
			 * @default {}
			 * @input
			 */

			'ltPropAriaBody': Lyte.attr('object', { 'default': {}, watch: true, 'input': true  }),
			...
			'ltPropFocusName': Lyte.attr( 'string', { 'default': '' } ),

			'ltPropBfocusName': Lyte.attr( 'string', { 'default': '' } ),

			'ltPropNfocusName': Lyte.attr( 'string', { 'default': '' } ),

			'ltPropUseItemOffsetForScroll': Lyte.attr( 'boolean', { 'default': false } ),

			'ltPropReduceHeightOfBody': Lyte.attr( 'boolean', { 'default': false } ),

			'ltPropAlignCalloutToIcon': Lyte.attr( 'boolean', { 'default': false } ),

			'ltPropEnableCyclicNavigation': Lyte.attr( 'boolean', { 'default': _lyteUiUtils.resolveDefaultValue( 'lyte-dropdown', 'enableCyclicNavigation', false ) } ),

			'ltPropNonRemovableItems': Lyte.attr( 'array', { 'default': [] } ),

			'ltPropFocusOnRemove': Lyte.attr( 'boolean', { 'default': true } )
	...
	readonly_obs : function(){
		$L( this.$node )[ ( this.data.ltPropReadOnly ? "add" : "remove" ) + "Class" ]( "lyteDropdownReadonly" );
...
_lyteUiUtils.addGlobalEventListener('keydown', function (event) {  //This is to take care of the tabbing problems in a dropdown and traversing(CODE HELP)
	...
	if (
		...
		var isLastVisibleItem = _lyteDropdown.isLastVisibleItem(elems, i),
		isFirstVisibleItem = _lyteDropdown.isFirstVisibleItem(elems, i),
		enableCyclicNavigation = component.getData( 'ltPropEnableCyclicNavigation' );
		...
		// Key up was pressed
			...
			var shouldCycle = enableCyclicNavigation && isFirstVisibleItem,
			elementToConsider = shouldCycle ? elems.length - 1 : i - 1;

			j = i;
			i = _lyteDropdown.find(elems, elementToConsider, false);

			if( i < elems.length && i >= 0 ) {
				component.scrollIntoView(elems[i], shouldCycle ? 'down' : 'up');
		...
		// Key down was pressed
			...
			var shouldCycle = enableCyclicNavigation && isLastVisibleItem,
			elementToConsider = shouldCycle ? 0 : i + 1;

			j = i;
			i = _lyteDropdown.find(elems, elementToConsider, true);

			if( i < elems.length && i >= 0 ) {
				component.scrollIntoView(elems[i], shouldCycle ? 'up' : 'down');
				elems[j].classList.remove('lyteDropdownSelection');
				elems[i].classList.add('lyteDropdownSelection');
				component.getActiveElement().setAttribute('aria-activedescendant', elems[i].getAttribute('id'));
				component.executeKeyNavigationCallback(elems[i]);
...
/**
 * @customElement lyte-drop-box represents the overall outer container
 * @version 1.0.0
 * @author anantha <ananthapadmanaban.n@zohocorp.com>
 */

/**
 * @customElement lyte-drop-header represents the header of the dropbox
 * @version 1.0.0
 * @author anantha <ananthapadmanaban.n@zohocorp.com>
 */

/**
 * @customElement lyte-drop-footer represents the footer of the dropbox
 * @version 1.0.0
 * @author anantha <ananthapadmanaban.n@zohocorp.com>
 */
...
if (!_lyteUiUtils.registeredCustomElements['lyte-drop-body']) {
	...
	/** 
	 * @customElement lyte-drop-body This is the scrollable area inside the dropdown
	 * @version 1.0.0
	 * @author anantha <ananthapadmanaban.n@zohocorp.com>
		*/
...
if (!_lyteUiUtils.registeredCustomElements['lyte-drop-item']) {
	...
	/** 
	 * @customElement lyte-drop-item This renders a singular drop item in the dropbox
	 * @version 1.0.0
	 * @author anantha <ananthapadmanaban.n@zohocorp.com>
	 * @customAttribute {true|false} selected This is used to mark the item as selected
	 * @customAttribute lyte-shortcut This is used to provide shortcut key for the drop item
	 * @customAttribute data-title This is used to provide tooltip value for the drop item
	 * @customAttribute {true|false} data-custom-tooltip To show a customtooltip for the drop item without using dropdown's inbuilt tooltip
		*/
	...
	Lyte.createCustomElement('lyte-drop-item', {
		static: {
			"observedAttributes": {
				/* disable async function */
				get: function () {
					return ['selected', 'lyte-shortcut', 'class'];
				}
			}
		},
		...
		"connectedCallback": function () {
			...
			this.common_check( component, "create" );
		},

		common_check : function( component, from ){
			...
			component._FFBodyScrollOnAdd = window.setTimeout(function () {
				var isOpen = component.getData('ltPropIsOpen');

				if ( !isOpen ) {
					return;
				}

				var isBodyScrollable = component.isBodyScrollable();

				if( isBodyScrollable && /create|both/.test( from ) ) {
					component.addProperScrollbar();
				} else if ( !isBodyScrollable && /destroy|both/.test( from ) ) {
		...
		"disconnectedCallback": function () {
			...
			this.common_check( component, "destroy" );
		...
		"attributeChangedCallback": function (attr, oldValue, newValue, namespace) {
			...
			if ( attr == "class" || ( oldValue === null && newValue !== null ) || ( oldValue !== null && newValue === null ) ) {
			...
			if (attr == 'selected') {
				...
				var name = "lyteSearchHidden";
				if( ( oldValue || "" ).indexOf( name ) + 1 || ( newValue || "" ).indexOf( name ) + 1 ){
					this.common_check( _lyteDropdown.getDropdownFromItem( this ), "both" );
				}
			}
		}
	});
...
; var _lyteDropdown = {
	visibleQuery: 'lyte-drop-box:not(.lyteDropdownHidden)',
	...
	getVisibleDropbox: function () {
		/* For normal environment, drop box will be in the body so it will fetch it and other two listeners will return undefined
		For widget in parent, it will be inside shadow-wrapper so it will fetch it from there and other two listeners will be undefined
		For widget in iframe, it will be inside div in the body of the iframe and in parent its inside a div with part attribute which is inside another div so other two event listeners will return undefined.*/

		if( window.isWidget ) {
			return document.querySelector( _lyteDropdown.visibleQuery );
		}
	...
	isLastVisibleItem: function( items, index ) {
		return _lyteDropdown.traverseItems( items, index + 1, true );
	},

	isFirstVisibleItem: function( items, index ) {
		return _lyteDropdown.traverseItems(items, index - 1, false );
	},

	traverseItems: function( items, index, moveForward ) {
		for( var i = index; moveForward ? i < items.length : i >= 0; moveForward ? i++ : i-- ) {
			if( _lyteDropdown.isVisible( items[ i ] ) && items[ i ].getAttribute( 'disabled' ) !== "true" ) {
				return false;
			}
		}
...
if (!_lyteUiUtils.registeredCustomElements['lyte-drop-group']) {
	...
	/** 
	 * @customElement lyte-drop-group renders an optgroup for dropdown
	 * @version 1.0.0
	 * @author anantha <ananthapadmanaban.n@zohocorp.com>
	 * @customAttribute label Provides heading for the group of items in the dropdown
		*/
