...
_template:"<template tag-name=\"lyte-calendar\" lyte-calendar=\"\"> <template is=\"if\" value=\"{{renderCalendar}}\"><template case=\"true\"> <div class=\"{{containerClass}}\" ontouchstart=\"{{action('record',event)}}\" ontouchend=\"{{action('decide',event)}}\"> <div class=\"lyteCalendarView\"> <div> <template is=\"if\" value=\"{{navYield}}\"><template case=\"true\"> <lyte-yield yield-name=\"navigator\"></lyte-yield> </template><template case=\"false\"> <div class=\"lyteCalendarNavigator {{if(ifEquals(ltPropHeaderAlignType,&quot;centerdate&quot;),&quot;lyteCalHeaderCenterAlign&quot;,&quot;&quot;)}}\"> <span id=\"{{monthDropdownId}}\" class=\"lyteVisuallyHidden\">{{lyteUiI18n(\"lyte.calendar.choose.month\")}}</span> <span id=\"{{yearDropdownId}}\" class=\"lyteVisuallyHidden\">{{lyteUiI18n(\"lyte.calendar.choose.year\")}}</span> <span class=\"lyteVisuallyHidden\" aria-live=\"polite\" id=\"{{headerId}}\"> <template is=\"if\" value=\"{{expHandlers(viewType,'===','dateView')}}\"><template case=\"true\"> <span>{{lyteUiGetMonthOrYear(monthHeader,\"M\")}}</span><span>{{lyteUiGetMonthOrYear(monthHeader,\"Y\")}}</span> </template><template case=\"false\"><template is=\"if\" value=\"{{expHandlers(viewType,'===','monthView')}}\"><template case=\"true\"> <span>{{currentYear}}</span> </template><template case=\"false\"> <span>{{decadeStart}} - {{decadeEnd}}</span> </template></template></template></template> </span> <template is=\"if\" value=\"{{ifNotEquals(ltPropHeaderAlignType,&quot;centerdate&quot;)}}\"><template case=\"true\"> <span class=\"lyteCalsCalMon\"> <template is=\"if\" value=\"{{expHandlers(expHandlers(ltPropHeaderType,'===','dropdown'),'||',expHandlers(ltPropHeaderType,'===','picklist'))}}\"><template case=\"true\"> <lyte-dropdown lt-prop-aria-button=\"{{monthAriaObj}}\" lt-prop-freeze=\"false\" lt-prop=\"{{stringify(ltPropDropdown)}}\" on-before-show=\"{{method('setClass')}}\" on-show=\"{{method('setArrow')}}\" class=\"lyteCalMonthDD\" on-option-selected=\"{{method('optionSelected','M')}}\"> <template is=\"registerYield\" yield-name=\"yield\"> <lyte-drop-box> <lyte-drop-body> <template is=\"for\" items=\"{{monthNames}}\" item=\"item\" index=\"index\"> <lyte-drop-item data-value=\"{{item}}\">{{item}}</lyte-drop-item> </template> </lyte-drop-body> </lyte-drop-box> </template> </lyte-dropdown> <template is=\"if\" value=\"{{expHandlers(ltPropHeaderType,'===','dropdown')}}\"><template case=\"true\"> <lyte-dropdown lt-prop-aria-button=\"{{yearAriaObj}}\" lt-prop-freeze=\"false\" lt-prop=\"{{stringify(ltPropDropdown)}}\" on-before-show=\"{{method('setClass')}}\" on-show=\"{{method('setArrow')}}\" class=\"lyteCalYearDD\" on-option-selected=\"{{method('optionSelected','Y')}}\"> <template is=\"registerYield\" yield-name=\"yield\"> <lyte-drop-box> <lyte-drop-body> <template is=\"for\" items=\"{{years}}\" item=\"item\" index=\"index\"> <lyte-drop-item data-value=\"{{item}}\">{{item}}</lyte-drop-item> </template> </lyte-drop-body> </lyte-drop-box> </template> </lyte-dropdown> </template><template case=\"false\"> <lyte-picklist lt-prop-options=\"{{years}}\" lt-prop-dropdown=\"{&quot;freeze&quot;: false, &quot;callout&quot;: true}\" class=\"lyteCalYearDD\" on-option-select=\"{{method('optionSelected','Y')}}\" on-show=\"{{method('setClass')}}\"> </lyte-picklist> </template></template> </template><template case=\"false\"><template is=\"if\" value=\"{{expHandlers(ltPropHeaderType,'===','drilldown')}}\"><template case=\"true\"> <template is=\"if\" value=\"{{expHandlers(viewType,'===','dateView')}}\"><template case=\"true\"> <span aria-label=\"{{lyteUiI18n('lyte.calendar.monthview.drilldown.button')}}\" tabindex=\"0\" role=\"button\" class=\"lyteDrillCalHeaderButton\" onclick=\"{{action('changeToMonthView',event)}}\" onkeydown=\"{{action('changeToMonthViewOnKeys',event)}}\"> <span class=\"lyteCalsCalMonth\">{{lyteUiGetMonthOrYear(monthHeader,\"M\")}}</span> <span class=\"lyteCalsCalYear\">{{lyteUiGetMonthOrYear(monthHeader,\"Y\")}}</span> </span> </template><template case=\"false\"><template is=\"if\" value=\"{{expHandlers(viewType,'===','monthView')}}\"><template case=\"true\"> <span aria-label=\"{{lyteUiI18n('lyte.calendar.decadeview.drilldown.button')}}\" tabindex=\"0\" role=\"button\" class=\"lyteDrillCalHeaderButton\" onclick=\"{{action('changeToDecadeView',event)}}\" onkeydown=\"{{action('changeToDecadeViewOnKeys',event)}}\"> <span class=\"lyteCalsCalYear\">{{currentYear}}</span> </span> </template><template case=\"false\"><template is=\"if\" value=\"{{expHandlers(viewType,'===','decadeView')}}\"><template case=\"true\"> <span class=\"lyteDrillCalHeaderButton lyteDrillCalYearListHeader\"> {{decadeStart}} - {{decadeEnd}} </span> </template></template></template></template></template></template> </template><template case=\"false\"><template is=\"if\" value=\"{{expHandlers(expHandlers(ltPropSelectionType,'===','month'),'||',expHandlers(ltPropSelectionType,'===','year'))}}\"><template case=\"true\"> <template is=\"if\" value=\"{{expHandlers(viewType,'===','monthView')}}\"><template case=\"true\"> <span> <span class=\"lyteCalsCalYear\">{{currentYear}}</span> </span> </template><template case=\"false\"><template is=\"if\" value=\"{{expHandlers(viewType,'===','decadeView')}}\"><template case=\"true\"> <span class=\"lyteDrillCalHeaderButton lyteDrillCalYearListHeader\"> {{decadeStart}} - {{decadeEnd}} </span> </template></template></template></template> </template><template case=\"false\"> <span class=\"lyteCalsCalMonth\">{{lyteUiGetMonthOrYear(monthHeader,\"M\")}}</span> <span class=\"lyteCalsCalYear\">{{lyteUiGetMonthOrYear(monthHeader,\"Y\")}}</span> </template></template></template></template></template></template> </span> </template></template> <template is=\"if\" value=\"{{ifNotEquals(ltPropHeaderType,&quot;dropdown&quot;)}}\"><template case=\"true\"> <template is=\"if\" value=\"{{expHandlers(expHandlers(showYear,'&amp;&amp;',expHandlers(ltPropSelectionType,'!==','month')),'&amp;&amp;',expHandlers(ltPropSelectionType,'!==','year'))}}\"><template case=\"true\"> <span role=\"button\" tabindex=\"0\" class=\"lyteCalNav lyteCalyearNavLft\" lt-prop-title=\"{{ltPropPrevYearTooltip}}\" lt-prop-tooltip-config=\"{{ltPropTooltip}}\" onclick=\"{{action('previous','Y',event)}}\" onkeydown=\"{{action('previousOnKeys','Y',event)}}\"> <span class=\"lyteVisuallyHidden\">{{lyteUiI18n('lyte.calendar.previous.year')}}</span> </span> </template></template> </template></template> <span role=\"button\" class=\"lyteCalNav lyteCaldLft {{lyteUiDisableCalendarNav(viewDate,'previous')}}\" lt-prop-title=\"{{leftNavTooltip}}\" lt-prop-tooltip-config=\"{{ltPropTooltip}}\" tabindex=\"0\" onclick=\"{{action('previous','M',event)}}\" onkeydown=\"{{action('previousOnKeys','M',event)}}\"> <span class=\"lyteVisuallyHidden\">{{lyteUiI18n('lyte.calendar.previous.month')}}</span> </span> <template is=\"if\" value=\"{{ifEquals(ltPropHeaderAlignType,&quot;centerdate&quot;)}}\"><template case=\"true\"> <span class=\"lyteCalsCalMon\"> <template is=\"if\" value=\"{{expHandlers(expHandlers(ltPropHeaderType,'===','dropdown'),'||',expHandlers(ltPropHeaderType,'===','picklist'))}}\"><template case=\"true\"> <lyte-dropdown lt-prop-aria-button=\"{{monthAriaObj}}\" lt-prop-freeze=\"false\" lt-prop=\"{{stringify(ltPropDropdown)}}\" on-show=\"{{method('setClass')}}\" class=\"lyteCalMonthDD\" on-option-selected=\"{{method('optionSelected','M')}}\"> <template is=\"registerYield\" yield-name=\"yield\"> <lyte-drop-box> <lyte-drop-body> <template is=\"for\" items=\"{{monthNames}}\" item=\"item\" index=\"index\"> <lyte-drop-item data-value=\"{{item}}\">{{item}}</lyte-drop-item> </template> </lyte-drop-body> </lyte-drop-box> </template> </lyte-dropdown> <template is=\"if\" value=\"{{expHandlers(ltPropHeaderType,'===','dropdown')}}\"><template case=\"true\"> <lyte-dropdown lt-prop-aria-button=\"{{yearAriaObj}}\" lt-prop-freeze=\"false\" lt-prop=\"{{stringify(ltPropDropdown)}}\" on-show=\"{{method('setClass')}}\" class=\"lyteCalYearDD\" on-option-selected=\"{{method('optionSelected','Y')}}\"> <template is=\"registerYield\" yield-name=\"yield\"> <lyte-drop-box> <lyte-drop-body> <template is=\"for\" items=\"{{years}}\" item=\"item\" index=\"index\"> <lyte-drop-item data-value=\"{{item}}\">{{item}}</lyte-drop-item> </template> </lyte-drop-body> </lyte-drop-box> </template> </lyte-dropdown> </template><template case=\"false\"> <lyte-picklist lt-prop-options=\"{{years}}\" lt-prop-dropdown=\"{&quot;freeze&quot;: false, &quot;callout&quot;: true}\" class=\"lyteCalYearDD\" on-option-select=\"{{method('optionSelected','Y')}}\" on-show=\"{{method('setClass')}}\"> </lyte-picklist> </template></template> </template><template case=\"false\"><template is=\"if\" value=\"{{expHandlers(ltPropHeaderType,'===','drilldown')}}\"><template case=\"true\"> <template is=\"if\" value=\"{{expHandlers(viewType,'===','dateView')}}\"><template case=\"true\"> <span aria-label=\"{{lyteUiI18n('lyte.calendar.monthview.drilldown.button')}}\" tabindex=\"0\" role=\"button\" class=\"lyteDrillCalHeaderButton\" onclick=\"{{action('changeToMonthView',event)}}\" onkeydown=\"{{action('changeToMonthViewOnKeys',event)}}\"> <span class=\"lyteCalsCalMonth\">{{lyteUiGetMonthOrYear(monthHeader,\"M\")}}</span> <span class=\"lyteCalsCalYear\">{{lyteUiGetMonthOrYear(monthHeader,\"Y\")}}</span> </span> </template><template case=\"false\"><template is=\"if\" value=\"{{expHandlers(viewType,'===','monthView')}}\"><template case=\"true\"> <span aria-label=\"{{lyteUiI18n('lyte.calendar.decadeview.drilldown.button')}}\" tabindex=\"0\" role=\"button\" class=\"lyteDrillCalHeaderButton\" onclick=\"{{action('changeToDecadeView',event)}}\" onkeydown=\"{{action('changeToDecadeViewOnKeys',event)}}\"> <span class=\"lyteCalsCalYear\">{{currentYear}}</span> </span> </template><template case=\"false\"><template is=\"if\" value=\"{{expHandlers(viewType,'===','decadeView')}}\"><template case=\"true\"> <span class=\"lyteDrillCalHeaderButton lyteDrillCalYearListHeader\"> {{decadeStart}} - {{decadeEnd}} </span> </template></template></template></template></template></template> </template><template case=\"false\"><template is=\"if\" value=\"{{expHandlers(expHandlers(ltPropSelectionType,'===','month'),'||',expHandlers(ltPropSelectionType,'===','year'))}}\"><template case=\"true\"> <template is=\"if\" value=\"{{expHandlers(viewType,'===','monthView')}}\"><template case=\"true\"> <span> <span class=\"lyteCalsCalYear\">{{currentYear}}</span> </span> </template><template case=\"false\"><template is=\"if\" value=\"{{expHandlers(viewType,'===','decadeView')}}\"><template case=\"true\"> <span class=\"lyteDrillCalHeaderButton lyteDrillCalYearListHeader\"> {{decadeStart}} - {{decadeEnd}} </span> </template></template></template></template> </template><template case=\"false\"> <span class=\"lyteCalsCalMonth\">{{lyteUiGetMonthOrYear(monthHeader,\"M\")}}</span> <span class=\"lyteCalsCalYear\">{{lyteUiGetMonthOrYear(monthHeader,\"Y\")}}</span> </template></template></template></template></template></template> </span> </template></template> <span role=\"button\" class=\"lyteCalNav lyteCaldRgt {{lyteUiDisableCalendarNav(viewDate,'next')}}\" lt-prop-title=\"{{rightNavTooltip}}\" lt-prop-tooltip-config=\"{{ltPropTooltip}}\" tabindex=\"0\" onkeydown=\"{{action('nextOnKeys','M',event)}}\" onclick=\"{{action('next','M',event)}}\"> <span class=\"lyteVisuallyHidden\">{{lyteUiI18n('lyte.calendar.next.month')}}</span> </span> <template is=\"if\" value=\"{{ifNotEquals(ltPropHeaderType,&quot;dropdown&quot;)}}\"><template case=\"true\"> <template is=\"if\" value=\"{{expHandlers(expHandlers(showYear,'&amp;&amp;',expHandlers(ltPropSelectionType,'!==','month')),'&amp;&amp;',expHandlers(ltPropSelectionType,'!==','year'))}}\"><template case=\"true\"> <span role=\"button\" class=\"lyteCalNav lyteCalyearNavRgt\" lt-prop-title=\"{{ltPropNextYearTooltip}}\" lt-prop-tooltip-config=\"{{ltPropTooltip}}\" tabindex=\"0\" onkeydown=\"{{action('nextOnKeys','Y',event)}}\" onclick=\"{{action('next','Y',event)}}\"> <span class=\"lyteVisuallyHidden\">{{lyteUiI18n('lyte.calendar.next.year')}}</span> </span> </template></template> </template></template> </div> </template></template> </div> <div class=\"lyteCalTableContainer\" role=\"grid\"> <template is=\"if\" value=\"{{ltPropBodyYield}}\"><template case=\"true\"> <lyte-yield yield-name=\"body\"></lyte-yield> </template><template case=\"false\"> <template is=\"if\" value=\"{{expHandlers(viewType,'===','dateView')}}\"><template case=\"true\"> <div role=\"row\" class=\"lyteCalTableRowHeader\"> <template is=\"if\" value=\"{{ltPropWeekNumber}}\"><template case=\"true\"> <div role=\"columnheader\" class=\"lyteCalTableCellHeader lyteWeekNumberGrid\"><span>{{ltPropWeekNumHeader}}</span></div> </template></template> <template is=\"for\" items=\"{{daysOfWeek}}\" item=\"day\" index=\"idod\"> <div role=\"columnheader\" aria-label=\"{{day.title}}\" class=\"{{day.class}}\" id=\"{{day.id}}\">{{lyteUiI18n(day.day)}}</div> </template> </div> </template></template> <div class=\"lyteCalTableRowGroup\"> <template is=\"if\" value=\"{{expHandlers(viewType,'===','dateView')}}\"><template case=\"true\"> <template is=\"for\" items=\"{{matrix}}\" item=\"vector\" index=\"rowid\"> <template is=\"if\" value=\"{{expHandlers(lyteUiCheckEmpty(vector),'!')}}\"><template case=\"true\"> <div class=\"lyteCalTableRow\" role=\"row\"> <template is=\"if\" value=\"{{ltPropWeekNumber}}\"><template case=\"true\"> <div role=\"gridcell\" tabindex=\"-1\" lt-prop-title=\"Week Number\" lt-prop-tooltip-config=\"{&quot;position&quot; : &quot;right&quot;, &quot;appearance&quot; : &quot;box&quot;}\" class=\"{{weeknum[rowid].class}}\"><span>{{if(ifNotEquals(weeknum[rowid].val,0),weeknum[rowid].val,'')}}</span></div> </template></template> <template is=\"for\" items=\"{{vector}}\" item=\"date\" index=\"cellid\"> <template is=\"if\" value=\"{{expHandlers(lyteUiCheckInRange(ltPropMinDate,ltPropMaxDate,date.val,ltPropFormat),'&amp;&amp;',expHandlers(lyteUiDisabledDates(date,ltPropDisabledDates),'!'))}}\"><template case=\"true\"> <template is=\"if\" value=\"{{date.emptyBlock}}\"><template case=\"true\"> <div role=\"gridcell\" class=\"lyteCalEmpty\" data-selectable=\"false\"></div> </template><template case=\"false\"> <div role=\"gridcell\" tabindex=\"-1\" id=\"{{date.id}}\" aria-labelledby=\"{{concat(date.id,' ',headerId,' ',daysOfWeek[cellid]['id'])}}\" onkeydown=\"{{action('performNavigation',event)}}\" onclick=\"{{action('dateSelected',event)}}\" class=\"{{date.clsname}}\" data-date=\"{{date.val}}\" data-iso=\"{{date.iso}}\" data-selectable=\"true\"><span class=\"lyteCalDateSpan\">{{date.date}}</span></div> </template></template> </template><template case=\"false\"> <template is=\"if\" value=\"{{date.emptyBlock}}\"><template case=\"true\"> <div role=\"gridcell\" class=\"lyteCalEmpty\" data-selectable=\"false\"></div> </template><template case=\"false\"> <div role=\"gridcell\" lt-prop-title=\"{{ltPropDisabledDateTooltip}}\" lt-prop-tooltip-config=\"{{ltPropTooltip}}\" tabindex=\"-1\" id=\"{{date.id}}\" aria-labelledby=\"{{concat(date.id,' ',headerId,' ',daysOfWeek[cellid]['id'])}}\" aria-disabled=\"true\" onkeydown=\"{{action('performNavigation',event)}}\" data-date=\"{{date.val}}\" data-iso=\"{{date.iso}}\" class=\"{{date.clsname}}\" data-selectable=\"false\"><span class=\"lyteCalDateSpan\">{{date.date}}</span></div> </template></template> </template></template> </template> </div> </template></template> </template> </template><template case=\"false\"><template is=\"if\" value=\"{{expHandlers(viewType,'===','monthView')}}\"><template case=\"true\"> <template is=\"for\" items=\"{{monthViewData}}\" item=\"row\" index=\"rowIndex\"> <div class=\"lyteCalTableRow\"> <template is=\"for\" items=\"{{row}}\" item=\"column\" index=\"columnIndex\"> <div aria-label=\"{{lyteUiI18n(lyteUiGetLinearIndex(ariaMonthNames,rowIndex,columnIndex))}}\" role=\"gridcell\" tabindex=\"-1\" onkeydown=\"{{action('performNavigation',event)}}\" onclick=\"{{action('monthSelected',event)}}\" class=\"{{column['class']}}\" data-date=\"{{column['systemValue']}}\"> {{column['displayValue']}} </div> </template> </div> </template> </template><template case=\"false\"><template is=\"if\" value=\"{{expHandlers(viewType,'===','decadeView')}}\"><template case=\"true\"> <template is=\"for\" items=\"{{decadeViewData}}\" item=\"row\" index=\"rowIndex\"> <div class=\"lyteCalTableRow\"> <template is=\"for\" items=\"{{row}}\" item=\"column\" index=\"columnIndex\"> <template is=\"if\" value=\"{{expHandlers(column.emptyBlock,'!')}}\"><template case=\"true\"> <div role=\"gridcell\" tabindex=\"-1\" onkeydown=\"{{action('performNavigation',event)}}\" onclick=\"{{action('yearSelected',event)}}\" class=\"lyteCalTableCell {{column.class}}\" data-date=\"{{column.year}}\"> {{column.year}} </div> </template><template case=\"false\"> <div role=\"gridcell\" class=\"lyteCalEmpty\"> </div> </template></template> </template> </div> </template> </template></template></template></template></template></template> </div> </template></template> </div> <div> <div class=\"lyteCalBtns\"> <template is=\"if\" value=\"{{expHandlers(expHandlers(showToday,'&amp;&amp;',ltPropShowToday),'&amp;&amp;',expHandlers(viewType,'===','monthView'))}}\"><template case=\"true\"> <p role=\"button\" tabindex=\"0\" onkeydown=\"{{action('curMonthOnKey',event)}}\" class=\"lyteCalCurrentDate\"><a onclick=\"{{action('curMonth',event)}}\">{{lyteUiI18n('Current Month')}}</a></p> </template><template case=\"false\"><template is=\"if\" value=\"{{expHandlers(expHandlers(showToday,'&amp;&amp;',ltPropShowToday),'&amp;&amp;',expHandlers(viewType,'===','decadeView'))}}\"><template case=\"true\"> <p role=\"button\" tabindex=\"0\" onkeydown=\"{{action('curYearOnKey',event)}}\" class=\"lyteCalCurrentDate\"><a onclick=\"{{action('curYear',event)}}\">{{lyteUiI18n('Current Year')}}</a></p> </template><template case=\"false\"><template is=\"if\" value=\"{{expHandlers(expHandlers(expHandlers(showToday,'&amp;&amp;',ltPropShowToday),'&amp;&amp;',expHandlers(viewType,'===','dateView')),'&amp;&amp;',expHandlers(ltPropSelectionType,'===','week'))}}\"><template case=\"true\"> <p role=\"button\" tabindex=\"0\" onkeydown=\"{{action('curWeekOnKey',event)}}\" class=\"lyteCalCurrentDate\"><a onclick=\"{{action('curWeek',event)}}\">{{lyteUiI18n('Current Week')}}</a></p> </template><template case=\"false\"><template is=\"if\" value=\"{{expHandlers(showToday,'&amp;&amp;',ltPropShowToday)}}\"><template case=\"true\"> <p role=\"button\" tabindex=\"0\" onkeydown=\"{{action('todayOnKey',event)}}\" class=\"lyteCalCurrentDate\"><a onclick=\"{{action('today',event)}}\">{{lyteUiI18n('today')}}</a></p> </template></template></template></template></template></template></template></template> <template is=\"if\" value=\"{{ltPropYield}}\"><template case=\"true\"> <lyte-yield yield-name=\"footer\"></lyte-yield> </template></template> </div> </div> </div> </div> </template></template> </template>",
_dynamicNodes : [{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,1,1,1]},{"type":"if","position":[1,1,1,1],"cases":{"true":{"dynamicNodes":[{"type":"insertYield","position":[1]}]},"false":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,1]},{"type":"text","position":[1,1,0]},{"type":"attr","position":[1,3]},{"type":"text","position":[1,3,0]},{"type":"attr","position":[1,5]},{"type":"attr","position":[1,5,1]},{"type":"if","position":[1,5,1],"cases":{"true":{"dynamicNodes":[{"type":"text","position":[1,0]},{"type":"text","position":[2,0]}]},"false":{"dynamicNodes":[{"type":"attr","position":[0]},{"type":"if","position":[0],"cases":{"true":{"dynamicNodes":[{"type":"text","position":[1,0]}]},"false":{"dynamicNodes":[{"type":"text","position":[1,0]},{"type":"text","position":[1,2]}]}},"default":{}}]}},"default":{}},{"type":"attr","position":[1,7]},{"type":"if","position":[1,7],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1,1]},{"type":"if","position":[1,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"registerYield","position":[1,1],"dynamicNodes":[{"type":"attr","position":[1,1,1]},{"type":"for","position":[1,1,1],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,0]},{"type":"componentDynamic","position":[1]}]},{"type":"componentDynamic","position":[1,1]},{"type":"componentDynamic","position":[1]}]},{"type":"componentDynamic","position":[1]},{"type":"attr","position":[3]},{"type":"if","position":[3],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"registerYield","position":[1,1],"dynamicNodes":[{"type":"attr","position":[1,1,1]},{"type":"for","position":[1,1,1],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,0]},{"type":"componentDynamic","position":[1]}]},{"type":"componentDynamic","position":[1,1]},{"type":"componentDynamic","position":[1]}]},{"type":"componentDynamic","position":[1]}]},"false":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"componentDynamic","position":[1]}]}},"default":{}}]},"false":{"dynamicNodes":[{"type":"attr","position":[0]},{"type":"if","position":[0],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,1,0]},{"type":"text","position":[1,3,0]}]},"false":{"dynamicNodes":[{"type":"attr","position":[0]},{"type":"if","position":[0],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,1,0]}]},"false":{"dynamicNodes":[{"type":"attr","position":[0]},{"type":"if","position":[0],"cases":{"true":{"dynamicNodes":[{"type":"text","position":[1,1]},{"type":"text","position":[1,3]}]}},"default":{}}]}},"default":{}}]}},"default":{}}]},"false":{"dynamicNodes":[{"type":"attr","position":[0]},{"type":"if","position":[0],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[{"type":"text","position":[1,1,0]}]},"false":{"dynamicNodes":[{"type":"attr","position":[0]},{"type":"if","position":[0],"cases":{"true":{"dynamicNodes":[{"type":"text","position":[1,1]},{"type":"text","position":[1,3]}]}},"default":{}}]}},"default":{}}]},"false":{"dynamicNodes":[{"type":"text","position":[1,0]},{"type":"text","position":[3,0]}]}},"default":{}}]}},"default":{}}]}},"default":{}}]}},"default":{}},{"type":"attr","position":[1,9]},{"type":"if","position":[1,9],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,1,0]}]}},"default":{}}]}},"default":{}},{"type":"attr","position":[1,11]},{"type":"text","position":[1,11,1,0]},{"type":"attr","position":[1,13]},{"type":"if","position":[1,13],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1,1]},{"type":"if","position":[1,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"registerYield","position":[1,1],"dynamicNodes":[{"type":"attr","position":[1,1,1]},{"type":"for","position":[1,1,1],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,0]},{"type":"componentDynamic","position":[1]}]},{"type":"componentDynamic","position":[1,1]},{"type":"componentDynamic","position":[1]}]},{"type":"componentDynamic","position":[1]},{"type":"attr","position":[3]},{"type":"if","position":[3],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"registerYield","position":[1,1],"dynamicNodes":[{"type":"attr","position":[1,1,1]},{"type":"for","position":[1,1,1],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,0]},{"type":"componentDynamic","position":[1]}]},{"type":"componentDynamic","position":[1,1]},{"type":"componentDynamic","position":[1]}]},{"type":"componentDynamic","position":[1]}]},"false":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"componentDynamic","position":[1]}]}},"default":{}}]},"false":{"dynamicNodes":[{"type":"attr","position":[0]},{"type":"if","position":[0],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,1,0]},{"type":"text","position":[1,3,0]}]},"false":{"dynamicNodes":[{"type":"attr","position":[0]},{"type":"if","position":[0],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,1,0]}]},"false":{"dynamicNodes":[{"type":"attr","position":[0]},{"type":"if","position":[0],"cases":{"true":{"dynamicNodes":[{"type":"text","position":[1,1]},{"type":"text","position":[1,3]}]}},"default":{}}]}},"default":{}}]}},"default":{}}]},"false":{"dynamicNodes":[{"type":"attr","position":[0]},{"type":"if","position":[0],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[{"type":"text","position":[1,1,0]}]},"false":{"dynamicNodes":[{"type":"attr","position":[0]},{"type":"if","position":[0],"cases":{"true":{"dynamicNodes":[{"type":"text","position":[1,1]},{"type":"text","position":[1,3]}]}},"default":{}}]}},"default":{}}]},"false":{"dynamicNodes":[{"type":"text","position":[1,0]},{"type":"text","position":[3,0]}]}},"default":{}}]}},"default":{}}]}},"default":{}}]}},"default":{}},{"type":"attr","position":[1,15]},{"type":"text","position":[1,15,1,0]},{"type":"attr","position":[1,17]},{"type":"if","position":[1,17],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,1,0]}]}},"default":{}}]}},"default":{}}]}},"default":{}},{"type":"attr","position":[1,1,3,1]},{"type":"if","position":[1,1,3,1],"cases":{"true":{"dynamicNodes":[{"type":"insertYield","position":[1]}]},"false":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1,1]},{"type":"if","position":[1,1],"cases":{"true":{"dynamicNodes":[{"type":"text","position":[1,0,0]}]}},"default":{}},{"type":"attr","position":[1,3]},{"type":"for","position":[1,3],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,0]}]}]}},"default":{}},{"type":"attr","position":[3,1]},{"type":"if","position":[3,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"for","position":[1],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1,1]},{"type":"if","position":[1,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,0,0]}]}},"default":{}},{"type":"attr","position":[1,3]},{"type":"for","position":[1,3],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[]},"false":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,0,0]}]}},"default":{}}]},"false":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[]},"false":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,0,0]}]}},"default":{}}]}},"default":{}}]}]}},"default":{}}]}]},"false":{"dynamicNodes":[{"type":"attr","position":[0]},{"type":"if","position":[0],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"for","position":[1],"dynamicNodes":[{"type":"attr","position":[1,1]},{"type":"for","position":[1,1],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,1]}]}]}]},"false":{"dynamicNodes":[{"type":"attr","position":[0]},{"type":"if","position":[0],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"for","position":[1],"dynamicNodes":[{"type":"attr","position":[1,1]},{"type":"for","position":[1,1],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,1]}]},"false":{"dynamicNodes":[]}},"default":{}}]}]}]}},"default":{}}]}},"default":{}}]}},"default":{}}]}},"default":{}},{"type":"attr","position":[1,1,5,1,1]},{"type":"if","position":[1,1,5,1,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,0]},{"type":"text","position":[1,0,0]}]},"false":{"dynamicNodes":[{"type":"attr","position":[0]},{"type":"if","position":[0],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,0]},{"type":"text","position":[1,0,0]}]},"false":{"dynamicNodes":[{"type":"attr","position":[0]},{"type":"if","position":[0],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,0]},{"type":"text","position":[1,0,0]}]},"false":{"dynamicNodes":[{"type":"attr","position":[0]},{"type":"if","position":[0],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,0]},{"type":"text","position":[1,0,0]}]}},"default":{}}]}},"default":{}}]}},"default":{}}]}},"default":{}},{"type":"attr","position":[1,1,5,1,3]},{"type":"if","position":[1,1,5,1,3],"cases":{"true":{"dynamicNodes":[{"type":"insertYield","position":[1]}]}},"default":{}}]}},"default":{}}],
_observedAttributes :["ltPropStartDate","ltPropEndDate","ltPropStartYear","ltPropEndYear","ltPropCurrentDate","ltPropFormat","ltPropYear","ltPropMonthHeaderFormat","daysOfWeek","ariaMonthNames","monthSystemValues","monthNames","shortHands","todayName","viewDate","changeData","ltPropYield","ltPropMinDate","ltPropMaxDate","ltPropMinMonth","ltPropMaxMonth","ltPropStartWeekDay","navYield","selectDate","currentDatechanged","ltPropFillRows","ltPropFillRowsVariants","ltPropNumberOfRows","callFrmDidcnct","monthDD","yearDD","years","ltPropHeaderType","ltPropDropdown","cords","start","prev","tt","showToday","monthViewTableArray","ltPropBodyYield","ltPropShowToday","ltPropI18n","ltPropActivateNavigation","ltPropDisableNavigation","ltPropPreventAddingRows","ltPropSelectionType","ltPropWeekends","ltPropCurrentWeek","ltPropCurrentMonth","ltPropCurrentYear","ltPropDisabledDates","ltPropCurrentDates","ltPropMultiple","headerId","monthDropdownId","yearDropdownId","ltPropIso","ltPropWeekNumCriteria","ltPropHolidays","ltPropDisableWeekends","ltPropDisableHolidays","ltPropWeekNumber","ltPropAlwaysShowToday","ltPropHighlightWeekendHolidays","ltPropTimeZone","ltPropDisabledDays","ltPropHeaderAlignType","ltPropWeekNumHeader","showYear","ltPropCurrentDisplayMonth","ltPropCurrentDisplayYear","ltPropCurrentDisplayDecade","ltPropDisabledDateTooltip","ltPropTooltip","isoFlag","displayObs","ltPropTransitMonthOnDateSel","renderCalendar","ltPropDisableNavKeyOutOfRange","ltPropPrevMonthTooltip","ltPropNextMonthTooltip","ltPropPrevYearTooltip","ltPropNextYearTooltip","ltPropPrevDecadeTooltip","ltPropNextDecadeTooltip","leftNavTooltip","rightNavTooltip","ltPropDays","ltPropEvents","ltPropPreventCellActivation"],
_observedAttributesType :["string","string","number","number","string","string","boolean","string","array","array","array","array","array","string","object","number","boolean","string","string","string","string","number","boolean","boolean","number","boolean","object","number","boolean","object","object","array","string","object","object","number","boolean","boolean","boolean","array","boolean","boolean","boolean","boolean","boolean","boolean","string","array","array","string","string","array","array","boolean","string","string","string","string","number","array","boolean","boolean","boolean","boolean","boolean","string","array","string","string","boolean","string","string","string","string","object","boolean","boolean","boolean","boolean","boolean","string","string","string","string","string","string","string","string","array","array","boolean"],

	_lyteUtilFunctions: [ 'revertToToday', 'revertToSelected' ],
	data: function() {
		return {
			 ...
			 * @condition ltPropSelectionType day
			...
			*/
			...
			'ltPropMinMonth': Lyte.attr( 'string', { 
				'default': '',
				'input': true
			} ),
			...
			'ltPropMaxMonth': Lyte.attr( 'string', { 
				'default': '',
				'input': true 
			} ),
			...
			'ltPropHeaderType' : Lyte.attr( "string", { 
				"default": _lyteUiUtils.resolveDefaultValue( 'lyte-calendar', 'headerType', 'default' ),
				'input': true
			 } ),
			 ...
			 * @condition ltPropHeaderType dropdown
			 * @input
			 */
			...
			/**
			 * @componentProperty {string} ltPropSelectionType
			 * @default day
			 * @input
			 */

			'ltPropSelectionType': Lyte.attr( 'string', { 'default': 'day', 'input': true } ),

			/**
			 * @componentProperty {array} ltPropWeekends
			 * @default [6,0]
			 * @input
			 */

			'ltPropWeekends': Lyte.attr( 'array', { 'default': [ 6, 0 ], 'input': true } ),

			/**
			 * @componentProperty {array} ltPropCurrentWeek
			 * @default []
			 * @condition ltPropSelectionType week
			 * @output
			 * @input
			 */

			'ltPropCurrentWeek': Lyte.attr( 'array', { 'default': [], 'input': true, 'output': true } ),

			/**
			 * @componentProperty {string} ltPropCurrentMonth
			 * @default ''
			 * @condition ltPropSelectionType month
			 * @output
			 * @input
			 */

			'ltPropCurrentMonth': Lyte.attr( 'string', { 'default': '', 'input': true, 'output': true } ),

			/**
			 * @componentProperty {string} ltPropCurrentYear
			 * @default ''
			 * @condition ltPropSelectionType year
			 * @output
			 * @input
			 */

			'ltPropCurrentYear': Lyte.attr( 'string', { 'default': '', 'input': true, 'output': true } ),
			...
			'ltPropDisabledDates': Lyte.attr( 'array', { 'default': [], 'input': true } ),

			/**
			 * @componentProperty {array} ltPropCurrentDates
			 * @default []
			 * @condition ltPropMultiple true
			 * @condition ltPropSelectionType day
			 * @output
			 * @input
			 */

			'ltPropCurrentDates': Lyte.attr( 'array', { 'default': [], 'input': true, 'output': true } ),

			/**
			 * @componentProperty {boolean} ltPropMultiple
			 * @default false
			 * @condition ltPropSelectionType day
			 * @input
			 */

			'ltPropMultiple': Lyte.attr( 'boolean', { 'default': false, 'input': true } ),
			...
			/**
			 * @componentProperty {string} ltPropIso
			 * @output
			 * @input
			 */

			'ltPropIso' : Lyte.attr( 'string', { 'input': true, 'output': true } ),

			/**
			 * @componentProperty {number} ltPropWeekNumCriteria
			 * @default 1
			 * @input
			 */

			'ltPropWeekNumCriteria': Lyte.attr( 'number', { 'default': 1, 'input': true } ),

			/**
			 * @componentProperty {array} ltPropHolidays
			 * @default []
			 * @input
			 */

			'ltPropHolidays': Lyte.attr( 'array', { 
				'default': _lyteUiUtils.resolveDefaultValue( 'lyte-calendar', 'holidays', [] ),
				'input': true
			} ),

			/**
			 * @componentProperty {boolean} ltPropDisableWeekends
			 * @default false
			 * @input
			 */

			'ltPropDisableWeekends': Lyte.attr( 'boolean', { 'default': false, 'input': true } ),

			/**
			 * @componentProperty {boolean} ltPropDisableHolidays
			 * @default false
			 * @input
			 */

			'ltPropDisableHolidays': Lyte.attr( 'boolean', { 'default': false, 'input': true } ),

			/**
			 * @componentProperty {boolean} ltPropWeekNumber
			 * @default false
			 * @input
			 */

			'ltPropWeekNumber': Lyte.attr( 'boolean', { 'default': false, 'input': true } ),

			/**
			 * @componentProperty {boolean} ltPropAlwaysShowToday
			 * @default false
			 * @input
			 */
			
			'ltPropAlwaysShowToday': Lyte.attr( 'boolean', { 'default': false, 'input': true } ),  //showToday even when we are in current date

			/**
			 * @componentProperty {boolean} ltPropHighlightWeekendHolidays
			 * @default false
			 * @input
			 */

			'ltPropHighlightWeekendHolidays': Lyte.attr( 'boolean', { 'default': false, 'input': true } ),
			...
			'ltPropTimeZone' : Lyte.attr( 'string', { 'input': true } ),

			/**
			 * @componentProperty {array} ltPropDisabledDays
			 * @default []
			 * @input
			 */

			'ltPropDisabledDays' : Lyte.attr( 'array', { 
				default : _lyteUiUtils.resolveDefaultValue( 'lyte-calendar', 'disabledWeekDays', [] ),
				'input': true
			} ),

			/**
			 * @componentProperty {string} ltPropHeaderAlignType
			 * @default ''
			 * @input
			 */

			'ltPropHeaderAlignType': Lyte.attr( 'string', { 
				'default': '',
				'input': true
			} ),

			/**
			 * @componentProperty {string} ltPropWeekNumHeader
			 * @default ''
			 * @input
			 */

			'ltPropWeekNumHeader': Lyte.attr( 'string', { 'default': '', 'input': true } ),

			'showYear': Lyte.attr( 'boolean', { 'default': false } ),

			/**
			 * @componentProperty {string} ltPropCurrentDisplayMonth
			 * @default ''
			 * @output
			 */

			'ltPropCurrentDisplayMonth': Lyte.attr( 'string', { 'default': '', 'output': true } ),

			/**
			 * @componentProperty {string} ltPropCurrentDisplayYear
			 * @default ''
			 * @output
			 */

			'ltPropCurrentDisplayYear': Lyte.attr( 'string', { 'default': '', 'output': true } ),

			/**
			 * @componentProperty {string} ltPropCurrentDisplayDecade
			 * @default ''
			 * @output
			 */

			'ltPropCurrentDisplayDecade': Lyte.attr( 'string', { 'default': '', 'output': true } ),

			/**
			 * @componentProperty {string} ltPropDisabledDateTooltip
			 * @default ''
			 * @input
			 */

			'ltPropDisabledDateTooltip': Lyte.attr( 'string', { 'default': '', 'input': true } ),
			...
			'ltPropTransitMonthOnDateSel': Lyte.attr('boolean', { 
				'default': _lyteUiUtils.resolveDefaultValue( 'lyte-calendar', 'transitMonthOnDateSel', false ),
				'input': true 
			} ),
			...
			/**
			 * @componentProperty {boolean} ltPropDisableNavKeyOutOfRange
			 * @default false
			 * @input
			 */

			'ltPropDisableNavKeyOutOfRange': Lyte.attr( 'boolean', { 
				'default': false,
				'input': true
			} ),

			/**
			 * @componentProperty {string} ltPropPrevMonthTooltip
			 * @default ''
			 * @input
			 */

			'ltPropPrevMonthTooltip': Lyte.attr('string', { 'default': '' } ),

			/**
			 * @componentProperty {string} ltPropNextMonthTooltip
			 * @default ''
			 * @input
			 */

			'ltPropNextMonthTooltip': Lyte.attr('string', { 'default': '' } ),

			/**
			 * @componentProperty {string} ltPropPrevYearTooltip
			 * @default ''
			 * @input
			 */

			'ltPropPrevYearTooltip': Lyte.attr('string', { 'default': '' } ),

			/**
			 * @componentProperty {string} ltPropNextYearTooltip
			 * @default ''
			 * @input
			 */

			'ltPropNextYearTooltip': Lyte.attr('string', { 'default': '' } ),

			/**
			 * @componentProperty {string} ltPropPrevDecadeTooltip
			 * @default ''
			 * @input
			 */

			'ltPropPrevDecadeTooltip': Lyte.attr('string', { 'default': '' } ),

			/**
			 * @componentProperty {string} ltPropNextDecadeTooltip
			 * @default ''
			 * @input
			 */

			'ltPropNextDecadeTooltip': Lyte.attr('string', { 'default': '' } ),

			'leftNavTooltip': Lyte.attr( 'string', { 'default': '' } ),

			'rightNavTooltip': Lyte.attr( 'string', { 'default': '' } ),

			/**
			 * @componentProperty {array} ltPropDays
			 * @input
			 */

			'ltPropDays': Lyte.attr( 'array' ),
			'ltPropEvents': Lyte.attr( 'array', {  'default': [], 'input': true } ),
			'ltPropPreventCellActivation': Lyte.attr( 'boolean', { 'default': false } )
		}
	},
	...
	focusActiveCell: function() {
		var activeCell = this.getActiveCell(),
		shouldPreventCellActivation = this.getData( 'ltPropPreventCellActivation' );

		if( shouldPreventCellActivation ) {
			return ;
		}
	...
	getCellFromDifferentView: function( navDirection, currentNavIndex, cellsToMove, event ) {
		...
		if( viewType === 'monthView' || viewType === 'decadeView' ) {
			this.changeView( navDirection, event );
	...
	changeView: function( navDirection, event ) {
	...
	changeBodyContainerClass: function() {
		if( this.getData('renderCalendar') ){
	...
	}.observes( 'ltPropSelectionType', 'viewType', 'renderCalendar' ).on( 'didConnect' ),
	...
	changeDaysOfWeek: function() {
		...
		var ltPropDays = this.getData('ltPropDays');

		if( ltPropDays && Array.isArray( ltPropDays ) && ltPropDays.length === 7 ){
			days = ltPropDays;
		}
	...
	weekendObserver: function() {
		this.changeDaysOfWeek();
	}.observes( 'ltPropWeekends.[]' ),
	...
	findSimilarCell: function( userDateObj ) {
		...
		resultDateObj = this.safeDateObj( currentViewedYear, currentViewedMonth, resultDate ); 
	...
	activateCell: function( cell ) {
		...
		if( this.getData( 'ltPropPreventCellActivation' ) ) {
			return ;
		}
	...
	revert: function( event ) {
		...
		if( this.getMethods( 'onNavigate' ) 
			...
			/**
			 * This callback is fired when a user navigates to a different month
			 * @method onNavigate
			 * @author ananthapadmanaban.n@zohocorp.com
			 * @param { object } event
			 * @param { string } dateFromWhichWeAreNavigatingAway
			 * @param { string } dateToWhichWeAreNavigatingTo
			 * @param { boolean } calendarContext
			 * @param { string } ifTodayButtonWasClicked
			 */
	...
	isInRangeMonth: function( current, start, end ) {
		var startDate, endDate;
	...
	holidayObs: function( ){
		this.updateDateMarkers( 'ltPropHolidays', 'lyteCalHoliday' );
	}.observes( 'ltPropHolidays' ),

	eventObs: function( ){
		this.updateDateMarkers( 'ltPropEvents', 'lyteCalEvent' );
	}.observes( 'ltPropEvents' ),

	updateDateMarkers: function( propName, className ){
		this.removeExistingDateMarkers( className );
		this.addDateMarkers( propName, className );
	},

	addDateMarkers: function( propName, className ){
		var dates = this.getData( propName );
		var format = this.getData( 'ltPropFormat' );
		...
		var isHoliday = className === 'lyteCalHoliday';

		for( var i = 0; i < dates.length; i++ ){
			var cur = dates[i];
			var curDate = isHoliday ? this.stringToDate( dates[i], format ) : null;
	...
	removeExistingDateMarkers: function( className ){
		var cells = this.$node.querySelectorAll( '.' + className );
		var isHoliday = className === 'lyteCalHoliday';
		var disabledDates = isHoliday ? this.getDisabledDates() : null;

		for( var i = 0; i < cells.length; i++ ){
			var currentProcessedDate = isHoliday ? this.stringToDate( cells[i].getAttribute( 'data-date' ), this.getData( 'ltPropFormat' ) ) : null;

			cells[i].classList.remove( className );

			// Holiday-specific cleanup logic
			if( isHoliday ){
	...
	addHolidays: function( ){
		this.addDateMarkers( 'ltPropHolidays', 'lyteCalHoliday' );
	},

	removeExistingHolidays: function( ){
		this.removeExistingDateMarkers( 'lyteCalHoliday' );
	},

	addEvents: function( ){
		this.addDateMarkers( 'ltPropEvents', 'lyteCalEvent' );
	},

	removeExistingEvents: function( ){
		this.removeExistingDateMarkers( 'lyteCalEvent' );
	},
	...
	safeDateObj: function( year, month, date ) {
		return this.stringToDate( year.toString().padStart( 4, '0' ) + '-' + ( month + 1 ).toString().padStart( 2, '0' ) + '-' + date.toString().padStart( 2, '0' ), 'YYYY-MM-DD' );
	},
	...
	getFirstDateOfDateView: function() {
		...
		calStartDate = this.safeDateObj( year, month, 1 ),
	...
	checkIfPrevMonthIsValid: function() {
		var minDate = this.getData( 'ltPropMinDate' );
	...
	checkIfNextMonthIsValid: function() {
		var maxDate = this.getData( 'ltPropMaxDate' );
	...
	checkIfPrevYearIsValid: function() {
		var minDate = this.getData( 'ltPropMinDate' );
	...
	checkIfNextYearIsValid: function() {
		var maxDate = this.getData( 'ltPropMaxDate' );
	...
	getCellClass: function( currentProcessedDate ) {
		...
		clsname += this.addEventClass( currentProcessedDate );
	...
	addEventClass: function( currentProcessedDate ) {
		var clsname = '';
		var eventDates = this.getEventDates();

		if( this.isEvent( currentProcessedDate, eventDates ) ) {
			clsname += ' lyteCalEvent';
		}
	...
	getIsoFromFormat: function( calStartDate ){
		...
		if( this.isMomentSupported ){
			if( this.isHavingTimezone ){
				iso =  $L.moment( $L.moment( calStartDate, void 0, { ignore_timezone : true } ).format( 'MM-DD-YYYY' ), 'MM-DD-YYYY' ).format()
			} else {
	...
	getEventDates: function() {
		var eventDates = this.getData( 'ltPropEvents' );

		return this.getDObjArrayFromStrings( eventDates );
	},

	isEvent: function( date, eventDates ) {
		return this.isDateInArray( eventDates, date );
	},
	...
	stringToDate: function( cur, dateStringsFormat ) {
		var ret;

		cur = this.convertToEnglish( cur, dateStringsFormat );

		if( this.isMomentSupported ) {
			ret = this.getDateObjFromMoment( cur, dateStringsFormat );
		}
		else {
			ret = this.getDateObjFromString( cur, dateStringsFormat );
		}
	...
	convertToEnglish: function( cur, dateStringsFormat ) {
		var i18n = this.getData( 'ltPropI18n' ),
		format = this.getRelevantFormat( this.getData( 'ltPropFormat' ) );

		dateStringsFormat = this.getRelevantFormat( dateStringsFormat || this.getData( 'ltPropFormat' ) );

		if( i18n ) {
			return this.moment( cur, dateStringsFormat, { i18n : true } ).format( dateStringsFormat );
		}

		return this.moment( cur, dateStringsFormat ).format( dateStringsFormat );
	},
	...
	setAndBuildView: function( viewType, event, preventCallback ) {
		...
		if( !preventCallback && ( oldView !== newView ) ) {
			/**
			 * In drilldown calendar, when user moves from date to month, month to year views or vice versa, this callback is fired.
			 * @method onViewChange
			 * @condition ltPropHeaderType drilldown
			 * @author ananthapadmanaban.n@zohocorp.com
			 * @param { object } event
			 * @param { string } viewWeAreMovingTo
			 * @param { boolean } calendarContext
			 */
	...
	buildDateView: function() {
		var isRenderCalendar = this.getData( 'renderCalendar' );
		if( !isRenderCalendar ){
			return;
		}
	...
	determineViewDateFromUserInput: function() {
		...
		if( selectionType === 'week' ) {
			...
			viewDate = _lyteUiUtils.getViewDate(
				this.stringToDate(  "01/01/" + ( this.getData( 'ltPropStartYear' ) || 1900 ), "DD/MM/YYYY" ),
				this.stringToDate( "01/01/" + ( this.getData( 'ltPropEndYear' ) || 2100 ), "DD/MM/YYYY" ),
				_lyteUiUtils.getTodaysDateBasedOnTimeZone( this.data.ltPropTimeZone, this.isHavingTimezone ),
				this.getData( 'ltPropIso' ) ? this.isoToDate( this.getData( 'ltPropIso' ) ) : ''
			);
		}
		else{
			viewDate = _lyteUiUtils.getViewDate(
				...
				this.stringToDate( "01/01/" + ( this.getData( 'ltPropEndYear' ) || 2100 ), "DD/MM/YYYY" ),
				_lyteUiUtils.getTodaysDateBasedOnTimeZone( this.data.ltPropTimeZone, this.isHavingTimezone ),
				this.getData( 'ltPropCurrentDate' ) ? this.stringToDate( this.getData( 'ltPropCurrentDate' ), this.getData( 'ltPropFormat' ) ) : ''
			);
		}
	...
	renderCalObs: function( ) {
		...
		if( isRenderCalendar ){
			...
			this.setData( 'monthDD', null );
			this.setData( 'yearDD', null );
		}
	}.observes('renderCalendar'),
	...
	addListenerForLeaveEvent: function( ) {
		var parDiv = this.$node.querySelector('div.lyteCalTableRowGroup');
		if( parDiv ){
	...
	changeViewDate: function( val ) {
		...
		if(this.isMomentSupported){
			if( this.isHavingTimezone ){
				isoRes = $L.moment( val, this.data.ltPropFormat, { i18n : this.data.ltPropI18n } ).format()
			} else {
	...
	changeCurrentMonth: function( ){
		...
		this.setData( 'viewDate', this.safeDateObj( currentYear, parsedCurMonth, 1 ) );
	...
	}.observes( 'ltPropWeekNumber', 'viewType', 'renderCalendar' ).on( 'didConnect' ),
	...
	selectMultiple: function( event ) {
		...
		if( this.alreadySelected( dateCell ) ) {
			...
			if( this.getMethods( 'onDateRemoved' ) ) {
				/**
				 * This callback is fired when a date is removed from selected option in multiselect calendar.
				 * @method onDateRemoved
				 * @condition ltPropMultiple true
				 * @condition ltPropSelectionType day
				 * @author ananthapadmanaban.n@zohocorp.com
				 * @param { object } event
				 * @param { string } removedDate
				 * @param { boolean } accordionContext
				 */
	...
	fireBeforeRemove: function( event, dateCell ) {
		if( this.getMethods( 'onBeforeRemove' ) ) {
			/**
			 * This callback is fired just before a date is removed from selected list in multiselect calendar
			 * @method onBeforeRemove
			 * @condition ltPropMultiple True
			 * @condition ltPropSelectionType day
			 * @author ananthapadmanaban.n@zohocorp.com
			 * @param { object } event
			 * @param { object } removedDate
			 * @param { boolean } calendarContext
			 */
	...
	fireBeforeAdd: function( event, dateCell ) {
		if( this.getMethods( 'onBeforeAdd' ) ) {
			/**
			 * This callback is fired just before a date is added to selected list in multiselect calendar
			 * @method onBeforeAdd
			 * @condition ltPropMultiple True
			 * @condition ltPropSelectionType day
			 * @author ananthapadmanaban.n@zohocorp.com
			 * @param { object } event
			 * @param { object } addedDate
			 * @param { boolean } calendarContext
			 */
	...
	selectCell: function( event ) {
		...
		if( this.getMethods( 'onBeforeDateSelected' ) ) {
			/**
			 * This callback is fired just before a date is selected
			 * @method onBeforeDateSelected
			 * @condition ltPropSelectionType day
			 * @author ananthapadmanaban.n@zohocorp.com
			 * @param { object } event
			 ...
			 * @param { boolean } calendarContext
			 */
			var ret = this.executeMethod( 'onBeforeDateSelected', event, target.getAttribute( 'data-date' ), this );
			if( ret === false ) {
				return ;
			}
		}
		...
		if( this.getMethods( 'onDateSelected' ) ) {
			/**
			 * This callback is fired when a date in the calendar is selected
			 * @method onDateSelected
			 * @condition ltPropSelectionType day
			 * @author ananthapadmanaban.n@zohocorp.com
			 * @param { object } event
			 * @param { string } selectedDate
			 * @param { object } calendarContext
			 */
	...
	monthSelected: function( event ) {
		...
		this.setData( 'viewDate', this.safeDateObj( currentYear, currentSelectedMonth - 1, 1 ) );
		...
		if( this.getMethods( 'onMonthSelected' ) ) {
			/**
			 * This callback is fired when a month is selected in the drilldown calendar
			 * @method onMonthSelected
			 * @condition ltPropSelectionType month
			 * @author ananthapadmanaban.n@zohocorp.com
			 * @param { object } event
	...
	yearSelected: function( event ) {
		...
		if( this.getMethods( 'onYearSelected' ) ) {
			/**
			 * This callback is fired when a year in the calendar is selected
			 * @method onYearSelected
			 * @condition ltPropSelectionType year
			 * @author ananthapadmanaban.n@zohocorp.com
			 * @param { object } event
	...
	selectWeek: function( event ) {
		...
		if( this.getMethods( 'onWeekSelected' ) ) {
			/**
			 * This callback is fired when a week is selected in the calendar
			 * @method onWeekSelected
			 * @condition ltPropSelectionType week
			 * @author ananthapadmanaban.n@zohocorp.com
			 * @param { object } event
			 * @param { string } firstDayOfWeek
			 * @param { string } lastDayOfWeek
			 * @param { object } calendarContext
			 */
	...
	getCurrentWeekNumber: function( currentDateObj ) {
		...
		var startDateObj = this.safeDateObj( currentDateObj.getFullYear(), 0, startDate );
	...
	getDateOfFirstDay: function( year, day ){
		var currDateObj = this.safeDateObj( year, 0, 1 );
		for( var i=0; i<7; i++ ){
	...
	actions: {
		changeToMonthView: function( event ) {
			...
			setTimeout( function() {
				that.changeToMonthView( event );
				that.focusDrillDownButton();	
			}, 0 );
		...
		changeToDecadeView: function( event ) {
			...
			setTimeout( function() {
				that.changeToDecadeView( event );
				that.focusActiveCell();
			}, 0 );
