 ...
 */
/**
 * @domEvents keydown, keyup, focus, blur
 */
Lyte.Component.register("lyte-calculator", {
_template:"<template tag-name=\"lyte-calculator\" lyte-calculator=\"\"> <div class=\"lyteCalculator basic\" tabindex=\"0\" data-tabindex=\"{{ltPropDataTabindex}}\" onkeydown=\"{{action('keydown',event)}}\" onkeyup=\"{{action('keyup',event)}}\"> <div class=\"calculatorDisplay\" role=\"presentation\" tabindex=\"0\" data-tabindex=\"{{ltPropDataTabindex}}\"> <template is=\"if\" value=\"{{ltPropEditable}}\"><template case=\"true\"> <input type=\"text\" class=\"lyteCalculatorTextField\" autocomplete=\"off\" onmousedown=\"{{action('mdwnTextField',event)}}\" onmouseup=\"{{action('mupTextField',event)}}\" spellcheck=\"false\"> </template><template case=\"false\"> <div> <div class=\"lyteCalculatorTextField\" tabindex=\"0\" data-tabindex=\"{{ltPropDataTabindex}}\"></div> </div> </template></template> <div class=\"calculatorDispspan\" tabindex=\"0\" data-tabindex=\"{{ltPropDataTabindex}}\">0</div> <div class=\"calculatorrad\"></div> </div> <div class=\"calculatorbuttons\" onmousedown=\"{{action('mousedown',event)}}\" onmouseup=\"{{action('mouseup',event)}}\"> <div class=\"calculatorToggle\"> <span class=\"calculatorsmaller\"></span> </div> <div class=\"advancedCalculator\"> <span class=\"CalculatorBtn15\" role=\"button\" aria-label=\"inverse\">2<sup>nd</sup></span> <span class=\"CalculatorBtn15\" role=\"button\" aria-label=\"memory plus\">m+</span> <span class=\"CalculatorBtn15\" role=\"button\" aria-label=\"memory minus\">m-</span> <span class=\"CalculatorBtn15 memorymr\" role=\"button\" aria-label=\"memory recall\">mr</span> <span class=\"CalculatorBtn15\" role=\"button\" aria-label=\"memory clear\">mc</span> <span class=\"CalculatorBtn14 Deg\" role=\"button\" aria-label=\"switch between radians and degrees\">Deg</span> <span class=\"CalculatorBtn15\" role=\"button\" aria-label=\"left parenthesis\">(</span> <span class=\"CalculatorBtn15\" role=\"button\" aria-label=\"right parenthesis\">)</span> <span class=\"CalculatorBtn14\" role=\"button\" aria-label=\"random\">Rand</span> <span class=\"CalculatorBtn15\" role=\"button\" aria-label=\"1 divide by X\">1/x</span> <span class=\"CalculatorBtn15\" role=\"button\" aria-label=\"logarithm of y\">log<sub>y</sub></span> <span class=\"CalculatorBtn16 pieButton\" role=\"button\" aria-label=\"pi\">p</span> <span class=\"CalculatorBtn14\" role=\"button\" aria-label=\"exponential\">E</span> <span class=\"CalculatorBtn16\" role=\"button\" aria-label=\"euler's number\">e</span> <span class=\"CalculatorBtn15\" role=\"button\" aria-label=\"factorial\">!</span> <span class=\"CalculatorBtn17 toggleBtns squareroot\" role=\"button\" aria-label=\"{{if(expHandlers(secondActive,'!'),&quot;X to the power of 2&quot;,&quot;squareroot&quot;)}}\">x<sup>2</sup></span> <span class=\"CalculatorBtn15 toggleBtns logbtn\" role=\"button\" aria-label=\"{{if(expHandlers(secondActive,'!'),&quot;logarithm&quot;,&quot;ten to the power of X&quot;)}}\">log</span> <span class=\"CalculatorBtn14 toggleBtns trignometry\" role=\"button\" aria-label=\"{{if(expHandlers(secondActive,'!'),&quot;sine&quot;,&quot;arcsine&quot;)}}\">sin</span> <span class=\"CalculatorBtn14 toggleBtns trignometry\" role=\"button\" aria-label=\"{{if(expHandlers(secondActive,'!'),&quot;cosine&quot;,&quot;arccosine&quot;)}}\">cos</span> <span class=\"CalculatorBtn14 toggleBtns trignometry\" role=\"button\" aria-label=\"{{if(expHandlers(secondActive,'!'),&quot;tangent&quot;,&quot;arctangent&quot;)}}\">tan</span> <span class=\"CalculatorBtn17 toggleBtns calcLeft lastrow cuberoot\" role=\"button\" aria-label=\"{{if(expHandlers(secondActive,'!'),&quot;X to the power of Y&quot;,&quot;Y root of X&quot;)}}\">x<sup>y</sup></span> <span class=\"CalculatorBtn16 toggleBtns lastrow naturallog\" role=\"button\" aria-label=\"{{if(expHandlers(secondActive,'!'),&quot;natural logarithm&quot;,&quot;E to the power of X&quot;)}}\">ln</span> <span class=\"CalculatorBtn14 toggleBtns lastrow hyperbolic\" role=\"button\" aria-label=\"{{if(expHandlers(secondActive,'!'),&quot;hyperbolic sine&quot;,&quot;hyperbolic arcsine&quot;)}}\">sinh</span> <span class=\"CalculatorBtn14 toggleBtns lastrow hyperbolic\" role=\"button\" aria-label=\"{{if(expHandlers(secondActive,'!'),&quot;hyperbolic cosine&quot;,&quot;hyperbolic arccosine&quot;)}}\">cosh</span> <span class=\"CalculatorBtn14 toggleBtns lastrow hyperbolic\" role=\"button\" aria-label=\"{{if(expHandlers(secondActive,'!'),&quot;hyperbolic tangent&quot;,&quot;hyperbolic arctangent&quot;)}}\">tanh</span> </div> <div class=\"basicCalculator\"> <span class=\"calcBackspace\" role=\"button\" aria-label=\"clear\">C</span> <span class=\"calcClearAc\" role=\"button\" aria-label=\"all clear\">AC</span> <span class=\"calcPercent\" role=\"button\" aria-label=\"percentage\">%</span> <span class=\"basicOp calcDivide\" role=\"button\" aria-label=\"divide\">/</span> <span role=\"button\">7</span> <span role=\"button\">8</span> <span role=\"button\">9</span> <span class=\"basicOp calcMultiply\" role=\"button\" aria-label=\"multiply\">*</span> <span role=\"button\">4</span> <span role=\"button\">5</span> <span role=\"button\">6</span> <span class=\"basicOp calcAdd\" role=\"button\" aria-label=\"plus\">+</span> <span role=\"button\">1</span> <span role=\"button\">2</span> <span role=\"button\">3</span> <span class=\"basicOp calcSub\" role=\"button\" aria-label=\"minus\">-</span> <span class=\"lastrow doubleWidth calcLeft\" role=\"button\">0</span> <span class=\"calzero lastrow\" role=\"button\" aria-label=\"point\">.</span> <span class=\"basicOp lastrow calcRight calcEqual\" role=\"button\" aria-label=\"equals\">=</span> </div> </div> </div> </template>",
_dynamicNodes : [{"type":"attr","position":[1]},{"type":"attr","position":[1,1]},{"type":"attr","position":[1,1,1]},{"type":"if","position":[1,1,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]}]},"false":{"dynamicNodes":[{"type":"attr","position":[1,1]}]}},"default":{}},{"type":"attr","position":[1,1,3]},{"type":"attr","position":[1,3]},{"type":"attr","position":[1,3,3,31]},{"type":"attr","position":[1,3,3,33]},{"type":"attr","position":[1,3,3,35]},{"type":"attr","position":[1,3,3,37]},{"type":"attr","position":[1,3,3,39]},{"type":"attr","position":[1,3,3,41]},{"type":"attr","position":[1,3,3,43]},{"type":"attr","position":[1,3,3,45]},{"type":"attr","position":[1,3,3,47]},{"type":"attr","position":[1,3,3,49]}],
...
_observedAttributesType :["boolean","string","string","array","array","object","array","string","boolean","boolean","number","array","array","boolean","array","boolean","number","boolean","boolean","boolean","object","number"],
	...
	didConnect: function () {
		...
		this.$node.getValue = function () {
			var inputField = this.$node.querySelector('.calculatorDispspan')
	...
	keyDown: function (event, obj) { // works for mouse and key
		var target = obj || this.getTargetKey(event.target),
	...
	preformMouseDown: function (event) {
		this.keyDown(event);
