...
_template:"<template tag-name=\"lyte-daterangepicker\" lyte-daterangepicker=\"\"> <template is=\"switch\" value=\"{{ltPropSelectionType}}\"><template case=\"continuous\"> <div class=\"lyteDateRangePickerRow {{if(ltPropYear,'lyteDateRPWithYearNavigator')}}\" onmousedown=\"{{action('mouseDown',event)}}\" onmouseover=\"{{action('mouseOver',event)}}\" onkeydown=\"{{action('keydown',event)}}\"> <div class=\"lyteDateRangePickerCol1\"> <lyte-calendar render-calendar=\"{{renderCalendar}}\" lt-prop-fill-rows-variants=\"{{startFill}}\" on-month-selected=\"{{method('monthSelect','1')}}\" lt-prop=\"{{ltPropCalendar}}\" lt-prop-header-type=\"{{ltPropHeaderType}}\" nav-yield=\"{{navYield1}}\" lt-prop-format=\"{{ltPropFormat}}\" lt-prop-max-date=\"{{ltPropMaxDate}}\" lt-prop-min-date=\"{{ltPropMinDate}}\" lt-prop-fill-rows=\"{{ltPropFillRows}}\" lt-prop-start-week-day=\"{{ltPropStartWeekDay}}\" class=\"dRPCalendar1\" on-viewdate-change=\"{{method('viewDateChange','cal1')}}\" lt-prop-disable-navigation=\"true\" header-id=\"{{lbind(headerId1)}}\" month-dropdown-id=\"{{lbind(monthDropdownId1)}}\" year-dropdown-id=\"{{lbind(yearDropdownId1)}}\" month-header=\"{{lbind(monthHeader1)}}\"> <template is=\"registerYield\" yield-name=\"navigator\"> <div class=\"lyteDateRPLeftNav\"> <template is=\"if\" value=\"{{ltPropYear}}\"><template case=\"true\"><span role=\"button\" case=\"true\" class=\"lyteCalNav lyteCalyearNavLft\" onclick=\"{{action('previous','Y',event)}}\" onkeydown=\"{{action('prevKey','Y',event)}}\" tabindex=\"{{navtab}}\" aria-label=\"{{previousYear}}\"> </span></template></template> <span role=\"button\" class=\"lyteCalNav lyteCaldLft\" onclick=\"{{action('previous','M',event)}}\" onkeydown=\"{{action('prevKey','M',event)}}\" tabindex=\"{{navtab}}\" aria-label=\"{{previousMonth}}\"> </span> </div> <div class=\"{{lyteUiDateRPHeaderClass(ltPropHeaderType)}}\"> <template is=\"switch\" value=\"{{ltPropHeaderType}}\"> <template case=\"dropdown\"> <lyte-dropdown lt-prop-selected=\"{{lbind(month1)}}\" on-before-show=\"{{method('addDropdownClass')}}\" on-show=\"{{method('editArrowPosition')}}\" lt-prop-callout=\"true\" class=\"monthDD\" lt-prop-tabindex=\"{{droptab1}}\" on-option-selected=\"{{method('optionSelected','cal1','M')}}\" lt-prop=\"{{ltPropDropdown}}\"> <template is=\"registerYield\" yield-name=\"yield\"> <lyte-drop-box class=\"lyteDateRangepickerDropdown\"> <lyte-drop-body> <template is=\"for\" items=\"{{monthNames}}\" item=\"item\" index=\"index\"> <lyte-drop-item data-value=\"{{item}}\">{{item}}</lyte-drop-item> </template> </lyte-drop-body> </lyte-drop-box> </template> </lyte-dropdown> <lyte-dropdown lt-prop-selected=\"{{lbind(year1)}}\" lt-prop-display-value=\"{{lbind(display1)}}\" on-before-show=\"{{method('addDropdownClass')}}\" on-show=\"{{method('editArrowPosition')}}\" lt-prop-callout=\"true\" class=\"yearDD\" lt-prop-tabindex=\"{{droptab2}}\" on-option-selected=\"{{method('optionSelected','cal1','Y')}}\" lt-prop=\"{{ltPropDropdown}}\"> <template is=\"registerYield\" yield-name=\"yield\"> <lyte-drop-box class=\"lyteDateRangepickerDropdown\"> <lyte-drop-body> <template is=\"for\" items=\"{{years}}\" item=\"item\" index=\"index\"> <lyte-drop-item data-value=\"{{item}}\">{{item}}</lyte-drop-item> </template> </lyte-drop-body> </lyte-drop-box> </template> </lyte-dropdown> <span class=\"lyteVisuallyHidden\" aria-live=\"polite\" id=\"{{headerId1}}\">{{monthHeader1}}</span> </template> <template case=\"drilldown\"> <button aria-label=\"{{lyteUiI18n('lyte.calendar.monthview.drilldown.button')}}\" tabindex=\"0\" class=\"lyteDrillCalHeaderButton\" onclick=\"{{action('switchDrill',event,this,'1')}}\"> <span class=\"lyteCalsCalMonth\">{{lyteUiGetMonthOrYear(monthHeader1,\"M\")}}</span> <span class=\"lyteCalsCalYear\">{{lyteUiGetMonthOrYear(monthHeader1,\"Y\")}}</span> </button> </template> <template default=\"\"> <span aria-live=\"polite\" id=\"{{headerId1}}\">{{monthHeader1}}</span>  </template> </template> </div> </template> </lyte-calendar> </div> <div class=\"lyteDateRangePickerCol2\"> <lyte-calendar render-calendar=\"{{renderCalendar}}\" lt-prop-fill-rows-variants=\"{{endFill}}\" on-month-selected=\"{{method('monthSelect','2')}}\" lt-prop=\"{{ltPropCalendar}}\" lt-prop-header-type=\"{{ltPropHeaderType}}\" nav-yield=\"{{navYield2}}\" lt-prop-format=\"{{ltPropFormat}}\" lt-prop-max-date=\"{{ltPropMaxDate}}\" lt-prop-min-date=\"{{ltPropMinDate}}\" lt-prop-fill-rows=\"{{ltPropFillRows}}\" lt-prop-start-week-day=\"{{ltPropStartWeekDay}}\" class=\"dRPCalendar2\" select-date=\"false\" on-viewdate-change=\"{{method('viewDateChange','cal2')}}\" lt-prop-disable-navigation=\"true\" header-id=\"{{lbind(headerId2)}}\" month-dropdown-id=\"{{lbind(monthDropdownId2)}}\" year-dropdown-id=\"{{lbind(yearDropdownId2)}}\" month-header=\"{{lbind(monthHeader2)}}\"> <template is=\"registerYield\" yield-name=\"navigator\"> <div class=\"{{lyteUiDateRPHeaderClass(ltPropHeaderType)}}\"> <template is=\"switch\" value=\"{{ltPropHeaderType}}\"> <template case=\"dropdown\"> <lyte-dropdown lt-prop-selected=\"{{lbind(month2)}}\" on-before-show=\"{{method('addDropdownClass')}}\" on-show=\"{{method('editArrowPosition')}}\" lt-prop-callout=\"true\" class=\"monthDD\" lt-prop-tabindex=\"{{droptab1}}\" on-option-selected=\"{{method('optionSelected','cal2','M')}}\" lt-prop=\"{{ltPropDropdown}}\"> <template is=\"registerYield\" yield-name=\"yield\"> <lyte-drop-box class=\"lyteDateRangepickerDropdown\"> <lyte-drop-body> <template is=\"for\" items=\"{{monthNames}}\" item=\"item\" index=\"index\"> <lyte-drop-item data-value=\"{{item}}\">{{item}}</lyte-drop-item> </template> </lyte-drop-body> </lyte-drop-box> </template> </lyte-dropdown> <lyte-dropdown lt-prop-selected=\"{{lbind(year2)}}\" lt-prop-display-value=\"{{lbind(display2)}}\" on-before-show=\"{{method('addDropdownClass')}}\" on-show=\"{{method('editArrowPosition')}}\" lt-prop-callout=\"true\" class=\"yearDD\" lt-prop-tabindex=\"{{droptab2}}\" on-option-selected=\"{{method('optionSelected','cal2','Y')}}\" lt-prop=\"{{ltPropDropdown}}\"> <template is=\"registerYield\" yield-name=\"yield\"> <lyte-drop-box class=\"lyteDateRangepickerDropdown\"> <lyte-drop-body> <template is=\"for\" items=\"{{years}}\" item=\"item\" index=\"index\"> <lyte-drop-item data-value=\"{{item}}\">{{item}}</lyte-drop-item> </template> </lyte-drop-body> </lyte-drop-box> </template> </lyte-dropdown> <span class=\"lyteVisuallyHidden\" aria-live=\"polite\" id=\"{{headerId2}}\">{{monthHeader2}}</span> </template> <template case=\"drilldown\"> <button aria-label=\"{{lyteUiI18n('lyte.calendar.monthview.drilldown.button')}}\" tabindex=\"0\" class=\"lyteDrillCalHeaderButton\" onclick=\"{{action('switchDrill',event,this,'2')}}\"> <span class=\"lyteCalsCalMonth\">{{lyteUiGetMonthOrYear(monthHeader2,\"M\")}}</span> <span class=\"lyteCalsCalYear\">{{lyteUiGetMonthOrYear(monthHeader2,\"Y\")}}</span> </button> </template> <template default=\"\"> <span aria-live=\"polite\" id=\"{{headerId2}}\">{{monthHeader2}}</span>  </template> </template> </div> <div class=\"lyteDateRPRightNav\"> <span role=\"button\" case=\"true\" class=\"lyteCalNav lyteCaldRgt\" onclick=\"{{action('previous','M',event,'next')}}\" onkeydown=\"{{action('nextKey','M',event)}}\" tabindex=\"{{navtab}}\" aria-label=\"{{nextMonth}}\"> </span> <template is=\"if\" value=\"{{ltPropYear}}\"><template case=\"true\"><span role=\"button\" class=\"lyteCalNav lyteCalyearNavRgt\" onclick=\"{{action('previous','Y',event,'next')}}\" onkeydown=\"{{action('nextKey','Y',event)}}\" tabindex=\"{{navtab}}\" aria-label=\"{{nextYear}}\"> </span></template></template> </div> </template> </lyte-calendar> </div> </div> </template><template case=\"separate\"> <div class=\"lyteDateRangePickerRow {{if(ltPropYear,'lyteDateRPWithYearNavigator')}} lyteSeperateDRP\" onmousedown=\"{{action('separateMouseDown',event)}}\" onkeydown=\"{{action('keydown',event)}}\"> <div class=\"lyteDateRangePickerCol1\"> <lyte-calendar render-calendar=\"{{renderCalendar}}\" on-month-selected=\"{{method('monthSelect','1')}}\" lt-prop=\"{{ltPropCalendar}}\" lt-prop-header-type=\"{{ltPropHeaderType}}\" nav-yield=\"{{navYield1}}\" lt-prop-format=\"{{ltPropFormat}}\" lt-prop-max-date=\"{{ltPropMaxDate}}\" lt-prop-min-date=\"{{ltPropMinDate}}\" lt-prop-fill-rows=\"{{ltPropFillRows}}\" lt-prop-start-week-day=\"{{ltPropStartWeekDay}}\" class=\"dRPCalendar1\" on-viewdate-change=\"{{method('viewDateChange','cal1')}}\" lt-prop-disable-navigation=\"true\" header-id=\"{{lbind(headerId1)}}\" month-dropdown-id=\"{{lbind(monthDropdownId1)}}\" year-dropdown-id=\"{{lbind(yearDropdownId1)}}\" month-header=\"{{lbind(monthHeader1)}}\"> <template is=\"registerYield\" yield-name=\"navigator\"> <div class=\"lyteDateRPLeftNav\"> <template is=\"if\" value=\"{{ltPropYear}}\"><template case=\"true\"><span role=\"button\" case=\"true\" class=\"lyteCalNav lyteCalyearNavLft\" onclick=\"{{action('separatePrevious','Y','cal1',event)}}\" onkeydown=\"{{action('prevKey','Y',event,'cal1')}}\" tabindex=\"{{navtab}}\" aria-label=\"{{previousYear}}\"> </span></template></template> <span role=\"button\" class=\"lyteCalNav lyteCaldLft\" onclick=\"{{action('separatePrevious','M','cal1',event)}}\" onkeydown=\"{{action('prevKey','M',event,'cal1')}}\" tabindex=\"{{navtab}}\" aria-label=\"{{previousMonth}}\"> </span> </div> <div class=\"{{lyteUiDateRPHeaderClass(ltPropHeaderType)}}\"> <template is=\"switch\" value=\"{{ltPropHeaderType}}\"> <template case=\"dropdown\"> <lyte-dropdown lt-prop-selected=\"{{lbind(month1)}}\" on-before-show=\"{{method('addDropdownClass')}}\" on-show=\"{{method('editArrowPosition')}}\" lt-prop-callout=\"true\" class=\"monthDD\" lt-prop-tabindex=\"{{droptab1}}\" on-option-selected=\"{{method('optionSelected','cal1','M')}}\" lt-prop=\"{{ltPropDropdown}}\"> <template is=\"registerYield\" yield-name=\"yield\"> <lyte-drop-box class=\"lyteDateRangepickerDropdown\"> <lyte-drop-body> <template is=\"for\" items=\"{{monthNames}}\" item=\"item\" index=\"index\"> <lyte-drop-item data-value=\"{{item}}\">{{item}}</lyte-drop-item> </template> </lyte-drop-body> </lyte-drop-box> </template> </lyte-dropdown> <lyte-dropdown lt-prop-selected=\"{{lbind(year1)}}\" lt-prop-display-value=\"{{lbind(display1)}}\" on-before-show=\"{{method('addDropdownClass')}}\" on-show=\"{{method('editArrowPosition')}}\" lt-prop-callout=\"true\" class=\"yearDD\" lt-prop-tabindex=\"{{droptab2}}\" on-option-selected=\"{{method('optionSelected','cal1','Y')}}\" lt-prop=\"{{ltPropDropdown}}\"> <template is=\"registerYield\" yield-name=\"yield\"> <lyte-drop-box class=\"lyteDateRangepickerDropdown\"> <lyte-drop-body> <template is=\"for\" items=\"{{years}}\" item=\"item\" index=\"index\"> <lyte-drop-item data-value=\"{{item}}\">{{item}}</lyte-drop-item> </template> </lyte-drop-body> </lyte-drop-box> </template> </lyte-dropdown> <span class=\"lyteVisuallyHidden\" aria-live=\"polite\" id=\"{{headerId1}}\">{{monthHeader1}}</span> </template> <template case=\"drilldown\"> <button aria-label=\"{{lyteUiI18n('lyte.calendar.monthview.drilldown.button')}}\" tabindex=\"0\" class=\"lyteDrillCalHeaderButton\" onclick=\"{{action('switchDrill',event,this,'1')}}\"> <span class=\"lyteCalsCalMonth\">{{lyteUiGetMonthOrYear(monthHeader1,\"M\")}}</span> <span class=\"lyteCalsCalYear\">{{lyteUiGetMonthOrYear(monthHeader1,\"Y\")}}</span> </button> </template> <template default=\"\"> <span aria-live=\"polite\" id=\"{{headerId1}}\">{{monthHeader1}}</span>  </template> </template> </div> <div class=\"lyteDateRPRightNav\"> <span role=\"button\" case=\"true\" class=\"lyteCalNav lyteCaldRgt\" onclick=\"{{action('separatePrevious','M','cal1',event,'next')}}\" onkeydown=\"{{action('nextKey','M',event,'cal1')}}\" tabindex=\"{{navtab}}\" aria-label=\"{{nextMonth}}\"> </span> <template is=\"if\" value=\"{{ltPropYear}}\"><template case=\"true\"><span role=\"button\" class=\"lyteCalNav lyteCalyearNavRgt\" onclick=\"{{action('separatePrevious','Y','cal1',event,'next')}}\" onkeydown=\"{{action('nextKey','Y',event,'cal1')}}\" tabindex=\"{{navtab}}\" aria-label=\"{{nextYear}}\"> </span></template></template> </div> </template> </lyte-calendar> </div> <div class=\"lyteDateRangePickerCol2\"> <lyte-calendar render-calendar=\"{{renderCalendar}}\" on-month-selected=\"{{method('monthSelect','2')}}\" lt-prop=\"{{ltPropCalendar}}\" lt-prop-header-type=\"{{ltPropHeaderType}}\" nav-yield=\"{{navYield2}}\" lt-prop-format=\"{{ltPropFormat}}\" lt-prop-max-date=\"{{ltPropMaxDate}}\" lt-prop-min-date=\"{{ltPropMinDate}}\" lt-prop-fill-rows=\"{{ltPropFillRows}}\" lt-prop-start-week-day=\"{{ltPropStartWeekDay}}\" class=\"dRPCalendar2\" on-viewdate-change=\"{{method('viewDateChange','cal2')}}\" lt-prop-disable-navigation=\"true\" header-id=\"{{lbind(headerId2)}}\" month-dropdown-id=\"{{lbind(monthDropdownId2)}}\" year-dropdown-id=\"{{lbind(yearDropdownId2)}}\" month-header=\"{{lbind(monthHeader2)}}\"> <template is=\"registerYield\" yield-name=\"navigator\"> <div class=\"lyteDateRPLeftNav\"> <template is=\"if\" value=\"{{ltPropYear}}\"><template case=\"true\"><span role=\"button\" case=\"true\" class=\"lyteCalNav lyteCalyearNavLft\" onclick=\"{{action('separatePrevious','Y','cal2',event)}}\" onkeydown=\"{{action('prevKey','Y',event,'cal2')}}\" tabindex=\"{{navtab}}\" aria-label=\"{{previousYear}}\"> </span></template></template> <span role=\"button\" class=\"lyteCalNav lyteCaldLft\" onclick=\"{{action('separatePrevious','M','cal2',event)}}\" onkeydown=\"{{action('prevKey','M',event,'cal2')}}\" tabindex=\"{{navtab}}\" aria-label=\"{{previousMonth}}\"> </span> </div> <div class=\"{{lyteUiDateRPHeaderClass(ltPropHeaderType)}}\"> <template is=\"switch\" value=\"{{ltPropHeaderType}}\"> <template case=\"dropdown\"> <lyte-dropdown lt-prop-selected=\"{{lbind(month2)}}\" on-before-show=\"{{method('addDropdownClass')}}\" on-show=\"{{method('editArrowPosition')}}\" lt-prop-callout=\"true\" class=\"monthDD\" lt-prop-tabindex=\"{{droptab1}}\" on-option-selected=\"{{method('optionSelected','cal2','M')}}\" lt-prop=\"{{ltPropDropdown}}\"> <template is=\"registerYield\" yield-name=\"yield\"> <lyte-drop-box class=\"lyteDateRangepickerDropdown\"> <lyte-drop-body> <template is=\"for\" items=\"{{monthNames}}\" item=\"item\" index=\"index\"> <lyte-drop-item data-value=\"{{item}}\">{{item}}</lyte-drop-item> </template> </lyte-drop-body> </lyte-drop-box> </template> </lyte-dropdown> <lyte-dropdown lt-prop-selected=\"{{lbind(year2)}}\" lt-prop-display-value=\"{{lbind(display2)}}\" on-before-show=\"{{method('addDropdownClass')}}\" on-show=\"{{method('editArrowPosition')}}\" lt-prop-callout=\"true\" class=\"yearDD\" lt-prop-tabindex=\"{{droptab2}}\" on-option-selected=\"{{method('optionSelected','cal2','Y')}}\" lt-prop=\"{{ltPropDropdown}}\"> <template is=\"registerYield\" yield-name=\"yield\"> <lyte-drop-box class=\"lyteDateRangepickerDropdown\"> <lyte-drop-body> <template is=\"for\" items=\"{{years}}\" item=\"item\" index=\"index\"> <lyte-drop-item data-value=\"{{item}}\">{{item}}</lyte-drop-item> </template> </lyte-drop-body> </lyte-drop-box> </template> </lyte-dropdown> <span class=\"lyteVisuallyHidden\" aria-live=\"polite\" id=\"{{headerId2}}\">{{monthHeader2}}</span> </template> <template case=\"drilldown\"> <button aria-label=\"{{lyteUiI18n('lyte.calendar.monthview.drilldown.button')}}\" tabindex=\"0\" class=\"lyteDrillCalHeaderButton\" onclick=\"{{action('switchDrill',event,this,'2')}}\"> <span class=\"lyteCalsCalMonth\">{{lyteUiGetMonthOrYear(monthHeader2,\"M\")}}</span> <span class=\"lyteCalsCalYear\">{{lyteUiGetMonthOrYear(monthHeader2,\"Y\")}}</span> </button> </template> <template default=\"\"> <span aria-live=\"polite\" id=\"{{headerId2}}\">{{monthHeader2}}</span>  </template> </template> </div> <div class=\"lyteDateRPRightNav\"> <span role=\"button\" case=\"true\" class=\"lyteCalNav lyteCaldRgt\" onclick=\"{{action('separatePrevious','M','cal2',event,'next')}}\" onkeydown=\"{{action('nextKey','M',event,'cal2')}}\" tabindex=\"{{navtab}}\" aria-label=\"{{nextMonth}}\"> </span> <template is=\"if\" value=\"{{ltPropYear}}\"><template case=\"true\"><span role=\"button\" class=\"lyteCalNav lyteCalyearNavRgt\" onclick=\"{{action('separatePrevious','Y','cal2',event,'next')}}\" onkeydown=\"{{action('nextKey','Y',event,'cal2')}}\" tabindex=\"{{navtab}}\" aria-label=\"{{nextYear}}\"> </span></template></template> </div> </template> </lyte-calendar> </div> </div> </template></template> </template>",
_dynamicNodes : [{"type":"attr","position":[1]},{"type":"switch","position":[1],"cases":{"continuous":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,1,1]},{"type":"registerYield","position":[1,1,1,1],"dynamicNodes":[{"type":"attr","position":[1,1]},{"type":"if","position":[1,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[0]}]}},"default":{}},{"type":"attr","position":[1,3]},{"type":"attr","position":[3]},{"type":"attr","position":[3,1]},{"type":"switch","position":[3,1],"cases":{"dropdown":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"registerYield","position":[1,1],"dynamicNodes":[{"type":"attr","position":[1,1,1]},{"type":"for","position":[1,1,1],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,0]},{"type":"componentDynamic","position":[1]}]},{"type":"componentDynamic","position":[1,1]},{"type":"componentDynamic","position":[1]}]},{"type":"componentDynamic","position":[1]},{"type":"attr","position":[3]},{"type":"registerYield","position":[3,1],"dynamicNodes":[{"type":"attr","position":[1,1,1]},{"type":"for","position":[1,1,1],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,0]},{"type":"componentDynamic","position":[1]}]},{"type":"componentDynamic","position":[1,1]},{"type":"componentDynamic","position":[1]}]},{"type":"componentDynamic","position":[3]},{"type":"attr","position":[5]},{"type":"text","position":[5,0]}]},"drilldown":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,1,0]},{"type":"text","position":[1,3,0]}]}},"default":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,0]}]}}]},{"type":"componentDynamic","position":[1,1,1]},{"type":"attr","position":[1,3,1]},{"type":"registerYield","position":[1,3,1,1],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,1]},{"type":"switch","position":[1,1],"cases":{"dropdown":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"registerYield","position":[1,1],"dynamicNodes":[{"type":"attr","position":[1,1,1]},{"type":"for","position":[1,1,1],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,0]},{"type":"componentDynamic","position":[1]}]},{"type":"componentDynamic","position":[1,1]},{"type":"componentDynamic","position":[1]}]},{"type":"componentDynamic","position":[1]},{"type":"attr","position":[3]},{"type":"registerYield","position":[3,1],"dynamicNodes":[{"type":"attr","position":[1,1,1]},{"type":"for","position":[1,1,1],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,0]},{"type":"componentDynamic","position":[1]}]},{"type":"componentDynamic","position":[1,1]},{"type":"componentDynamic","position":[1]}]},{"type":"componentDynamic","position":[3]},{"type":"attr","position":[5]},{"type":"text","position":[5,0]}]},"drilldown":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,1,0]},{"type":"text","position":[1,3,0]}]}},"default":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,0]}]}},{"type":"attr","position":[3,1]},{"type":"attr","position":[3,3]},{"type":"if","position":[3,3],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[0]}]}},"default":{}}]},{"type":"componentDynamic","position":[1,3,1]}]},"separate":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,1,1]},{"type":"registerYield","position":[1,1,1,1],"dynamicNodes":[{"type":"attr","position":[1,1]},{"type":"if","position":[1,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[0]}]}},"default":{}},{"type":"attr","position":[1,3]},{"type":"attr","position":[3]},{"type":"attr","position":[3,1]},{"type":"switch","position":[3,1],"cases":{"dropdown":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"registerYield","position":[1,1],"dynamicNodes":[{"type":"attr","position":[1,1,1]},{"type":"for","position":[1,1,1],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,0]},{"type":"componentDynamic","position":[1]}]},{"type":"componentDynamic","position":[1,1]},{"type":"componentDynamic","position":[1]}]},{"type":"componentDynamic","position":[1]},{"type":"attr","position":[3]},{"type":"registerYield","position":[3,1],"dynamicNodes":[{"type":"attr","position":[1,1,1]},{"type":"for","position":[1,1,1],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,0]},{"type":"componentDynamic","position":[1]}]},{"type":"componentDynamic","position":[1,1]},{"type":"componentDynamic","position":[1]}]},{"type":"componentDynamic","position":[3]},{"type":"attr","position":[5]},{"type":"text","position":[5,0]}]},"drilldown":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,1,0]},{"type":"text","position":[1,3,0]}]}},"default":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,0]}]}},{"type":"attr","position":[5,1]},{"type":"attr","position":[5,3]},{"type":"if","position":[5,3],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[0]}]}},"default":{}}]},{"type":"componentDynamic","position":[1,1,1]},{"type":"attr","position":[1,3,1]},{"type":"registerYield","position":[1,3,1,1],"dynamicNodes":[{"type":"attr","position":[1,1]},{"type":"if","position":[1,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[0]}]}},"default":{}},{"type":"attr","position":[1,3]},{"type":"attr","position":[3]},{"type":"attr","position":[3,1]},{"type":"switch","position":[3,1],"cases":{"dropdown":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"registerYield","position":[1,1],"dynamicNodes":[{"type":"attr","position":[1,1,1]},{"type":"for","position":[1,1,1],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,0]},{"type":"componentDynamic","position":[1]}]},{"type":"componentDynamic","position":[1,1]},{"type":"componentDynamic","position":[1]}]},{"type":"componentDynamic","position":[1]},{"type":"attr","position":[3]},{"type":"registerYield","position":[3,1],"dynamicNodes":[{"type":"attr","position":[1,1,1]},{"type":"for","position":[1,1,1],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,0]},{"type":"componentDynamic","position":[1]}]},{"type":"componentDynamic","position":[1,1]},{"type":"componentDynamic","position":[1]}]},{"type":"componentDynamic","position":[3]},{"type":"attr","position":[5]},{"type":"text","position":[5,0]}]},"drilldown":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,1,0]},{"type":"text","position":[1,3,0]}]}},"default":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,0]}]}},{"type":"attr","position":[5,1]},{"type":"attr","position":[5,3]},{"type":"if","position":[5,3],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[0]}]}},"default":{}}]},{"type":"componentDynamic","position":[1,3,1]}]}},"default":{}}],
_observedAttributes :["monthHeader1","monthHeader2","ltPropCurrentDate","ltPropFormat","ltPropMonthHeaderFormat","shortMonthNames","longMonthNames","ltPropStartYear","ltPropEndYear","ltPropStartDate","ltPropEndDate","ltPropDisabledDates","ltPropMinDate","ltPropMaxDate","ltPropSelectionType","ltPropPosition","ltPropHeaderType","ltPropFillRows","ltPropDropdown","ltPropMaxDiff","ltPropActivateNavigation","ltPropNavigation","ltPropTabindex","ltPropDisableCheck","ltPropStartWeekDay","ltPropCalendar","ltPropYear","ltPropAllowOtherMonthSelection","ltPropTransitMonthOnDateSel","ltPropDiffDirection","ltPropLazyRendering","years","dateSelected","selectedDate1","selectedDate2","calViewDate1","calViewDate2","tempDate","monthNames","clickCount","convertedDates","convert","internallyChanged","monthNames1","monthNames2","years1","years2","triggerDidconnect","activeDate","selected","preventKeydown","navtab","droptab1","droptab2","headerId1","monthDropdownId1","yearDropdownId1","headerId2","monthDropdownId2","yearDropdownId2","previousMonth","nextMonth","previousYear","nextYear","navYield1","navYield2","startFill","endFill","renderCalendar","month1","month2","year1","year2","display1","display2"],
_observedAttributesType :["string","string","string","string","string","array","array","number","number","string","string","array","string","string","string","string","string","boolean","string","number","boolean","boolean","string","boolean","number","string","boolean","boolean","boolean","string","boolean","array","boolean","string","string","object","object","string","array","number","array","number","boolean","array","array","array","array","number","string","string","boolean","string","string","string","string","string","string","string","string","string","string","string","string","string","boolean","boolean","object","object","boolean","string","string","string","string","string","string"],

	_lyteUtilFunctions : [ "revertToSelected", "revertToToday"/*, "reset"*/ ],
	data: function () {

		var default_values = _lyteUiUtils.getDefault( 'lyte-daterangepicker' );
		...
		return {
			 ...
			 * @condition ltPropStartDate undefined
			 * @input
			 */
			"ltPropCurrentDate": Lyte.attr("string", { "default": default_values.currentDate || '', input : true }),
			/** 
			 * @typedef {
			 * MM/DD/YYYY |
			 * YYYY/MM/DD |
			...
			*/
			/**
			 * @componentProperty {daterangedateFormat} ltPropFormat
			 * @mandatory
			 * @version 1.0.0
			 * @default MM/DD/YYYY
			 * @format date
			 * @input
			 */
			"ltPropFormat": Lyte.attr("string", { "default": default_values.format || "MM/DD/YYYY", input : true }),
			/**
			 * @typedef {
			 * 'MMMM YYYY' |
			 * 'MMM YYYY' 
			 * } daterangemonthHeaderFormat
			 */

			/**
			 * @componentProperty {daterangemonthHeaderFormat} ltPropMonthHeaderFormat
			 * @version 1.0.0
			 * @default MMM YYYY
			 * @options MMMM YYYY,MMM YYYY
			 * @input
			 */
			"ltPropMonthHeaderFormat": Lyte.attr("string", { "default": default_values.monthheaderFormat || "MMM YYYY", input : true }),
			 ...
			 * @input
			 */
			"ltPropStartYear": Lyte.attr("number", { "default": default_values.startYear || 1900, input : true }),
			 ...
			 * @input
			 */
			"ltPropEndYear": Lyte.attr("number", { "default": default_values.endYear || 2100, input : true }),
			 ...
			 * @input
			 */
			"ltPropDisabledDates": Lyte.attr("array", { "default": default_values.disabledDates || [], input : true }),
			 ...
			 * @input
			 */
			"ltPropMinDate": Lyte.attr("string", { "default": default_values.minDate || "", input : true }),
			 ...
			 * @input
			 */
			"ltPropMaxDate": Lyte.attr("string", { "default": default_values.maxDate || "", input : true }),
			 ...
			 * @input
			 */
			"ltPropSelectionType": Lyte.attr("string", { "default": default_values.selectionType || "continuous", input : true }),
			 ...
			 * @input
			 */
			"ltPropPosition": Lyte.attr("string", { "default": default_values.position || "left", input : true }),

			/**
			 * @componentProperty {default|dropdown} ltPropHeaderType
			 * @version 2.2.16
			 * @default dropdown
			 * @mandatory
			 * @input
			 */
			"ltPropHeaderType": Lyte.attr("string", { "default": default_values.headerType || "dropdown", input : true }),
			 ...
			 * @input
			 */
			"ltPropFillRows": Lyte.attr("boolean", { "default": default_values.fillRows || false, input : true }),

			/**
			 * @typedef {object} daterangeboudary
			 * @property {number} top
			...
			// /**
			//  * @typedef {object} daterangetooltipConfig
			...
			/**
			 * @typedef {object} daterangedropdown
			 * @property {boolean} freeze
			 * @property {up|down|left|right} position=down
			 * @property {boolean} disabled
			 * @property {daterangeboudary} boundary
			 */

			/**
			 * @componentProperty {daterangedropdown} ltPropDropdown
			 * @default {}
			 * @version 3.39.0
			 * @input
			 */
			...
			ltPropMaxDiff : Lyte.attr( 'number', { default : default_values.maxDiff, input : true } ),

			// /**
			//  * @componentProperty {boolean} ltPropActivateNavigation=false
			//  * @condition ltPropNavigation true
			//  * @version 3.46.0
			//  * @input
			//  */
			ltPropActivateNavigation : Lyte.attr( 'boolean', { default : false, input : true } ),
			...
			ltPropTabindex : Lyte.attr( 'string', { default : default_values.tabindex || "2", input : true } ),
			/**
			 ...
			 * @input
			 */
			ltPropDisableCheck : Lyte.attr( 'boolean', { default : default_values.disableCheck || false, input : true } ),
			/**
			 ...
			 * @input
			 */
			ltPropStartWeekDay : Lyte.attr( 'number', { default : default_values.startWeekDay || 1, input : true } ),
			/**
			 * @typedef {object} dateRangeCalendar
			 * @property {array} weekends
			 * @default [0,6]
			 * @property {array} holidays
			 * @default []
			 * @property {boolean} weekNumber=false
			 * @property {boolean} highlightWeekendHolidays=false
			 * @condition ltPropCalendar.holidays =! []
			 * @condition ltPropCalendar.weekends =! []
			 */
			
			/**
			 * @componentProperty {dateRangeCalendar} ltPropCalendar
			 * @default {}
			 * @version 3.109.0
			 * @input
			 */
			ltPropCalendar : Lyte.attr( "string", { default : default_values.calendar || '{}', input : true } ),
			/**
			 ...
			 * @input
			 */
			ltPropYear : Lyte.attr( 'boolean', { default : false, input : true } ),
			/**
			 * @componentProperty {boolean} ltPropAllowOtherMonthSelection
			 * @default false
			 * @version 3.109.0
			 * @input
			 * @condition ltPropFillRows true
			 */
			ltPropAllowOtherMonthSelection : Lyte.attr( "boolean", { default : default_values.allowOtherMonthSelection || false, input : true } ),
			/**
			 * @componentProperty {boolean} ltPropTransitMonthOnDateSel
			 * @default false
			 * @version 3.109.0
			 * @input
			 * @condition ltPropFillRows true
			 * @condition ltPropAllowOtherMonthSelection true
			 */
			ltPropTransitMonthOnDateSel : Lyte.attr( "boolean", { default : default_values.transitMonthOnDateSel || false, input : true } ),

			/**
			 * @componentProperty {forward|backward|both} ltPropDiffDirection
			 * @version 3.111.0
			 * @default forward
			 * @condition ltPropMaxDiff =! undefined
			 * @input
			 */
			ltPropDiffDirection : Lyte.attr( 'string', { default : default_values.diffDirection || "forward", input : true } ),
			...
			navYield1 : Lyte.attr( 'boolean', { default : true } ),
			navYield2 : Lyte.attr( 'boolean', { default : true } ),
			
			startFill : Lyte.attr( "object", { default : { bottom : true, top : true } } ),
			endFill : Lyte.attr( "object", { default : { bottom : true, top : true } } ),

			renderCalendar : Lyte.attr( 'boolean', { default : false } ),
			month1 : Lyte.attr( 'string', { default : "" } ),
			month2 : Lyte.attr( 'string', { default : "" } ),
			year1 : Lyte.attr( 'string', { default : "" } ),
			year2 : Lyte.attr( 'string', { default : "" } ),

			display1 : Lyte.attr( 'string', { default : "" } ),
			display2 : Lyte.attr( 'string', { default : "" } )
		}
	},
	...
	revertToToday: function ( __date ) {
		...
		if (this.getData('ltPropSelectionType') == "continuous") {
			...
			if (selected) {
				var selectedDate = $L.moment(selected.dataset.date, this.getData('ltPropFormat').toUpperCase()).getDObj();
			...
			if (selected.length > 0) {
				for (var i = 0; i < selected.length; i++) {
					var selectedDate = $L.moment(selected[i].dataset.date, this.getData('ltPropFormat').toUpperCase()).getDObj();

					if (selectedDate.getMonth() === today.getMonth() && selectedDate.getDate() === today.getDate() && selectedDate.getFullYear() === today.getFullYear()) {
						selected[i].classList.remove('lyteCalSel');
	...
	update_selected : function( node, prop, value ){
		var __index = node.className.match( /drpcalendar(\d)/i )[ 1 ];
		this.setData( prop + __index, value );

		if( prop == "year" && this.data.years.indexOf( value ) == -1 ){
			this.setData( "display" + __index, value );
		}
	},
	...
	setCalendarHeader: function (cal, comp, viewDate) {
		...
		if (this.getData('ltPropSelectionType') == "continuous") {
			if (this.getData('ltPropHeaderType') == "dropdown") {
				this.update_selected( comp.$node, "month", this.getData("monthNames")[mm] );
				this.update_selected( comp.$node, "year", yy );
		...
		if (this.getData('ltPropSelectionType') == "separate") {
			if (this.getData('ltPropHeaderType') == "dropdown") {
				if (cal == "cal1") {
					this.update_selected( comp.$node, "month", this.getData("monthNames1")[mm] );
					// comp.$node.querySelector('.monthDD').ltProp("selected", this.getData("monthNames1")[mm]);
				}
				if (cal == "cal2") {
					this.update_selected( comp.$node, "month", this.getData("monthNames2")[mm] );
	...
	get_today : function( __today ){
		var __data = this.data,
		current_date = __data.ltPropCurrentDate,
		format = __data.ltPropFormat;

		if( current_date ){
			return this.stringToDate( current_date, format );
		}
		...
		start_year = __data.ltPropStartYear,
		end_year = __data.ltPropEndYear,
		abs_min = this.moment( start_year.toString().padStart( 4, '0' ) + "-01-01", 'YYYY-MM-DD' ).toDate();
		abs_max = this.moment( end_year.toString().padStart( 4, '0' ) + "-12-01", 'YYYY-MM-DD' ).toDate();
		
		if( min_date ){
			var min_obj = this.moment( min_date, format ).toDate();
			if( min_obj.getTime() > abs_min.getTime() ){
				abs_min = min_obj;
			}
		}

		if( max_date ){
			var max_obj = this.moment( max_date, format ).toDate();
			if( max_obj.getTime() < abs_max.getTime() ){
				abs_max = max_obj;
			}
		}

		if( __today.getTime() < abs_min.getTime() ){
			__today = abs_min;
		}
		
		if( __today.getTime() > abs_max.getTime() ){
			__today = abs_max;
		}
	...
	didConnectFunc: function ( arg ) {
		...
		var is_min_max_change = !( arg && /ltprop(min|max)date/i.test( arg.item ) );
		...
		var today = this.get_today( currentDate );
		if (this.getData('ltPropSelectionType') == "continuous" && this.getData('ltPropStartDate') /*&& this.getData('ltPropEndDate')*/) {
		...
		if (this.getData('ltPropSelectionType') == "continuous") {
			...
			this.data.renderCalendar && this.validateNavigationAndDropdown();
			is_min_max_change && this.setTodayClass();
		}
		...
		if( !arg && !this.data.renderCalendar ){
			this.setData( 'renderCalendar', true );
			this.disablecheck();

			if( this.data.ltPropSelectionType == "separate" ){
				this.validateNavigationAndDropdown();
			}
		}
	...
	changeStartAndEndDate: function () {
		...
		if (this.getData('ltPropSelectionType') == "separate") {
			...
			if (!this.getData('internallyChanged')) {
				...
				!this.__ignoremin && this.checkAndRemoveAllSelectedClasses();
			...
			if(this.getData('ltPropSelectionType') == 'continuous'){
				if(this.getData('ltPropStartYear')){
					...
					if (date.getMonth() == 0 && date.getFullYear() == this.getData('ltPropStartYear')) {
						...
						$L( node ).find( '.lyteCalNav' ).attr( 'tabindex', '-1' );
					}
					else {
						node.classList.remove('lyteDateRPNavDisabled');
						$L( node ).find( '.lyteCalNav' ).attr( 'tabindex', this.data.navtab );
					}
				}
	...
	setMonthAndYear: function (cal, date, view) {
		...
		if (this.getData('ltPropHeaderType') == "dropdown") {
			this.update_selected( cal, "month", this.getData("monthNames")[date.mm] );
			this.update_selected( cal, "year", date.yy );
	...
	executeSelected: function (event) {
		...
		/**
		 * This method is executed when the user selects a range of dates in the daterangepicker.
		 ...
		 * @param { object } daterangepickerComponent
		 */
	...
	callOnNavigate : function(event,fromMonths,toMonths,comp,cal){
		...
		this.setTodayClass();
		/**
		 * This method is called after changing the view.
		 * @method onNavigation
		 * @author ponkarthikeyan.t@zohocorp.com
		 * @version 1.0.0
		 * @param { object } event
	...
	constructDateString : function (mm,dd,yy) {
		...
		var dateObj = new Date( yy.toString().padStart( 4, '0' ) + "-" + mm.toString().padStart( 2, '0' ) + "-" + dd.toString().padStart( 2, '0' ) );
	...
	start_obs : function( arg ){	
		...
		if( this.getMethods( cb ) ){
		    /**
			 * This method is called when the start date is changed.
	...
	setup_maxdiff : function( arg ){
		...
		diff_dir = data.ltPropDiffDirection,
		min_date = data.ltPropMinDate,
		is_both_backward = /both|backward/i.test( diff_dir );

		if( !value || ( !is_both_backward && min_date == value ) || ( is_both_backward && min_date == this.moment( value, format ).subtract( maxDiff, 'day' ).format( format ) ) ){
			return;
		}

		if( is_both_backward && data.selectedDate1 && data.selectedDate2 ){
			return;
		}
		...
		if( is_both_backward ){
			obj.ltPropMinDate = this.get_crct_value( this.moment( value, format ).subtract( maxDiff, 'day' ), "Min" ).format( format );
		} else {
			obj.ltPropMinDate = value;
		}

		if( /both|forward/i.test( diff_dir ) ){
			__max = this.get_crct_value( this.moment( value, format ).add( maxDiff, 'day' ), "Max" ).format( format );
		} else {
			__max = value;
		}
		...
		var __prev = data.internallyChanged;
		this.setData( obj );
		data.internallyChanged = __prev;
		...
		this.setData( 'ltPropMaxDate', __max );

		var fn = function( ns, is_first ){
			 var __node = this[ "__" + ns ];
			 if( __node ){
				var __date = __node.getAttribute( 'data-date' );
				this[ "__" + ns ] = $L( this.$node.querySelector( 'div[data-date="' + __date + '"]:not(.lyteCalDiffMonth)' ) ).removeClass( 'lyteCalToday' ).get( 0 ) || __node;
				if( is_first ){
					this.__frm_init = true;
					this.setData( "seletedDate1", __date );
					delete this.__frm_init;
				}
			 }
		}.bind( this );
	...
	get_crct_value : function( __max, ns ){
		var data = this.data,
		max_date = data[ "ltProp" + ns + "Date" ];

		if( max_date ){
			var max_moment = this.moment( max_date, data.ltPropFormat ),
			res = __max.fromNow( max_moment ).past;
	...
	switch_view_date : function( cal, view_date, fact ){
				...
				if (cal == "cal1") {
					...
					if (this.getData('ltPropEndDate')) {
						...
						if (mm > date.getMonth() && yy >= date.getFullYear()) {
							if (opt == 'M') {
								this.update_selected( calendar, "month", this.getData("monthNames")[calendar.getData('viewDate').getMonth()] );
								// calendar.querySelector('.monthDD').ltProp("selected", this.getData("monthNames")[calendar.getData('viewDate').getMonth()]);
							}
							if (opt == 'Y') {
								this.update_selected( calendar, "year", calendar.getData('viewDate').getFullYear() );
	...
	set_navigationNode : function( to_check ){
		...
		if( !final && !to_check ){
			var __today = this.moment().format( format );
		...
		var value_to_be = this.moment( final ).format( format );
	...
	active_obs : function( __new, __old, return_dom ){
		...
		__old && $L( query + __old + '"]:not(.lyteCalDiffMonth)', $node ).eq( __index ).removeClass( cls_name ).attr( tabindex, '-1' );
		
		var dom = $L( query + __new + '"]:not(.lyteCalDiffMonth)', $node ).eq( __index );
		...
		if( call_selection ){
			if( is_continuous ){
				...
				if( this.data.selected == "1" ){
					...
					this.active_obs( active, active );
					this.setData( 'activeDate', active );
				} else {
	...
	key_enter : function( evt ){
		...
		if( type == "continuous" ){
			...
			if( __data.selected == '1' && start_date ){
				delete this.__dateNode2;
				this.setData({
					ltPropEndDate : "",
					selectedDate2 : ""
				});
	...
	disablecheck : function(){
		...
		fn2 = function( bool, elem ){
			if( bool ){
				elem.addClass( cls_name ).attr( __attr, 'true' ).find( '.lyteCalNav' ).attr( "tabindex", "-1" );
			} else {
				elem.removeClass( cls_name ).removeAttr( __attr ).find( '.lyteCalNav' ).attr( "tabindex", this.data.navtab );
			}
		}.bind( this ),
		...
		if( min_date ){
			...
			var common_query = ' .lyteDateRPLeftNav';
			fn2( false, $L( cal_query + 1 + common_query, $node ) );
			if( is_separate ){
				fn2( false, $L( cal_query + 2 + common_query, $node ) );
			}
		}
