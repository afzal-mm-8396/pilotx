 ...
 */
/**
 * This callback is fired when the video started playing.
 * @method onProgress
 * @author vaisag.r@zohocorp.com
 * @param { object } videoElement
 * @param { number } currentTime
 * @param { object } event
 * @param { object } lyteVideoElement
 */

/**
 * This callback is fired when the video is paused.
 * @method onPause
 * @author vaisag.r@zohocorp.com
 * @param { object } videoElement
 * @param { object } event
...
/**
 * This callback is fired when the video is played.
 * @method onPlay
 * @author vaisag.r@zohocorp.com
 * @param { object } videoElement
 * @param { object } event
...
/**
 * This callback is fired when a menu item is selected.If returned false, selected option won't apply.
 * @method onMenuClick
 * @author vaisag.r@zohocorp.com
...
/**
 * This callback is fired before fetching the video file when prefetch enabled,returing false wont fetch that file.
...
/**
 * This callback is fired before after fetching the video file when prefetch enabled.
...
/**
 * This callback is fired if prefetch is failed.
...
/**
 * This callback is fired after the video ended.
 * @method onEnded
 * @author vaisag.r@zohocorp.com
 * @param { object } lyteVideoElement
 */
...
_template:"<template tag-name=\"lyte-video\" lyte-video=\"\"> <div tabindex=\"0\" aria-valuetext=\"video\" class=\"lyteVideoContainer lyteVideoControlsShow\" onpointerenter=\"{{action('mouseEnter',event,this)}}\" onpointerleave=\"{{action('mouseLeave',this)}}\" onpointermove=\"{{action('mouseMove',event,this)}}\" onkeydown=\"{{action('keyDown',event)}}\"> <template is=\"if\" value=\"{{ltPropControls}}\"><template case=\"true\"> <div class=\"lyteVideoAnimateWrapper lyteVideoAnimateBackward\"> <span class=\"lyteVideoAnimateBackArrow lyteVideoAnimateArrow3\"></span> <span class=\"lyteVideoAnimateBackArrow lyteVideoAnimateArrow2\"></span> <span class=\"lyteVideoAnimateBackArrow lyteVideoAnimateArrow1\"></span> </div> <div class=\"lyteVideoAnimateWrapper lyteVideoAnimatePlay\"> <span class=\"lyteVideoAnimatePauseIcon\"></span> </div> <div class=\"lyteVideoAnimateWrapper lyteVideoAnimateForward\"> <span class=\"lyteVideoAnimateForwardArrow lyteVideoAnimateArrow1\"></span> <span class=\"lyteVideoAnimateForwardArrow lyteVideoAnimateArrow2\"></span> <span class=\"lyteVideoAnimateForwardArrow lyteVideoAnimateArrow3\"></span> </div> </template></template> <template is=\"if\" value=\"{{expHandlers(expHandlers(renderPrefetch,'&amp;&amp;',expHandlers(prefetchLoading,'==',&quot;lyteVideoPrefetchLoading&quot;)),'||',expHandlers(expHandlers(renderPrefetch,'!'),'&amp;&amp;',expHandlers(canPlay,'!')))}}\"><template case=\"true\"> <div class=\"lyteVideoPrefetchLoadingContainer {{if(initialLoad,'lyteVideoPrefetchInitialLoadingContainer','')}}\"> <div class=\"lyteCircleLoader\"> <span class=\"lyteCircleInnerLoader\"></span> </div> </div> </template></template> <canvas class=\"lyteVideoPoster {{if(hidePoster,'lyteVideoPosterHide','')}} {{if(renderPrefetch,'lyteVideoPosterBeforeVideoLoad','')}}\" onclick=\"{{action('clickOnVideo')}}\"></canvas> <template is=\"if\" value=\"{{renderPrefetch}}\"><template case=\"true\"> <template is=\"if\" value=\"{{ltPropControls}}\"><template case=\"true\"> <div class=\"lyteVideoControls hoverControls lyteVideoPrefetchControlsContainer\"> <div class=\"lyteVideoProgressWrapper\"> <div class=\"lyteVideoProgressBar\"> <span class=\"lyteVideoProgressHandler\" style=\"left: 0;\"></span> </div> <div class=\"lyteVideoTimer\"> <time class=\"duration\">{{currentDuration}}</time> <span class=\"lyteVideoTimerSeparator\">/</span> <time>{{duration}}</time> </div> </div> <div class=\"lyteVideoIconsWrap\"> <template is=\"if\" value=\"{{expHandlers(ltPropOptions.play,'!=',false)}}\"><template case=\"true\"><div class=\"lyteVideoPlayPauseIconWrap\"> <span class=\"lyteVideoIcons lyteVideoPlayIcon lyteVideoPaused\" lt-prop-title=\"{{videoStatus}}\" onclick=\"{{action('prefetch',this)}}\"></span> </div></template></template> <template is=\"if\" value=\"{{expHandlers(ltPropOptions.backward,'!=',false)}}\"><template case=\"true\"><div class=\"lyteVideoRewind\"> <span class=\"lyteVideoIcons lyteVideoRewindIcon {{backwardStatus}}\" lt-prop-title=\"Play the video to enable controls\"></span> </div></template></template> <template is=\"if\" value=\"{{expHandlers(ltPropOptions.forward,'!=',false)}}\"><template case=\"true\"><div class=\"lyteVideoForward\"> <span class=\"lyteVideoIcons lyteVideoForwardIcon {{forwardStatus}}\" lt-prop-title=\"Play the video to enable controls\"></span> </div></template></template> <template is=\"if\" value=\"{{expHandlers(ltPropOptions.volume,'!=',false)}}\"><template case=\"true\"><div class=\"lyteVideoVolumeControls\"> <span class=\"lyteVideoVolumeIcon {{if(muted,'lyteVideoMuted','')}} {{if(lowVolume,'lyteVideoLow','')}}\" lt-prop-title=\"{{volumeStatus}}\" onclick=\"{{action('mute',this)}}\"></span> <div class=\"lyteVideoVolumeSlider\"> <lyte-multislider lt-prop-css-direction=\"ltr\" lt-prop-max=\"1\" lt-prop-yield=\"true\" lt-prop-handler=\"lyteCircle\" lt-prop-value=\"{{sliderData}}\" on-change=\"{{method('setVolume')}}\"></lyte-multislider> </div> </div></template></template> <div class=\"lyteVideoRightIcons\"> <template is=\"if\" value=\"{{expHandlers(ltPropOptions.settings,'!=',false)}}\"><template case=\"true\"><div class=\"lyteVideoSettings\"> <span class=\"lyteVideoIcons lyteVideoSettingsIcon\" lt-prop-title=\"Play the video to enable controls\"></span> </div></template></template> <template is=\"if\" value=\"{{isNotFirefox}}\"><template case=\"true\"> <template is=\"if\" value=\"{{expHandlers(ltPropOptions.pip,'!=',false)}}\"><template case=\"true\"><div class=\"lyteVideoPip\"> <span class=\"lyteVideoIcons lyteVideoPipIcon\" lt-prop-title=\"Play the video to enable controls\"></span> </div></template></template> </template></template> <template is=\"if\" value=\"{{expHandlers(ltPropOptions.fullScreen,'!=',false)}}\"><template case=\"true\"><div class=\"lyteVideoFullScreenControl\"> <span class=\"lyteVideoIcons lyteVideoFullScreen\" lt-prop-title=\"Play the video to enable controls\"></span> </div></template></template> </div> </div> </div> </template></template> </template><template case=\"false\"> <template is=\"if\" value=\"{{ltPropMiniMode}}\"><template case=\"true\"> <lyte-pip lt-prop-pip-mode=\"{{miniMode}}\" lt-prop-use-browser-api=\"false\" lt-prop-resize=\"{{miniModeOptions.resize}}\" lt-prop-draggable=\"{{miniModeOptions.draggable}}\" lt-prop-resize-max-width=\"{{miniModeOptions.resizeMaxWidth}}\" lt-prop-resize-min-width=\"{{miniModeOptions.resizeMinWidth}}\" lt-prop-resize-max-height=\"{{miniModeOptions.resizeMaxHeight}}\" lt-prop-resize-min-height=\"{{miniModeOptions.resizeMinHeight}}\" lt-prop-header-yield=\"{{miniModeOptions.headerYield}}\" lt-prop-footer-yield=\"{{miniModeOptions.footerYield}}\" lt-prop-pip-window-width=\"{{miniModeOptions.miniWindowWidth}}\" lt-prop-pip-window-height=\"{{miniModeOptions.miniWindowHeight}}\"> <template is=\"registerYield\" yield-name=\"header\"> <lyte-yield yield-name=\"header\"></lyte-yield> </template> <template is=\"registerYield\" yield-name=\"video\"> <div class=\"lyteVideoMiniContainer\" onpointerenter=\"{{action('mouseEnter',event,this)}}\" onpointerleave=\"{{action('mouseLeave',event,this)}}\" onpointermove=\"{{action('mouseMove',event,this)}}\"> <div class=\"lytePipFullScreenIconContainer\" onclick=\"{{action('toggleMiniMode')}}\"> <div class=\"lytePipFullScreenIcon\"></div> </div> <div class=\"lytePipCloseIconContainer\" onclick=\"{{action('toggleMiniMode',true)}}\"> <div class=\"lytePipCloseIcon\"></div> </div> </div> </template> <template is=\"registerYield\" yield-name=\"footer\"> <lyte-yield yield-name=\"footer\"></lyte-yield> </template> </lyte-pip> </template></template> <video class=\"lyteVideo\" onvolumechange=\"{{action('changeVolume',event)}}\" preload=\"{{ltPropPreLoad}}\" ontimeupdate=\"{{action('update',event)}}\" onloadeddata=\"{{action('progress',event)}}\" onprogress=\"{{action('progress',event)}}\" onloadedmetadata=\"{{action('meta',event)}}\" onpause=\"{{action('pause',event)}}\" onplay=\"{{action('play',event)}}\" onclick=\"{{action('clickOnVideo')}}\" ondblclick=\"{{action('toggleFullScreen')}}\" oncanplay=\"{{action('onCanPlay')}}\" onwaiting=\"{{action('onWaiting',false)}}\" onplaying=\"{{action('onWaiting',true)}}\"> <source src=\"{{ltPropSource[0].src}}\" type=\"{{ltPropSource[0].type}}\" label=\"{{ltPropSource[0].label}}\" size=\"{{ltPropSource[0].size}}\"> <template is=\"if\" value=\"{{ltPropTracks}}\"><template case=\"true\"> <track> </template></template> </video> <template is=\"if\" value=\"{{subtitles}}\"><template case=\"true\"> <div class=\"lyteVideoSubtitleWrapper\"> <p class=\"lyteVideoSubtitle\">{{subText}}</p> </div> </template></template> <template is=\"if\" value=\"{{ltPropControls}}\"><template case=\"true\"> <div class=\"lyteVideoControls hoverControls\"> <div class=\"lyteVideoProgressWrapper\"> <div class=\"lyteVideoProgressBar\" role=\"slider\" aria-label=\"Seek Slider\" aria-valuemin=\"0\" aria-valuemax=\"{{durationSec}}\" aria-valuenow=\"{{elapsedTime}}\" aria-valuetext=\"\" tabindex=\"0\" onclick=\"{{action('progressClick',event)}}\" onmousemove=\"{{action('updateToolTip',event)}}\"> <template is=\"if\" value=\"{{expHandlers(miniMode,'!')}}\"><template case=\"true\"><div class=\"lyteVideoToolTip\"> <div> <p class=\"lyteVideoTooltipChapterName\">{{toolTip.name}}</p> <p class=\"lyteVideoTooltipCurrentTime\">{{toolTip.time}}</p> </div> </div></template></template> <template is=\"if\" value=\"{{chaptersData}}\"><template case=\"true\"> <div class=\"lyteVideoChapterWrapper\"> <template is=\"for\" items=\"{{chaptersData}}\" item=\"item\" index=\"index\"> <div class=\"lyteVideoChapter\" data-start=\"{{item.startTime}}\" data-end=\"{{item.endTime}}\" data-label=\"{{item.title}}\" style=\"width: {{item.width}}%;\"> <span class=\"lyteVideoProgressed\" style=\"width: {{item.time}}%;\"></span> <span class=\"lyteVideoProgressLoad\" style=\"width : {{item.loadedTime}}%\"></span> </div> </template> </div> </template><template case=\"false\"> <span class=\"lyteVideoProgressed\" style=\"width: {{elapsedTime}}%;\"></span> <span class=\"lyteVideoProgressLoad\" style=\"width : {{loadedTime}}%\"></span> </template></template> <span class=\"lyteVideoProgressHandler\" ontouchstart=\"{{action('progressMouseDown',event)}}\" onmousedown=\"{{action('progressMouseDown',event)}}\" style=\"left: 0;\"></span> </div> <div class=\"lyteVideoTimer\"> <time class=\"duration\">{{currentDuration}}</time> <span class=\"lyteVideoTimerSeparator\">/</span> <time>{{duration}}</time> </div> </div> <div class=\"lyteVideoIconsWrap\"> <template is=\"if\" value=\"{{expHandlers(ltPropOptions.play,'!=',false)}}\"><template case=\"true\"><div tabindex=\"0\" aria-keyshortcuts=\"k\" aria-label=\"{{videoStatus}} keyboard shortcut k\" class=\"lyteVideoPlayPauseIconWrap\" onclick=\"{{action('togglePlayPause',this)}}\"> <span class=\"lyteVideoIcons lyteVideoPlayIcon lyteVideoPaused\" lt-prop-title=\"{{videoStatus}} (k)\"></span> </div></template></template> <template is=\"if\" value=\"{{expHandlers(ltPropOptions.backward,'!=',false)}}\"><template case=\"true\"><div tabindex=\"0\" aria-label=\"{{lyteUiI18n('lyte.video.skip.backward')}}\" class=\"lyteVideoRewind\" onclick=\"{{action('skipVideo','rewind')}}\"> <span class=\"lyteVideoIcons lyteVideoRewindIcon {{backwardStatus}}\" lt-prop-title=\"{{lyteUiI18n('lyte.video.skip.backward')}}\"></span> </div></template></template> <template is=\"if\" value=\"{{expHandlers(ltPropOptions.forward,'!=',false)}}\"><template case=\"true\"><div tabindex=\"0\" aria-label=\"{{lyteUiI18n('lyte.video.skip.forward')}}\" class=\"lyteVideoForward\" onclick=\"{{action('skipVideo','forward')}}\"> <span class=\"lyteVideoIcons lyteVideoForwardIcon {{forwardStatus}}\" lt-prop-title=\"{{lyteUiI18n('lyte.video.skip.forward')}}\"></span> </div></template></template> <template is=\"if\" value=\"{{expHandlers(ltPropOptions.volume,'!=',false)}}\"><template case=\"true\"><div class=\"lyteVideoVolumeControls\"> <span tabindex=\"0\" aria-label=\"{{volumeStatus}} keyboard shortcut m\" aria-keyshortcuts=\"m\" class=\"lyteVideoVolumeIcon {{if(muted,'lyteVideoMuted','')}} {{if(lowVolume,'lyteVideoLow','')}}\" lt-prop-title=\"{{volumeStatus}} (m)\" onclick=\"{{action('mute',this)}}\"></span> <div class=\"lyteVideoVolumeSlider\"> <lyte-multislider lt-prop-aria=\"true\" lt-prop-css-direction=\"ltr\" lt-prop-max=\"1\" lt-prop-yield=\"true\" lt-prop-handler=\"lyteCircle\" lt-prop-value=\"{{sliderData}}\" on-change=\"{{method('setVolume')}}\" lt-prop-tabindex=\"-1\"></lyte-multislider> </div> </div></template></template> <div class=\"lyteVideoRightIcons\"> <template is=\"if\" value=\"{{expHandlers(ltPropOptions.settings,'!=',false)}}\"><template case=\"true\"><div tabindex=\"0\" aria-label=\"{{lyteUiI18n('lyte.video.settings')}}\" class=\"lyteVideoSettings\" onclick=\"{{action('toggleSettings',event)}}\"> <span class=\"lyteVideoIcons lyteVideoSettingsIcon\" lt-prop-title=\"{{lyteUiI18n('lyte.video.settings')}}\"></span> </div></template></template> <template is=\"if\" value=\"{{expHandlers(ltPropOptions.settings,'!=',false)}}\"><template case=\"true\"><div role=\"menu\" class=\"lyteVideoSettingsWrapper lyteVideoSettingsItemHover lyteVideoMenuHide\" onmouseover=\"{{action('mouseOver')}}\"> <template is=\"if\" value=\"{{subMenuOpened}}\"><template case=\"true\"> <div data-value=\"back\" role=\"menuitem\" tabindex=\"0\" class=\"lyteVideoSettingsDropdownHead\" onclick=\"{{action('settingsMenuClick',this)}}\"> <div class=\"lyteVideoSettingsBackIcon\"></div> <span class=\"lyteVideoSettingsLabel\">{{lyteUiI18n(lyteUiConcat('lyte.video.menu.',selectedOption))}}</span> </div> </template></template> <template is=\"switch\" value=\"{{selectedOption}}\"><template case=\"playBackSpeed\"><template is=\"for\" items=\"{{speedData}}\" item=\"item\" index=\"index\"> <div tabindex=\"0\" role=\"menuitem\" aria-label=\"{{item.label}}\" data-value=\"{{item.label}}\" class=\"lyteVideoSettingDropItem lyteVideoPl-40 {{lyteUiSetSelectedClass(item.label,ltPropPlayRate)}}\" onclick=\"{{action('settingsMenuClick',this)}}\"> <span class=\"lyteVideoSettingsLabel\">{{item.label}} </span> </div> </template></template><template case=\"qualityOption\"> <div tabindex=\"0\" role=\"menuitem\" aria-label=\"{{lyteUiI18n('lyte.video.menu.qualityOption.auto')}}\" data-value=\"auto\" class=\"lyteVideoSettingDropItem lyteVideoPl-40 {{lyteUiSetSelectedClass('auto',ltPropQuality)}}\" onclick=\"{{action('settingsMenuClick',this)}}\"> <span class=\"lyteVideoSettingsLabel\">{{lyteUiI18n(\"lyte.video.menu.qualityOption.auto\")}}</span> </div> <template is=\"for\" items=\"{{ltPropSource}}\" item=\"item\" index=\"index\"> <template is=\"if\" value=\"{{item.size}}\"><template case=\"true\"><div tabindex=\"0\" role=\"menuitem\" aria-label=\"{{item.size}}\" data-value=\"{{item.size}}\" class=\"lyteVideoSettingDropItem lyteVideoPl-40 {{lyteUiSetSelectedClass(item.size,ltPropQuality)}}\" onclick=\"{{action('settingsMenuClick',this)}}\"> <span class=\"lyteVideoSettingsLabel\">{{item.size}} </span> </div></template></template> </template></template><template case=\"subtitles\"> <div tabindex=\"0\" role=\"menuitem\" aria-label=\"{{lyteUiI18n('lyte.video.menu.subtitles.off')}}\" data-value=\"off\" class=\"lyteVideoSettingDropItem lyteVideoPl-40 {{lyteUiSetSelectedClass('off',ltPropCaption)}}\" onclick=\"{{action('settingsMenuClick',this)}}\"> <span class=\"lyteVideoSettingsLabel\">{{lyteUiI18n(\"lyte.video.menu.subtitles.off\")}}</span> </div> <template is=\"for\" items=\"{{ltPropTracks}}\" item=\"item\" index=\"index\"> <div tabindex=\"0\" role=\"menuitem\" aria-label=\"item.label\" data-value=\"{{item.label}}\" class=\"lyteVideoSettingDropItem lyteVideoPl-40 {{lyteUiSetSelectedClass(item.label,ltPropCaption)}}\" onclick=\"{{action('settingsMenuClick',this)}}\"> <span class=\"lyteVideoSettingsLabel\">{{item.label}} </span> </div> </template></template><template default=\"\"> <div tabindex=\"0\" role=\"menuitem\" aria-haspopup=\"true\" aria-label=\"{{lyteUiI18n('lyte.video.menu.subtitles')}}\" data-value=\"subtitles\" class=\"lyteVideoSettingsItem \" onclick=\"{{action('settingsMenuClick',this)}}\"> <span class=\"lyteVideoSettingsLabel\">{{lyteUiI18n(\"lyte.video.menu.subtitles\")}} </span> <span class=\"lyteVideoSettingsKey\">{{getQualityI18n(ltPropCaption)}}</span> </div> <div tabindex=\"0\" role=\"menuitem\" aria-haspopup=\"true\" aria-label=\"{{lyteUiI18n('lyte.video.menu.playBackSpeed')}}\" data-value=\"playBackSpeed\" class=\"lyteVideoSettingsItem\" onclick=\"{{action('settingsMenuClick',this)}}\"> <span class=\"lyteVideoSettingsLabel\">{{lyteUiI18n(\"lyte.video.menu.playBackSpeed\")}} </span> <span class=\"lyteVideoSettingsKey\">{{ltPropPlayRate}}</span> </div> <div tabindex=\"0\" role=\"menuitem\" aria-haspopup=\"true\" aria-label=\"{{lyteUiI18n('lyte.video.menu.qualityOption')}}\" data-value=\"qualityOption\" class=\"lyteVideoSettingsItem\" onclick=\"{{action('settingsMenuClick',this)}}\"> <span class=\"lyteVideoSettingsLabel\">{{lyteUiI18n(\"lyte.video.menu.qualityOption\")}} </span> <span class=\"lyteVideoSettingsKey\">{{getQualityI18n(ltPropQuality)}}</span> </div> </template></template> </div></template></template> <template is=\"if\" value=\"{{ltPropMiniMode}}\"><template case=\"true\"><div tabindex=\"0\" aria-label=\"{{lyteUiI18n('lyte.video.mode.miniMode')}}\" class=\"lyteVideoPip\" onclick=\"{{action('toggleMiniMode')}}\"> <span class=\"lyteVideoIcons lyteVideoPipIcon\" lt-prop-title=\"{{lyteUiI18n('lyte.video.mode.miniMode')}}\"></span> </div></template></template> <template is=\"if\" value=\"{{isNotFirefox}}\"><template case=\"true\"> <template is=\"if\" value=\"{{expHandlers(ltPropOptions.pip,'!=',false)}}\"><template case=\"true\"><div tabindex=\"0\" aria-label=\"{{lyteUiI18n('lyte.video.mode.pip')}}\" class=\"lyteVideoPip\" onclick=\"{{action('togglePip')}}\"> <span class=\"lyteVideoIcons lyteVideoPipIcon\" lt-prop-title=\"{{lyteUiI18n('lyte.video.mode.pip')}}\"></span> </div></template></template> </template></template> <template is=\"if\" value=\"{{expHandlers(ltPropOptions.fullScreen,'!=',false)}}\"><template case=\"true\"><div tabindex=\"0\" aria-keyshortcuts=\"f\" aria-label=\"{{lyteUiI18n('lyte.video.mode.fullScreen')}} keyboard shortcut f\" class=\"lyteVideoFullScreenControl\" onclick=\"{{action('toggleFullScreen',this)}}\"> <span class=\"lyteVideoIcons lyteVideoFullScreen\" lt-prop-title=\"{{lyteUiI18n('lyte.video.mode.fullScreen')}} (f)\"></span> </div></template></template> </div> </div> </div> </template></template> </template></template> </div> </template>",
_dynamicNodes : [{"type":"attr","position":[1]},{"type":"attr","position":[1,1]},{"type":"if","position":[1,1],"cases":{"true":{"dynamicNodes":[]}},"default":{}},{"type":"attr","position":[1,3]},{"type":"if","position":[1,3],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]}]}},"default":{}},{"type":"attr","position":[1,5]},{"type":"attr","position":[1,7]},{"type":"if","position":[1,7],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[{"type":"text","position":[1,1,3,1,0]},{"type":"text","position":[1,1,3,5,0]},{"type":"attr","position":[1,3,1]},{"type":"if","position":[1,3,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[0,1]}]}},"default":{}},{"type":"attr","position":[1,3,3]},{"type":"if","position":[1,3,3],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[0,1]}]}},"default":{}},{"type":"attr","position":[1,3,5]},{"type":"if","position":[1,3,5],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[0,1]}]}},"default":{}},{"type":"attr","position":[1,3,7]},{"type":"if","position":[1,3,7],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[0,1]},{"type":"attr","position":[0,3,1]},{"type":"componentDynamic","position":[0,3,1]}]}},"default":{}},{"type":"attr","position":[1,3,9,1]},{"type":"if","position":[1,3,9,1],"cases":{"true":{"dynamicNodes":[]}},"default":{}},{"type":"attr","position":[1,3,9,3]},{"type":"if","position":[1,3,9,3],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[]}},"default":{}}]}},"default":{}},{"type":"attr","position":[1,3,9,5]},{"type":"if","position":[1,3,9,5],"cases":{"true":{"dynamicNodes":[]}},"default":{}}]}},"default":{}}]},"false":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"registerYield","position":[1,1],"dynamicNodes":[{"type":"insertYield","position":[1]}]},{"type":"registerYield","position":[1,3],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,1]},{"type":"attr","position":[1,3]}]},{"type":"registerYield","position":[1,5],"dynamicNodes":[{"type":"insertYield","position":[1]}]},{"type":"componentDynamic","position":[1]}]}},"default":{}},{"type":"attr","position":[3]},{"type":"attr","position":[3,1]},{"type":"attr","position":[3,3]},{"type":"if","position":[3,3],"cases":{"true":{"dynamicNodes":[]}},"default":{}},{"type":"attr","position":[5]},{"type":"if","position":[5],"cases":{"true":{"dynamicNodes":[{"type":"text","position":[1,1,0]}]}},"default":{}},{"type":"attr","position":[7]},{"type":"if","position":[7],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1,1,1]},{"type":"attr","position":[1,1,1,1]},{"type":"if","position":[1,1,1,1],"cases":{"true":{"dynamicNodes":[{"type":"text","position":[0,1,1,0]},{"type":"text","position":[0,1,3,0]}]}},"default":{}},{"type":"attr","position":[1,1,1,3]},{"type":"if","position":[1,1,1,3],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1,1]},{"type":"for","position":[1,1],"dynamicNodes":[{"type":"attr","position":[1],"attr":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'width: '","item.width","'%;'"]}}}},{"type":"attr","position":[1,1],"attr":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'width: '","item.time","'%;'"]}}}},{"type":"attr","position":[1,3],"attr":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'width : '","item.loadedTime","'%'"]}}}}]}]},"false":{"dynamicNodes":[{"type":"attr","position":[1],"attr":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'width: '","elapsedTime","'%;'"]}}}},{"type":"attr","position":[3],"attr":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'width : '","loadedTime","'%'"]}}}}]}},"default":{}},{"type":"attr","position":[1,1,1,5]},{"type":"text","position":[1,1,3,1,0]},{"type":"text","position":[1,1,3,5,0]},{"type":"attr","position":[1,3,1]},{"type":"if","position":[1,3,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[0]},{"type":"attr","position":[0,1]}]}},"default":{}},{"type":"attr","position":[1,3,3]},{"type":"if","position":[1,3,3],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[0]},{"type":"attr","position":[0,1]}]}},"default":{}},{"type":"attr","position":[1,3,5]},{"type":"if","position":[1,3,5],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[0]},{"type":"attr","position":[0,1]}]}},"default":{}},{"type":"attr","position":[1,3,7]},{"type":"if","position":[1,3,7],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[0,1]},{"type":"attr","position":[0,3,1]},{"type":"componentDynamic","position":[0,3,1]}]}},"default":{}},{"type":"attr","position":[1,3,9,1]},{"type":"if","position":[1,3,9,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[0]},{"type":"attr","position":[0,1]}]}},"default":{}},{"type":"attr","position":[1,3,9,3]},{"type":"if","position":[1,3,9,3],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[0]},{"type":"attr","position":[0,1]},{"type":"if","position":[0,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,3,0]}]}},"default":{}},{"type":"attr","position":[0,3]},{"type":"switch","position":[0,3],"cases":{"playBackSpeed":{"dynamicNodes":[{"type":"attr","position":[0]},{"type":"for","position":[0],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,1,0]}]}]},"qualityOption":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,1,0]},{"type":"attr","position":[3]},{"type":"for","position":[3],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[0]},{"type":"text","position":[0,1,0]}]}},"default":{}}]}]},"subtitles":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,1,0]},{"type":"attr","position":[3]},{"type":"for","position":[3],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,1,0]}]}]}},"default":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,1,0]},{"type":"text","position":[1,3,0]},{"type":"attr","position":[3]},{"type":"text","position":[3,1,0]},{"type":"text","position":[3,3,0]},{"type":"attr","position":[5]},{"type":"text","position":[5,1,0]},{"type":"text","position":[5,3,0]}]}}]}},"default":{}},{"type":"attr","position":[1,3,9,5]},{"type":"if","position":[1,3,9,5],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[0]},{"type":"attr","position":[0,1]}]}},"default":{}},{"type":"attr","position":[1,3,9,7]},{"type":"if","position":[1,3,9,7],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[0]},{"type":"attr","position":[0,1]}]}},"default":{}}]}},"default":{}},{"type":"attr","position":[1,3,9,9]},{"type":"if","position":[1,3,9,9],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[0]},{"type":"attr","position":[0,1]}]}},"default":{}}]}},"default":{}}]}},"default":{}}],
_observedAttributes :["ltPropSource","ltPropTracks","ltPropVolume","ltPropMuted","ltPropPlayRate","ltPropCrossOrigin","ltPropCurrentTime","ltPropChapters","ltPropLoop","ltPropPreLoad","ltPropAutoPlay","ltPropPoster","ltPropCaption","ltPropQuality","ltPropOptions","ltPropPrefetch","ltPropPrefetchOptions","ltPropFocus","ltPropMiniMode","ltPropMiniModeOptions","ltPropControls","isNotFirefox","volume","selectedOption","elapsedTime","loadedTime","toolTip","currentDuration","duration","subMenuOpened","speedData","captionsData","qualityData","chaptersData","subtitles","subText","selectedSource","renderPrefetch","prefetchLoading","metaSetted","durationSec","videoStatus","volumeStatus","forwardStatus","backwardStatus","canPlay","sliderData"],
_observedAttributesType :["array","array","number","boolean","number","string","number","array","boolean","string","boolean","string","string","string","object","boolean","object","boolean","boolean","object","boolean","boolean","number","string","number","number","object","string","string","boolean","array","array","array","array","array","string","number","boolean","string","boolean","number","string","string","string","string","boolean","array"],

    _lyteUtilFunctions: ["play", "pause"],
	data : function(){
		return{
            /**
             ...
             * @output
			 */
			ltPropSource : Lyte.attr( 'array',{ input : true, output : true } ),
            /**
             ...
             * @output
			 */
			ltPropTracks : Lyte.attr( 'array',{ input : true, output : true } ),
            /**
             ...
             * @input
             * @output
             * @condition ltPropMuted =! true
			 */
			ltPropVolume : Lyte.attr( 'number', { default : 1, input : true, output : true  }),
            /**
			 * @componentProperty {boolean} ltPropMuted
			 * @version 3.45.0
             * @input
             * @output
             * @condition ltPropVolume =! 0
			 */
            ltPropMuted : Lyte.attr( 'boolean', { input : true, output : true } ),
            /**
             ...
             * @output
			 */
			ltPropPlayRate : Lyte.attr( 'number', { default : 1, input : true, output : true  }),
            /**
             ...
             * @output
			 */
			ltPropCrossOrigin : Lyte.attr('string',{ input : true, output : true }),
            /**
             ...
             * @output
			 */
			ltPropCurrentTime : Lyte.attr( 'number',{ input : true, output : true } ),
            /**
			 * @componentProperty {Object[]} ltPropChapters
			 * @version 3.45.0
             * @input
			 */
			ltPropChapters : Lyte.attr( 'array',{ input : true } ),
            /**
            ...
            * @output
            */
			ltPropLoop : Lyte.attr( 'boolean',{ input : true, output : true }),
            /**
            * @componentProperty {string} ltPropPreLoad=metadata
            * @version 3.45.0
            * @input
            */
            ltPropPreLoad : Lyte.attr( 'string', { default : 'metadata', input : true } ),
            /**
            * @componentProperty {boolean} ltPropAutoPlay
            * @version 3.45.0
            * @input
            * @condition ltPropPrefetch false
            */
            ltPropAutoPlay : Lyte.attr( 'boolean',{ input : true } ),
            /**
            ...
            * @output
            */
            ltPropPoster : Lyte.attr( 'string',{ input : true, output : true } ),
            /**
            ...
            * @output
            */
            ltPropCaption : Lyte.attr( 'string', { default : 'off',  input : true, output : true } ),
            /**
            ...
            * @output
            */
            ltPropQuality : Lyte.attr( 'string' , { default : 'auto', input : true, output : true } ),
            /**
            * @typedef {object} options
            * @property {boolean} play=true
            * @property {boolean} backward=true
            * @property {boolean} forward=true
            * @property {boolean} volume=true
            * @property {boolean} settings=true
            * @property {boolean} pip=true
            * @property {boolean} fullScreen=true
            */
            /**
            * @componentProperty {options} ltPropOptions
            * @default {}
            * @version 3.71.0
            * @input
            * @output
            */
            ltPropOptions : Lyte.attr( 'object', { default : {}, input : true, output : true }),
            /**
			 * @componentProperty {boolean} ltPropPrefetch=false
			 * @version 3.71.0
             * @input
			 */
            ltPropPrefetch :  Lyte.attr( 'boolean', { default : false, input : true } ),
            /**
			...
			//  * @version 3.91.1
			//  */
            ltPropMiniMode :  Lyte.attr( 'boolean', { default : false,input : true } ),
            // /**
			//  * @componentProperty {object} ltPropMiniModeOptions
			//  * @version 3.91.1
			//  */
            ltPropMiniModeOptions :  Lyte.attr( 'object', { default : {}, input : true } ),
            /**
             * @componentProperty {boolean} ltPropControls=true
             * @version 3.117.0
             */
            ltPropControls : Lyte.attr('boolean', { default : true, input : true }),
			//system data
            ...
            sliderData : Lyte.attr('array', { default : [ { "value" : 1, "min" : 0, "max" : 1, "tabindex" : "0" } ] })
		}
	},
	...
	didDestroy : function(){
		...
		if( this.__preloaded ){
			let src = this.data.ltPropSource;
    ...
    isValidTimeFormat : function(timeString) {
        const timeFormatRegex = /^([0-9]{2}):([0-5][0-9]):([0-5][0-9])$/;
    ...
    setVolume : function( change ){
        ...
        var video = this._video;
        if( this._slider && this._slider.ltProp && this._slider.ltProp('value')[0].value != change.newValue ){
    ...
    source : function( change ){
        ...
        video.load();
        var fn = function(){ 
            if( !isPaused || ( this.data && this.data.ltPropAutoPlay ) ){
                this.play();
            }
            video.removeEventListener('canplay',fn);
        }.bind(this);
    ...
    prefetchObserver : function( change ){
        this.setData( "renderPrefetch", change.newValue );
        if( !change.newValue ){
            this.setGlobals();
        }
    }.observes( 'ltPropPrefetch' ),
    menuListener : function( evt, fl ){
        if( !this._menu ){
            return
        }
        if( evt && !document.contains( evt.target ) ){
            return;
        }
        let flag = true,
    ...
    updateTime : function( evt, flag){
        ...
        if( this._mouseDown && this._handler){
    ...
    actions : {
        keyDown : function( evt ){
            if( !this._video || !this.data.ltPropControls ){
                return
            }
            var video = this._video,
            wrapperEle,
            i = 0;
            if( evt.keyCode == 9 && !this._focused ){
                this._focused = true;
            }
            if( this._focused ){  
                switch( evt.keyCode ){
        ...
        mute : function(){
            ...
            video.muted = !video.muted;
            video.muted ? this.setData('previousVolume', video.volume ) : video.volume = this.data.previousVolume || this._defaultVolume;
            this.setData("ltPropMuted", video.muted );
        },
        ...
        changeVolume : function(){
            ...
            if(video.volume < 0.5) {
                this.setData( "lowVolume", true );
            }else{
                this.setData( "lowVolume", false );
            }
            if( vol > 0 && __data.muted ) {
				mute = video.muted = false;
				vol = new_vol = video.volume;
			} else if( !is_muted && vol == 0 ) {
				vol = new_vol = video.volume = this._defaultVolume;
			} else if( is_muted ){
				mute = true;
				vol = new_vol = 0;
			}
        ...
        onCanPlay : function(){
            ...
            this.data.ltPropAutoPlay && this.play();
        },
...
Lyte.Component.registerHelper( "getQualityI18n" , function( quality){
	if( quality === "auto" ){
        ...
        return _lyteUiUtils.i18n("lyte.video.menu.subtitles.off");
    }
	return quality;
});
/**
