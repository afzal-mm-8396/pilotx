...
_observedAttributesType :["string","boolean","boolean","string","string","string","string","string","string","string","string","string","string","string","boolean","object","string","string","string","string"],

	_lyteUtilFunctions: [ 'click', 'focus', 'blur' ],
	data: function() {
		return {
			//For builder
			/**
			...
			*/
			 ...
			 * @input
			 */
			'ltPropDataTabindex': Lyte.attr('string', { 
				'default': null,
				'input': true 
			}),
