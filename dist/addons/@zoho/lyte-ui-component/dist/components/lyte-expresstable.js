...
_observedAttributesType :["array","array","string","string","boolean","boolean","string","string","boolean","string","boolean","boolean","number","boolean","boolean","string","boolean","boolean","string","boolean","boolean","string","number","number","object","boolean","array","array","array","array","array","string","string"],
    ...
    data: function () {
        return {
             ...
             * @input
             */
            ltPropMinWidth: Lyte.attr('string', { 'default': '50px', input: true }),
            /** 
             * @componentProperty {string} ltPropMaxWidth=1000px
             * @version 3.1.0
             * @input
             */
            ltPropMaxWidth: Lyte.attr('string', { 'default': '1000px', input: true }),
            /** 
              * @componentProperty {boolean} ltPropFixedTableScroll=false
              * @version 3.1.0
              * @input
              */
            ltPropFixedTableScroll: Lyte.attr('boolean', { 'default': false, input: true }),
            /** 
             ...
             * @input
             */
            ltPropPreventWidth: Lyte.attr('boolean', { 'default': false, input: true }),
            // column sortable
            /**
             ...
             * @input
             */
            ltPropColumnSortable: Lyte.attr('boolean', { default: false, input: true }),
            /** 
             ...
             * @input
             */
            ltPropScrollStep: Lyte.attr('number', { default: 10, input: true }),
            /** 
             ...
             * @input
             */
            ltPropHeaderOnly: Lyte.attr('boolean', { default: false, input: true }),
            /** 
             ...
             * @input
             */
            ltPropPreventTableModify: Lyte.attr('boolean', { default: false, input: true }),
            /** 
             ...
             * @input
             */
            ltPropPreventContentObserver: Lyte.attr('boolean', { default: false, input: true }),

            ltPropStickyTable: Lyte.attr('boolean'),
            /** 
             * @componentProperty {string} ltPropCellTag=lyte-exptable-td
             * @version 3.1.0
             * @input
             */
            ltPropCellTag: Lyte.attr('string', { default: 'lyte-exptable-td', input: true }),
            /** 
             * @componentProperty {boolean} ltPropNavigation=false
             * @version 3.1.0
             * @input
             */
            ltPropNavigation: Lyte.attr('boolean', { default: false, input: true }),

            ltPropFullYield: Lyte.attr('boolean', { default: false }),
            /** 
             * @componentProperty {string} ltPropFixedResizeGap=100px
             * @condition ltPropYield false
             * @version 3.1.0
             * @input
             */
            ltPropFixedResizeGap: Lyte.attr('string', { default: '100px', input: true }),
            /** 
             ...
             * @input
             */
            ltPropAriaAttributes: Lyte.attr('object', { 'default': {}, watch: true, input: true }),
            ltPropRowViewPort: Lyte.attr('boolean', { default: false }),
    ...
    init: function () {
        ...
        /**
         * @method beforeRender
         * @author vidhya <vidhya.d @zohocorp.com>
         * @version 1.0.0
         * @param { * } node
         */
        ...
        this.$node.scrollTo = function (arg1, arg2, event) {
            ...
            if (this._scrolled) {
                ...
                this._scrollTimeOut = setTimeout(function () {
                    this.scrollFunc(event, arg1, arg2, true);
                }.bind(this), 20)
            }
    ...
    ariaObserver: function (change) {
        _lyteUiUtils.setAttribute(this.$node.querySelector('.lyteExpTableWrapper'), this.getData('ltPropAriaAttributes') || {}, {});
    ...
    beforeNavigationFunc: function (tableCell) {
        if (!this.$node.querySelector('lyte-exptable.lyteExpOriginalTable').contains(tableCell)) {
            ...
            var fakeColumnIndex = Array.from(tableCell.parentNode.children).indexOf(tableCell),
            ...
            if (originalHeader) {
                var headerRow = this._oriwrap.getElementsByTagName('lyte-exptable-tr')[0],
                    rowIndex = Array.from(this.$node.getElementsByClassName('lyteExpTableFixedColWrapper')[0].querySelectorAll('lyte-exptable-tr')).indexOf(tableCell.parentNode),
    ...
    afterNavigationFunc: function (tableCell, event) {
        ...
        var columnIndex = Array.from(tableCell.parentNode.children).indexOf(tableCell),
        ...
        if (this._fixHeaderCount - 1 >= fixedIndex) {
            ...
            var rowIndex = Array.from(this._oriwrap.querySelectorAll('lyte-exptable-tr')).indexOf(tableCell.parentNode);
    ...
    setFixTableRowHeight: function (row) { //Fixing Row Height 
        ...
        if (that.getMethods('beforeSetFixTableRowHeight')) {
                /**
                 * @method beforeSetFixTableRowHeight
                 * @author vidhya <vidhya.d @zohocorp.com>
                 * @version 1.0.0
                 * @param { * } node
                 */
        ...
        if (that.getMethods('afterSetFixTableRowHeight')) {
                    /**
                     * @method afterSetFixTableRowHeight
                     * @author vidhya <vidhya.d @zohocorp.com>
                     * @version 1.0.0
                     * @param { * } node
                     */
    ...
    setFixTableColumnWidth: function (col) { //Fixing Row Height 
        ...
        if (col != undefined && (col.nodeType === 1 || !isNaN(col))) {
            ...
            if (that.getMethods('beforeSetFixTableColumnWidth')) {
                /**
                 * @method beforeSetFixTableColumnWidth
                 * @author vidhya <vidhya.d @zohocorp.com>
                 * @version 1.0.0
                 * @param { * } node
                 */
                ...
                $L.fastdom.measure(function () {
                    $L.fastdom.mutate(function () {
                        if (that.getMethods('afterSetFixTableColumnWidth')) {
                            /**
                             * @method afterSetFixTableColumnWidth
                             * @author vidhya <vidhya.d @zohocorp.com>
                             * @version 1.0.0
                             * @param { * } node
                             */
    ...
    callHeaderObs: function () {
        if (!this.getData('ltPropStickyTable')) {
            ...
            this.setTableHeader()
            this.addRightFixedClassForCell()
            this.setLeftForInterSection(true)
        }
    },
    ...
    addRightFixedClassForCell: function () {
        var headerCells = Array.from(this.getHeaderCells()),
            __this = this
        headerCells.forEach(function (cell, index) {
            if ($L(cell).hasClass('lyteTableRightFixed')) {
                __this.stickyFunction(cell, false, 'addClass', 'lyteTableRightFixed');
    ...
    minWidth: function (resizeComponent, arg) {
        ...
        var minWidth = getComputedStyle(resizeComponent, null).getPropertyValue('min-width'),
    ...
    resizeFunc: function (event) {
        ...
        if (resize.tagName == 'LYTE-EXPTABLE-TH' && offset) {
            var finalWidth = offset + width,
                ...
                if (finalWidth < minWidth1) {
                    finalWidth = minWidth1;
                    offset = finalWidth - width;  
                }
            ...
            //     return;
            // }
            if (fixed && (((isFixed && (_this._fixedSum + offset < tableWidth - parseInt(_this.getData('ltPropFixedResizeGap')))) || !isFixed) && finalWidth >= minWidth1)) {
                if (_this.oriTab) {
                ...
                $L(_this._originalTable).css('width', currTableWidth +'px');
    ...
    mouseup: function (event) {
        ...
        _lyteUiUtils.removeEventListenerGlobal(isTch ? 'touchend' : 'mouseup', component._mouseup);
        _lyteUiUtils.removeEventListenerGlobal(isTch ? 'touchmove' : 'mousemove', component._resizeFunc);
        // $L.fastdom.mutate( function(){
        ...
        if (component.getData('ltPropStickyTable')) {
            component.addRightFixedClassForCell()
    ...
    scrollFunc: function (event, scrollLeft, scrollTop, ignore) {
        if (this.getData('ltPropStickyTable')) {
            // if( this._FF ){
    ...
    actions: {
        scroll: function (event, scrollLeft, scrollTop, ignore) {
            ...
            this.scrollFunc(event, scrollLeft, scrollTop, ignore)
        },
        ...
        tableResize: function (event) {
            ...
            var originalheaderList = this._originalDiv.getElementsByTagName('lyte-exptable-th'),
                ...
                isFixed = getComputedStyle(table).tableLayout == 'fixed',
                style1 = getComputedStyle(resizeComponent),
                style2 = next ? getComputedStyle(next) : {},
            ...
            this._resizeMeasure = $L.fastdom.measure(function () {
                ...
                $L.fastdom.mutate(function () {
                    ...
                    innTab.style.tableLayout = layout;
                     this._resizeFunc = this.resizeFunc.bind(this)
                    _lyteUiUtils.addGlobalEventListener(isTch ? 'touchmove' : 'mousemove', this._resizeFunc)
            ...
            _lyteUiUtils.addGlobalEventListener(isTch ? 'touchend' : 'mouseup', this._mouseup);
    ...
    getTouch: function (evt) {
        if (!this._touchend) {
            ...
            _lyteUiUtils.addGlobalEventListener('touchend', this._touchend, true);
        }
    ...
    touchend: function () {
        _lyteUiUtils.removeEventListenerGlobal('touchend', this._touchend, true);
    ...
    sortablemousedown: function (ev) {
        ...
        if (!this.data.ltPropPreventTableModify) {
            if (!this.data.ltPropHeaderOnly) {
                var height = 0;
                var tValue = Math.max(this._thisBccr.top + 10, -10),
                    bValue = Math.min(window.innerWidth + 10, this._thisBccr.bottom)
                ...
                for (var i = 0; i < rows.length; i++) {
                    ...
                    var rowbcr = __current[getBoundingClientRect]();
                    if (rowbcr.bottom > tValue && rowbcr.top < bValue) {
        ...
        _lyteUiUtils.addGlobalEventListener(isTch ? 'touchmove' : 'mousemove', this._sortmousemove, true);
        _lyteUiUtils.addGlobalEventListener(isTch ? 'touchend' : 'mouseup', this._sortmouseup, true);
    ...
    findFormClosest: function (evt) {
        var __tag = this.data.ltPropCellTag,
            scrollDiv = this._scrollDiv || this.$node.getElementsByClassName('lyteExpTableOrigTableInnerWrap')[0],
            sortElem = $L(this._elem).data('sortElement'),
            sortElemBcr = sortElem.getBoundingClientRect(),
            scrollDivBcr = scrollDiv.getBoundingClientRect(),
            x = scrollDivBcr.left + 10 >= sortElemBcr.left ? scrollDivBcr.left + 10 : sortElemBcr.left,
            elementsFromPoint = document.elementsFromPoint(x, sortElemBcr.y), closest;
        for (var index = 0; index < elementsFromPoint.length; index++) {
            var elem = elementsFromPoint[index],
                closest = $L(elem).closest('lyte-exptable');
            if (elem && elem.tagName.toLowerCase() == 'lyte-exptable-th' && closest && $L(closest).hasClass('lyteExpOriginalTable')) {
                var idx = Array.apply(Array, elem.parentNode.children).indexOf(elem);
                closest = this._elem.parentNode.children[idx];
                closest._index = idx;
                return closest
            }
        }
    ...
    sortmousemove: function (ev, allow, pos) {
        ...
        if (closestTd && this._moved) {
            ...
            if (index != this._index || prevtable) {
                ...
                // console.log("index",transindex)

                if (div && td == closestTd) {
                    transindex = index;
                    td._transformedindex = transindex;
                }
                if (inc > 0 || (inc == 0 && pos)) {
        ...
        if (prevtable) {
            ...
            if (closestTd && !interchangeprevent) {
                if (closestTd != td) {
                    ...
                    //    console.log("index",td._transformedindex)
                }
            }
            ...
            for (var i = 0; i < cells.length; i++) {
                ...
                if (closestTd && !interchangeprevent) {
                    ...
                    if (newcell) {
                        ...
                        // console.log("index",newcell._transformedindex)
                    }
                }
            }
        }
    ...
    sortmouseup: function (evt) {
        ...
        _lyteUiUtils.removeEventListenerGlobal(isTch ? 'touchmove' : 'mousemove', this._sortmousemove, true);
        _lyteUiUtils.removeEventListenerGlobal(isTch ? 'touchend' : 'mouseup', this._sortmouseup, true);
        ...
        this._setmeasure = $L.fastdom.measure(function () {
            ...
            if (__length + 1) {
                ...
                var width = __this.getHeaderWidths(headerCells),
                    sum = 0, left = __this.rtlfunc('left'),
    ...
    registerInterSection: function (scrollDiv) {
        this._intersectionObs = new IntersectionObserver(this.intersection.bind(this), { threshold: [0.01], root: scrollDiv })
    },
    ...
    singleIntersection: function (intersection) {
        ...
        this._rightFixedWidth = this._rightFixedWidth || 0;
            ...
            raf(function () {
                ...
                raf(function () {
                    $tbody.addClass(animation_class).removeClass(anime_initial_class).on(evt_name, function () {
                        ...
                        anime_fn(empty);
                        if (_that.getMethods('onAfterToggleRow')) {
                            _that.executeMethod('onAfterToggleRow', tbody, _that);
                        }
                    });
                    anime_fn(arr);
                });
...
/**
 * @customElement lyte-exptable-th
 * @customAttribute {true|false} fixed
 * @customAttribute {true|false} resize
 * @attribute icon
 */
    ...
    Lyte.createCustomElement("lyte-exptable-th", {
        ...
        "attributeChangedCallback": function (attr, oldVal, newVal) {
            ...
            if (attr == 'fixed') {
                ...
                while (scrollingDiv && scrollingDiv.tagName != 'DIV') {
                    scrollingDiv = scrollingDiv.parentNode;
                }
                if (newVal == 'enable') {
            ...
            } else if (attr = 'sticky-position') {
                var table = $L(this).closest('lyte-expresstable').get(0);
                if ($node.attr('fixed') == "enable" && table.getData('ltPropStickyTable')) {
                    var is_enable = newVal == "right",
                        __table = table.component,
                    ...
                    table.component.stickyFunction(this, false, fn + 'Class', __class);
                    this.checkIntersection(is_enable, true);
                }
            }
        },
        checkIntersection: function (arg, ignore_removal) {
            var table = $L(this).closest('lyte-expresstable').get(0);
        ...
        createIntersection: function (table) {
            ...
            div._cell = this;
            table.component.addRightFixedClassForCell
...
/**
 * @customElement lyte-exptable-tr
 */
