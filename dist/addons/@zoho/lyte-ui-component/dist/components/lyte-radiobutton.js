...
_observedAttributes :["ltPropType","ltPropName","ltPropDisabled","ltPropChecked","ltPropLabel","ltPropValue","ltPropFireOnInit","ltPropLabelClass","ltPropClass","ltPropYield","ltPropAriaRadio","ltPropFocus","ltPropPreventFocus","lyteUnbound","ltPropReadOnly","ltPropDataTabindex","ltPropId","ltPropKeyboardNavigation","ltPropTabindex"],
_observedAttributesType :["string","string","boolean","boolean","string","string","boolean","string","string","boolean","object","boolean","boolean","boolean","boolean","string","string","boolean","string"],

	_lyteUtilFunctions: [ 'focus', 'click', 'blur' ],
	data: function () {
		return {
	...
	check: function (inp, comp) {
		if ((!_lyteUiUtils.globalConfig.preventScriptChangeCallback || this.eventType() != 'script') && this.getMethods('onChecked')) {
			/**
			 * This callback is fired when a radiobutton is checked
			 * @method onChecked
			 * @author ananthapadmanaban.n@zohocorp.com
			 * @param { object } inputElementThatWasChecked
			 * @param { object } radioContext
	...
	uncheck: function (inp, comp) {
		if ((!_lyteUiUtils.globalConfig.preventScriptChangeCallback || this.eventType() != 'script') && this.getMethods('onUnchecked')) {
			/**
			 * This callback is fired when a radiobutton is unchecked
			 * @method onUnchecked
			 * @author ananthapadmanaban.n@zohocorp.com
			 * @param { object } inputElementThatWasChecked
			 * @param { object } radioContext
	...
	beforeCheck: function (inp, comp) {
		if ((!_lyteUiUtils.globalConfig.preventScriptChangeCallback || this.eventType() != 'script') && this.getMethods('onBeforeChecked')) {
			/**
			 * This callback is fired just before a radiobutton is checked
	...
	beforeUncheck: function (inp, comp) {
		if ((!_lyteUiUtils.globalConfig.preventScriptChangeCallback || this.eventType() != 'script') && this.getMethods('onBeforeUnchecked')) {
			/**
			 * This callback is fired just before a radiobutton is unchecked
	...
	onchanged: function (inp, comp) {
		if ((!_lyteUiUtils.globalConfig.preventScriptChangeCallback || this.eventType() != 'script') && this.getMethods('onChanged')) {
			/**
			 * This callback is fired when a radiobutton's state is changed
			 * @method onChanged
			 * @author ananthapadmanaban.n@zohocorp.com
			 * @param { object } inputElementThatWasChecked
			 * @param { object } radioContext
