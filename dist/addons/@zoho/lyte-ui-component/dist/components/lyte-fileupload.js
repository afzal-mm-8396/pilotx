 ...
 */
/**
 * This method is invoked before rendering the component.
 * @method beforeRender
 * @author varun.a@zohocorp.com
 * @param { object } component
 */
/**
 * This method is invoked after rendering the component.
 * @method afterRender
 * @author varun.a@zohocorp.com
 * @param { object } component
 */
 ...
 */
/**
 * This method is called when file chunk is uploaded successfully.
 * @method onChunkSuccess
 * @author varun.a@zohocorp.com
 * @param { object } lxhr
 * @param { object } chunk
 * @param { object } file
 ...
 */
/**
 * This method is called when file chunk is failed or aborted.
 * @method onChunkError
 * @author varun.a@zohocorp.com
 * @param { object } lxhr
 * @param { object } chunk
 ...
 * @param { object } lyteDomAjaxObject
 */
/**
...
_template:"<template tag-name=\"lyte-fileupload\" lyte-fileupload=\"\"> <input class=\"fileuploadInput {{ltPropClass}}\" id=\"{{ltPropId}}\" type=\"file\" name=\"{{ltPropName}}\" onchange=\"{{action('change',event,this)}}\" oncancel=\"{{action('cancel',event,this)}}\" multiple=\"{{ltPropMultiple}}\" accept=\"{{ltPropAccept}}\"> <div tabindex=\"{{ltPropTabindex}}\" class=\"fileUploadWrapper {{fileClass}} {{if(ltPropMultiple,'multiFileupload','singleFileUpload')}} lyteFileUpd{{ltPropAppearance}}Type {{if(ltPropDisabled,'lyteFileUpdDisabled')}} {{maxFileClass}}\" ondragenter=\"{{action('drag',event)}}\" ondragover=\"{{action('drag',event)}}\" ondrop=\"{{action('drop',event)}}\" onclick=\"{{action('click',event)}}\" style=\"outline: none;position: relative;\" onpaste=\"{{action('paste',event)}}\" onkeydown=\"{{action('keydown',event)}}\" aria-labelledby=\"{{randomAriaId}}\" data-tabindex=\"{{ltPropDataTabindex}}\"> <template is=\"if\" value=\"{{ltPropYield}}\"><template case=\"true\"> <lyte-yield yield-name=\"file\" queue-list=\"{{queueList}}\" predefined-list=\"{{predefinedList}}\"></lyte-yield> </template><template case=\"false\"> <template is=\"if\" value=\"{{ltPropMultiple}}\"><template case=\"true\"> <lyte-file-select-area aria-hidden=\"true\"> <lyte-file-message class=\"lyteFileUpdMsgWrap\"> <span class=\"lyteFileUpdMsg\">{{lyteUiI18n(ltPropMessage,\"fileupload\")}}</span> </lyte-file-message> </lyte-file-select-area> <div class=\"lyteFileUpdList\"> <template is=\"for\" items=\"{{predefinedList}}\" item=\"item\" index=\"index\"> <div class=\"lyteFileUpdListFile\"> <div class=\"lyteFileUpdTypePreview\"> <template is=\"if\" value=\"{{lyteUiImageFile(item)}}\"><template case=\"true\"> <img class=\"lyteFileUpdThumb\" src=\"{{item.src}}\"> </template><template case=\"false\"> <span class=\"lyteFileUpdTypeIcon {{item.fileType}}\"></span> </template></template> </div> <lyte-text class=\"lyteFileUpdFileName\" lt-prop-value=\"{{item.name}}\"></lyte-text> <span class=\"lyteFileUpdFileSize\">( {{lyteUiFileSize(item.size,ltPropFileUnit,ltPropDigits,ltPropSizeFormat)}} )</span> <lyte-file-close data-value=\"{{item.id}}\" role=\"button\" aria-label=\"{{ariaCloseLabel}} selected {{item.name}} file\"> </lyte-file-close> </div> </template> <template is=\"for\" items=\"{{queueList}}\" item=\"item\" index=\"index\"> <div class=\"lyteFileUpdListFile {{concat('lyteFile',lyteUiCapitalizeName(item.status))}}\"> <div class=\"lyteFileUpdTypePreview\"> <template is=\"if\" value=\"{{lyteUiImageFile(item)}}\"><template case=\"true\"> <img class=\"lyteFileUpdThumb\" src=\"{{item.src}}\"> </template><template case=\"false\"> <span class=\"lyteFileUpdTypeIcon {{item.fileType}}\"></span> </template></template> </div> <lyte-text class=\"lyteFileUpdFileName\" lt-prop-value=\"{{item.name}}\"></lyte-text> <span class=\"lyteFileUpdFileSize\">( {{lyteUiFileSize(item.size,ltPropFileUnit,ltPropDigits,ltPropSizeFormat)}} )</span> <template is=\"if\" value=\"{{expHandlers(item.percentage,'!=',undefined)}}\"><template case=\"true\"> <div class=\"lyteFileUpdFileStatus\" data-completed=\"{{item.percentage}}\"> <div class=\"lyteFileUpdProgressBar\"> <div class=\"lyteFileUpdProgressFill\" style=\"width: {{item.percentage}}%\"></div> </div> </div> </template></template><template is=\"if\" value=\"{{expHandlers(item.status,'==',&quot;error&quot;)}}\"><template case=\"true\"> <lyte-file-retry data-value=\"{{item.id}}\" role=\"button\"> <span class=\"lyteFileUpdFailMsg\">{{lyteUiI18n(ltPropFailureMessage,\"fileupload\")}}</span> <template is=\"if\" value=\"{{expHandlers(ltPropUploadMultiple,'!')}}\"><template case=\"true\"> <span class=\"lyteFileUpdRetryMsg\">{{lyteUiI18n(ltPropRetryText,\"fileupload\")}}</span> </template></template> </lyte-file-retry> </template></template> <template is=\"if\" value=\"{{item.lyteErrorMsg}}\"><template case=\"true\"><span class=\"lyteFileUpdFailMsg\"> {{item.lyteErrorMsg}} </span></template></template> <template is=\"if\" value=\"{{expHandlers(expHandlers(ltPropUploadMultiple,'!'),'||',expHandlers(expHandlers(expHandlers(item.status,'!'),'||',expHandlers(item.status,'==',&quot;error&quot;)),'||',expHandlers(item.status,'==',&quot;success&quot;)))}}\"><template case=\"true\"> <lyte-file-close aria-level=\"2\" tabindex=\"0\" aria-label=\"{{ariaCloseLabel}} selected {{item.name}} file\" role=\"button\" data-value=\"{{item.id}}\"> </lyte-file-close> </template></template> </div> </template> </div> </template><template case=\"false\"> <lyte-file-select-area aria-hidden=\"true\"> <lyte-file-message class=\"lyteFileUpdMsgWrap {{if(expHandlers(queueList.length,'||',predefinedList.length),'lyteHide','')}}\"> <span class=\"lyteFileUpdMsg\"> {{lyteUiI18n(ltPropMessage,\"fileupload\")}} </span> </lyte-file-message> <div class=\"lyteFileUpdList\" tabindex=\"0\" aria-level=\"2\" aria-label=\"SelectedFile:{{ariaSelectedFiles}}\"> <template is=\"for\" items=\"{{predefinedList}}\" item=\"item\" index=\"index\"> <div class=\"lyteFileUpdListFile\"> <div class=\"lyteFileUpdTypePreview\"> <template is=\"if\" value=\"{{lyteUiImageFile(item)}}\"><template case=\"true\"> <img class=\"lyteFileUpdThumb\" src=\"{{item.src}}\"> </template><template case=\"false\"> <span class=\"lyteFileUpdTypeIcon {{item.fileType}}\"></span> </template></template> </div> <lyte-text class=\"lyteFileUpdFileName\" lt-prop-value=\"{{item.name}}\"></lyte-text> <span class=\"lyteFileUpdFileSize\">( {{lyteUiFileSize(item.size,ltPropFileUnit,ltPropDigits,ltPropSizeFormat)}} )</span> <lyte-file-close data-value=\"{{item.id}}\" aria-label=\"{{ariaCloseLabel}} selected {{item.name}} file\" role=\"button\"> </lyte-file-close> </div> </template> <template is=\"for\" items=\"{{queueList}}\" item=\"item\" index=\"index\"> <div class=\"lyteFileUpdListFile {{concat('lyteFile',lyteUiCapitalizeName(item.status))}}\"> <div class=\"lyteFileUpdTypePreview\"> <template is=\"if\" value=\"{{lyteUiImageFile(item)}}\"><template case=\"true\"> <img class=\"lyteFileUpdThumb\" src=\"{{item.src}}\"> </template><template case=\"false\"> <span class=\"lyteFileUpdTypeIcon {{item.fileType}}\"></span> </template></template> </div> <lyte-text class=\"lyteFileUpdFileName\" lt-prop-value=\"{{item.name}}\"></lyte-text> <span class=\"lyteFileUpdFileSize\">( {{lyteUiFileSize(item.size,ltPropFileUnit,ltPropDigits,ltPropSizeFormat)}} )</span> <template is=\"if\" value=\"{{expHandlers(item.percentage,'!=',undefined)}}\"><template case=\"true\"> <div class=\"lyteFileUpdFileStatus\" data-completed=\"{{item.percentage}}\"> <div class=\"lyteFileUpdProgressBar\"> <div class=\"lyteFileUpdProgressFill\" style=\"width: {{item.percentage}}%\"></div> </div> </div> </template></template><template is=\"if\" value=\"{{expHandlers(item.status,'==',&quot;error&quot;)}}\"><template case=\"true\"> <lyte-file-retry data-value=\"{{item.id}}\" role=\"button\"> <span class=\"lyteFileUpdFailMsg\">{{lyteUiI18n(ltPropFailureMessage,\"fileupload\")}}</span> <span class=\"lyteFileUpdRetryMsg\"> {{lyteUiI18n(ltPropRetryText,\"fileupload\")}} </span> </lyte-file-retry> </template></template> <lyte-file-close data-value=\"{{item.id}}\" tabindex=\"0\" aria-label=\"{{ariaCloseLabel}} selected {{item.name}} file\" role=\"button\"> </lyte-file-close> </div> </template> </div> </lyte-file-select-area> </template></template> </template></template> <template is=\"if\" value=\"{{fileClass}}\"><template case=\"true\"><div ondragleave=\"{{action('drag',event)}}\" class=\"lyteFileDragWrapper\"> </div></template></template> </div> <template is=\"if\" value=\"{{ltPropAria}}\"><template case=\"true\"><span id=\"{{randomAriaId}}\" style=\"display: none;\"> SelectedFiles:{{ariaSelectedFiles}} </span></template></template> </template>",
_dynamicNodes : [{"type":"attr","position":[1]},{"type":"attr","position":[3]},{"type":"attr","position":[3,1]},{"type":"if","position":[3,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"insertYield","position":[1]}]},"false":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[{"type":"text","position":[1,1,1,0]},{"type":"componentDynamic","position":[1,1]},{"type":"componentDynamic","position":[1]},{"type":"attr","position":[3,1]},{"type":"for","position":[3,1],"dynamicNodes":[{"type":"attr","position":[1,1,1]},{"type":"if","position":[1,1,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]}]},"false":{"dynamicNodes":[{"type":"attr","position":[1]}]}},"default":{}},{"type":"attr","position":[1,3]},{"type":"componentDynamic","position":[1,3]},{"type":"text","position":[1,5,1]},{"type":"attr","position":[1,7]},{"type":"componentDynamic","position":[1,7]}]},{"type":"attr","position":[3,3]},{"type":"for","position":[3,3],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,1,1]},{"type":"if","position":[1,1,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]}]},"false":{"dynamicNodes":[{"type":"attr","position":[1]}]}},"default":{}},{"type":"attr","position":[1,3]},{"type":"componentDynamic","position":[1,3]},{"type":"text","position":[1,5,1]},{"type":"attr","position":[1,7]},{"type":"if","position":[1,7],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,1,1],"attr":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'width: '","item.percentage","'%'"]}}}}]}},"default":{}},{"type":"attr","position":[1,8]},{"type":"if","position":[1,8],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,1,0]},{"type":"attr","position":[1,3]},{"type":"if","position":[1,3],"cases":{"true":{"dynamicNodes":[{"type":"text","position":[1,0]}]}},"default":{}},{"type":"componentDynamic","position":[1]}]}},"default":{}},{"type":"attr","position":[1,10]},{"type":"if","position":[1,10],"cases":{"true":{"dynamicNodes":[{"type":"text","position":[0,1]}]}},"default":{}},{"type":"attr","position":[1,12]},{"type":"if","position":[1,12],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"componentDynamic","position":[1]}]}},"default":{}}]}]},"false":{"dynamicNodes":[{"type":"attr","position":[1,1]},{"type":"text","position":[1,1,1,1]},{"type":"componentDynamic","position":[1,1]},{"type":"attr","position":[1,3]},{"type":"attr","position":[1,3,1]},{"type":"for","position":[1,3,1],"dynamicNodes":[{"type":"attr","position":[1,1,1]},{"type":"if","position":[1,1,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]}]},"false":{"dynamicNodes":[{"type":"attr","position":[1]}]}},"default":{}},{"type":"attr","position":[1,3]},{"type":"componentDynamic","position":[1,3]},{"type":"text","position":[1,5,1]},{"type":"attr","position":[1,7]},{"type":"componentDynamic","position":[1,7]}]},{"type":"attr","position":[1,3,3]},{"type":"for","position":[1,3,3],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,1,1]},{"type":"if","position":[1,1,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]}]},"false":{"dynamicNodes":[{"type":"attr","position":[1]}]}},"default":{}},{"type":"attr","position":[1,3]},{"type":"componentDynamic","position":[1,3]},{"type":"text","position":[1,5,1]},{"type":"attr","position":[1,7]},{"type":"if","position":[1,7],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,1,1],"attr":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'width: '","item.percentage","'%'"]}}}}]}},"default":{}},{"type":"attr","position":[1,8]},{"type":"if","position":[1,8],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,1,0]},{"type":"text","position":[1,3,1]},{"type":"componentDynamic","position":[1]}]}},"default":{}},{"type":"attr","position":[1,10]},{"type":"componentDynamic","position":[1,10]}]},{"type":"componentDynamic","position":[1]}]}},"default":{}}]}},"default":{}},{"type":"attr","position":[3,3]},{"type":"if","position":[3,3],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[0]}]}},"default":{}},{"type":"attr","position":[5]},{"type":"if","position":[5],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[0]},{"type":"text","position":[0,1]}]}},"default":{}}],
_observedAttributes :["ltPropName","ltPropMultiple","ltPropAccept","ltPropId","ltPropClass","ltPropAppearance","ltPropDisabled","ltPropYield","ltPropFileLimit","ltPropMinimumFileSize","ltPropTotalFilesSize","ltPropParallel","ltPropAutoUpload","ltPropTriggerUpload","ltPropParamName","ltPropThumb","ltPropTabindex","ltPropRetry","ltPropFileUnit","ltPropDigits","ltPropMessage","ltPropFailureMessage","ltPropRetryText","ltPropFiles","ltPropFolder","ltPropChunk","ltPropChunkSize","ltPropParallelChunkUpload","ltPropParallelChunkCount","ltPropChunkRetry","ltPropUploadMultiple","ltPropUploadMultipleCount","ltPropAjax","ltPropAllowReplace","ltPropFilesCount","ltPropAriaAttributes","ltPropReset","ltPropPreventDuplicate","ltPropListErrorFiles","ltPropResetFileValue","ltPropAria","ltPropDataTabindex","ltPropValidateByExt","ltPropRenameDuplicateFile","ltPropActiveElement","ltPropExtCaseSensitive","ltPropSizeFormat","queueList","predefinedList","currentUpload","chunkUpload","fileClass","chunkCount","abort","lxhrs","uploadedFiles","manualUpdFiles","uploadMultipleRetry","retryFiles","retry","manualUpload","totalFilesSize","curTotFilesSize","ariaCloseLabel","commonAriaLabel","ariaSelectedFiles","randomAriaId"],
_observedAttributesType :["string","boolean","string","string","string","string","boolean","boolean","number","number","string","number","boolean","boolean","string","boolean","number","number","string","number","string","string","string","array","boolean","boolean","number","boolean","number","number","boolean","number","object","boolean","number","object","boolean","boolean","boolean","boolean","boolean","string","boolean","boolean","boolean","boolean","string","array","array","array","array","string","number","boolean","array","array","array","number","array","boolean","boolean","number","number","string","object","string","string"],

	_lyteUtilFunctions: [ 'upload', 'removeUpload', 'addFiles', 'predefined', 'openSelection' ],
	init : function(){
		var ua = navigator.userAgent;
		var ltPropExtCaseSensitive = this.data.ltPropExtCaseSensitive;
		this.getMethods( 'beforeRender' ) && this.executeMethod( 'beforeRender', this.$node )
		this.extCaseSensitive = typeof ltPropExtCaseSensitive === "boolean" ? ltPropExtCaseSensitive : /Linux/i.test(ua);
	},
	...
	didConnect : function(){
		...
		/**
		 * @utility upload
		 * @author Varun a <varun.a@zohocorp.com>
		 * @version 1.0.0
		 * @param { string | array } id
		 */
		this.$node.upload = this.processqueue.bind( this );
		/**
		 * @utility removeUpload
		 * @author Varun a <varun.a@zohocorp.com>
		 * @version 1.0.0
		 * @param { string | array } id
		 */
		...
		*/ 
		...
		/**
		 * @utility openSelection
		 * @author Varun a <varun.a@zohocorp.com>
		 * @version 1.0.0
		 */
		this.$node.openSelection = function(){
			this._file.click();
		}.bind(this);
		this.folderUpload();
	...
	data : function(){
		return {
			 ...
			 * @input
			 */
			ltPropName : Lyte.attr( 'string', { "default" : "file", "input" : true, "output" : true } ),
			/** 
			 * @componentProperty {boolean} ltPropMultiple=true
			 * @input
			 * @output
			 */
			ltPropMultiple : Lyte.attr( 'boolean', { "default" : true, "input" : true, "output" : true } ),
			/** 
			 * @componentProperty {string} ltPropAccept
			 * @input
			 */
			ltPropAccept : Lyte.attr( 'string', { "default" : '', "input" : true} ),
			/** 
			...
			*/
			 ...
			 * @input
			 */
			ltPropClass : Lyte.attr( 'string', { "default" : '', "input" : true} ),
			/**
			 ...
			 * @input
			 */
			ltPropDisabled : Lyte.attr('boolean',{"default":false, "input": true}),
			// file uploader data
			/** 
			 ...
			 * @input
			*/
			ltPropFileLimit : Lyte.attr( 'number', { 
				"default" : _lyteUiUtils.resolveDefaultValue( 'lyte-fileupload', 'fileLimit', undefined ),
				"input" : true 
			} ),
			/** 
			 ...
			 * @input
			*/
			ltPropMinimumFileSize : Lyte.attr( 'number',{
				"default": _lyteUiUtils.resolveDefaultValue( 'lyte-fileupload', 'minimumFileSize', 0 ) ,
				"input": true
			} ),
			/** 
			 ...
			 * @input
			*/
			ltPropTotalFilesSize : Lyte.attr('string', {"input": true}),
			/** 
			 * @componentProperty {number} ltPropParallel=2
			 * @input
			*/
			ltPropParallel : Lyte.attr( 'number', { "default" : 2, "input" : true } ),
			/** 
			 * @componentProperty {boolean} ltPropAutoUpload=true
			 * @input
			*/
			ltPropAutoUpload : Lyte.attr( 'boolean', { "default" : true, "input" : true } ),
			/** 
			 * @componentProperty {boolean} ltPropTriggerUpload=false
			 * @input
			 * @output
			*/
			ltPropTriggerUpload : Lyte.attr( 'boolean', { "default" : false, "input" : true, "output" : true } ),
			/** 
			 ...
			 * @input
			 */
			ltPropThumb : Lyte.attr( 'boolean', { "default" : false, "input" : true } ),
			/** 
			 ...
			 * @input
			 */
			ltPropFileUnit : Lyte.attr( 'string', { "default" : '', "input" : true } ),
			/**
			 ...
			 * @input
			 */
			ltPropFolder : Lyte.attr("boolean",{"default" : false, "input" : true}),
			// chunking
			/**
			 * @componentProperty {boolean} ltPropChunk=false
			 * @input
			 */
			ltPropChunk : Lyte.attr( 'boolean', { "default" : false, "input" : true } ),
			/**
			 * @componentProperty {number} ltPropChunkSize=2000000
			 * @input
			 */
			ltPropChunkSize : Lyte.attr( 'number', { "default" : 2000000, "input" : true } ),
			/**
			 * @componentProperty {boolean} ltPropParallelChunkUpload=false
			 * @input
			 */
			ltPropParallelChunkUpload : Lyte.attr('boolean' , { "default" : false, "input" : true }),
			/**
			 * @componentProperty {number} ltPropParallelChunkCount=Infinity
			 * @input
			 */
			ltPropParallelChunkCount : Lyte.attr( 'number', { "default" :  Infinity, "input" : true } ),
			/**
			 * @componentProperty {number} ltPropChunkRetry=2
			 * @input
			 */
			ltPropChunkRetry : Lyte.attr( 'number', { "default" : 2, "input" : true } ),
			 ...
			 * @input
			 */
			ltPropUploadMultiple : Lyte.attr( 'boolean', { "default" : false, "input" : true } ),
			/**
			 * @componentProperty {number} ltPropUploadMultipleCount=Infinity
			 * @input
			 */
			ltPropUploadMultipleCount : Lyte.attr('number', { "default" : Infinity, "input" : true } ),
			/**
			 ...
			 * @input
			 */
			ltPropAjax : Lyte.attr( 'object', { "default" : { url : '' }, "input" : true } ),
			/**
			 * @componentProperty {boolean} ltPropAllowReplace=false
			 * @input
			 */
			ltPropAllowReplace : Lyte.attr("boolean",{"default":false, "input": true}),
			/**
			 * @componentProperty {number} ltPropFilesCount=Infinity
			 * @version 3.25.0
			 * @input
			 */
			ltPropFilesCount : Lyte.attr("number",{"default" : Infinity, "input" : true}),
			/**
			...
			* @input
            */
 			ltPropAriaAttributes : Lyte.attr( 'object', { default : _lyteUiUtils.resolveDefaultValue( 'lyte-fileupload', 'ariaAttributes', {
				role : "button",
				'aria-roledescription' : "fileupload"
			}), watch : true, "input" : true }),
			/**
            * @componentProperty {boolean} ltPropReset=false
            * @version 3.59.0
			* @input
			*/
			ltPropReset : Lyte.attr("boolean",{ default : false, "input" : true }),
			/**
            * @componentProperty {boolean} ltPropPreventDuplicate=false
            * @version 3.93.0
			* @input
			*/
			ltPropPreventDuplicate : Lyte.attr("boolean",{ default : false, "input" : true }),
			ltPropListErrorFiles : Lyte.attr("boolean", { default : false}),
			...
			ltPropValidateByExt : Lyte.attr("boolean",{ default : false}),
			ltPropRenameDuplicateFile : Lyte.attr("boolean",{ default : false}),
			ltPropActiveElement : Lyte.attr("boolean",{ default : false}),
			ltPropExtCaseSensitive : Lyte.attr("boolean"),
			ltPropSizeFormat : Lyte.attr("string",{ default : "decimal"}),
			// system data
	...
	getFileDataAsString :  function(array) {
		...
		var ltPropSizeFormat = this.data.ltPropSizeFormat;
		array.forEach(function(item){
			string += ("name "+item.name+" size "+sizeHelper(item.size, ltPropFileUnit, ltPropDigits, ltPropSizeFormat)) + " "
		});
		return string;
	},
	...
	constructReasonAsStr : function(object) {
		var str = "";
		if(object.fileCount) {
	...
	validateAndGetType : function(fileName, fileType, reason){
		...
		if(fileName){
			...
			extension = this.extCaseSensitive  ? extension : extension.toLowerCase();
	...
	checkFileName : function(fileName, fileObject) {
		return fileName === fileObject.name;
	},
	findDuplicateInArray : function(array, fileName) {
		var index = this.findIndex(array, this.checkFileName.bind( this, fileName ))
		return index > -1;
	},
	validateDuplicateFile : function(fileObject, reason) {
	...
	validate : function( files ){ 
		...
		for( var j = 0; j < files.length; j++ ) {
			...
			if ( Object.keys(reason).length > 0 ){ 
				...
				if(listErrorFiles) { 
					Lyte.arrayUtils( this.data.queueList, 'push', fileObject );
				}
		...
		this.getMethods( 'onValidationEnd' ) && this.executeMethod( 'onValidationEnd', this.$node, this.data.queueList );
	...
	getValidQueueListCount : function() {
		var queueList = this.data.queueList;
	...
	changeFileName : function(fileObject) {
	...
	constructFileObject : function(file, isChunk, fileType, errorMsg) {
		var fileObject = { id : 'lyte' + new Date().getTime() + parseInt( Math.random() * 10E10 ), file : file, size : file.size, name : file.name, isChunk: isChunk, retry : 0, fileType : ( fileType? fileType:'document') };
 		if( this.data.ltPropThumb && /image/i.test( file.type ) ) {
 			Lyte.Component.set( fileObject, 'src', URL.createObjectURL( file ) );
		}
		if(errorMsg) {
 	...
 	add : function( file, fileObject ){ //fileobject => file info,  file =>File Constructor
		Lyte.arrayUtils( this.data.queueList, 'push', fileObject );
		this.addToTotalFilesSize(file.size);
		Lyte.arrayUtils( this.data.uploadedFiles, 'push', fileObject );
		Lyte.arrayUtils( this.data.ltPropFiles, 'push' , file);
	...
	getRelativePath : function(fileInfo) {
	...
	finishcallback :function(files){
	 ...
	 convertToBytes : function(){
		...
		if(size){
			...
			var predefinedList = this.data.predefinedList;
			var sizeValue = this.data.ltPropSizeFormat === "decimal" ? 1000 : 1024;
			if(indexOf > -1){
				this.setData("totalFilesSize",totalSize*(Math.pow(sizeValue,indexOf+1)))
			}
	 ...
	 getTotalFileSize : function(array) {
		var fileSize = 0;
	...
	getFilesFromEntry : function(entry, fileList, path) {
	...
	getFilesFromDirectory : function(directory, path, fileList) {
		var self = this;
	...
	filterDropItems : function(items) {
		var self = this;
	...
	getValidDroppedItems : function(dataTransfer, event) { // Valid file and folder
		var self = this;
	...
	getValidFileFromUrl : function(dataItems) { // Valid file from url
		return new Promise(function(resolve, reject){
			const clonedDataItems = Array.from(dataItems);
			clonedDataItems.forEach(function(item) {
				if (item.kind === "string" && item.type === "text/uri-list") {
					item.getAsString(function(url) {
						_lyteUiUtils.getImageFromUrl(url).then(function(file) {
	...
	actions : {
		...
		drop : function( evt ){
			...
			if (dT.files.length)  {
				...
				var self = this;
				evt.preventDefault();
				this.getValidFileFromUrl(dT.items).then(function(validList){
					debugger;
					if( validList.length ) {
						if( self.getMethods( 'onBeforeDrop' ) && self.executeMethod( 'onBeforeDrop', evt, self.$node, validList ) == false ) {
							return;
					...
					self.getMethods( 'onError' ) && self.executeMethod( 'onError', error , self.$node, "drop" );
				})
			}
		},
...
_lyteUiUtils.addGlobalEventListener( 'paste', function( event ) {
