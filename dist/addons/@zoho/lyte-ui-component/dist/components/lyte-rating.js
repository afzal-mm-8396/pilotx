...
_template:"<template tag-name=\"lyte-rating\" class=\"{{lyteUiAddClassRating(this,ltPropWrapperClass,ltPropReadOnly)}}\" lyte-rating=\"\"> <template is=\"if\" value=\"{{ltPropYield}}\"><template case=\"true\"> <lyte-yield yield-name=\"rateIcon\"></lyte-yield> </template><template case=\"false\"><template is=\"if\" value=\"{{expHandlers(ifNotEquals(ltPropAppearance,'smiley'),'&amp;&amp;',lyteUiIfEqualsAny(ltPropType,'switch','multiple'))}}\"><template case=\"true\"> <template is=\"for\" items=\"{{countArray}}\" item=\"item\" index=\"index\"> <template is=\"if\" value=\"{{expHandlers(expHandlers(ltPropAllowDimension,'!'),'&amp;&amp;',ifNotEquals(ltPropAppearance,'custom'))}}\"><template case=\"true\"><lyte-rate-icon class=\"{{lyteUiGetArrayValueByIndex(emptyIconArray,index)}}\" data-lrc=\"{{item.ind}}\"></lyte-rate-icon></template><template case=\"false\"><lyte-rate-icon class=\"{{lyteUiGetArrayValueByIndex(emptyIconArray,index)}}\" data-lrc=\"{{item.ind}}\" style=\"{{lyteUiConcat('width:',ltPropWidth,'; height:',ltPropHeight,';')}}\"></lyte-rate-icon></template></template> </template> </template><template case=\"false\"><template is=\"if\" value=\"{{ifEquals(ltPropType,'svg')}}\"><template case=\"true\"> <template is=\"for\" items=\"{{countArray}}\" item=\"item\" index=\"index\"> <lyte-rate-icon class=\"{{lyteUiGetArrayValueByIndex(emptyIconArray,index)}}\" data-lrc=\"{{item.ind}}\"> <template is=\"if\" value=\"{{lyteUiCheckHalfRatingSvg(ltPropHalfIncrement,ltPropPrecision)}}\"><template case=\"true\"> <svg viewBox=\"{{item.viewbox}}\" style=\"{{lyteUiConcat('width:',ltPropWidth,'; height:',ltPropHeight,lyteUiGetFillOrStroke(ltPropAppearance,'var(--lyte-rating-empty-color)',ltPropStroke))}}\"> <linearGradient id=\"{{lyteUiConcat('filledGradient',ratingNum,'__',item.ind)}}\" x1=\"0%\" y1=\"0%\" x2=\"100%\" y2=\"0%\"> <stop offset=\"0%\" style=\"stop-color: var(--lyte-rating-empty-color);\"></stop> <stop offset=\"0%\" style=\"stop-color: var(--lyte-rating-empty-color);\"></stop> <stop offset=\"0%\" style=\"stop-color: var(--lyte-rating-empty-color);\"></stop> </linearGradient> <use href=\"{{item.appearance}}\" fill=\"{{lyteUiConcat('url(#','filledGradient',ratingNum,'__',item.ind,')')}}\"></use> </svg> </template><template case=\"false\"> <svg viewBox=\"{{item.viewbox}}\" style=\"{{lyteUiConcat('width:',ltPropWidth,'; height:',ltPropHeight,lyteUiGetFillOrStroke(ltPropAppearance,'var(--lyte-rating-empty-color)',ltPropStroke))}}\"> <use href=\"{{item.appearance}}\"></use> </svg> </template></template> </lyte-rate-icon> </template> </template><template case=\"false\"> <template is=\"for\" items=\"{{countArray}}\" item=\"item\" index=\"index\"> <template is=\"if\" value=\"{{expHandlers(expHandlers(lyteUiIfEqualsAny(ltPropAppearance,'smiley','heart'),'&amp;&amp;',lyteUiIfEqualsAny(ltPropType,'toggle','multiple','switch')),'&amp;&amp;',expHandlers(ltPropAllowDimension,'!'))}}\"><template case=\"true\"> <lyte-rate-icon class=\"{{ltPropEmptyIcon}}\" data-lrc=\"{{item.ind}}\"></lyte-rate-icon> </template><template case=\"false\"> <lyte-rate-icon class=\"{{ltPropEmptyIcon}}\" data-lrc=\"{{item.ind}}\" style=\"{{lyteUiConcat('width:',ltPropWidth,'; height:',ltPropHeight,';')}}\"></lyte-rate-icon> </template></template> </template> </template></template></template></template></template></template> <svg version=\"1.1\" id=\"Layer_1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" x=\"0px\" y=\"0px\" viewBox=\"0 0 18 18\" style=\"display: none;\" xml:space=\"preserve\"> <g> <path id=\"heart\" d=\"M7.2,1C4.5,1,2.3,3.4,2.1,6.7c0,0.1-0.1,0.9,0.2,2.2c0.4,1.8,1.3,3.4,2.6,4.7l6.6,6.5l6.7-6.5 c1.3-1.3,2.2-2.9,2.6-4.7c0.3-1.2,0.2-2,0.2-2.2C20.7,3.4,18.6,1,15.9,1c-1.8,0-3.4,1-4.4,2.7C10.5,2,8.9,1,7.2,1L7.2,1z\"></path> </g> </svg> <svg version=\"1.1\" id=\"Layer_1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" x=\"0px\" y=\"0px\" viewBox=\"0 0 18 18\" style=\"display: none;\" xml:space=\"preserve\"> <style type=\"text/css\"> .st0{fill:none;stroke-miterlimit:10;} </style> <g> <path id=\"lineHeart\" class=\"st0\" d=\"M6.1,1C3.4,1,1.2,3.4,1,6.7c0,0.1-0.1,0.9,0.2,2.2c0.4,1.8,1.3,3.4,2.6,4.7l6.6,6.5l6.7-6.5 c1.3-1.3,2.2-2.9,2.6-4.7c0.3-1.2,0.2-2,0.2-2.2C19.7,3.4,17.6,1,14.9,1c-1.8,0-3.4,1-4.4,2.7C9.4,2,7.8,1,6.1,1L6.1,1z\"></path> </g> </svg> <svg version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" x=\"0px\" y=\"0px\" viewBox=\"5 5 89.6 80\" style=\"display: none;\" xml:space=\"preserve\"> <polygon id=\"star\" points=\"17,4.7 19.5,12 27,12 21,16.6 23.2,23.8 17,19.5 10.8,23.8 13,16.6 7,12 14.5,12 \"></polygon> </svg> </template>",
_dynamicNodes : [{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[{"type":"insertYield","position":[1]}]},"false":{"dynamicNodes":[{"type":"attr","position":[0]},{"type":"if","position":[0],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"for","position":[1],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[0]},{"type":"componentDynamic","position":[0]}]},"false":{"dynamicNodes":[{"type":"attr","position":[0],"attr":{"style":{"name":"style","helperInfo":{"name":"lyteUiConcat","args":["'width:'","ltPropWidth","'; height:'","ltPropHeight","';'"]}}}},{"type":"componentDynamic","position":[0]}]}},"default":{}}]}]},"false":{"dynamicNodes":[{"type":"attr","position":[0]},{"type":"if","position":[0],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"for","position":[1],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,1]},{"type":"if","position":[1,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1],"attr":{"style":{"name":"style","helperInfo":{"name":"lyteUiConcat","args":["'width:'","ltPropWidth","'; height:'","ltPropHeight",{"type":"helper","value":{"name":"lyteUiGetFillOrStroke","args":["ltPropAppearance","'var(--lyte-rating-empty-color)'","ltPropStroke"]}}]}}}},{"type":"attr","position":[1,1]},{"type":"attr","position":[1,3]}]},"false":{"dynamicNodes":[{"type":"attr","position":[1],"attr":{"style":{"name":"style","helperInfo":{"name":"lyteUiConcat","args":["'width:'","ltPropWidth","'; height:'","ltPropHeight",{"type":"helper","value":{"name":"lyteUiGetFillOrStroke","args":["ltPropAppearance","'var(--lyte-rating-empty-color)'","ltPropStroke"]}}]}}}},{"type":"attr","position":[1,1]}]}},"default":{}},{"type":"componentDynamic","position":[1]}]}]},"false":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"for","position":[1],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"componentDynamic","position":[1]}]},"false":{"dynamicNodes":[{"type":"attr","position":[1],"attr":{"style":{"name":"style","helperInfo":{"name":"lyteUiConcat","args":["'width:'","ltPropWidth","'; height:'","ltPropHeight","';'"]}}}},{"type":"componentDynamic","position":[1]}]}},"default":{}}]}]}},"default":{}}]}},"default":{}}]}},"default":{}}],
_templateAttributes :{"type":"attr","position":[]},
_observedAttributes :["ltPropValue","ltPropCount","ltPropWrapperClass","ltPropType","ltPropAppearance","ltPropReadOnly","ltPropClearable","ltPropHalfIncrement","ltPropEmptyIcon","ltPropFullIcon","ltPropHalfIcon","ltPropHoverFullIcon","ltPropHoverHalfIcon","ltPropYield","ltPropEmptyColor","ltPropFillColor","ltPropHoverColor","ltPropWidth","ltPropHeight","ltPropPrecision","ltPropStroke","ltPropAllowDimension","countArray","currentHover","emptyIconArray","fullIconArray","halfIconArray","hoverFullIconArray","hoverHalfIconArray","starVB","lineStarVB","heartVB","lineHeartVB","ratingNum"],
_observedAttributesType :["number","number","string","string","string","boolean","boolean","boolean","string","string","string","string","string","boolean","string","string","string","string","string","number","string","boolean","array","number","array","array","array","array","array","string","string","string","string","number"],
	...
	data : function(){
		return {
			 ...
			 * @input
             */
			"ltPropValue" : Lyte.attr("number",{"default":0 , 'input' : 'true', 'output' : 'true' }),
			 ...
			 * @maxValue 10
             */
			"ltPropCount" : Lyte.attr("number",{"default":5, 'input' : 'true', 'output' : 'false'}),
			 ...
			 * @input
             */
			"ltPropType" : Lyte.attr("string",{"default":"svg", 'input' : 'true', 'output' : 'false'}),	//svg,multiple,switch,toggle,class

			/**
             * @componentProperty {star|heart|lineStar|lineHeart|smiley|likeDislike|custom} ltPropAppearance
             * @version 3.1.0
			 * @condition ltPropType svg,toggle,multiple,switch
			 * @allowedValuesDepends ltPropType
			 * @map svg star,heart,lineStar,lineHeart
			 * @map class custom
			 * @map multiple smiley,custom
			 * @map switch likeDislike,custom
			 * @map toggle heart,custom
			 * @input
             */
			"ltPropAppearance" : Lyte.attr("string",{"default" : '', 'input' : 'true', 'output' : 'false'}),				//star,heart,lineStar,lineHeart,smiley,likeDislike,custom
             ...
             * @input
             */
			"ltPropReadOnly" : Lyte.attr("boolean",{"default":false, 'input' : 'true', 'output' : 'false'}),

			/**
             * @componentProperty {boolean} ltPropClearable
			 * @condition ltPropType svg,multiple,class
             * @version 3.1.0
             * @default false
             * @input
             */
			"ltPropClearable" : Lyte.attr("boolean",{"default":false, 'input' : 'true', 'output' : 'false'}),

			/**
             * @componentProperty {boolean} ltPropHalfIncrement
             * @version 3.1.0
             * @default false
             * @condition ltPropType class,svg
			 * @condition ltPropAppearance star,heart,custom,lineStar,lineHeart
			 * @input
             */
			"ltPropHalfIncrement" : Lyte.attr("boolean",{"default":false, 'input' : 'true', 'output' : 'false' }),

			/**
             * @componentProperty {string} ltPropEmptyIcon
             * @version 3.1.0
             * @default lyteRatingHeartEmptyIcon
			 * @condition ltPropType class,multiple,toggle,switch 
			 * @condition ltPropAppearance custom,class
			 * @input
             */
			"ltPropEmptyIcon" : Lyte.attr("string",{"default":"lyteRatingHeartEmptyIcon", 'input' : 'true', 'output' : 'false'}),
			 ...
			 * @input
             */
			"ltPropFullIcon" : Lyte.attr("string",{"default":"lyteRatingHeartRatedIcon",'input' : 'true', 'output' : 'false'}),

			/**
             * @componentProperty {string} ltPropHalfIcon
             * @version 3.1.0
             * @default lyteRatingHalf
			 * @condition ltPropHalfIncrement true
			 * @condition ltPropType class
			 * @input
             */
			"ltPropHalfIcon" : Lyte.attr("string",{"default":"lyteRatingHeartRatedHalfIcon", 'input' : 'true', 'output' : 'false'}),
			 ...
			 * @input
             */
			"ltPropHoverFullIcon" : Lyte.attr("string",{"default":"lyteRatingHeartHoverRatedIcon",'input' : 'true', 'output' : 'false'}),
			 ...
			 * @input
             */
			"ltPropHoverHalfIcon" : Lyte.attr("string",{"default":"lyteRatingHeartHoverHalfIcon", 'input' : 'true', 'output' : 'false'}),
			 ...
			 * @input
             */
			"ltPropEmptyColor" : Lyte.attr("string",{"default":'', 'input' : 'true', 'output' : 'false'}),
			 ...
			 * @input
             */
			"ltPropFillColor" : Lyte.attr("string",{"default":'', 'input' : 'true', 'output' : 'false'}),
			 ...
			 * @input
             */
			"ltPropHoverColor" : Lyte.attr("string",{"default":'', 'input' : 'true', 'output' : 'false'}),
			 ...
			 * @condition ltPropType svg,class
			 * @condition ltPropAppearance star,heart,lineStar,lineHeart,custom,class
			 * @input
             */
			"ltPropWidth" : Lyte.attr("string",{"default":"22px", 'input' : 'true', 'output' : 'false'}),
			 ...
			 * @input
             */
			"ltPropHeight" : Lyte.attr("string",{"default":"22px", 'input' : 'true', 'output' : 'false'}),
			 ...
			 * @input
             */
			"ltPropPrecision" : Lyte.attr("number",{"default":0.5, 'input' : 'true', 'output' : 'false'}),
			/**
             * @componentProperty {string} ltPropStroke
             * @version 3.1.0
			 * @input
             */
			"ltPropStroke" : Lyte.attr("string",{'default': '', 'input' : 'true', 'output' : 'false'}),
			"ltPropAllowDimension" : Lyte.attr('boolean',{"default" : true}),
	...
	onColorchange : function(){
		if(this.getData('ltPropStroke')){
			this.$node.style.setProperty('--lyte-rating-empty-color',this.getData('ltPropStroke'));
		}else if(this.getData('ltPropEmptyColor')){
	...
	didConnectFn : function(){
		...
		if(!this.rendered){
			...
			if(this.getMethods("onRender")){
				/**
				 * This will be executed once the rating component is rendered.
				 * @method onRender
	...
	setRating : function(stopMethod){
		...
		if(this.getData('ltPropType') == "svg"){
			if(this.getData('ltPropHalfIncrement')){
				var stops;
				var emptyColor = ['star','heart'].includes(this.getData('ltPropAppearance')) ?  this.getEmptyColor() : 'transparent';
				...
				for(var i = Math.floor(currentRating); i < nodes.length; i++){
					...
					stops[2].setAttribute('offset','0%');
					stops[0].style.stopColor = emptyColor;
					stops[1].style.stopColor = emptyColor;
					stops[2].style.stopColor = emptyColor;
		...
		if(!stopMethod && this.getMethods("onClick")){
			/**
			 * This will be executed once a rating icon is clicked.
			 * @method onClick
			 * @author santhoshraj.s@zohocorp.com
			 * @param { number } value
			 * @param { object } component
	...
	onOver : function(event){
		...
		if(prevValue != this.getData('currentHover') && this.getMethods("onHover")){
			/**
			 * This will be executed when the mouse is over a rating icon.
			 * @method onHover
			 * @author santhoshraj.s@zohocorp.com
			 * @param { number } value
			 * @param { object } component
	...
	onOut : function(event){
		...
		if(this.getMethods("onOut")){
			/**
			 * This will be executed after the mouse moves out of a rating icon.
			 * @method onOut
			 * @author santhoshraj.s@zohocorp.com
			 * @param { number } value
			 * @param { object } component
