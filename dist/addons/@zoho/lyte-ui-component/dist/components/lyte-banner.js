...
_observedAttributesType :["object","boolean","boolean","object","object","boolean","boolean","string","string","string","string","string","string","string","string","object","boolean","string","boolean","boolean"],
	...
	data:function(){
		return {
			 ...
			 * @ignore-props ltPropShow,ltPropTransition,ltPropOffset,ltPropShowCloseButton,ltPropWidth,ltPropHeight,ltPropReRenderModal,ltPropBindToBody, ltPropTransition
			 * @input
			 */
			 ...
			 * @input
			 */
			"ltPropFloating":Lyte.attr("boolean",{"default":true,"input": true}),
			/** 
			 * @componentProperty {boolean} ltPropInline=false
			 * @input
			 */
			"ltPropInline":Lyte.attr("boolean",{"default":false,"input": true}),
			/** 
			...
			*/
			 ...
			 * @input
			 */
			"ltPropTransition":Lyte.attr("object",{
				"default":_lyteUiUtils.resolveDefaultValue('lyte-banner', 'transition', {animation:"slideFromTop",duration:"0.5"}),
				"input": true
			}),
			/**
			 ...
			 * @input
			 */
			"ltPropShowCloseButton":Lyte.attr("boolean",{"default":true, "input": true}),
			/** 
			 ...
			 * @input
			 */
			"ltPropInitialSpacing":Lyte.attr("string",{
				"default":_lyteUiUtils.resolveDefaultValue( 'lyte-banner', 'initialSpacing', "0px"),
				"input": true
			}),
			/** 
			 ...
			 * @input
			 */
			"ltPropBannerSpacing":Lyte.attr("string",{"default":"2px", "input": true}),
			/** 
			 * @componentProperty {string} ltPropWidth=100%
			 * @input
			 */
			"ltPropWidth":Lyte.attr("string",{
				"default":_lyteUiUtils.resolveDefaultValue( 'lyte-banner', 'width', "100%"),
				"input": true
			}),
			/** 
			...
			"ltPropHeight":Lyte.attr("string",{
				"default":_lyteUiUtils.resolveDefaultValue( 'lyte-banner', 'height', "auto"),
				"input": true
			}),
			/** 
			 ...
			 * @input
			 */
			"ltPropReRenderModal" : Lyte.attr("string",{"default":false , "input": true}),
			/** 
			 * @componentProperty {boolean} ltPropBindToBody=false
			 * @input
			 */
			"ltPropBindToBody" : Lyte.attr("string",{"default":false, "input": true}),
			/**
            ...
            */
			...
			"ltPropOverrideOffset" : Lyte.attr('boolean',{'default' : false}),
	...
	onBeforeShow : function(){
		if(this.getMethods('onBeforeShow')){
			/**
			 * This will be executed before the banner is shown. Returning false from this callback will prevent banner from showing.
			 * @method onBeforeShow
	...
	onShow : function(){
		if(this.getMethods('onShow')){
			/**
			 * This will be executed after the banner is shown.
			 * @method onShow
			 * @author varun.a@zohocorp.com
			 * @param { object } component
			 */
	...
	onBeforeClose : function(){
		if(this.getMethods('onBeforeClose')){
			/**
			 * This will be executed before the banner close. Returning false from this callback will prevent banner from closing.
	...
	onClose : function(){
		if(this.getMethods('onClose')){
			/**
			 * This will be executed once the banner is closed.
			 * @method onClose
			 * @author varun.a@zohocorp.com
			 * @param { object } component
			 */
	...
	transitionEnd : function(callback, event){
	...
	rearrangeBanner : function(){
		...
		if(position != "" && _LyteBanner_[position] && _LyteBanner_[position].length){
			...
			if(!this.data.ltPropOverrideOffset) {
	...
	methods:{
		modalOnBeforeShow:function(component){
			...
			if(offsetFlag || this.data.ltPropOverrideOffset){
				var position = this.$node.ltProp("Position"),
				init_diff = parseFloat(this.$node.ltProp("InitialSpacing")),
				banner_diff = parseFloat(this.$node.ltProp("BannerSpacing"));
				var offsetVal = this.data.ltPropOverrideOffset ? this.data.ltPropOffset : {"left" : "0px"};
				if(position){
					...
					if(banners.length){
						...
						if(position == "top"){
							offsetVal.top = height+"px";
							component.$node.ltProp("offset", offsetVal);
						}
						else{
							this.$node.ltProp("transition",{"animation":"slideFromBottom"});
							offsetVal.bottom = height+"px";
							this.$node.ltProp("offset", offsetVal);
						}
					}
					else{
						if(init_diff){
