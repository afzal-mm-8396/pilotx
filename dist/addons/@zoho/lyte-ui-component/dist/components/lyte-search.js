 ...
 * @import lyte-input
 * @ignoreMethods
 * @ignoreUtils revertToSelected,revertToToday,focus,blur,click,select
 * @ignoreProperties
 */
...
_observedAttributesType :[null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null],


   _lyteUtilFunctions : [ "setValue", "focus", "blur", "select", "click" ],

   init : function(){
         /**
          * This method is called before rendering the search component
          * @method beforeRender 
    ...
    didConnect : function(){
        ...
        /**
         * This method is called after rendering the search component
         * @method afterRender
         * @author ponkarthikeyan.t@zohocorp.com
         * @version 1.0.1
         * @param { object } searchElement
     ...
     data : function (){
        ...
        __value;
          ...
          return {
              ...
              * @version 1.0.0
              * @linkTo lyte-input ltPropAutocomplete
              * @input
              */
              ...
              * @input
              */
             ltPropPlaceholder : Lyte.attr(__string, { default : default_values.search || '', input : true }),
             ltPropAutofocus : Lyte.attr( __boolean, { default : default_values.autofocus || false, input : true }),
             /**
              * @componentProperty {boolean} ltPropDisabled=false
              * @version 1.0.0
              * @linkTo lyte-input ltPropDisabled
              * @input
              */
              ...
              * @input
              */ 
             ltPropMaxlength : Lyte.attr( __number, { default : default_values.maxlength || 25, input : true }),
              /**
             ...
             ltPropId : Lyte.attr( __string, { default : default_values.id || 'inputId', input : true }),
             ltPropClass : Lyte.attr( __string, { default : default_values.class || '', input : true }),
             ltPropType : Lyte.attr( __string, { default : 'search', input : true }),
             ltPropName : Lyte.attr( __string, { default : '', input : true }),
             ltPropWidth : Lyte.attr( __string, { default : default_values.width || '100%', input : true }),
              ...
              */
             ltPropValue : Lyte.attr( __string, { default : '', input : true, output : true }),
              /**
               ...
               * @input
               */
             ltPropAppearance : Lyte.attr( __string, { default : default_values.appearance || 'flat', input : true }),
              ...
              * @input
              */
             ltPropQuerySelector : Lyte.attr( __object, { default : {}, input : true }),
             /**
              ...
              * @input
              */
             ltPropMinLength : Lyte.attr( __number, { default : ( __value = default_values.minLength ) == void 0 ? 1 : __value, input : true }),
             /**
              * @componentProperty {startsWith | endsWith | contains} ltPropMethod=contains
              * @version 1.0.0
              * @input
              */
             ltPropMethod : Lyte.attr( __string, { default : default_values.method || 'contains', input : true }),
             ...
             ltPropAutoUpdate : Lyte.attr( __boolean, { default : true, input : true }),
             ...
             ltPropSearchDelay : Lyte.attr( __number, { default : default_values.hasOwnProperty( 'searchDelay' ) ? default_values.searchDelay : 100, input : true }),
             /**
              * @componentProperty {boolean} ltPropCaseSensitive=false
              * @version 2.2.10
              * @input
              */
             ltPropCaseSensitive : Lyte.attr( __boolean, { default : default_values.caseSensitive || false, input : true } ),
             /**
              * @componentProperty {accordion|tree} ltPropComponent
              * @version 2.0.0
              * @input
              */
             ltPropComponent : Lyte.attr( __string, { default : undefined, input : true } ),
             /**
              * @componentProperty {boolean} ltPropTrim=false
              * @version 2.2.6
              * @input
              */
             ltPropTrim : Lyte.attr( __boolean, { default : default_values.trim || false, input : true } ),
             ltPropFocus : Lyte.attr( __boolean, { default : default_values.focus || false, input : true } ),
             ...
             ltPropDiacritic : Lyte.attr( __boolean, { default : default_values.diacritic || false, input : true } ),

             /**
              * @componentProperty {boolean} ltPropMaintainState=true
              * @condition ltPropComponent accordion
              * @version 3.16.3
              * @input
              */

             ltPropMaintainState : Lyte.attr( __boolean, { default : ( __value = default_values.maintainState ) == void 0 ? true : __value, input : true } ),

            //  /**
            //   * @componentProperty {boolean} ltPropPreventEmptyKeys=false
            //   * @version 3.19.3
            //   * @input
            //   */

             ltPropPreventEmptyKeys : Lyte.attr( __boolean, { default : default_values.preventEmptyKeys || _lyteUiUtils.isWidget } ),

            /**
              * @componentProperty {boolean} ltPropMultipleSearch=false
              * @condition ltPropComponent undefined
              * @version 3.25.0
              * @input
              */

             ltPropMultipleSearch : Lyte.attr( __boolean, { default : default_values.multipleSearch || false, input : true } ),

             /**
              * @componentProperty {boolean} ltPropIgnoreChildren=false
              * @condition ltPropComponent tree
              * @version 3.27.0
              * @input
              */

              ltPropIgnoreChildren : Lyte.attr( __boolean, { default : default_values.ignoreChildren || false, input : true } ),
              ltPropInput : Lyte.attr( __string, { default : default_values.input || '{}', input : true } ),
              ltPropDontHideOnEmpty : Lyte.attr( __boolean, { default : default_values.aria || false, input : true } ),
                  ...
                  if(! _children.childElementCount)
                      {
                        ...
                        if(query.target)
                          {
                            var scope = this.getScope( typeof query.scope == 'string' ? document[ _lyteUiUtils.isWidget ? "querySelectorGlobal" : "querySelector" ]( query.scope.trim() ) : query.scope ),
     ...
     actions : {
        "on-ip-clear" : function( evt ){
              this.$node.setValue( '', { type : 'clear' } );
               /**
                * This method is called when the search input is cleared
                * @method onClear 
                * @author ponkarthikeyan.t@zohocorp.com
                * @version 2.2.9
                * @param { object } searchElement
        ...
        'input' :  function( evt ) {
              ...
              if( value.length >= minLength || /delete/i.test( evt.inputType || "" ) ){
                if( delay == undefined ){
                   this.pressFunc( value, evt );
                } else {
        ...
        fNcase : function( str ){
         ...
         multi_search : function( value, evt ){
           ...
           scope = $L( _lyteUiUtils.isWidget ? document.querySelectorGlobal( query.scope ) : query.scope ),
        ...
        check_label : function( visible, hidden, related, label, target_visible, target_hidden, evt, value ){
          ...
          // here need to process on target hidden instead of hidden
         ...
         /**
          * This method is called when the search operation is performed
          * @method onSearch 
          * @author ponkarthikeyan.t@zohocorp.com
          * @version 2.2.9
          * @param { array } visibleElementsList
          * @param { object } searchElement
          * @param { object } event
          * @param { string } value
          * @param { array } hiddenElementsList
          */
          ...
          this.common_hide( target_visible, target_hidden, evt );
        },
        ...
        filteringArray : function(searchList, targetList, val, searchComp, evt, related, label ){
            ...
            if( val.length )
             ...
             if( this.data.ltPropSearchDelay == undefined ) {
               ...
               $L.fastdom.clear( this.___fdm );
               this.___fdm = $L.fastdom.mutate( this.hideProcess.bind( this, searchList, targetList, method, val, related, evt, hiddenList, visibleList ) )
             }
        },
        ...
        listboxfilter : function( vis, hid, value, clear ){
          var query = this.data.ltPropQuerySelector,
          scope_str = this.getScope( query.scope ),
          scope = $L( typeof scope_str == "string" && _lyteUiUtils.isWidget ? document.querySelectorGlobal( scope_str ) : scope_str ),
          _length = vis.length,
          toOpen = [];
        ...
        accfilter : function( vis, hid, value, clear ){
            var __scope_str = this.getScope( this.data.ltPropQuerySelector.scope ),
            scope = _lyteUiUtils.isWidget ? $L( document.querySelectorGlobal( __scope_str ) ) : $L( __scope_str ),
            ...
            $L.fastdom.mutate( function(){
               ...
               var is_exclusive =  _lyteUiUtils.isWidget || scope.get( 0 ).ltProp( 'exclusive' ),
               is_not_value = !value && this.data.ltPropMaintainState,
               __map = new Map();
                ...
                for( var i = 0; i < vis.length; i++ ){
                   ...
                   if( isclose ){
                     if( __map.has( close[ 0 ] ) ){
                        continue;
                     }
                     __map.set( close[ 0 ], true );
                      close.click();
                ...
                for( var j = 0; j < hid.length; j++ ){
                    ...
                    if( clear ){
                      __is_allow_click = !close[ 0 ]._state && close.hasClass( active );
                    } else {
                       __is_allow_click = close.hasClass( active );
                    }
       ...
       treefilter : function( visible, hidden, value, clear ){
            var data = this.data,
            scope_str = this.getScope( data.ltPropQuerySelector.scope ),
            scope = $L( typeof scope_str == "string" && _lyteUiUtils.isWidget ? document.querySelectorGlobal( scope_str ) : scope_str ).get( 0 ),
            ...
            for( var i = 0; i < vis_len; i++ ){
                var cur = __map.get( visible[ i ] ) || this.closest( visible[ i ], query ),
                _dom = cur.get( 0 );

               __map.set( visible[ i ], cur );

                for( var j = 0; j < hid_len; j++ ){
                    var cur_close = __map.get( hidden[ j ] ) || this.closest( hidden[ j ], query ),
                    hid_dom = cur_close.get( 0 );

                   __map.set( hidden[ j ], cur_close );
            ...
            for( var i = 0; i < vis_len; i++ ){
                ...
                if( value ){
                    ...
                    if( _lyteUiUtils.isWidget ){
                     var tree_body = this.closest( cur, 'lyte-tree-body' );
                     if( !tree_body.hasClass( 'lyteTreeBodyOpened') ){
                        tree_body.find( 'lyte-tree-icon' ).eq( 0 ).click();
                     }
                    } else {
            ...
            if( value || data.ltPropDontHideOnEmpty ){
                hidden.forEach( function( item ){
                    ( __map.get( item ) || this.closest( item, query ) ).addClass( hidden_class );
                }.bind( this ));
            } else {
                this.hiderecurse( $L( 'lyte-yield:not(.noChildClass) lyte-tree-icon', scope ), clear, scope );
            }

            this.last_tree_element( visible, hidden, scope, __map );
       },

        last_tree_element : function( visible, hidden, scope, __map ){

          var class_name = 'lyteTreeBodyDivLastVisibleElem',
          query = 'lyteTreeBodyDiv',
          search_class = "lyteSearchHidden",
          fn = function( item ){
             var elem = $L( __map.get( item ) || item.closest( '.' + query, scope ) ),
             fn_name = "addClass";
        ...
        hiderecurse : function( elem, flag, scope ){
           ...
           for( var i = elem.length - 1; i >= 0; i-- ) {
              ...
              if( fn ){
                  if( _lyteUiUtils.isWidget ){
                     if( fn == "closeTree" && icon.closest( '.lyteTreeBodyClosed' ) ){
                        return;
                     }
                     setTimeout( __fn.bind( this, icon ), 20 );
        ...
        pressFunc : function ( val, evt ){
               /**
                * This method is called when the search input is pressed
                * @method onBeforeSearch 
                * @author ponkarthikeyan.t@zohocorp.com
                * @version 3.86.0
                * @param { object } event
                * @param { object } searchElement
            ...
            if( this.getMethods("onGetValue") ){
               let ret = this.executeMethod("onGetValue", val, this.$node );
               if( ret != void 0 ){
                  val = ret;
               }
            }
             ...
             var scope = typeof query.scope == 'string' ? document[ _lyteUiUtils.isWidget ? "querySelectorGlobal" : "querySelector" ]( query.scope.trim() ) : query.scope;
