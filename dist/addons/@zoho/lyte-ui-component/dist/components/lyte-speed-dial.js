...
_observedAttributesType :["boolean","array"],
	...
	speedShowFunction : function(node){
		if(this.$node.getData('ltPropSpeedShow')){
			...
			if(this.getMethods('onBeforeShow')){
				var onBeforeShowVal = null;
				if(this.getMethods('onBeforeShow')){
					onBeforeShowVal = this.executeMethod('onBeforeShow');
				}
			}
