...
_observedAttributes :["ltPropType","ltPropShow","ltPropWrapperClass","ltPropAllowMultiple","ltPropHeading","ltPropPrimaryMessage","ltPropSecondaryMessage","ltPropTop","ltPropButtons","ltPropButtonPosition","ltPropShowCloseButton","ltPropCloseOnEscape","ltPropDimmer","ltPropYield","ltPropAnimation","ltPropContentAlign","ltPropAria","ltPropAriaAttributes","ltPropPreventFocus","ltPropFocusOnClose","nonYieldFooter","triggerShow","escClicked"],
_observedAttributesType :["string","boolean","string","boolean","string","string","string","string","array","string","boolean","boolean","object","boolean","string","string","boolean","object","boolean","boolean","boolean","number","object"],
    ...
    data: function(){
        return {
             ...
             * @input
             */
            "ltPropType":Lyte.attr("string",{"default": "",input:true,output:false}),
             ...
             * @input
             */
            "ltPropShow":Lyte.attr("boolean",{"default": false , input:true,output:false}),
             ...
             * @output
             */
            "ltPropWrapperClass":Lyte.attr("string",{"default": "",input:true,output:true}),
             ...
             * @output
             */
            "ltPropHeading":Lyte.attr("string",{"default": "",input:true,output:true}),
             ...
             * @output
             */
            "ltPropPrimaryMessage":Lyte.attr("string",{"default": "",input:true,output:true}),
             ...
             * @output
             */
            "ltPropSecondaryMessage":Lyte.attr("string",{"default": "",input:true,output:true}),
             ...
             * @input
             */
            "ltPropTop":Lyte.attr("string",{"default":"40px",input:true,output:false}),
             ...
             * @output
             */
            "ltPropButtons":Lyte.attr("array",{"default": [],input:true,output:true}),
             ...
             * @input
             */
            "ltPropButtonPosition":Lyte.attr("string",{"default": "right",input:true,output:false}),
             ...
             * @output
             */
            "ltPropDimmer":Lyte.attr("object",{"default":{"color":"black","opacity":"0.4"},input:true,output:false}),
             ...
             * @output
             */
            "ltPropYield":Lyte.attr("boolean",{"default":false,input:true,output:true}),
             ...
             * @input
             */
            "ltPropAnimation" : Lyte.attr("string",{"default":"slideDown",input:true,output:false}), //Other value zoomIn
             ...
             * @input
             */
            "ltPropContentAlign" : Lyte.attr("string",{"default" : "left",input:true,output:false}), //other value center
             ...
             * @output
             */
            "ltPropAriaAttributes" : Lyte.attr( 'object', { default : {}, watch:true ,input:true,output:true} ),
    ...
    addAriaValues : function() {
        if(this.getData('ltPropAria')){
            ...
            if('aria-describedby' in ariaProp){
                ...
                if(content){
                    ariaProp['aria-describedby'].split(' ').map((className)=>{
    ...
    showToggled : function() {
        ...
        if(!this.$node.ltProp("show")){
            _lyteUiUtils.dispatchEvent('lyteAlertBeforeClose' , this.actualModalDiv)
            if(this.getMethods("onBeforeClose")){
                /**
                 * @method onBeforeClose
                 * @author surendran.m@zohocorp.com
                 * @version 1.0.0
                 * @param { object } lyteAlert
                 * @param { boolean } isEscClicked
                 */
    ...
    showAlert : function(){
        ...
        this.showTId = setTimeout(function(){
            ...
            if(self.actualModalDiv){
                _lyteUiUtils.dispatchEvent('lyteAlertBeforeOpened' , self.actualModalDiv, { originalEvent: null, component : self.$node, wormhole : self.actualModalDiv })
