...
_template:"<template tag-name=\"lyte-svg\" lyte-svg=\"\"> <svg class=\"{{ltPropClass}}\" viewBox=\"{{ltPropViewBox}}\"> <use id=\"{{ltPropId}}\" xlink:href=\"{{lyteUiSetURL(ltPropPath,flag)}}\"></use> </svg> </template>",
...
_observedAttributesType :["string","string","string","string","boolean"],
