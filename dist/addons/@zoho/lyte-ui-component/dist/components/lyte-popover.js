...
_observedAttributes :["ltPropShow","ltPropType","ltPropFreeze","ltPropShowCloseButton","ltPropCloseOnEscape","ltPropOriginElem","ltPropPosition","ltPropPlacement","ltPropDimmer","ltPropDraggable","ltPropAllowMultiple","ltPropScrollable","ltPropMaxHeight","ltPropMaxWidth","ltPropWidth","ltPropHeight","ltPropWrapperClass","ltPropBoundary","ltPropCloseOnBodyClick","ltPropDuration","ltPropOffset","ltPropOffsetFromTarget","ltPropBindToBody","ltPropHeaderPadding","ltPropContentPadding","ltPropFooterPadding","ltPropAnimation","ltPropWindowSpacing","ltPropForceScroll","ltPropAutoAlign","ltPropAria","ltPropAriaAttributes","ltPropPreventFocus","ltPropStopClick","ltPropIgnoreBoundary","ltPropMargin","ltPropCloseOnScroll","ltPropAllowContainment","ltPropIgnoreInput","ltPropFocusOnClose","ltPropAutoPlacement","ltPropShowWormhole","ltPropHostElement","buttons","ltPropShowCopy","visible","timeOutId","classTobeAdded","keys","first","arrowHidden","arrowEle","returnedFalse","transformOrigin","windowSpacing","lyteUnbound","prevOffsetVal","calculateHW","checkAria","prevRect","margin","modalElemWidth","modalElemHeight","dragRunning","duringAutoPlacement"],
_observedAttributesType :["boolean","string","boolean","boolean","boolean","string","string","string","object","boolean","boolean","boolean","string","string","string","string","string","object","boolean","number","object","object","boolean","string","string","string","string","object","boolean","boolean","boolean","object","boolean","boolean","boolean","object","boolean","boolean","boolean","boolean","boolean","boolean","string","array","boolean","boolean","number","string","object","boolean","boolean","object","boolean","string","object","boolean","object","boolean","number","object","object","string","string","boolean","object"],

    _lyteUtilFunctions: ['alignPopover', 'calculateOffset', 'trapFocus'],
    data: function () {
        return {
            //config from callee
            /**
             ...
             * @input
             */
            "ltPropType": Lyte.attr("string", { "default": "callout", input: true, output: false }),
             ...
             * @input
             */
            "ltPropFreeze": Lyte.attr("boolean", { "default": true, input: true, output: false }),
             ...
             * @input
             */
            "ltPropShowCloseButton": Lyte.attr("boolean", { "default": true, input: true, output: false }),
             ...
             * @input
             */
            "ltPropCloseOnEscape": Lyte.attr("boolean", { "default": true, input: true, output: false }),
             ...
             * @input
             */
            "ltPropOriginElem": Lyte.attr("string", { "default": "", input: true, output: false }),

            /**
             * @experimental ltPropPosition
             */
            /**
             * @componentProperty {string} ltPropPosition="bottom"
             * @author surendran.m@zohocorp.com
             * @version 1.0.0
             * @input
             */
            "ltPropPosition": Lyte.attr("string", { "default": "bottom", input: true, output: false }),
             ...
             * @input
             */
            "ltPropPlacement": Lyte.attr("string", { "default": "", input: true, output: false }),
             ...
             * @input
             */
            "ltPropDimmer": Lyte.attr("object", { "default": {}, input: true, output: false }),
             ...
             * @input 
             */
            "ltPropAllowMultiple": Lyte.attr("boolean", { "default": false, input: true, output: false }),
             ...
             * @input
             */
            "ltPropScrollable": Lyte.attr("boolean", { "default": false, input: true, output: false }),
             ...
             * @input
             */
            "ltPropMaxHeight": Lyte.attr("string", { "default": "", input: true, output: false }),
             ...
             * @input
             */
            "ltPropMaxWidth": Lyte.attr("string", { "default": "", input: true, output: false }),
             ...
             * @input
             */
            "ltPropHeight": Lyte.attr("string", { "default": "auto", input: true, output: false }),
             ...
             * @input
             */
            "ltPropWrapperClass": Lyte.attr("string", { "default": "", input: true, output: false }),
            /**
             ...
             * @input
             */
            "ltPropBoundary": Lyte.attr("object", { "default": {}, input: true, output: false }),
             ...
             * @input
             */
            "ltPropDuration": Lyte.attr("number", { "default": 400, input: true, output: false }),
            /**
             ...
             */
            /**
             * @componentProperty {popoverOffset} ltPropOffset
             * @version 1.0.0
             * @input
             * @output
             */
            "ltPropOffset": Lyte.attr("object", { "default": {}, input: true, output: true }),

            /**
             * @typedef {object} offsetFromTarget
             * @property {string} top
             * @property {string} left
             * @property {string} bottom
             * @property {string} right
             */
            /**
              * @componentProperty {offsetFromTarget} ltPropOffsetFromTarget
              * @input
            */
            "ltPropOffsetFromTarget": Lyte.attr("object", { "default": {}, input: true, output: false }),
             ...
             * @output
             */
            "ltPropBindToBody": Lyte.attr("boolean", { "default": false, input: true, output: true }),
             ...
             * @input
             */
            "ltPropHeaderPadding": Lyte.attr("string", { "default": "", input: true, output: false }),
             ...
             * @input
             */
            "ltPropContentPadding": Lyte.attr("string", { "default": "", input: true, output: false }),
             ...
             * @input
             */
            "ltPropFooterPadding": Lyte.attr("string", { "default": "", input: true, output: false }),
             ...
             * @input
             */
            "ltPropAnimation": Lyte.attr("string", { "default": "fade", input: true, output: false }),
            /**
             ...
             */
            /**
             * @componentProperty {windowspacing} ltPropWindowSpacing
             * @version 2.1.1
             * @default { "top" : "30","left" : "30","bottom":"30","right" : "30"}
             * @input
             */
            "ltPropWindowSpacing": Lyte.attr("object", { input: true, output: false }),
             ...
             * @input
             */
            "ltPropForceScroll": Lyte.attr('boolean', { default: false, input: true, output: false }),
             ...
             * @input
             */
            "ltPropAutoAlign": Lyte.attr('boolean', { default: false, input: true, output: false }),
             ...
             * @input
             */
            "ltPropAria": Lyte.attr('boolean', { default: false, input: true, output: false }),
             ...
             * @input
             */
            "ltPropAriaAttributes": Lyte.attr('object', { default: {}, input: true, output: false }),

            "ltPropPreventFocus": Lyte.attr('boolean', { default: false, input: true, output: false }),
             ...
             * @input
             */
            "ltPropStopClick": Lyte.attr('boolean', { default: false, input: true, output: false }),

            /**
             * @componentProperty {boolean} ltPropIgnoreBoundary=false
             * @version 1.0.0
             * @input
             */
            "ltPropIgnoreBoundary": Lyte.attr('boolean', { default: false, input: true, output: false }),

            /**
             * @componentProperty {object} ltPropMargin
             * @version 1.0.0
             * @input
             */
            "ltPropMargin": Lyte.attr('object', { input: true, output: false }),

            /**
             * @componentProperty {boolean} ltPropCloseOnScroll=false
             * @version 1.0.0
             * @input
             */
            ...
            /**
             * @componentProperty {boolean} ltPropIgnoreInput=false
             * @version 1.0.0
             * @input
             */
            ...
            /**
             * @componentProperty {boolean} ltPropAutoPlacement=false
             * @version 1.0.0
             * @input
             */
            "ltPropAutoPlacement": Lyte.attr('boolean', {
                default: false, input: true, output: false
            }),
            ...
            "duringAutoPlacement": Lyte.attr('object', {
                default: {
                    height: '',
                    width: ''
                }
    ...
    handleMove: function (e) {
        ...
        if (e.type == "mousedown") {
            _lyteUiUtils.addGlobalEventListener('mousemove', e.currentTarget.parentEle.handleDrag, true);
            _lyteUiUtils.addGlobalEventListener('mouseup', e.currentTarget.parentEle.stopDrag, true);
        }
        else if (e.type == "touchstart") {
    ...
    stopDrag: function (e) {
        ...
        while (targetElem && targetElem !== document) {
            if (targetElem.parentEle) {
                if (e.type == "mouseup") {
                    _lyteUiUtils.removeGlobalEventListener('mousemove', targetElem.parentEle.handleDrag, true);
                    _lyteUiUtils.removeGlobalEventListener('mouseup', targetElem.parentEle.stopDrag, true);
    ...
    showToggled: function () {
        ...
        if (this.$node.ltProp("show") && !this.$node.ltProp("showCopy")) {
            if (this.getData('ltPropWindowSpacing') && this.getData('ltPropWindowSpacing').hasOwnProperty('left')) {
                Lyte.objectUtils(this.getData('windowSpacing'), 'add', 'left', this.getData('ltPropWindowSpacing').left)
            }
            if (this.getData('ltPropWindowSpacing') && this.getData('ltPropWindowSpacing').hasOwnProperty('right')) {
                Lyte.objectUtils(this.getData('windowSpacing'), 'add', 'right', this.getData('ltPropWindowSpacing').right)
            }
            if (this.getData('ltPropWindowSpacing') && this.getData('ltPropWindowSpacing').hasOwnProperty('bottom')) {
                Lyte.objectUtils(this.getData('windowSpacing'), 'add', 'bottom', this.getData('ltPropWindowSpacing').bottom)
            }
            if (this.getData('ltPropWindowSpacing') && this.getData('ltPropWindowSpacing').hasOwnProperty('top')) {
                Lyte.objectUtils(this.getData('windowSpacing'), 'add', 'top', this.getData('ltPropWindowSpacing').top)
            }
            ...
            _lyteUiUtils.dispatchEvent('lytePopoverBeforeOpen', this.actualModalDiv)
        }
        else {
    ...
    callOnResize: function (event) {
        ...
        if (this.getData('ltPropAutoPlacement')) {
            this.$node.alignPopover()
        }
        ...
        if (this.getData('ltPropHostElement') !== "") {
            origElemPosition = document.querySelector(this.$node.ltProp('hostElement')).shadowRoot.querySelector(this.getData('ltPropOriginElem')).getBoundingClientRect()
        }
        if (!!origElemPosition) {
    ...
    updateScrollHandling: function (event) {   //Sets the height and width of the popover
        ...
        this.fastdomfn1 = $L.fastdom.measure(function () {   //Measures the initial height and width based on the content of popover
            ...
            if(this.getData('ltPropAnimation') === 'zoom'){
                modalElemOffset.height = modalElem.offsetHeight
                modalElemOffset.width = modalElem.offsetWidth
            }
            ...
            if (this.$node.ltProp("showCopy")) {
                if (this.$node.ltProp('originElem') != "" || !(Lyte.Component.registeredHelpers.lyteUiIsEmptyObject(this.$node.ltProp('offset')))) {
                    ...
                    if (!ele && Lyte.Component.registeredHelpers.lyteUiIsEmptyObject(this.$node.ltProp('offset'))) {
                        ...
                        ele = $L(this.getData('ltPropHostElement'))[0].shadowRoot.querySelector(this.getData('ltPropOriginElem'))
                    ...
                    var modalElePosition = {
                        top: modalElemOffset.top,
                    ...
                    var getCurrentBottom = function (_this) {

                        var bottom = parseInt(_this.$node.ltProp('offset').bottom)

                        if ((bottom !== undefined) && bottom !== NaN) {
                            return bottom
                        }

                        bottom = parseInt(_this.$node.ltProp('offset').top) + (parseInt(_this.$node.ltProp('offset').height))
                    ...
                    var getCurrentRight = function (_this) {

                        var right = parseInt(_this.$node.ltProp('offset').right)

                        if ((right !== undefined) && right !== NaN) {
                            return right
                        }

                        right = parseInt(_this.$node.ltProp('offset').left) + (parseInt(_this.$node.ltProp('offset').width))
                    ...
                    if (Lyte.Component.registeredHelpers.lyteUiIsEmptyObject(this.$node.ltProp('offset'))) {  //If origin element is present and there is no ltPropOffset
                        ...
                        origElemPosition = {
                            ...
                            bottom: getCurrentBottom(this),
                            right: getCurrentRight(this)
                        }
                    }
                    ...
                    if (noPlaceAvailable && this.getData('ltPropAutoPlacement')) {
                        Lyte.objectUtils(this.getData('duringAutoPlacement'),  'add','width', this.getData('width'))
                        Lyte.objectUtils(this.getData('duringAutoPlacement'), 'add','height', this.getData('height'))
                        // offObj.offsetLeft = bodyWidth - modalElePosition.width - 10;
                        offObj.offsetLeft = origElemPosition.left - 10
                        var windowSpaceVal = 0
                        if (origElemPosition.top > window.innerHeight - origElemPosition.bottom) {
                            if (this.getData('ltPropWindowSpacing') && this.getData('ltPropWindowSpacing').top) {
                                windowSpaceVal = parseFloat(this.getData('ltPropWindowSpacing').top)
                            }
                            offObj.offsetTop = 5 + windowSpaceVal
                            offObj.classTobeAdded = "lytePopoverArrowBottom";
                            this.setData('ltPropHeight', ((origElemPosition.top - 5 - windowSpaceVal) + 'px'))
                            position = 'top'
                        } else {
                            if (this.getData('ltPropWindowSpacing') && this.getData('ltPropWindowSpacing').bottom) {
                                windowSpaceVal = parseFloat(this.getData('ltPropWindowSpacing').bottom)
                            }
                            offObj.offsetTop = origElemPosition.bottom + 5
                            offObj.classTobeAdded = "lytePopoverArrowTop";
                            this.setData('ltPropHeight', ((window.innerHeight - origElemPosition.bottom - windowSpaceVal) + 'px'))
                            position = 'bottom'
                        }

                        offObj.offsetTop = origElemPosition.top - 10
                        var windowSpaceVal = 0
                        if (origElemPosition.left > window.innerWidth - origElemPosition.right) {
                            if (this.getData('ltPropWindowSpacing') && this.getData('ltPropWindowSpacing').left) {
                                windowSpaceVal = parseFloat(this.getData('ltPropWindowSpacing').left)
                            }
                            offObj.offsetLeft = 5 + windowSpaceVal
                            offObj.classTobeAdded = "lytePopoverArrowRight";
                            this.setData('ltPropWidth', ((origElemPosition.left - 5 - windowSpaceVal) + 'px'))
                            position = 'left'
                        } else {
                            if (this.getData('ltPropWindowSpacing') && this.getData('ltPropWindowSpacing').right) {
                                windowSpaceVal = parseFloat(this.getData('ltPropWindowSpacing').right)
                            }
                            offObj.offsetLeft = origElemPosition.right + 5
                            offObj.classTobeAdded = "lytePopoverArrowLeft";
                            this.setData('ltPropWidth', ((window.innerWidth - origElemPosition.right - windowSpaceVal) + 'px'))
                            position = 'right'
                        }
                    }
    ...
    setOpacityAndVisibility: function () {
        ...
        _lyteUiUtils.dispatchEvent('lytePopupOpened', this.$node, this.actualModalDiv)
    ...
    onBeforeCloseHandling: function (event) {
        ...
        if (this.getMethods("onBeforeClose")) {
             ...
             * @param { object } lytePopover
             */
            result = this.executeMethod("onBeforeClose", (thisEvent ? thisEvent : event), this);
        }
        var self = this;
        if (result === undefined || result) {
            _lyteUiUtils.dispatchEvent('lytePopoverBeforeClose', this.actualModalDiv)
            ...
            function resetAutoPlacement() {
                if (self.getData('ltPropAutoPlacement')) {
                    self.setData('ltPropWidth', self.getData('duringAutoPlacement').width)
                    self.setData('ltPropHeight', self.getData('duringAutoPlacement').height)
                }
            }
            if (this.getData('ltPropDuration') == undefined) {
                ...
                LytePopup.closePopup(this);
                _lyteUiUtils.dispatchEvent('lytePopupClosed', this.$node, this.actualModalDiv)
                _lyteUiUtils.dispatchEvent('lytePopoverClosed', this.$node, this.actualModalDiv)
                // LytePopup.bindTransitionEnd(this.actualModalDiv);
                this.setData('visible', false);
                ...
                if (this.getMethods("onClose")) {
                     ...
                     * @param { object } lytePopover
                     */
                    this.executeMethod("onClose", (thisEvent ? thisEvent : event), this);
                    if (this.childComp) {
                        this.setData('ltPropShowWormhole', false)
                    }
                }
                ...
                this.tIdClose = setTimeout(function () {
                    ...
                    if (self.getMethods("onClose")) {
                        self.executeMethod("onClose", (thisEvent ? thisEvent : event), self);
                        if (self.childComp) {
                            self.setData('ltPropShowWormhole', false)
                        }
                    }
        ...
        if (result === undefined || result) {
            ...
            $L.fastdom.measure(function () {
                ...
                if (this.getData('ltPropHostElement') !== "") {
                    ...
                    scrollParent = this.$node.ltProp('originElem') ? LytePopup.getScrollParent($L(this.getData('ltPropHostElement'))[0].shadowRoot.querySelector(this.getData('ltPropOriginElem'))) : null;

                    // $L(this.getData('ltPropHostElement'))[0].shadowRoot.querySelector(this.getData('ltPropOriginElem'))

                }

                // var scrollParent = this.$node.ltProp('originElem') ? LytePopup.getScrollParent(document.querySelector(this.$node.ltProp('originElem'))) : null;
                if (!this.getData('ltPropFreeze') && !(scrollParent && scrollParent == document.body)) {
    ...
    actions: {
        close: function () {
            this.$node.ltProp("show",false);
            this.setData('ltPropShowWormhole' , false)
            _lyteUiUtils.ignoreAriaKeydown = true
            setTimeout(function(){
                _lyteUiUtils.ignoreAriaKeydown = false
            },300)
        }
    },
    methods: {
        beforeWormholeAppend: function (arg) {
            ...
            this.$node.getChildComp = function () {
...
if (document.readyState === "complete" || document.readyState === "interactive") {
    ...
    _lyteUiUtils.addGlobalEventListener("DOMContentLoaded", function (event) {
...
function addPopoverEvent(event) {
    ...
    _lyteUiUtils.addGlobalEventListener('click', function (event) {
        ...
        if ($L(event.target).closest('.lyteInputCalendar')[0] || $L(event.target).closest('.lyteCalendarView')[0]) {
            closeBoolean = true
        }
        if (event.originParent && event.originParent.tagName === "LYTE-INPUT") {
            closeBoolean = true
        }
        var ele = event.target;
        if (!closeBoolean) {
            ele = $L.traverseUp(ele, ["LYTE-POPOVER-FREEZE", "LYTE-DROP-BOX", "HTML"], ["popoverWrapper"])
        }
        if (!ele) {
            return;
        }
        if (ele.tagName == 'HTML' || ele.tagName == "LYTE-POPOVER-FREEZE") {
            for (var i = LytePopup.components.length - 1; i >= 0; i--) {
                var dropdowns = $L(LytePopup.components[i].childComp).find('lyte-dropdown')
                var dontClose = false;
                if (dropdowns[0]) {
                ...
                if (LytePopup.components[i].$node.tagName == "LYTE-POPOVER" && LytePopup.components[i].childComp.style.visibility == "visible" && !dontClose) {
                    // LytePopup.evt = event;
                    ...
                    if ((popover && popover.component.getData('visible') && popover.component.getData('ltPropCloseOnBodyClick') && !popover.component.getData('dragRunning')) && ((!$L(event.target).closest('lyte-input')[0]) || (!popover.component.getData('ltPropIgnoreInput')) && !closeBoolean)) {
                        if(_lyteUiUtils.popupStack.globalStack && _lyteUiUtils.popupStack.globalStack.length > 0 && _lyteUiUtils.popupStack.globalStack[_lyteUiUtils.popupStack.globalStack.length-1].parentElement === LytePopup.components[i].$node){
    ...
    _lyteUiUtils.addGlobalEventListener('scroll', function (event) {    //This is for closing the dropdown when an outside area is clicked(CODE HELP)
        ...
        for (var i = LytePopup.components.length - 1; i >= 0; i--) {
            if (LytePopup.components[i].$node && LytePopup.components[i].$node.nodeName == "LYTE-POPOVER" && LytePopup.components[i].childComp.style.visibility == "visible") {
                ...
                if (LytePopup.components[i].data.ltPropCloseOnScroll && (!$L(event.target).closest('.popoverWrapper')[0])) {
                    if ($L(event.target).closest('lyte-drop-box')[0] && $L(event.target).closest('lyte-drop-box')[0].origindd.closest('.lytePopover')) {
                        return
                    }
                    LytePopup.components[i].event = event
                ...
                if (wormhole && wormhole._callee.component.$node.ltProp("scrollable")) {
                    if (LytePopup.components[i].callOnScroll(event)) {
                        ...
                        while (curscroll.tagName != "LYTE-WORMHOLE" && curscroll.tagName != 'HTML' && curscroll.nodeName != "#document") {
                            if(curscroll.parentElement){
                                curscroll = curscroll.parentElement
                            } else {
                                break
                            }
                        }
                        if (curscroll.tagName == 'LYTE-WORMHOLE' && curscroll == ele) {
                            return;
                        }
                        ...
                        if (ele._callee.ltProp('originElem')) {
                            return
                        }

                        var par = document.querySelector(ele._callee.ltProp('originElem'));
                        if (ele._callee.ltProp('hostElement')) {
                            par = document.querySelector(ele._callee.ltProp('hostElement')).shadowRoot.querySelector(ele._callee.ltProp('originElem'));
                        }
