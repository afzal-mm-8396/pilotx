...
_template:"<template tag-name=\"lyte-beta-modal\"> <template is=\"if\" value=\"{{expHandlers(ltPropBindToBody,'&amp;&amp;',expHandlers(reRenderModal,'!'))}}\"><template case=\"true\"> <lyte-wormhole case=\"true\" class=\"lyteModalVisibilityHidden\" lt-prop-show=\"{{ltPropShowWormhole}}\" lt-prop-focus-on-close=\"{{ltPropFocusOnClose}}\" on-before-append=\"{{method(&quot;beforeWormholeAppend&quot;)}}\"> <template is=\"registerYield\" yield-name=\"lyte-content\"> <div class=\"lyteModalWrapper lytePopupZI\"> <div class=\"lyteModalElement\"> <template is=\"if\" value=\"{{ltPropShowCloseButton}}\"> <template case=\"true\"><span class=\"lyteModalClose\" onclick=\"{{action('closeModal')}}\" tabindex=\"0\" role=\"button\" aria-label=\"Close Modal\"></span></template> </template> <lyte-yield class=\"lyteModalYield lyteBetaModalYield\" yield-name=\"modal\"></lyte-yield> </div> <template is=\"if\" value=\"{{showFreeze}}\"><template case=\"true\"> <lyte-modal-freeze class=\"lytePopupFreezeLayer lyteModalHideFreeze\"></lyte-modal-freeze> </template></template> <template is=\"if\" value=\"{{showDragFreeze}}\"><template case=\"true\"> <lyte-modal-freeze class=\"lytePopupFreezeLayer lytePopupDragFreezeLayer\"></lyte-modal-freeze> </template></template> </div> </template> </lyte-wormhole> </template></template> </template>",
_dynamicNodes : [{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"registerYield","position":[1,1],"dynamicNodes":[{"type":"attr","position":[1,1,1]},{"type":"if","position":[1,1,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[0]}]}},"default":{}},{"type":"insertYield","position":[1,1,3]},{"type":"attr","position":[1,3]},{"type":"if","position":[1,3],"cases":{"true":{"dynamicNodes":[{"type":"componentDynamic","position":[1]}]}},"default":{}},{"type":"attr","position":[1,5]},{"type":"if","position":[1,5],"cases":{"true":{"dynamicNodes":[{"type":"componentDynamic","position":[1]}]}},"default":{}}]},{"type":"componentDynamic","position":[1]}]}},"default":{}}],
_observedAttributes :["ltPropShow","ltPropShowWormhole","ltPropFreeze","ltPropShowCloseButton","ltPropCloseOnEscape","ltPropTransition","ltPropOffset","ltPropDimmer","ltPropDraggable","ltPropAllowMultiple","ltPropScrollable","ltPropMaxHeight","ltPropMaxWidth","ltPropWidth","ltPropHeight","ltPropWrapperClass","ltPropBindToBody","ltPropReRenderModal","ltPropOverlayClose","ltPropAria","ltPropAriaAttributes","ltPropPreventFocus","ltPropSetContentHeight","ltPropCloseDuration","ltPropOverlapModal","ltPropIgnoreInlineDirection","ltPropAllowContainment","ltPropFocusOnClose","ltPropResizeModal","ltPropResizerMinWidth","ltPropResizerMaxWidth","ltPropResizerMinHeight","ltPropResizerMaxHeight","ltPropRetainPosition","ltPropCloseButtonClass","ltPropDragHandle","preservedOffset","showFreeze","showDragFreeze","initialModalDim","initialMouseDown","initialDragMouseDown","initialComputedModalDim","resizeLimit","closeDurationTimeOut","reRenderModal","popoverclosevaluechanged","activeResizer","returnedFalse","oppositeSidePosition","ignoreOffsetObserver","onCloseTriggered"],
_observedAttributesType :["boolean","boolean","boolean","boolean","boolean","object","object","object","boolean","boolean","boolean","string","string","string","string","string","boolean","boolean","boolean","boolean","object","boolean","boolean","number","boolean","boolean","boolean","boolean","boolean","number","number","number","number","boolean","string","string","object","boolean","boolean","object","object","object","object","object","number","boolean","boolean","string","boolean","string","boolean","boolean"],
	...
	data : function(){
		return {
             ...
             */
			  ...
			  */
			 "ltPropTransition":Lyte.attr("object",{"default":_lyteUiUtils.resolveDefaultValue( 'lyte-beta-modal', 'transition', {"animation":"slideFromTop","duration":"0.5"} )}), //---------------------->  done
			 /**
			  ...
			  * @version 1.0.0
			  */
			 "ltPropDimmer":Lyte.attr("object" , {default : {}}), //---------------------->  done
			 /**
			 ...
			 "ltPropRetainPosition" : Lyte.attr('boolean' , {default : false}),

			 "ltPropCloseButtonClass" : Lyte.attr('string' , {
				default : 'lyteModalClose'
			 }),

			 "ltPropDragHandle" : Lyte.attr('string' , {
				default : ''
			 }),
			 
			
			 preservedOffset : Lyte.attr('object' , {
				default : {}
			 }),
			 showFreeze : Lyte.attr('boolean' , {
				default : true
			 }),
			 showDragFreeze : Lyte.attr('boolean' , {
				default : false
			 }),
			...
			ignoreOffsetObserver: Lyte.attr("boolean", {default: false}),
			onCloseTriggered : Lyte.attr('boolean' , {default : false})
		}		
	},
	init : function(){
		var _this = this;
		if(!_lyteUiUtils.lyteModalKeyDown){
			...
			document.addEventListener('keydown' , function(evt){
				...
				if(isEnter){
					if($L(document.activeElement).hasClass('lyteModalClose')){
	...
	actions : {
		closeModal : function(){
			if(!_lyteUiUtils.isAriaKeyDownEnabled){
	...
	setFreezeDimmer : function(){
		if(this.childComp && this.getData('ltPropShow')){
			...
			if(freeze[0] && Object.keys(this.getData('ltPropDimmer')).length > 0 ){
				freeze[0].style.setProperty('--lyte-modal-freeze-bg', this.getData('ltPropDimmer').color)
				freeze[0].style.setProperty('--lyte-modal-freeze-opacity', this.getData('ltPropDimmer').opacity)
			}
		}
	},
	...
	closeModal : function(event){
		if(this.getData('showDragFreeze')){
			...
			$L('.lyteModalResizeRunning').removeClass('lyteModalResizeRunning')
			if(modalElement){
				modalElement.style.overflow = "auto"
			}
			this.setData("activeResizer", "");
		}
		var result = true;
		if(this.getMethods("onBeforeClose") && !this.getData('onCloseTriggered')){
            result = this.executeMethod("onBeforeClose", event ,this);
        }
		if(result !== false){
			if(this.getData('ltPropFreeze')){
				$L(this.childComp).find('.lytePopupFreezeLayer').addClass('lyteModalHideFreeze')
			}
			if(_lyteUiUtils.popupStack){
				...
				if(animationType === 'zoom') {
					...
					var scaleFrom = (transitionData.scaleFrom) ? "scale(" + transitionData.scaleFrom + ")" : "scale(0)";
					var originElem = $L(transitionData.originElement);
					if(originElem.length > 0) {
						...
						modalInnerElem[0].style.transform = 'translate(' + translateXval + ',' + translateYval + ')' + scaleFrom;
					}
				}
				...
				this.closeModalTransition = setTimeout(function() {
					if(_this.childComp){
						...
						_this.childComp.style.display="none";
						$L(_this.childComp).addClass('lyteModalHidden')
						$L(_this.childComp).find('.lyteModalCurrentlyClosing').removeClass('lyteModalCurrentlyClosing');
						_lyteUiUtils.dispatchEvent('lyteModalClosed' , _this.actualModalDiv)
						if(_this.getMethods("onClose") && !_this.getData('onCloseTriggered')){
							_this.setData('onCloseTriggered' , true)
							result = _this.executeMethod("onClose",_this);
						}
						$L(_this.childComp).trapFocus('destroy')
				...
				if(_lyteUiUtils.getRTL()){
					...
					var offset = _this.getData('ltPropOffset'),newOffset = {};
					if(offset && Object.keys(offset).length > 0){
						...
						_this.setData('ignoreOffsetObserver', true);
						_this.setData('ltPropOffset',newOffset);
						_this.setData('ignoreOffsetObserver', false);
					}
				  }
				}
			}
	...
	createResizeNodes: function () {
		...
		if(!$L(this.actualModalDiv).find('.lyteModalResizeNodeWrapper')[0]){
	...
	dragMouseDown : function(eve){
		...
		if($L(eve.target).hasClass('lyteModalResizeNode')){
			...
			if (resizeStart === false) {
				...
				if(_this.getData('ltPropRetainPosition')){
					_this.setData('preservedOffset' , {})
				}
	...
	dragMouseMove : function(eve){
		...
		var minWidth = _this.getData("ltPropResizerMinWidth"),
			maxWidth = _this.getData("ltPropResizerMaxWidth"),
		...
		switch (activeResizer) {
			case "topLeftNode": { 
				...
				var topVal = Math.max(_this.getData('initialDragMouseDown').top - (maxHeight - _this.getData('initialDragMouseDown').height), Math.min(_this.getData('initialDragMouseDown').top - (_this.getData('initialDragMouseDown').clientY - eve.clientY), _this.getData('initialDragMouseDown').bottom - minHeight))
				if(topVal >= 0){
					...
					modalElement.style.height = _this.getData('initialDragMouseDown').bottom + 'px'
				}
				
				var leftVal = Math.max( _this.getData('initialDragMouseDown').left - (maxWidth - _this.getData('initialDragMouseDown').width), Math.min(_this.getData('initialDragMouseDown').left - (_this.getData('initialDragMouseDown').clientX - eve.clientX), _this.getData('initialDragMouseDown').right - minWidth))
				if(leftVal >= 0){
					...
					modalElement.style.width = _this.getData('initialDragMouseDown').right + 'px'
				}
			...
			case "topRightNode": { 
				...
				var rightVal = _this.getData('initialDragMouseDown').left + Math.min(maxWidth, Math.max(_this.getData('initialDragMouseDown').width - (_this.getData('initialDragMouseDown').clientX - eve.clientX), minWidth))
				if(rightVal <= window.innerWidth){
					modalElement.style.width = Math.min(maxWidth, Math.max(_this.getData('initialDragMouseDown').width - (_this.getData('initialDragMouseDown').clientX - eve.clientX), minWidth)) + 'px'
				} else {
					modalElement.style.width = window.innerWidth - _this.getData('initialDragMouseDown').left + "px"
				}
				break;
			}
			case "rightNode": { 
			...
			case "bottomRightNode": { 
				...
				var bottomVal = _this.getData('initialDragMouseDown').top + Math.min(maxHeight, Math.max(_this.getData('initialDragMouseDown').height - (_this.getData('initialDragMouseDown').clientY - eve.clientY), minHeight))
				if(bottomVal <= window.innerHeight){
					modalElement.style.height = Math.min(maxHeight, Math.max(_this.getData('initialDragMouseDown').height - (_this.getData('initialDragMouseDown').clientY - eve.clientY), minHeight)) + 'px'
				} else {
					modalElement.style.height = window.innerHeight - _this.getData('initialDragMouseDown').top + "px"
				}
				break;
			}
			case "bottomNode": { 
	...
	dragMouseUp : function(eve){
		...
		var modalWrapperElem = $L(modalElement.parentElement);
		if(animationType == 'slideFromRight') {
			var modalElemClientRect = modalElement.getBoundingClientRect();
			...
			modalElement.style.right = modalElemRightValue + 'px';
			...
			modalElement.style.transition = 'none';
			modalElement.style.bottom = modalElemBottomValue + 'px';
		...
		if(_this.getData('ltPropRetainPosition')){
			var modalEleGBCR = modalElement.getBoundingClientRect();
			var modalEleDim = {}
			modalEleDim.left = modalEleGBCR.left+"px"
			modalEleDim.top = modalEleGBCR.top+"px"
			modalEleDim.width = modalEleGBCR.width+"px"
			modalEleDim.height = modalEleGBCR.height+"px"
			_this.setData('preservedOffset' , modalEleDim)
		}
	...
	mousedownFun : function(eve){
		...
		if( $L(eve.target).hasClass(_this.getData('ltPropCloseButtonClass')) ){
			return
		}
	...
	mouseupFun : function(eve){
		...
		if(_this.getData('ltPropRetainPosition')){
			var modalEleGBCR = modalEle.getBoundingClientRect();
			var modalEleDim = {}
			modalEleDim.left = modalEleGBCR.left+"px"
			modalEleDim.top = modalEleGBCR.top+"px"
			modalEleDim.width = modalEleGBCR.width+"px"
	...
	_showModal : function(){
		...
		if(this.getData('ltPropShow')){
			...
			$L(this.childComp).find('.lyteModalWrapper').addClass(this.getData('ltPropWrapperClass'))

			if( this.getData('ltPropRetainPosition') && Object.keys(this.getData('preservedOffset')).length > 0 ){
				var preservedOffset = this.getData('preservedOffset')
				this.setData('ignoreOffsetObserver' , true)
				this.setData('ltPropOffset' , {})
				this.setData('ltPropOffset' , preservedOffset)
				this.setData('ltPropWidth' , preservedOffset.width)
				this.setData('ltPropHeight' , preservedOffset.height)
				this.setData('ignoreOffsetObserver' , false)
				// Lyte.objectUtils(this.getData('ltPropOffset') ,'add', 'top' , preservedOffset)
			}
		...
		if(result !== false){
			if(this.getData('ltPropOffset') === undefined){
				this.setData('ltPropOffset' , {top : 'center' , left : 'center'})
			}
			if(_lyteUiUtils.getRTL()){
				if(!this.getData('ltPropIgnoreInlineDirection')){
					...
					var offset = this.getData('ltPropOffset'),newOffset = {};
					if(offset && Object.keys(offset).length > 0){
						for(let key in offset){
							if(key == "left" && offset[key] != "center"){
								newOffset.right = offset[key];
			...
			var modalElem = $L(this.childComp).find('.lyteModalWrapper');
			if(_lyteUiUtils.popupStack && _lyteUiUtils.popupStack.betaModalStack && _lyteUiUtils.popupStack.betaModalStack.length>1){
				modalElem[0].style.setProperty('--lyte-modal-zindex', _lyteUiUtils.getZIndex())
			}
			var modalInnerElem = modalElem.find('.lyteModalElement');
			...
			if(!this.getData('ltPropOverlapModal')) {
				if(_lyteUiUtils.popupStack.betaModalStack && _lyteUiUtils.popupStack.betaModalStack.length > 2	) {
			...
			if(animationType == "zoom" && this.getData('ltPropTransition').scaleFrom) {
				modalElem[0].style.setProperty('--lyte-modal-zoom-scale-from', this.getData('ltPropTransition').scaleFrom)
			}

			if(offsetObject && !offsetObject.left && !offsetObject.right){
				offsetObject.left = 'center'
			}
			if(offsetObject && !offsetObject.top && !offsetObject.bottom){
			...
			setTimeout(function(){
				if($L(_this.childComp).find('.lyteModalHideFreeze')[0]){
					$L(_this.childComp).find('.lyteModalHideFreeze').removeClass('lyteModalHideFreeze')
				}
			},10)
			setTimeout(function(){
			...
			setTimeout(function(){
				if(!_this.getData('ltPropPreventFocus')){
					$L(_this.childComp).trapFocus({forLytePopups : true})
				}
			},(this.getData('ltPropTransition').duration * 1000 + 100))
		} else {
	...
	_updateOffset : function(){
		if(!this.getData('ignoreOffsetObserver') && this.childComp && this.getData('ltPropShow')){
			var offsetObject = this.getData('ltPropOffset')
			var modalElem = $L(this.childComp).find('.lyteModalWrapper');
			var modalInnerElem = modalElem.find('.lyteModalElement');
			var animationType = this.getData('ltPropTransition').animation;
	...
	_changeWrapperClass : function(args){
		if(this.childComp){
			$L(this.childComp).find('.lyteModalWrapper').removeClass(args.oldValue)
			$L(this.childComp).find('.lyteModalWrapper').addClass(args.newValue)
		}
	...
	didDestroy : function(){
		...
		_lyteUiUtils.dispatchEvent('lyteModalDestroyed')
...
;(function(){
  if($L){
    $L.prototype.trapFocus = function(arg){
      ...
      $L(this).addClass('lyteFocusTrappedElement')
      ...
      if(arg === 'destroy' || arg === "Destroy"){
        $L(this[0]).data('trapFocusActiveIndex' , 0)
        $L(this).removeClass('lyteFocusTrappedElement')
        _lyteUiUtils.removeEventListenerGlobal('keydown' , _lyteUiUtils.trapFocusFun)
      ...
      var focusableElementsString = 'a[href], area[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled]), iframe, object, embed, [tabindex]:not([tabindex="-1"]), *[contenteditable],*:not([aria-attribute="true"])';
      ...
      iniFocusableItems = iniFocusableItems.not('[aria-hidden="true"]');
      ...
      if(forLytePopups){
        if(!preventdefault){
          ...
          _lyteUiUtils.trapFocusFun = function(evt){
            ...
            if(_lyteUiUtils.popupStack && _lyteUiUtils.popupStack.globalStack && _lyteUiUtils.popupStack.globalStack.length < 1){
              return
            }

            var lastPopup = _lyteUiUtils.popupStack.globalStack[_lyteUiUtils.popupStack.globalStack.length - 1]
            if(lastPopup.parentElement.tagName === 'LYTE-BETA-MODAL' || lastPopup.parentElement.tagName ===  'LYTE-BETA-POPOVER'){
              var parent = _lyteUiUtils.popupStack.globalStack[_lyteUiUtils.popupStack.globalStack.length - 1].childElement
            } else {
              return
            }
