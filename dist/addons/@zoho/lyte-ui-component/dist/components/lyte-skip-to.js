...
_template:"<template tag-name=\"lyte-skip-to\" lyte-skip-to=\"\"> <template is=\"for\" items=\"{{ltPropData}}\" item=\"item\" index=\"index\"> <div class=\"lyteSkipToClass\" tabindex=\"0\" dom-index=\"{{index}}\">{{item.message}}</div> </template> </template>",
