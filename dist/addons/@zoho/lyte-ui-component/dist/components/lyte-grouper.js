...
_template:"<template tag-name=\"lyte-grouper\" style=\"width:{{ltPropWidth}}\" lyte-grouper=\"\"> <lyte-yield yield-name=\"yield\" onfocusin=\"{{action('grouperFocusIn')}}\" onfocusout=\"{{action('grouperFocusOut')}}\" class=\"lyteGroupWrap lyteGroup{{ltPropAlignment}} {{ltPropAppearance}}Type {{if(isFocused,'lyteGrouperFocused')}}\" role=\"group\"> </lyte-yield> </template>",
...
_observedAttributesType :["string","string","string","array","string","boolean"],
	...
	data : function(){
		return {
			...
			/** 
			 * @componentProperty {line | fill | custom} ltPropAppearance=line
			 */
