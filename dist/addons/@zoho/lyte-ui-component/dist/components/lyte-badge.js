...
_template:"<template tag-name=\"lyte-badge\" lyte-badge=\"\"> <div class=\"lyteBadge\" lt-prop-title=\"{{tooltipData}}\"> <span class=\"lyteBadgeContent\">{{ltPropData}} <lyte-yield yield-name=\"lyteBadgeYield\"></lyte-yield> </span> </div> </template>",
...
_observedAttributesType :["object","string","string","string","boolean","number","number"],
	...
	didConnect : function(){
		//Lyte badge didConnect function block
