...
_template:"<template tag-name=\"lyte-card\" lyte-card=\"\"><template is=\"if\" value=\"{{lyteViewPort}}\"><template case=\"true\"><dummy-port-element></dummy-port-element> <template is=\"if\" value=\"{{expHandlers(ltPropLoadingYield,'!')}}\"><template case=\"true\"> <div class=\"lyteCardRenderPlaceholder\"> </div> </template><template case=\"false\"> <lyte-yield yield-name=\"loading\"></lyte-yield> </template></template> <dummy-port-element></dummy-port-element></template><template case=\"false\"> <lyte-card-box style=\"{{finalStyle}}\" class=\"{{finalClass}}\"> <lyte-yield yield-name=\"yield\"></lyte-yield> </lyte-card-box> </template></template></template>",
_dynamicNodes : [{"type":"attr","position":[0]},{"type":"if","position":[0],"cases":{"true":{"dynamicNodes":[{"type":"componentDynamic","position":[0]},{"type":"attr","position":[2]},{"type":"if","position":[2],"cases":{"true":{"dynamicNodes":[]},"false":{"dynamicNodes":[{"type":"insertYield","position":[1]}]}},"default":{}},{"type":"componentDynamic","position":[4]}]},"false":{"dynamicNodes":[{"type":"attr","position":[1],"attr":{"style":{"name":"style","dynamicValue":"finalStyle"}}},{"type":"insertYield","position":[1,1]},{"type":"componentDynamic","position":[1]}]}},"default":{}}],
_observedAttributes :["ltPropSize","ltPropBackgroundColor","ltPropAlignment","ltPropBoxShadow","lyteViewPort","ltPropViewPort","ltPropLoadingYield","finalClass","finalStyle"],
_observedAttributesType :["string","string","string","string","boolean","boolean","boolean","string","string"],
	...
	data: function() {
		return {
			...
			'ltPropSize': Lyte.attr( 'string', { 
				'default': _lyteUiUtils.resolveDefaultValue( 'lyte-card', 'size', 'medium' ),
				'input': true 
			} ),
			...
			'ltPropBackgroundColor': Lyte.attr( 'string', { 
				'default': _lyteUiUtils.resolveDefaultValue( 'lyte-card', 'backgroundColor', '' ),
				'input': true 
			} ),
			...
			'ltPropAlignment': Lyte.attr( 'string', { 
				'default': _lyteUiUtils.resolveDefaultValue( 'lyte-card', 'alignment', 'vertical' ),
				'input': true 
			} ),
			...
			'ltPropBoxShadow': Lyte.attr( 'string', { 
				'default': _lyteUiUtils.resolveDefaultValue( 'lyte-card', 'boxShadow', '' ),
				'input': true 
			} ),
