...
_template:"<template tag-name=\"lyte-tag\" lyte-tag=\"\"> <lyte-dropdown on-before-show=\"{{method('preventOpen')}}\" on-before-add=\"{{method('validate')}}\" on-add=\"{{method('onItemSelected')}}\" on-remove=\"{{method('onItemRemoved')}}\" on-before-remove=\"{{method('storeRemovedItem')}}\" on-change=\"{{method('fireOnChange')}}\" lt-prop-max-count=\"{{ltPropMaxCount}}\" lt-prop-type=\"multisearch\" lt-prop-no-result=\"{{ltPropNoResult}}\" lt-prop-options=\"{{standardizedOptions}}\" lt-prop-user-value=\"{{ltPropUserValue}}\" lt-prop-system-value=\"{{ltPropSystemValue}}\" lt-prop-selected-list=\"{{standardizedList}}\" lt-prop-disabled=\"{{ltPropDisabled}}\" lt-prop=\"{{stringify(ltPropDropdown)}}\"> <template is=\"registerYield\" yield-name=\"yield\"> <lyte-drop-button> <div class=\"lyteMultiSelect\"> <ul class=\"lyteMultipleSelect\"> <template is=\"if\" value=\"{{ltPropButtonYield}}\"><template case=\"true\"> <lyte-yield yield-name=\"button\" lyte-options-selected=\"{{standardizedList}}\"></lyte-yield> </template><template case=\"false\"> <template is=\"for\" items=\"{{standardizedList}}\" item=\"item\" index=\"index\"> <li data-value=\"{{item[ltPropSystemValue]}}\" class=\"{{if(expHandlers(ltPropErrorValue,'&amp;&amp;',item[ltPropErrorValue]),ltPropErrorClass,'')}}\"> <span class=\"lyteTagItem\">{{item[ltPropUserValue]}}</span> <lyte-drop-remove class=\"lyteCloseIcon\"></lyte-drop-remove> </li> </template> </template></template> <template is=\"if\" value=\"{{expHandlers(expHandlers(ltPropMaxCount,'!==',1),'||',expHandlers(standardizedList.length,'===',0))}}\"><template case=\"true\"> <li class=\"lyteTagInputLi\"> <input onclick=\"{{action('fireOnClick',event)}}\" placeholder=\"{{ltPropPlaceholder}}\" class=\"lyteDropdownTextField\" type=\"text\" oninput=\"{{action('searchItemsOnInput',event)}}\" onblur=\"{{action('searchItemsOnBlur',event)}}\" onkeydown=\"{{action('handleOtherKeys',event)}}\" disabled=\"{{ltPropDisabled}}\"> </li> </template></template> </ul> </div> </lyte-drop-button> <template is=\"if\" value=\"{{ltPropBoxYield}}\"><template case=\"true\"> <lyte-yield yield-name=\"box\" lyte-options=\"{{lyteOptions}}\"></lyte-yield> </template><template case=\"false\"> <lyte-drop-box> <lyte-drop-body> <template is=\"for\" items=\"{{lyteOptions}}\" item=\"item\" index=\"index\"> <template is=\"if\" value=\"{{lyteUiOptGroupCheck(item)}}\"><template case=\"true\"> <lyte-drop-group> <lyte-drop-label>{{lyteUiReturnOnlyKey(item)}}</lyte-drop-label> <template is=\"for\" items=\"{{lyteUiReturnValueBy(item,lyteUiReturnOnlyKey(item))}}\" item=\"subitem\" index=\"indexval\"> <lyte-drop-item data-value=\"{{subitem[ltPropSystemValue]}}\"> <lyte-tag-label> {{subitem[ltPropUserValue]}} </lyte-tag-label> <template is=\"if\" value=\"{{subitem[ltPropDescriptionValue]}}\"><template case=\"true\"> <lyte-tag-description> {{subitem[ltPropDescriptionValue]}} </lyte-tag-description> </template></template> </lyte-drop-item> </template> </lyte-drop-group> </template><template case=\"false\"> <lyte-drop-item data-value=\"{{item[ltPropSystemValue]}}\"> <lyte-tag-label> {{item[ltPropUserValue]}} </lyte-tag-label> <template is=\"if\" value=\"{{item[ltPropDescriptionValue]}}\"><template case=\"true\"> <lyte-tag-description> {{item[ltPropDescriptionValue]}} </lyte-tag-description> </template></template> </lyte-drop-item> </template></template> </template> </lyte-drop-body> </lyte-drop-box> </template></template> </template> </lyte-dropdown> </template>",
_dynamicNodes : [{"type":"attr","position":[1]},{"type":"registerYield","position":[1,1],"dynamicNodes":[{"type":"attr","position":[1,1,1,1]},{"type":"if","position":[1,1,1,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"insertYield","position":[1]}]},"false":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"for","position":[1],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,1,0]},{"type":"componentDynamic","position":[1,3]}]}]}},"default":{}},{"type":"attr","position":[1,1,1,3]},{"type":"if","position":[1,1,1,3],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1,1]}]}},"default":{}},{"type":"componentDynamic","position":[1]},{"type":"attr","position":[3]},{"type":"if","position":[3],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"insertYield","position":[1]}]},"false":{"dynamicNodes":[{"type":"attr","position":[1,1,1]},{"type":"for","position":[1,1,1],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[{"type":"text","position":[1,1,0]},{"type":"componentDynamic","position":[1,1]},{"type":"attr","position":[1,3]},{"type":"for","position":[1,3],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,1,1]},{"type":"componentDynamic","position":[1,1]},{"type":"attr","position":[1,3]},{"type":"if","position":[1,3],"cases":{"true":{"dynamicNodes":[{"type":"text","position":[1,1]},{"type":"componentDynamic","position":[1]}]}},"default":{}},{"type":"componentDynamic","position":[1]}]},{"type":"componentDynamic","position":[1]}]},"false":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,1,1]},{"type":"componentDynamic","position":[1,1]},{"type":"attr","position":[1,3]},{"type":"if","position":[1,3],"cases":{"true":{"dynamicNodes":[{"type":"text","position":[1,1]},{"type":"componentDynamic","position":[1]}]}},"default":{}},{"type":"componentDynamic","position":[1]}]}},"default":{}}]},{"type":"componentDynamic","position":[1,1]},{"type":"componentDynamic","position":[1]}]}},"default":{}}]},{"type":"componentDynamic","position":[1]}],
_observedAttributes :["ltPropOptions","ltPropUserValue","ltPropSystemValue","ltPropErrorValue","ltPropErrorClass","ltPropDescriptionValue","ltPropSearchKeys","ltPropSelectedList","ltPropDelimiters","ltPropNoResult","ltPropDropdown","ltPropPlaceholder","ltPropEvent","ltPropCaseSensitive","ltPropAddNewItems","ltPropBoxYield","ltPropButtonYield","ltPropExternalSearch","ltPropPreventDuplicate","ltPropType","ltPropDisabled","ltPropAutoComplete","ltPropDuplicateClass","ltPropOpenWhenEmpty","ltPropPreventInputFocus","ltPropPreventOpenOnClickingSelection","ltPropMaxCount","standardizedList","standardizedOptions","randId"],
_observedAttributesType :["array","string","string","string","string","string","array","array","array","string","object","string","string","boolean","boolean","boolean","boolean","boolean","boolean","string","boolean","boolean","string","boolean","boolean","boolean","number","array","array","number"],
	...
	data: function() {
		return {
			...
			'ltPropErrorValue': Lyte.attr( 'string', { 'default': '' } ),
			...
			'ltPropOpenWhenEmpty': Lyte.attr( 'boolean', {
				'default': false
			} ),

			'ltPropPreventInputFocus': Lyte.attr( 'boolean', {
				'default': false
			} ),

			'ltPropPreventOpenOnClickingSelection': Lyte.attr( 'boolean', {
				'default': false
			} ),
	...
	configureMaxCountClass: function() {
		var maxCount = this.getData( 'ltPropMaxCount' );

		if( maxCount === 1 ) {
			this.addMaxCountClass();
		}
		else {
			this.removeMaxCountclass();
		}
	},

	addMaxCountClass: function() {
		this.$node.querySelector( '.lyteMultiSelect' ).classList.add( 'lyteTagSingleSelect' );
	},

	removeMaxCountclass: function() {
		this.$node.querySelector( '.lyteMultiSelect' ).classList.remove( 'lyteTagSingleSelect' );
	},
	...
	updateArray: function( array, variableToStoreInside ) {
	...
	filterAndBuildTags: function( isBlur ) {
	...
	buildTagWithoutFilter: function( isBlur ) {
	...
	buildObjManually: function( value ) {
		...
		if( this.getMethods( 'onTagCreation' ) ) {
			/**
			 * This callback is fired just before a tag is about to be created
			 * @method onTagCreation
			 * @author ananthapadmanaban.n@zohocorp.com
			 * @param { string } valueTypedIn
			 */
	...
	makeApiRequest: function( event ) {
		...
		if( this.getMethods( 'onInput' ) ) {
			/**
			 * This callback is fired when a value is typed into the input
			 * @method onInput
			 * @author ananthapadmanaban.n@zohocorp.com
			 * @param { object } event
			 */
	...
	shouldAddTag: function( dataValue, typedLabel ) {
		...
		if( this.getMethods( 'onBeforeAdd' ) ) {
			/**
			 * This callback is fired just before a value is added into the selected tag list
			 * @method onBeforeAdd
			 * @author ananthapadmanaban.n@zohocorp.com
			 * @param { object } dataValueOfSelectedItem
			 */
		...
		if( parentWantsToPrevent || ( preventDuplicates && this.isAlreadySelected( typedLabel ) ) ) {
			if( this.getMethods( 'onItemRejected' ) ) {
				/**
				 * This callback is fired when a tag is rejected from being added to the selected list
				 * @method onItemRejected
				 * @author ananthapadmanaban.n@zohocorp.com
	...
	callAddMethod: function( obj, isAlreadySelected ) {
		...
		if( this.getMethods( 'onAdd' ) ) {
			/**
			 * This callback is fired when a value is added into the selected tag list
			 * @method onAdd
			 * @author ananthapadmanaban.n@zohocorp.com
			 * @param { string } dataValueOfSelectedItem
			 * @param { object } addedTagElement
	...
	callRemoveMethod: function() {
		...
		if( this.getMethods( 'onRemove' ) ) {
			/**
			 * This callback is fired when an item is removed from the selected tag list
			 * @method onRemove
			 * @author ananthapadmanaban.n@zohocorp.com
	...
	fireOnChange: function( curSelected, dropItem ) {
		if( this.getMethods( 'onChange' ) ) {
			/**
			 * This callback is fired when selected list changes in the tag
			 * @method onChange
			 * @author ananthapadmanaban.n@zohocorp.com
			 * @param { array } currentSelectedItems
			 * @param { object } itemThatWasAddedOrRemoved
			 */
			this.executeMethod( 'onChange', curSelected, dropItem );
		}
	},

	isMaximumAllowedItemsSelected: function() {
		var maxCount = this.getData( 'ltPropMaxCount' ),
		standardizedList = this.getData( 'standardizedList' ) || [];

		if( maxCount === 0 ) {
			return false;
		}

		return maxCount === standardizedList.length;
	},
	...
	actions: {
		fireOnClick: function( event ) {
			if( this.getMethods( 'onInputClick' ) ) {
				/**
				 * This callback is fired when the input is clicked
				 * @method onInputClick
				 * @author ananthapadmanaban.n@zohocorp.com
				 * @param { object } event
				 */
		...
		handleOtherKeys: function( event ) {
			...
			if( this.isMaximumAllowedItemsSelected() ) {
				// This also stops backspace but backspace is handled in dropdown where the event reaches there.
	...
	methods: {
		...
		preventOpen: function( event ) {
			...
			preventOpenOnClickingSelection = this.getData( 'ltPropPreventOpenOnClickingSelection' );

			if( this.isMaximumAllowedItemsSelected() ) {
				return false;
			}

			if( preventOpenOnClickingSelection && event && event.target && event.target.closest( '[data-value]' ) ) {
				return false;
			}
			...
			if( this.getMethods( 'onBeforeShow' ) ) {
				/**
				 * This callback is fired just before the dropdown is opened
				 * @method onBeforeShow
				 * @author ananthapadmanaban.n@zohocorp.com
				 * @param { object } event
				 */
...
_lyteUiUtils.addGlobalEventListener( 'mousedown', function( event ) {
