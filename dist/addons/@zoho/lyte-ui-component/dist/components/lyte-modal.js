...
_template:"<template tag-name=\"lyte-modal\" role=\"dialog\" aria-label=\"lyte modal\" lyte-modal=\"\"> <template is=\"if\" value=\"{{expHandlers(ltPropBindToBody,'&amp;&amp;',expHandlers(ltPropReRenderModal,'!'))}}\"><template case=\"true\"> <lyte-wormhole lyte-modal=\"\" case=\"true\" style=\"{{if(ltPropShowCopy,'visibility:visible','visibility:hidden')}}\" class=\"{{if(ltPropRenderHidden,'lyteModalDisplayNone','')}}\" lt-prop-focus-on-close=\"{{ltPropFocusOnClose}}\" on-before-append=\"{{method(&quot;beforeWormholeAppend&quot;)}}\" lt-prop-show=\"{{ltPropShowWormhole}}\"> <template is=\"registerYield\" yield-name=\"lyte-content\"> <div class=\"modalWrapper {{ltPropWrapperClass}} lytePopupZI\"> <div class=\"lyteModal\" role=\"dialog\"> <template is=\"if\" value=\"{{ltPropShowCloseButton}}\"> <template case=\"true\"><span class=\"lyteModalClose\" onclick=\"{{action('close')}}\" tabindex=\"0\" role=\"button\" aria-label=\"Close Modal\" lt-prop-aria-keydown=\"true\"></span></template> </template> <lyte-yield yield-name=\"modal\" class=\"lyteModalYield\"></lyte-yield> </div> <template is=\"if\" value=\"{{ltPropFreeze}}\"> <template case=\"true\"><lyte-modal-freeze></lyte-modal-freeze></template> </template> </div> </template> </lyte-wormhole> </template></template> </template>",
...
_observedAttributes :["ltPropShow","ltPropFreeze","ltPropShowCloseButton","ltPropCloseOnEscape","ltPropTransition","ltPropOffset","ltPropDimmer","ltPropDraggable","ltPropAllowMultiple","ltPropScrollable","ltPropMaxHeight","ltPropMaxWidth","ltPropWidth","ltPropHeight","ltPropWrapperClass","ltPropBindToBody","ltPropShowCopy","ltPropReRenderModal","ltPropOverlayClose","ltPropAria","ltPropAriaAttributes","ltPropPreventFocus","ltPropSetContentHeight","ltPropCloseDuration","ltPropOverlapModal","ltPropIgnoreInlineDirection","ltPropAllowContainment","ltPropFocusOnClose","ltPropPadding","ltPropIgnoreZindex","ltPropDependentModalId","ltPropParentModalId","ltPropShowWormhole","ltPropRenderHidden","first","resizeCalled","initializedPosition","prevHeight","returnedFalse","prevModalHeight","prevModalWidth","calculateHW","checkAria","beforeDragPosition","resetTriggered"],
_observedAttributesType :["boolean","boolean","boolean","boolean","object","object","object","boolean","boolean","boolean","string","string","string","string","string","boolean","boolean","boolean","boolean","boolean","object","boolean","boolean","number","boolean","boolean","boolean","boolean","string","boolean","string","string","boolean","boolean","boolean","boolean","boolean","number","boolean","number","number","boolean","number","object","boolean"],

    _lyteUtilFunctions : ['alignModal' , 'calculateOffset' , 'trapFocus'],
    data: function(){
        return {
            //config from callee
             ...
             * @input
             */
            "ltPropTransition":Lyte.attr("object",{"default":_lyteUiUtils.resolveDefaultValue( 'lyte-modal', 'transition', { "animation":"slideFromTop", "duration":"0.5" } ),
            'input' : true,
            'output' : false}),
            /**
             ...
             * @input
             */
            "ltPropAria" : Lyte.attr( 'boolean', { default : false,in:true,out:false } ),
            ...
            * @condition ltPropAria true
             ...
             * @output
             */
            "ltPropAriaAttributes" : Lyte.attr( 'object', { default : {},in:true,out:false } ),
            ...
            /**
             * @componentProperty {string} ltPropPadding=""
             * @version 1.0.0
             * @input
             */
            "ltPropPadding" : Lyte.attr('string' , {
                default : "",
            'input' : true,
            'output' : false
            }),
            /**
             * @componentProperty {boolean} ltPropIgnoreZindex=false
             * @version 1.0.0
             * @input
             */
            "ltPropIgnoreZindex" : Lyte.attr('boolean' , {
                default : false,
            'input' : true,
            'output' : false
            }),
            ...
            "ltPropRenderHidden" : Lyte.attr('boolean' , {
                default : false
            }),
    ...
    handleMove : function(e){
        ...
        var comp = $L(e.target).closest('lyte-wormhole')[0].component.parent.component
        ...
        if(e.type == "mousedown"){
            _lyteUiUtils.addEventListenerGlobal('mousemove',e.currentTarget.parentEle.handleDrag,true);
            _lyteUiUtils.addEventListenerGlobal('mouseup',e.currentTarget.parentEle.stopDrag,true);
        }
        if(e.type == "touchstart"){
    ...
    stopDrag : function(e){
        ...
        var comp = $L(targetElem).closest('lyte-wormhole')[0].component.parent.component
        ...
        if(LytePopup.node){
            ...
            if(comp.getData('ltPropTransition').animation != "fadeIn"){
                var matrix = new WebKitCSSMatrix(getComputedStyle(comp.actualModalDiv).transform);
        ...
        if(comp.getMethods('onDragEnd')){
             ...
             * @author surendran.m@zohocorp.com
             * @version 1.0.0
             * @param { object } lyteModalComponent
             * @param { object } wormholeOfLyteModal
             * @param { object } event
             */
            ...
            if(_lyteUiUtils.getRTL()){
              if(!this.getData('ltPropIgnoreInlineDirection')){
                if(this.getData('ltPropTransition').animation == "slideFromLeft"){
                    ...
                    Lyte.objectUtils(this.getData('ltPropTransition') , 'add' , 'animation' , 'slideFromRight')
                }
                else if(this.getData('ltPropTransition').animation == "slideFromRight"){
                    // this.getData('ltPropTransition').animation = "slideFromLeft";
                    Lyte.objectUtils(this.getData('ltPropTransition') , 'add' , 'animation' , 'slideFromLeft')
                }
        ...
        this.fastdomfn2 = $L.fastdom.measure(function() {    //Measures the initial height and width
            ...
            this.fastdomfn3 = $L.fastdom.mutate(function(){    //Checks for the max height and width provided by the user and sets the modal height and width based on that
                ...
                if(this.$node.ltProp("maxHeight")){
                    ...
                    */
                    modalElem.parentNode.style.overflow = 'hidden'
                    oldHeight = modalElem.offsetHeight - borderDimensionY + 1;
                    modalElem.parentNode.style.overflow = ''
    ...
    callOnShow: function(){
        ...
        var _this = this
        setTimeout(function(){
          var style = getComputedStyle(_this.actualModalDiv);
          ...
          _lyteUiUtils.dispatchEvent('lytePopupOpened' ,_this.$node , _this.actualModalDiv)
        },(parseFloat(this.getData('ltPropTransition').duration)*1000+10))
        this.transitionEndTimeout = setTimeout(function(){
            if(_this.getMethods("onTransitionEnd")){
                /**
                 ...
                 * @param { object } lyteModalComponent
                 */
                _this.executeMethod("onTransitionEnd",_this);
              }
        },(parseFloat(this.getData('ltPropTransition').duration)*1000+10))
    ...
    callOnResize : function(){
        ...
        // }
        var style = getComputedStyle(this.actualModalDiv);
        var matrix = new WebKitCSSMatrix(style.transform);
    ...
    computeOffsetImpl : function(arg, triggeredFromTransChange){    //sets the left and top of the modal based on user provided values
        ...
        /*------------------------------ MEASURE STARTS --------------------------*/
         _this.fastdomfn6 = $L.fastdom.measure(function() {
            ...
            var modalWrapperElement = modalEle.parentElement;
            modalWrapperElement.style.overflow = 'hidden';
            ...
            if(_this.getData('ltPropFreeze')){
                var parentStyle = getComputedStyle(modalEle.parentElement);
                parentLeft = parseInt(parentStyle.left);
    ...
    closeModal : function(){
		...
		setTimeout(function() {
                ...
                if(!_this.getData('ltPropIgnoreInlineDirection')){
                  if(_this.getData('ltPropTransition').animation == "slideFromLeft"){
                    //   _this.getData('ltPropTransition').animation = "slideFromRight";
                      Lyte.objectUtils(_this.getData('ltPropTransition') , 'add' , 'animation' , 'slideFromRight')
                  }
                  else if(_this.getData('ltPropTransition').animation == "slideFromRight"){
                    //   _this.getData('ltPropTransition').animation = "slideFromLeft";
                      Lyte.objectUtils(_this.getData('ltPropTransition') , 'add' , 'animation' , 'slideFromLeft')
                  }
            ...
            _lyteUiUtils.dispatchEvent('lytePopupClosed' ,_this.$node, _this.actualModalDiv)
		}, (transitionDuration * 1000));

        _lyteUiUtils.dispatchEvent('lyteModalClosed' , this.actualModalDiv)
        if(_lyteUiUtils.popupStack && _lyteUiUtils.popupStack.modalStack.length < 1 ){
            document.body.classList.remove('bodyWrapper');
    ...
    onBeforeCloseHandling : function(event){
        ...
        if(this.actualModalDiv){
            _lyteUiUtils.dispatchEvent('lyteModalBeforeClose' , this.actualModalDiv)
        }
    ...
    onBeforeShowHandling : function(){
        ...
        if(result === undefined || result){
            ...
            /**
             * @utility reflectTransitionChange
             * @author surendran.m@zohocorp.com
             * @version 1.0.0
             */
...
if (document.readyState === "complete" || document.readyState === "interactive"){
    ...
    _lyteUiUtils.addEventListenerGlobal("DOMContentLoaded", function(event){
        addModalEvent(event);
    });
}
function addModalEvent(event){
    ...
    _lyteUiUtils.addEventListenerGlobal('click',function(event){
        ...
        if($L(event.target).closest('.lyteInputCalendar')[0] || $L(event.target).closest('.lyteCalendarView')[0] || ($L(event.target).closest('lyte-menu-box')[0] && $L($L(event.target).closest('lyte-menu-box')[0].parent).closest('.lyteModal')[0])){
            closeBoolen = true
        }
        while(!$L(ele).hasClass('modalWrapper') && !$L(ele).hasClass('popoverWrapper') && ele.tagName != "LYTE-MODAL-FREEZE" && ele.tagName != 'LYTE-DROP-BOX' && ele.tagName != 'HTML' && !closeBoolen){
