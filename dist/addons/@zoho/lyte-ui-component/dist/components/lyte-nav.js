...
/**
 * @domEvents keydown, keyup, focus, blur, focusin, focusout 
 */
...
_observedAttributesType :["object","boolean","boolean","boolean","array","string","string","string","string","string","string","string","string","string","boolean","string","string","string","string","number","boolean","boolean","string","boolean","string","array","object","string","array","boolean","boolean","boolean","object","object","array"],

	_lyteUtilFunctions: [ 'recalculate' ],
	init: function () {
	...
	getCurrentSelected: function () {
		...
		sel = this.getData( 'ltPropSelected' ) || '',
		selElement = this.$node.querySelector( 'lyte-nav-item[data-value="' + sel + '"]' );

		return this.$node.querySelector('lyte-nav-item.' + click) || selElement;
	},
	...
	fireAfterRender: function () {
		if (this.getMethods('afterRender')) {
			/**
			 * This callback is fired after the nav is rendered
			 * @method afterRender
		...
		_lyteUiUtils.dispatchEvent( 'lytenavafterrender', this.$node );
	},
	...
	didConnect: function () {
		...
		if(align == "horizontal" && this.getData("ltPropBentoIcon")) {
			this.$node.classList.add("lyteNavWithBentoIcon");
		}
		if (align === 'horizontal') {
	...
	methods: {
		...
		moreOptionsItemSelected: function (value, event, menuElement, originElement, clickedItem) {
			var selObj = arguments[4],
				...
				sys = this.getData('ltPropSystemValue'),
				item = _lyteUiUtils.isWidget ? selObj : selObj.element, aux = this.getData('auxArray'),
			...
			if (preventCallback !== true) {
				if (dv) {
					...
					if (this.getMethods('onMenuClick') && !this.getData('preventCallback')) {
						/**
						 * This callback is fired when an item in the collapsible menu is clicked
						 * @method onMenuClick
						 * @author ananthapadmanaban.n@zohocorp.com
						 * @param { string } valueOfSelectedMenuItem
						 * @param { object } event
						 * @param { object } menuElement
						 * @param { object } elementWhichOpenedTheMenu
		...
		beforeOpen: function () {
			if (this.getMethods('onBeforeOpen')) {
				/**
				 * This callback is fired before the menu is opened
				 * @method onBeforeOpen
				 * @author ananthapadmanaban.n@zohocorp.com
				 * @condition ltPropType collapse
				 */
		...
		open: function () {
			if (this.getMethods('onOpen')) {
				...
				/**
				 * This callback is fired when the menu is opened
				 * @method onOpen
				 * @author ananthapadmanaban.n@zohocorp.com
				 * @condition ltPropType collapse
				 */
		...
		beforeClose: function (element, event) {
			if (this.getMethods('onBeforeClose')) {
				/**
				 * This callback is fired before the menu is closed
		...
		close: function () {
			if (this.getMethods('onClose')) {
				/**
				 * This callback is fired when the menu is closed
				 * @method onClose
				 * @author ananthapadmanaban.n@zohocorp.com
				 * @condition ltPropType collapse
				 */
		...
		befRender: function () {
			if (this.getMethods('beforeMenuRender')) {
				/**
				 * This callback is fired before the menu is rendered
				 * @method beforeMenuRender
				 * @author ananthapadmanaban.n@zohocorp.com
				 * @condition ltPropType collapse
				 */
		...
		aftRender: function () {
			if (this.getMethods('afterMenuRender')) {
				/**
				 * This callback is fired after the menu is rendered
				 * @method afterMenuRender
				 * @author ananthapadmanaban.n@zohocorp.com
				 * @condition ltPropType collapse
				 */
	...
	data: function () {
		return {
			 ...
			 * @property {down|up|left|right|upRight|upLeft|downRight|downLeft} position
			 * @property {string} width
			 * @property {string} height
			 * @property {boolean} callout=false
			 * @property {boolean} freeze=true
			 * @property {string} queryClass
			 * @property {boolean} preventInsideClick=false
			 * @property {boolean} animate=false
			 * @property {string} wrapperClass
			 * @property {boolean} bindToBody=true
			 * @property {boolean} aria=false
			 */

			/**
			 * @componentProperty {menuProps} ltPropMenu
			 * @default {}
			 * @version 1.0.8
			 * @component lyte-menu
			 * @condition ltPropType collapse
			...
			'ltPropMenu': Lyte.attr('object', { 
				'default': _lyteUiUtils.resolveDefaultValue('lyte-nav', 'menu', {}),
				'input': true 
			}),
			...
			'ltPropNavYield': Lyte.attr('boolean', { 
				'default': false,
				'input': true 
			}),
			...
			'ltPropMenuYield': Lyte.attr('boolean', { 
				'default': false,
				'input': true 
			} ),
			 ...
			 * @version 1.0.8
			 * @input
			 * @allowedValuesDepends ltPropAlignment
			 * @map vertical collapse
			 * @map horizontal collapse,default
			 */
			...
			'ltPropNavMenuClass': Lyte.attr('string', { 
				'default': _lyteUiUtils.resolveDefaultValue('lyte-nav', 'navMenuClass', 'lyteNavMenuClass'),
				'input': true 
			} ),
			...
			'ltPropMenuIcon': Lyte.attr('string', { 
				'default': _lyteUiUtils.resolveDefaultValue('lyte-nav', 'menuIcon', 'lyteNavKebabMenu'),
				'input': true 
			} ),
			...
			'ltPropContainerClass': Lyte.attr('string', { 
				'default': _lyteUiUtils.resolveDefaultValue('lyte-nav', 'containerClass', 'lyteNavIconContainer'),
				'input': true 
			} ),
			...
			'ltPropClick': Lyte.attr('string', { 
				'default': _lyteUiUtils.resolveDefaultValue('lyte-nav', 'click', 'lyteNavActive'),
				'input': true 
			} ),
			...
			/**
			 * @componentProperty {string} ltPropContainerId=''
			 * @input
			 */

			'ltPropContainerId': Lyte.attr('string', { 'default': '', 'input': true }),
...
if (!_lyteUiUtils.registeredCustomElements['lyte-nav-item']) {
	 ...
	 * @customAttribute lyte-shortcut This is used to provide shortcut key for the nav item
	 * @customAttribute {true|false} selected Whether to select the item or not
	 */
		...
		connectedCallback: function () {
			if (!this.prevent) {
				...
				$L.fastdom.measure(function () {
					...
					if( div.nodeType === 9 || div.nodeType === 11 ) {
						return ;
					}
					...
					this.addEventListener('click', function (event) {
						...
						if (dv) {
							...
							if (targetTagName !== 'LYTE-NAV-MENU-ICON') {
								...
								if( !component.getData('preventCallback') ){
									...
									_lyteUiUtils.dispatchEvent( 'lytenavitemselected', component.$node, { target : this } );
								}
							}
						}
						else {
...
if (!_lyteUiUtils.registeredCustomElements['lyte-nav-menu-icon']) {
	...
	/**
	 * @customElement lyte-nav-menu-icon
	 * @version 1.0.0
	 * @author anantha <ananthapadmanaban.n@zohocorp.com>
	 */
...
/**
 * @syntax yielded
 * <lyte-nav lt-prop-user-value="name" lt-prop-system-value="value" lt-prop-items='[{"name": "tab 1", "value": "1"}, {"name": "tab 2", "value": "2"}, {"name": "tab 3", "value": "3"}, {"name": "tab 4", "value": "4"}, {"name": "tab 5", "value": "5"}]' lt-prop-nav-yield="true" lt-prop-type="collapse" lt-prop-max-width="80%">
 * 		<template is="registerYield" yield-name="nav">
 * 			<template lyte-for="{{items}} as item index">
 *  			<lyte-nav-item data-value={{item.value}}>
 *     				<span>{{item.name}}</span>
 *   			</lyte-nav-item>
 *			</template>
 * 		</template>
 ...
 */
 ...
 /**
 * @syntax
 * @attribute ltPropNavYield=true
 * @attribute ltPropMenuYield=true
 * <lyte-nav lt-prop-user-value="name" lt-prop-system-value="value" lt-prop-items='[{"name": "tab 1", "value": "1"}, {"name": "tab 2", "value": "2"}, {"name": "tab 3", "value": "3"}, {"name": "tab 4", "value": "4"}, {"name": "tab 5", "value": "5"}]' lt-prop-nav-yield="true" lt-prop-menu-yield="true" lt-prop-type="collapse" lt-prop-max-width="80%">
 * 		<template is="registerYield" yield-name="nav">
 * 			<template lyte-for="{{items}} as item index">
 *  			<lyte-nav-item data-value={{item.value}}>
 *     				<span>{{item.name}}</span>
 ...
 */
 ...
 /**
 * @syntax
 * @attribute ltPropNavYield=false
 * @attribute ltPropMenuYield=true
 * <lyte-nav lt-prop-user-value="name" lt-prop-system-value="value" lt-prop-items='[{"name": "tab 1", "value": "1"}, {"name": "tab 2", "value": "2"}, {"name": "tab 3", "value": "3"}, {"name": "tab 4", "value": "4"}, {"name": "tab 5", "value": "5"}]' lt-prop-menu-yield="true" lt-prop-type="collapse" lt-prop-max-width="80%">
 * 		<template is="registerYield" yield-name="menu">
 *			<lyte-menu-body>
 *				<template lyte-for="{{items}} as item index">
 *  			  	<lyte-menu-item data-value={{item.value}}>{{item.name}}</lyte-menu-item>
