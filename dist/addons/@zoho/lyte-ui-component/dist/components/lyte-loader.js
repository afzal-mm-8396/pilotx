...
_template:"<template tag-name=\"lyte-loader\" lyte-loader=\"\"> <template is=\"if\" value=\"{{ltPropShowLoader}}\"><template case=\"true\"> <template is=\"if\" value=\"{{ltPropInline}}\"><template case=\"true\"> <div class=\"ltLoaderContainer {{ltPropShowClass}} {{ltPropWrapperClass}}\"> <template is=\"if\" value=\"{{expHandlers(ltPropType,'==',&quot;strip&quot;)}}\"><template case=\"true\"> <div class=\"lyteLoaderLazyLoad\"> <div class=\"lyteLoaderLazyLoadRunner\"></div> </div> </template><template case=\"false\"> <div class=\"ltLoader\"> <div class=\"ltexitdiv\"> <template is=\"if\" value=\"{{ltPropCloseIcon}}\"><template case=\"true\"> <span class=\"lyteLoaderExit\" onclick=\"{{action(&quot;lyteLoadCloser&quot;,event)}}\"></span> </template></template> </div> <div class=\"ltspindiv {{ltPropLoaderSpinClass}}\"> <div class=\"ltLoaderSpin\"></div> </div> <template is=\"if\" value=\"{{ltPropProgressBar.show}}\"><template case=\"true\"> <div class=\"ltLoaderProgressBar {{ltPropProgressBar.class}} {{ltPropProgressBar.mode}}\"> <template is=\"if\" value=\"{{ifEquals(ltPropProgressBar.mode,'definite')}}\"><template case=\"true\"> <span class=\"lyteLoaderProgressed\" style=\"width: {{ltPropProgressed}}%\"></span> </template></template> </div> <div class=\"lyteLoaderProgressMessage\">{{ltPropMessage}}</div> </template></template> <div class=\"lyteLoaderTimeoutMessage\">{{ltPropTimeoutMessage}}</div> </div> </template></template> <lyte-loader-freeze class=\"lyteLoaderFreeze\"></lyte-loader-freeze> </div> </template><template case=\"false\"> <lyte-wormhole lt-prop-query=\"{{ltPropSelector}}\" on-before-append=\"{{method('beforeWormholeAppend')}}\"> <template is=\"registerYield\" yield-name=\"lyte-content\"> <div class=\"ltLoaderContainer {{ltPropShowClass}} {{ltPropWrapperClass}}\"> <template is=\"if\" value=\"{{expHandlers(ltPropType,'==',&quot;strip&quot;)}}\"><template case=\"true\"> <div class=\"lyteLoaderLazyLoad\"> <div class=\"lyteLoaderLazyLoadRunner\"></div> </div> </template><template case=\"false\"> <div class=\"ltLoader\"> <div class=\"ltexitdiv\"> <template is=\"if\" value=\"{{ltPropCloseIcon}}\"><template case=\"true\"> <span class=\"lyteLoaderExit\" onclick=\"{{action(&quot;lyteLoadCloser&quot;,event)}}\"></span> </template></template> </div> <template is=\"if\" value=\"{{expHandlers(ltPropLoaderYield,'!')}}\"><template case=\"true\"><div class=\"ltspindiv {{ltPropLoaderSpinClass}}\"> <div class=\"ltLoaderSpin\"></div> </div></template><template case=\"false\"><div> <lyte-yield yield-name=\"loaderYield\"> </lyte-yield> </div></template></template> <template is=\"if\" value=\"{{ltPropProgressBar.show}}\"><template case=\"true\"> <div class=\"ltLoaderProgressBar {{ltPropProgressBar.class}} {{ltPropProgressBar.mode}}\"> <template is=\"if\" value=\"{{ifEquals(ltPropProgressBar.mode,'definite')}}\"><template case=\"true\"> <span class=\"lyteLoaderProgressed\" style=\"width: {{ltPropProgressed}}%\"></span> </template></template> </div> <div class=\"lyteLoaderProgressMessage\">{{ltPropMessage}}</div> </template></template> <div class=\"lyteLoaderTimeoutMessage\">{{ltPropTimeoutMessage}}</div> </div> </template></template> <lyte-loader-freeze class=\"lyteLoaderFreeze \"></lyte-loader-freeze> </div> </template> </lyte-wormhole> </template></template> </template></template> </template>",
_dynamicNodes : [{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,1]},{"type":"if","position":[1,1],"cases":{"true":{"dynamicNodes":[]},"false":{"dynamicNodes":[{"type":"attr","position":[1,1,1]},{"type":"if","position":[1,1,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]}]}},"default":{}},{"type":"attr","position":[1,3]},{"type":"attr","position":[1,5]},{"type":"if","position":[1,5],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,1]},{"type":"if","position":[1,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1],"attr":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'width: '","ltPropProgressed","'%'"]}}}}]}},"default":{}},{"type":"text","position":[3,0]}]}},"default":{}},{"type":"text","position":[1,7,0]}]}},"default":{}},{"type":"componentDynamic","position":[1,3]}]},"false":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"registerYield","position":[1,1],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,1]},{"type":"if","position":[1,1],"cases":{"true":{"dynamicNodes":[]},"false":{"dynamicNodes":[{"type":"attr","position":[1,1,1]},{"type":"if","position":[1,1,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]}]}},"default":{}},{"type":"attr","position":[1,3]},{"type":"if","position":[1,3],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[0]}]},"false":{"dynamicNodes":[{"type":"insertYield","position":[0,1]}]}},"default":{}},{"type":"attr","position":[1,5]},{"type":"if","position":[1,5],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,1]},{"type":"if","position":[1,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1],"attr":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'width: '","ltPropProgressed","'%'"]}}}}]}},"default":{}},{"type":"text","position":[3,0]}]}},"default":{}},{"type":"text","position":[1,7,0]}]}},"default":{}},{"type":"componentDynamic","position":[1,3]}]},{"type":"componentDynamic","position":[1]}]}},"default":{}}]}},"default":{}}],
_observedAttributes :["ltPropShow","ltPropSelector","ltPropProgressBar","ltPropShowClass","ltPropOnTimeout","ltPropMessage","ltPropProgressed","ltPropCloseIcon","ltPropTimeout","ltPropInline","ltPropDimmer","ltPropTimeoutMessage","ltPropShowLoader","ltPropCloseOnEscape","ltPropWrapperClass","ltPropLoaderYield","ltPropLoaderSpinClass","ltPropType"],
_observedAttributesType :["boolean","string","object","string","object","string","number","boolean","number","boolean","object","string","boolean","boolean","string","boolean","string","string"],
	...
	ShowLoader : function(){
		...
		if(this.CallOnberforeshow()){
			...
			if(this.data.ltPropInline){
				this.$node.classList.add('lyteLoaderParent');
			}else if( window.getComputedStyle(parent).position !== 'absolute' && parent.nodeName !== 'BODY' ){
	...
	timeout : function(){
		var Load_ref = this.childComp || this.$node;
		var errMsg = this.data.ltPropOnTimeout.errorMsg == undefined ? 'some unkown error has occured' : this.data.ltPropOnTimeout.errorMsg;
