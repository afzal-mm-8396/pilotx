 ...
 */
 ...
 /**
  * @domEvents commonEvents keydown,keyup,keypress,focusin,focusout,wheel,scroll
  */

 Lyte.Component.register('lyte-gridstack', {
_template:"<template tag-name=\"lyte-gridstack\" lyte-gridstack=\"\"> <lyte-yield yield-name=\"lyteGridStack\"> </lyte-yield> </template>",
_dynamicNodes : [{"type":"insertYield","position":[1]}],
_observedAttributes :["ltPropScope","ltPropHandler","ltPropMarginLeft","ltPropMarginTop","ltPropUnitX","ltPropUnitY","ltPropResizeDirection","ltPropFloat","ltPropDirection","ltPropUndo","ltPropResize","ltPropBestfit","ltPropMinUnitX","ltPropMinMarginLeft","ltPropBestfitClass","ltPropFreezeMode","ltPropDefaultLength","ltPropDefaultHeight","ltPropDefaultMinLength","ltPropDefaultMinHeight","ltPropDefaultMaxHeight","ltPropDefaultMaxLength","ltPropColumnMode","ltPropColumn","ltPropPrevent","ltPropGridLength","ltPropBestfitType","ltPropForcedReposition","ltPropSquareGrid","ltPropGridSpaceColor","ltPropHitBottom","ltPropGridSelectionClass","ltPropVisibleBoundary","ltPropVisible","ltPropCheckCurrentPosition","ltPropContainment","ltPropMaxGridHeight","ltPropScrollElement","ltPropIgnoreDrag","ltPropMaintainOrder","ltPropScrollValue","ltPropUpdateParentHeight","ltPropIgnoreEmptyBottomMove","ltPropPreventScroll","ltPropAria","ltPropAriaAttributes","ltPropTabindex","ltPropDataTabindex","gridLength","ltPropGridHeight","ltPropMarginLeftCopy","ltPropUnitxCopy","lyteGridStack","elements","oriNode","xElements","yElements","iniData","lyteQuerySelector","direction"],
_observedAttributesType :["string","string","number","number","number","number","array","boolean","string","boolean","boolean","boolean","number","number","string","boolean","string","string","string","string","string","string","boolean","number","object","number","string","boolean","boolean","string","boolean","string","object","array","boolean","boolean","number","string","boolean","boolean","number","boolean","boolean","boolean","boolean","object","number","number","number","number","number","number","array","object","object","array","array","array","object","boolean"],

    _lyteUtilFunctions : [ "addGrid", "removeGrid", "setProperty", "reRender", "placeholder", "getGridPositions", "getEmptyPos", "updateValue", "topMove" ],
    init : function(){
    ...
    didDestroy : function(){
        ...
        __document[ rel + ( _lyteUiUtils.isWidget ? "Global" : "" ) ]( 'keydown', data.lyteQuerySelector.keydown );
        __window[ rel ]( 'resize', _this._resizeFunc, true );
        __window[ rel ]( 'orientationchange', _this._resizeFunc, true );        
        __document[ rel + ( _lyteUiUtils.isWidget ? "Global" : "" ) ]( 'click', _this._click );
    ...
    append : function( element, classes, clsName, resizeDir ){
        var __aria = this.data.ltPropAria,
        tabIndex = this.data.ltPropTabindex;
        ...
        $L.fastdom.mutate(function(){
             ...
             if( !__children.length ){
                ...
                if( __aria ){
                    $L( divElem ).attr( {
                        "data-tabindex" : divElem.tabIndex = tabIndex,
                        role : "button",
                        "aria-label" : `resize hander ${ resizeDir }`,
                        direction : resizeDir
                    });
                }
    ...
    create_resize : function( elem ){
        ...
        clsName = ['top', 'topRight', 'right', 'bottomRight', 'bottom', 'bottomLeft', 'left', 'topLeft'];
    ...
    positionFind : function( elements ){
        ...
        elements = elements || data.map( function( item ){
            ...
            if( !evt.shiftKey ){
                ...
                if( ( prevSelected.length == 0 ) ) {   
                    ...
                    if( nodeName && method != false ) {
                        ...
                        $L( handler + '.' + __focusclass + ':not(.gridSelected)', this.$node ).removeClass( __focusclass ).attr( "aria-selected", "false" ).removeAttr( "selected" );
                        ...
                        evt.type && document.body.addEventListener( isTch ? 'touchmove' : 'mousemove', this.mvefunc, true );
...
mouseup : function ( evt ){   
   ...
   evt.type && document[ "removeEventListener" + ( _lyteUiUtils.isWidget ? "Global" : "" ) ]( isTch ? 'touchend' : 'mouseup', this.upfunc, true )
},
 ...
 initialPosFind : function( elem ){
  ...
  click : function( event ) {
    ...
    if( className ) {
        ...
        if( nodeName ) {
            $L( nodeName ).addClass( className ).attr({
                "aria-selected" : "true",
                "selected" : "true"
            });

            if( this.data.ltPropAria && !nodeName.contains( document.activeElement ) ){
   ...
   mousebind : function(event){
        if( event.target != this && event.button != 2 ) {  
            ...
            // if( false && comp.data.ltPropMaxGridHeight == Infinity ){
            ...
            if(!event.shiftKey){
                event.type && document[ "addEventListener" + ( _lyteUiUtils.isWidget ? "Global" : "" ) ]( isTouch ? 'touchend' : 'mouseup', comp.upfunc, true );
            }

            if( is_selected || !comp.$node.parentNode.closest( "lyte-gridstack" ) ){
                event.type && event.stopPropagation();
            }
        }
    },

    prevent : function( evt ) {
        if( this.data.ltPropFreezeMode ){
            return;
        }
...
// after rendering properties
    didConnect : function(){    
            ...
            document[ "addEventListener" + ( _lyteUiUtils.isWidget ? "Global" : "" ) ]( 'click', this._click );
            ...
            if( !__data.ltPropAria && element.tabIndex == -1 ){
                element.tabIndex = 0;
            }     
            element.lyteData = {};
            ...
            document[ "addEventListener" + ( _lyteUiUtils.isWidget ? "Global" : "" ) ]( 'keydown', this.getData( 'lyteQuerySelector' ).keydown );

            /**
             * @utility placeholder
             * @version 3.53.0
             * @author Pon karthikeyan T <ponkarthikeyan.t@zohocorp.com>
             * @param {string} nameOfTheOperation
             * @param {Object} event
             * @param {Object} GridElement
             * @param {Object} GridDetails
             */
    ...
    updateValue : function( grid_element, value, __force ){
        ...
        if( !is_resize ){
            for( var key in new_obj ){
                ...
                if( key == "resize" || new_value == void 0 ){
                    continue;
                }
    ...
    set_aria_values : function( __elem, role, obj ){
        var __data = this.data,
        exst_tabindex = __elem.tabIndex,
        __data_tab = __data.ltPropDataTabindex;

        $L( __elem ).attr({
            role : role,
            tabindex : exst_tabindex + 1 ? exst_tabindex : __data.ltPropTabindex,
            "data-tabindex" : __data_tab == void 0 ? __elem.getAttribute( 'data-tabindex' ) : __data_tab
        }).attr( obj || {} );
    ...
    didConnectWrk : function( flag, flag2 ){
        $L.fastdom.measure(function(){
            ...
            aria = __data.ltPropAria;

            this.bcrrelem  = element.getBoundingClientRect();

            aria && this.set_aria_values( element, "grid" );
            ...
            for( var i = 0; i < __length; i++ ) {
                var __cur = elements[ i ];
                $L( __cur ).attr( "aria-selected", "false" );
                aria && this.set_aria_values( __cur, "gridcell", __data.ltPropAriaAttributes );
                iniData.push( this.initialPosFind( __cur ) );
            }
    ...
    // data 
    data : function(){
        var default_values = _lyteUiUtils.getDefault( 'lyte-gridstack' );
        ...
        return {
            ...
            * @input
            */
            ltPropHandler : Lyte.attr("string",{"default":default_values.handler || '', input : true}),
           /**
            * @componentProperty {number} ltPropMarginLeft=10
            * @version 1.0.0
            * @input
            */ 
            ltPropMarginLeft : Lyte.attr("number",{"default": default_values.marginLeft || 10, input : true}), 
           /**
            * @componentProperty {number} ltPropMarginTop=10
            * @version 1.0.0
            * @input
            */ 
            ltPropMarginTop : Lyte.attr("number",{"default":default_values.marginTop || 10, input : true}), 
           /**
            * @componentProperty {number} ltPropUnitX=50
            * @version 1.0.0
            * @input
            */
            ltPropUnitX : Lyte.attr("number",{"default":default_values.unitX || 50, input : true}), 
           /**
            * @componentProperty {number} ltPropUnitY=50
            * @version 1.0.0
            * @input
            */
            ltPropUnitY : Lyte.attr("number",{"default": default_values.unitY || 50, input : true}), 
           /**
            ...
            * @input
            */
            ltPropResizeDirection : Lyte.attr("array",{"default": default_values.resizeDirection || ['top', 'topRight', 'right', 'bottomRight', 'bottom', 'bottomLeft', 'left', 'topLeft'], input : true}), 
           /**
            * @componentProperty {boolean} ltPropFloat=false
            * @version 1.0.0
            * @input
            */
            ltPropFloat : Lyte.attr("boolean",{"default": default_values.float || false, input : true}), 
           /**
            ...
            * @input
            */
            ltPropUndo : Lyte.attr("boolean",{"default": default_values.undo == false ? false : true, input : true}), 
           /**
            * @componentProperty {boolean} ltPropResize=true
            * @version 1.0.0
            * @input
            */
            ltPropResize : Lyte.attr("boolean",{"default": default_values.resize == false ? false : true, input : true}), 
           /**
            * @componentProperty {boolean} ltPropBestfit=true
            * @version 1.0.0
            * @input
            */
            ltPropBestfit : Lyte.attr("boolean",{"default": default_values.bestfit == false ? false : true, input : true}), 
           /**
            * @componentProperty {number} ltPropMinUnitX=0
            * @version 1.0.0
            * @input
            */
            ltPropMinUnitX : Lyte.attr('number',{default : default_values.minUnitX || 0, input : true}),
           /**
            * @componentProperty {number} ltPropMinMarginLeft=0
            * @version 1.0.1
            * @input
            */
            ltPropMinMarginLeft : Lyte.attr('number',{default : default_values.minMarginLeft || 0, input : true}),
           /**
            * @componentProperty {string} ltPropBestfitClass=''
            * @version 1.0.1
            * @input
            */
            ltPropBestfitClass : Lyte.attr('string', {default : default_values.bestfitClass || '', input : true}),
           /**
            * @componentProperty {boolean} ltPropFreezeMode=false
            * @version 1.0.1
            * @input
            */
            ltPropFreezeMode : Lyte.attr('boolean', {default : default_values.freezeMode || false, input : true}),
           /**
            * @componentProperty {string} ltPropDefaultLength=2
            * @version 1.0.1
            * @input
            */
            ltPropDefaultLength : Lyte.attr('string',{default : default_values.defaultLength || '2', input : true}),
           /**
            * @componentProperty {string} ltPropDefaultHeight=2
            * @version 1.0.1
            * @input
            */
            ltPropDefaultHeight : Lyte.attr('string',{default : default_values.defaultHeight || '2', input : true}),
           /**
            * @componentProperty {string} ltPropDefaultMinLength=1
            * @version 1.0.1
            * @input
            */
            ltPropDefaultMinLength : Lyte.attr('string',{default : default_values.defaultMinLength || '1', input : true}),
           /**
            * @componentProperty {string} ltPropDefaultMinHeight=1
            * @version 1.0.1
            * @input
            */
            ltPropDefaultMinHeight : Lyte.attr('string',{default : default_values.defaultMinHeight || '1', input : true}),
           /**
            * @componentProperty {string} ltPropDefaultMaxHeight=0
            * @version 1.0.1
            * @input
            */
            ltPropDefaultMaxHeight : Lyte.attr('string',{default : default_values.defaultMaxHeight || '0', input : true}),
           /**
            * @componentProperty {string} ltPropDefaultMaxLength=0
            * @version 1.0.1
            * @input
            */
            ltPropDefaultMaxLength : Lyte.attr('string',{default : default_values.defaultMaxLength || '0', input : true}),
           /**
            * @componentProperty {boolean} ltPropColumnMode=false
            * @version 1.0.1
            * @input
            */
            ltPropColumnMode : Lyte.attr('boolean', {default : default_values.columnMode || false, input : true}),
           /**
            * @componentProperty {number} ltPropColumn=false
            * @version 1.0.1
            * @input
            */
            ltPropColumn : Lyte.attr('number', {default : default_values.column || 3, input : true}),
            /**
             * @typedef {object} gridstackpreventObject
             * @property {boolean} horizontal=false
             * @property {boolean} vertical=false
             */

           /**
            * @componentProperty {gridstackpreventObject} ltPropPrevent
            * @version 1.0.2
            * @input
            */
            ltPropPrevent : Lyte.attr('object', { default : default_values.prevent || { horizontal : false, vertical : false }, input : true}),
           /**
            * @componentProperty {number} ltPropGridLength
            * @version 1.0.2
            * @input
            */
            ltPropGridLength : Lyte.attr('number', {default : default_values.gridLength, input : true }),
           /**
            * @componentProperty {default | grid } ltPropBestfitType=default
            * @version 1.0.2
            * @input
            */
            ltPropBestfitType : Lyte.attr('string', { default : default_values.bestfitType || 'default', input : true}),
           /**
            * @componentProperty {boolean} ltPropForcedReposition=false
            * @version 1.0.2
            * @input
            */
            ltPropForcedReposition : Lyte.attr('boolean', { default : default_values.forcedReposition || false, input : true}),
           /**
            * @componentProperty {boolean} ltPropSquareGrid=false
            * @version 1.0.2
            * @input
            */
            ltPropSquareGrid : Lyte.attr('boolean', { default : default_values.squareGrid || false, input : true}),
           /**
            * @componentProperty {string} ltPropGridSpaceColor=#f8f8f8
            * @version 1.0.2
            * @input
            */
            ltPropGridSpaceColor : Lyte.attr('string', { default : default_values.gridSpaceColor || '#f8f8f8', input : true }),
           /**
            * @componentProperty {boolean} ltPropHitBottom=false
            * @version 1.0.2
            * @input
            */
            ltPropHitBottom : Lyte.attr('boolean', { default : default_values.hitBottom || false, input : true}),
           /**
            * @componentProperty {string} ltPropGridSelectionClass=lyteGridFocused
            * @version 1.0.4
            * @input
            */
            ltPropGridSelectionClass: Lyte.attr( 'string', { default : default_values.gridSelectionClass || 'lyteGridFocused', input : true } ),
           /**
            ...
            * @input
            */
            ltPropVisibleBoundary : Lyte.attr( 'object', { default : {}, "output": true, input : true } ),
           /**
            ...
            * @input
            */
            ltPropVisible : Lyte.attr( 'array', { default : [], "output": true, input : true } ),
           /**
            * @componentProperty {boolean} ltPropCheckCurrentPosition=false
            * @version 2.2.6
            * @input
            */
            ltPropCheckCurrentPosition : Lyte.attr( 'boolean', { default : default_values.checkCurrentPosition || false, input : true } ),
           /**
            * @componentProperty {boolean} ltPropContainment=false
            * @version 2.2.6
            * @input
            */
            ltPropContainment : Lyte.attr( 'boolean', { default : default_values.containment || false, input : true } ),
             ...
             * @input
             */
            ltPropMaxGridHeight : Lyte.attr( 'number', { default : default_values.maxGridHeight || Infinity, input : true } ),
             ...
             * @input
             */
            ltPropScrollElement : Lyte.attr( "string", { default : default_values.scrollElement || void 0, input : true } ),
             ...
             * @input
             */
            ltPropIgnoreDrag : Lyte.attr( "boolean", { default : default_values.ignoreDrag || false, input : true } ),
             ...
             * @input
             */
            ltPropMaintainOrder : Lyte.attr( 'boolean', { default : default_values.maintainOrder || false, input : true } ),
            ...
            ltPropScrollValue : Lyte.attr( 'number', { default : default_values.scrollValue || 10, input : true } ),
            ...
            ltPropUpdateParentHeight : Lyte.attr( 'boolean', { default : default_values.updateParentHeight == void 0 ? true : default_values.updateParentHeight, input : true } ),
            ...
            ltPropIgnoreEmptyBottomMove : Lyte.attr( 'boolean', { default : default_values.ignoreEmptyBottomMove || false, input : true } ),

            /**
             * @experimental ltPropPreventScroll
             */

            ltPropPreventScroll : Lyte.attr( "boolean", { default : default_values.preventScroll || false, input : true } ),
            ...
            /**
             * @typedef {object} gridstackariaobject
             * @property {string} "aria-live"="assertive"
             * @property {string} "aria-draggable"="true"
             * @property {string} "aria-multiselectable"="true"
             * @property {string} "aria-describedby"="Press Enter or Space to select for dragging and resizing"
             */

            /**
             * @componentProperty {gridstackariaobject} ltPropAriaAttributes
             * @version 3.103.0
             * @input
             */
            ...
            ltPropAriaAttributes : Lyte.attr( 'object', { default : { 
                ...
                "aria-describedby" : "Press Enter or Space to select for dragging and resizing"
            }, input : true } ),
    ...
    mod_mousedown : function( ev, isTch ){
        var __data = this.data,
        evt = ( ev.touches || [ ev ] )[ 0 ];
        ...
        if( ret ){
            ...
            if( is_shift ){
                ...
                $L( handler + '.' + __focusclass + ':not(.gridSelected)', comp ).removeClass( __focusclass ).attr( "aria-selected", "false" ).removeAttr( "selected" );
    ...
    modified_up : function( evt ){
        ...
        __selected.forEach( function( item ){
            var $item = $L( item ).removeClass( 'gridSelected lyteGridStackMove' ),
        ...
        if( !ret ){
            ...
            __data.lyteQuerySelector.currentPos += 1;
            this.undoPrevious();
        }
        ...
        if( moved && !__data.ltPropAria && !this.scopeElement.contains( document.activeElement ) ){
            this.scopeElement.focus();
        }

        if( !moved ){
            this.getMethods( cb = "onRelease" ) && this.executeMethod( cb, __selected, evt, this.$node );
        }
    },
    ...
    modified_move : function( ev, frm_raf ){
        ...
        __selected.forEach( function( item ){
            ...
            $item.css( obj ).addClass( 'lyteGridStackMove' );
    ...
    modified_vertical : function( item, is_content, xInc, yInc, frm_recursice, horizontal ){
        ...
        if( yInc > 0 && is_content ){
            ...
            if( this.data.ltPropHitBottom && !frm_recursice ){
                var __data = this.data.lyteGridStack,
                moving_data = __data[ item.elemNum ];

                __arr = __arr.filter( function( item ){
                    var __cur = __data[ item ];
                    cur_bottom = __cur.y + __cur.height - 1,
                    moving_top = moving_data.y;
                    return cur_bottom == moving_top;
                });
            }
        ...
        } else if( fn == "modified_toptobottom" && !frm_recursice && !horizontal && yInc > 0 && is_content && this.data.ltPropHitBottom ){
            return true;
        }
    },
    ...
    setup_active : function( elem ){
        var active_cls = this.data.ltPropGridSelectionClass,
        __attr = "aria-selected";
    
        $L( '.' + active_cls, this.$node ).removeClass( active_cls ).attr( __attr, "false" ).removeAttr( "selected" );
        $L( elem ).addClass( active_cls ).attr( __attr, "true" ).attr( "selected", "true" );
      },
    
      check_aria_key :  function( evt ){
        var key = evt.key,
            to_prevent,
            active_element = document.activeElement,
            $active = $L( active_element ),
            data = this.data,
            active_cls = data.ltPropGridSelectionClass,
            is_shift = evt.shiftKey,
            resize_handler,
            force_allow = active_element == this.scopeElement;

            if( $active.hasClass( "lyteGridResize" ) ){
                resize_handler = $active;
                $active = $active.parent();
                active_element = $active.get( 0 );
            }
    
            if( $active.hasClass( 'lyteGridstackHandler' ) || force_allow ){
                var x_fact = 0,
                y_fact = 0,
                is_active = $active.hasClass( active_cls );
                ...
                switch( key ){
                    ...
                    case " " : {
                        ...
                        if( is_active ){
                            ...
                            this.setup_active( active_element );
                        }
                    }
                    break;
                    case "Escape" : {
                        is_active = false;
                        if( resize_handler ){
                            resize_handler.get( 0 ).parentNode.focus({
                                preventScroll : true
                            });
                        } else {
                            this.setup_active();
                    ...
                    case "Tab" : {
                        if( resize_handler ){
                            var __index,
                            resize_elem_cls = 'lyteGridResize';

                            if( is_shift ){
                                if( !resize_handler.prev().hasClass( resize_elem_cls ) ){
                                    __index = -1
                                }
                            } else {
                                if( !resize_handler.next().hasClass( resize_elem_cls ) ){
                                    __index = 0
                                }
                            }
                            if( __index != void 0 ){
                                to_prevent = true;
                                is_active = false;
                                resize_handler.parent().children( '.lyteGridResize' ).get( __index ).focus({
                                    preventScroll : true
                                });
                            }
                        } else if( is_active ) {
                            var handlers = $active.children( '.lyteGridResize' ),
                            __index = 0;
                ...
                if( is_active && ( to_prevent = x_fact || y_fact ) ){
    
                    if( is_shift || evt.ctrlKey || evt.metaKey ){
                        return;
                    } 
                    var __style = getComputedStyle( active_element ),
                    time = parseFloat( __style.transitionDelay ) * 1e3 + parseFloat( __style.transitionDuration ) * 1e3,
                    __evt_obj = { clientX : 0, clientY : 0 },
                    is_modified = data.ltPropMaxGridHeight != Infinity,
                    unit_x = data.ltPropUnitX,
                    unit_y = data.ltPropUnitY;
                    
                    if( resize_handler ){                       
                        __evt_obj.target = resize_handler.get( 0 );
                    } else {
                        __evt_obj.target = active_element.getElementsByTagName( 'lyte-grid-content' )[ 0 ];
                    }
                    
                    if( __evt_obj ){
                        this.mousebind.call( this.scopeElement, __evt_obj);

                        this[ is_modified ? 'modified_move' : "mMove" ]( { clientX : x_fact * unit_x, clientY : y_fact * unit_y } );
                        this[ is_modified ? "modified_up" : "mouseup" ]( { target : __evt_obj.target } );
        
                        setTimeout( function(){
                            active_element.scrollIntoView( { behavior: "smooth", block: "center" });
                        }, time );
                    }
                } else if( !is_active && ( x_fact || y_fact ) ){ 
                    var /*wrapper = this.scopeElement,*/
                    cur_order = active_element.elemNum,
                    order = cur_order == void 0 ? -1 : cur_order,
                    xElements = this.data.xElements,
                    __data = this.data.lyteGridStack,
                    arr = this.multipleRemoval( this.yElementsFind( 0, xElements.length, xElements ) ).sort( function( a, b ){
                        return __data[ a ].y - __data[ b ].y;
                    }.bind( this ) ),
                    __len = arr.length,
                    __index = ( arr.indexOf( order ) + 1 * ( x_fact || y_fact ) + __len ) % __len,
                    new_elem = __data[ arr[ __index ] ];
    
                    this.setup_active();
    
                    if( new_elem ){
                        $L( new_elem.nodeName )/*.addClass( active_cls )*/.focus();
                    }
                    /* else if( __index == arr.length ){
                        ( ( __data[ __index - 1 ] || {} ).nodeName || wrapper ).focus();
                        return;
                    }*/
                    to_prevent = 1;
                }
      ...
      update_aria_label : function( elem ){
            var dataset = elem.dataSet || {},
            data = this.data.lyteGridStack,
            fn = function( key, prop ){
                var replace_str = "lyte-grid-";
                return  `${key} : ${ ( dataset[ replace_str + prop ] || "0" ) }`;
            },
            str = `${ fn( "Row", "y" )}, ${ fn( "Column", "x" ) }, ${ fn( "Width", "length" ) }, ${ fn( "Height", "height" ) }`,
            cur_data = data[ elem.elemNum ];

            clearTimeout( elem.__aria_time );
            elem.__aria_time = setTimeout( function(){
                var min_length = cur_data.minLength,
                max_length = cur_data.maxLength,
                max_height = cur_data.maxHeight,
                min_height = cur_data.minHeight;

                $L( elem ).attr( "aria-label", `${ str }${ min_length ? `, Min length : ${ min_length }` : "" }${ max_length ? `, Max length : ${ max_length }` : "" }${ min_height ? `, Min height : ${ min_height }` : "" }${ max_height ? `, Max height : ${ max_height }` : "" };` );
            }, 0 );
      }
}); 
