...
_observedAttributesType :["string","string","string","string","string","number","number","string","boolean","boolean","object","string","string","string","boolean","array","string","boolean","number","number","boolean","boolean","boolean","boolean","boolean","string","string","string","string","string","number","array","array"],
	...
	data: function () {
		return {
			...
			/**
						 * @componentProperty { bar | circle |stacked | vertical } ltPropType
						 * @version 1.0.0
						 * @default bar
						 * @input
						 */
			ltPropType: Lyte.attr("string", { "default": 'bar','input' : 'true', 'output' : 'false' }),	//circle,vertical,stacked,bar
			...
			/**
						 ...
						 * @input
						 */
			ltPropProgressFillColor: Lyte.attr("string", { "default": '','input' : 'true', 'output' : 'false' }),
			...
			/**
						 ...
						 * @input
						 */
			ltPropCompletedFillColor: Lyte.attr("string", { "default": '','input' : 'true', 'output' : 'false' }),
			...
			/**
						 ...
						 * @input
						 */
			ltPropWidth: Lyte.attr("string"/*,{"default":'100%'}*/,{'input' : 'true', 'output' : 'false'}),
			...
			/**
						 ...
						 * @input
						 */
			ltPropHeight: Lyte.attr("string"/*,{"default":'12px'}*/,{'input' : 'true', 'output' : 'false'}),

			/**
						 * @componentProperty {number} ltPropRadius
						 * @version 1.0.0
						 * @condition ltPropType circle
						 * @default 50
						 * @minValue 0
						 * @decimalNotAllowed
						 * @input
						 */
			ltPropRadius: Lyte.attr("number", { "default": 50,'input' : 'true', 'output' : 'false' }),

			/**
						 * @componentProperty {number} ltPropStroke
						 * @version 1.0.0
						 * @condition ltPropType circle
						 * @default 5
						 * @minValue 0
						 ...
						 * @input
						 */
			ltPropStroke: Lyte.attr("number", { "default": 5,'input' : 'true', 'output' : 'false' }),
			...
			/**
						 ...
						 * @version 1.0.0
						 * @default true
						 * @condition ltPropType bar
						 * @input
						 */
			ltPropAnimated: Lyte.attr("boolean", { "default": true,'input' : 'true', 'output' : 'false' }),

			/**
						 * @componentProperty {boolean} ltPropShowPercentage
						 * @version 1.0.0
						 * @default true
						 * @condition ltPropLabel undefined
						 * @input
						 */
			ltPropShowPercentage: Lyte.attr("boolean", { "default": true,'input' : 'true', 'output' : 'false' }),
			/**
			...
			/**
						 ...
						 * @condition ltPropType circle,bar,vertical
						 * @input
						 */
			ltPropProgressProperty: Lyte.attr('object', { "default": { "value": "0", "duration": "0s" },'input' : 'true', 'output' : 'false' }),
			...
			/**
						 ...
						 * @input
						 */
			ltPropLabel: Lyte.attr("string",{'input' : 'true', 'output' : 'false'}),
			...
			/**
						 ...
						 * @input
						 */
			ltPropFontSize: Lyte.attr("string",{'input' : 'true', 'output' : 'false'}),
			...
			/**
						 ...
						 * @input
						 */
			ltPropLabelColor: Lyte.attr("string",{'input' : 'true', 'output' : 'false'}),
			...
			/**
						 ...
						 * @version 3.1.0
						 * @condition ltPropType stacked
						 * @input
						 */
			ltPropStack: Lyte.attr("array", { "default": [],'input' : 'true', 'output' : 'false' }),

			/**
						 * @componentProperty {up|down} ltPropDirection
						 * @version 3.1.0
						 * @default up
						 * @condition ltPropType vertical
						 * @input
						 */
			ltPropDirection: Lyte.attr("string", { "default": "up",'input' : 'true', 'output' : 'false' }),		//up,down
			...
			/**
						 ...
						 * @input
						 */
			ltPropPercentage: Lyte.attr("boolean", { "default": true,'input' : 'true', 'output' : 'false' }),
			ltPropMaxValue: Lyte.attr("number", { default: 100 }), 
			ltPropMinValue: Lyte.attr("number", { default: 0 }), 
			ltPropShowValue: Lyte.attr('boolean',{ default : false}),
			...
			ltPropContentYield : Lyte.attr("boolean", {"default" : false } ),
			/**
	...
	setProgressFillColor : function(){
		if($L('.lyteProgressStatus',this.$node)[0]){
			...
			$L('.ltProgressFillCircle',this.$node)[0].style.stroke = this.getData('ltPropProgressFillColor');
	...
	onStrokeChange: function () {
		...
		var value = this.getData('ltPropProgressProperty').value;
		var ltPropMaxValue = this.getData('ltPropMaxValue');
		var ltPropMinValue = this.getData('ltPropMinValue');
		var normalizedValue = ((value - ltPropMinValue) / (ltPropMaxValue - ltPropMinValue)) * 100;	
		var r = (radius)-(stroke)/2;
		var strokeDash =  2 * 3.14159 * r;
		var circle = this.$node.querySelector('.ltProgressFillCircle');
		var per = strokeDash * (1 - (normalizedValue) / 100);
		circle.style.transition = 'none';
		circle.setAttribute('stroke-dashoffset', per);
		setTimeout(function(){
			circle.style.transition = 'stroke-dashoffset '+ duration + ' ' + timingfn;
		},10);
	}.observes('ltPropStroke'),
	onTypeChange : function(){
		this.PerValue(this.getData('ltPropProgressProperty').value);
	}.observes('ltPropType'),
		...
		switch(type){
			...
			default:
				if(type == 'vertical'){
					...
					setTimeout(function(){
						progressbar.style.height = normalizedValue + '%';
					},10);	
				}else{
	...
	percentageObserver: function(){
		if(this.getData('ltPropType') === 'stacked'){
			var stacked = $L('.lyteProgressStatusStack',this.$node);
			var stacks = this.getData('ltPropStack');
			for(var i =0; i<stacked.length; i++){
				var label = stacked[i].querySelector('.lyteProgressPercentageStack');
				if( stacks[i].label ){
					stacks[i].label = stacks[i].label ? stacks[i].label : '';
					label.innerHTML = stacks[i].label.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;");
				}else{
					label.textContent = this.getData('ltPropStack')[i].value + (this.getData('ltPropPercentage') ? '%' : '');
				}
			}
		}
	}.observes('ltPropPercentage'),
	setBackground: function () {
		...
		var ltPropMaxValue = this.getData('ltPropMaxValue');
		var ltPropMinValue = this.getData('ltPropMinValue');
		var ShowValue = this.getData('ltPropShowValue');
		var normalizedValue = ShowValue ? value : ((value - ltPropMinValue) / (ltPropMaxValue - ltPropMinValue)) * 100;
		normalizedValue = parseFloat(parseFloat(normalizedValue).toFixed(2));
		...
		if (this.getData('ltPropType') === 'circle') {
			if (normalizedValue >= 100) {
				...
				this.setData('ltPropBackground', this.getData('ltPropProgressFillColor'));
				this.setData('duration', duration);
				this.setData('percentage', normalizedValue + "");
			}
			...
			for (var i = 0; i < stacks.length; i++) {
				...
				if (stacks[i].label) {
					stacks[i].label = stacks[i].label ? stacks[i].label : '';
					bars[i].querySelector('.lyteProgressPercentageStack').innerHTML = stacks[i].label.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;");
				}
				else {
			...
			if (parseInt(normalizedValue) >= 100) {
				this.setData('duration', duration);
				this.setData('ltPropBackground', this.getData('ltPropProgressFillColor'));
				this.setData('percentage', '100');
				// this.$node.querySelector('.lyteProgressStatus').style.width = "100%";
		...
		if (parseInt(this.getData('duration')) == 0) {
			this.setData('percentageDisplay', normalizedValue + "");
		} else if (p > normalizedValue) {
			var diff = p - normalizedValue;
			...
			this.iId = setInterval(function() {
				...
				self.setData('percentageDisplay', Math.max(parseFloat(p.toFixed(2)), normalizedValue) + "");
				if (parseFloat(p) == normalizedValue) {
					clearInterval(self.iId);
					self.iId = false;
				}
			}, 100)
		} else if (p < normalizedValue) {
			var diff = normalizedValue - p;
			var margin = ((diff / (parseInt(this.getData('duration')) * 1000)) * 100);
			this.iId = setInterval(function() {
				p += margin;
				if (!self.$node) {
				...
				self.setData('percentageDisplay', Math.min(parseFloat(p.toFixed(2)), normalizedValue) + "");
				if (parseFloat(p) >= normalizedValue) {
					clearInterval(self.iId);
					self.iId = false;
				}
	...
	callOnComplete : function(){
		if(this.getMethods("onComplete")){
			this.executeMethod("onComplete",this.$node);
		}
	},
