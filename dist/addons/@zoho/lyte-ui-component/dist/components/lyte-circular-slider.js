...
_observedAttributesType :["number","number","number","number","string","string","string","number","boolean","string","string","boolean","boolean","boolean","object","string","string","number","boolean","string","boolean","number","string","number","number","string","string"],
    ...
    data: function () {
        return {
            ...
            ltPropDiscrete: Lyte.attr('boolean', { default: false }),
