 ...
 */
  ...
  * @utility focus,blur,setCss
  */

/**
 * @domEvents commonEvents keydown,keyup,keypress,focusin,focusout,wheel,input,change
 * @import lyte-dropdown
 * @condition ltPropDropdown true
 */

Lyte.Component.register("lyte-datetime-input", {
_template:"<template tag-name=\"lyte-datetime-input\" lyte-datetime-input=\"\"> <div class=\"lyteDateTimeInputWrapper\"> <input tabindex=\"{{ltPropTabindex}}\" data-tabindex=\"{{ltPropDataTabindex}}\" type=\"text\" lyte-purpose=\"date\" class=\"lyteDateTimeDate\" disabled=\"{{ltPropDisabled}}\" readonly=\"{{ltPropReadonly}}\" value=\"{{lbind(dateValue)}}\" onfocus=\"{{action('focus',event,this)}}\" onblur=\"{{action('blur',event,this)}}\" oninput=\"{{action('input',event,this)}}\" onkeydown=\"{{action('keydown',event,this)}}\"> <template is=\"if\" value=\"{{ltPropAria}}\"><template case=\"true\"> <span aria-haspopup=\"true\" aria-label=\"{{ltPropAriaLabel.button}}\" disabled=\"{{ltPropDisabled}}\" aria-expanded=\"{{isExpanded}}\" aria-controls=\"#{{randomId}}\" class=\"lyteDateInputCalendarIcon\" onclick=\"{{action('calIconClick',event,this)}}\" onfocus=\"{{action('calIconFocus',event,this)}}\" onblur=\"{{action('calIconBlur',event,this)}}\" tabindex=\"{{ltPropTabindex}}\" data-tabindex=\"{{ltPropDataTabindex}}\" onkeydown=\"{{action('calIconKey',event,this)}}\"></span> </template></template><template is=\"if\" value=\"{{expHandlers(ltPropType,'==',&quot;datetime&quot;)}}\"><template case=\"true\"><template is=\"if\" value=\"{{ltPropDropdown}}\"><template case=\"true\"> <lyte-dropdown lt-prop-tabindex=\"-1\" class=\"lyteDateInputDropdown\" lt-prop-selected=\"{{lbind(selected)}}\" lt-prop=\"{{ltPropDropdownProperties}}\" on-before-show=\"{{method('beforeShow')}}\" on-before-hide=\"{{method('beforeHide')}}\" on-option-selected=\"{{method('timeselect')}}\"> <template is=\"registerYield\" yield-name=\"yield\"> <lyte-drop-button> <input tabindex=\"{{ltPropTabindex}}\" data-tabindex=\"{{ltPropDataTabindex}}\" type=\"text\" lyte-purpose=\"time\" class=\"lyteDateTimeTime\" disabled=\"{{ltPropDisabled}}\" readonly=\"{{ltPropReadonly}}\" value=\"{{lbind(timeValue)}}\" onfocus=\"{{action('focus',event,this)}}\" onblur=\"{{action('blur',event,this)}}\" oninput=\"{{action('input',event,this)}}\" onkeydown=\"{{action('keydown',event,this)}}\"> <template is=\"if\" value=\"{{timezone}}\"><template case=\"true\"> <span class=\"lyteDateTimezone\">{{timezone}}</span> </template></template> </lyte-drop-button> <lyte-drop-box class=\"lyteDaterangeInputDropdown\"> <template is=\"if\" value=\"{{ltPropHeaderYield}}\"><template case=\"true\"> <lyte-drop-head> <lyte-yield yield-name=\"timeheader\"></lyte-yield> </lyte-drop-head> </template></template> <lyte-drop-body> <template is=\"if\" value=\"{{ltPropTimeYield}}\"><template case=\"true\"><template is=\"for\" items=\"{{dropdown}}\" item=\"item\" index=\"index\"> <lyte-drop-item tabindex=\"-1\" data-timezone=\"{{item.timezone}}\" data-value=\"{{item.format}}\"> <lyte-yield yield-name=\"dropYield\" item-value=\"{{item}}\"></lyte-yield> </lyte-drop-item> </template></template><template case=\"false\"> <template is=\"for\" items=\"{{dropdown}}\" item=\"item\" index=\"index\"> <lyte-drop-item tabindex=\"-1\" data-timezone=\"{{item.timezone}}\" data-value=\"{{item.format}}\"> <span class=\"lyteDateValue\">{{item.time}}</span> <template is=\"if\" value=\"{{item.timezone}}\"><template case=\"true\"> <span class=\"lyteDateTimezoneValue\">{{item.timezone}}</span> </template></template> </lyte-drop-item> </template> </template></template> </lyte-drop-body> </lyte-drop-box> </template> </lyte-dropdown> </template><template case=\"false\"> <div> <input tabindex=\"{{ltPropTabindex}}\" data-tabindex=\"{{ltPropDataTabindex}}\" type=\"text\" lyte-purpose=\"time\" class=\"lyteDateTimeTime\" disabled=\"{{ltPropDisabled}}\" readonly=\"{{ltPropReadonly}}\" value=\"{{lbind(timeValue)}}\" onfocus=\"{{action('focus',event,this)}}\" onblur=\"{{action('blur',event,this)}}\" oninput=\"{{action('input',event,this)}}\" onkeydown=\"{{action('keydown',event,this)}}\"> <template is=\"if\" value=\"{{timezone}}\"><template case=\"true\"> <span class=\"lyteDateTimezone\">{{timezone}}</span> </template></template> </div> </template></template></template></template> </div> <template is=\"if\" value=\"{{ltPropBindToBody}}\"><template case=\"true\"> <lyte-wormhole id=\"{{randomId}}\" class=\"lyteDateTimeInputWormhole lyteDateTimeInputHidden\" on-before-append=\"{{method('beforeAppend')}}\" role=\"dialog\" aria-modal=\"true\" aria-label=\"{{ltPropAriaLabel.modal}}\"> <template is=\"registerYield\" yield-name=\"lyte-content\"> <lyte-calendar onkeydown=\"{{action('calKey',event)}}\" lt-prop=\"{{ltPropCalendarProperties}}\" lt-prop-yield=\"{{ltPropCalendarYield}}\" lt-prop-format=\"{{ltPropDateFormat}}\" lt-prop-time-zone=\"{{ltPropTimeZone}}\" lt-prop-min-date=\"{{minDate}}\" lt-prop-max-date=\"{{maxDate}}\" lt-prop-current-date=\"{{lbind(dateValue)}}\" lt-prop-activate-navigation=\"{{lbind(navigation)}}\" lt-prop-disable-navigation=\"{{expHandlers(ltPropAria,'!')}}\" on-date-selected=\"{{method('dateselect')}}\" on-navigate=\"{{method('navigate','onNavigate')}}\" on-view-change=\"{{method('navigate','onViewChange')}}\"> <template is=\"registerYield\" yield-name=\"footer\" from-parent=\"\"></template> </lyte-calendar> </template> </lyte-wormhole> </template></template> </template>",
_dynamicNodes : [{"type":"attr","position":[1,1]},{"type":"attr","position":[1,3]},{"type":"if","position":[1,3],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]}]}},"default":{}},{"type":"attr","position":[1,4]},{"type":"if","position":[1,4],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[0]},{"type":"if","position":[0],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"registerYield","position":[1,1],"dynamicNodes":[{"type":"attr","position":[1,1]},{"type":"attr","position":[1,3]},{"type":"if","position":[1,3],"cases":{"true":{"dynamicNodes":[{"type":"text","position":[1,0]}]}},"default":{}},{"type":"componentDynamic","position":[1]},{"type":"attr","position":[3,1]},{"type":"if","position":[3,1],"cases":{"true":{"dynamicNodes":[{"type":"insertYield","position":[1,1]},{"type":"componentDynamic","position":[1]}]}},"default":{}},{"type":"attr","position":[3,3,1]},{"type":"if","position":[3,3,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[0]},{"type":"for","position":[0],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,1]},{"type":"insertYield","position":[1,1]},{"type":"componentDynamic","position":[1]}]}]},"false":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"for","position":[1],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,1,0]},{"type":"attr","position":[1,3]},{"type":"if","position":[1,3],"cases":{"true":{"dynamicNodes":[{"type":"text","position":[1,0]}]}},"default":{}},{"type":"componentDynamic","position":[1]}]}]}},"default":{}},{"type":"componentDynamic","position":[3,3]},{"type":"componentDynamic","position":[3]}]},{"type":"componentDynamic","position":[1]}]},"false":{"dynamicNodes":[{"type":"attr","position":[1,1]},{"type":"attr","position":[1,3]},{"type":"if","position":[1,3],"cases":{"true":{"dynamicNodes":[{"type":"text","position":[1,0]}]}},"default":{}}]}},"default":{}}]}},"default":{}},{"type":"attr","position":[3]},{"type":"if","position":[3],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"registerYield","position":[1,1],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"registerYield","position":[1,1],"dynamicNodes":[]},{"type":"componentDynamic","position":[1]}]},{"type":"componentDynamic","position":[1]}]}},"default":{}}],
_observedAttributes :["ltPropValue","ltPropDateFormat","ltPropTimeFormat","ltPropMaxDate","ltPropMinDate","ltPropType","ltPropDateProperties","ltPropTimeProperties","ltPropCalendarProperties","ltPropDropdownProperties","ltPropDropdown","ltPropCalendarYield","ltPropTimeYield","ltPropHeaderYield","ltPropBoundary","ltPropOffset","ltPropInterval","ltPropPosition","ltPropPreventEmpty","ltPropAllowKeys","ltPropI18n","ltPropAppearance","ltPropDisabled","ltPropReadonly","ltPropAria","ltPropDateAriaAttributes","ltPropTimeAriaAttributes","ltPropAriaLabel","ltPropTabindex","ltPropDataTabindex","ltPropTimeZone","dateValue","timeValue","timezone","minDate","maxDate","dropdown","lastDate","selected","minDate","maxDate","navigation","randomId","isExpanded"],
_observedAttributesType :[null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"number",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"array",null,null,null,null,null,null,null],

	_lyteUtilFunctions : [ "focus", "blur", "setCss" ],
	init : function(){
		var _this = this,
		data = this.data,
		...
		/**
		 * This method is called before the datetime input is rendered.
		 * @method beforeRender
		 * @author ponkarthikeyan.t@zohocorp.com
		 * @version 3.44.0
		 * @param { object } datetimeInputElement
		 */
	...
	data : function(){
		...
		return {
			 ...
			 * @input
			 */
			ltPropValue : Lyte.attr( str, { default : "", output : true, input : true } ),
			/**
			 * @componentProperty {string} ltPropDateFormat="MM/DD/YYYY"
			 * @version 3.44.0
			 * @input
			 */
			ltPropDateFormat : Lyte.attr( str, { default : default_values.dateFormat || "MM/DD/YYYY", input : true } ),
			/**
			 * @componentProperty {string} ltPropTimeFormat="hh:mm A"
			 * @version 3.44.0
			 * @input
			 */
			ltPropTimeFormat : Lyte.attr( str, { default : default_values.timeFormat || "hh:mm A", input : true } ),
			/**
			 * @componentProperty {string} ltPropMaxDate=""
			 * @version 3.44.0
			 * @input
			 */
			ltPropMaxDate : Lyte.attr( str, { default : default_values.maxDate || "", input : true } ),
			/**
			 * @componentProperty {string} ltPropMinDate=""
			 * @version 3.44.0
			 * @input
			 */
			ltPropMinDate : Lyte.attr( str, { default : default_values.minDate || "", input : true } ),
			/**
			 * @componentProperty { datetime | default } ltPropType="datetime"
			 * @version 3.44.0
			 * @input
			 */
			ltPropType : Lyte.attr( str, { default : default_values.dateType || "datetime", input : true } ),
			...
			ltPropDateProperties : Lyte.attr( obj, { default : default_values.dateProperties || {}, watch : true, input : true } ),
			/**
			 ...
			 * @input
			 */
			ltPropTimeProperties : Lyte.attr( obj, { default : default_values.timeProperties || {}, watch : true, input : true } ),
			/**
			 ...
			 * @input
			 */
			ltPropCalendarProperties : Lyte.attr( str, { default : default_values.calendarProperties || '{"disableNavigation":true}', input : true } ),
			/**
			 ...
			 * @input
			 */
			ltPropDropdownProperties : Lyte.attr( str, { default : default_values.dropdownProperties || '{"freeze" : false}', input : true } ),
			/**
			 * @componentProperty {boolean} ltPropDropdown=false
			 * @version 3.44.0
			 * @input
			 */
			ltPropDropdown : Lyte.attr( bool, { default : default_values.dropdown || false, input : true } ),
			/**
			 * @componentProperty {boolean} ltPropCalendarYield=false
			 * @version 3.44.0
			 * @input
			 */
			ltPropCalendarYield : Lyte.attr( bool, { default : default_values.calendarYield || false, input : true } ),
			/**
			 * @componentProperty {boolean} ltPropTimeYield=false
			 * @version 3.44.0
			 * @input
			 */
			ltPropTimeYield : Lyte.attr( bool, { default : default_values.timeYield || false, input : true } ),
			/**
			 * @componentProperty {boolean} ltPropHeaderYield=false
			 * @version 3.44.0
			 * @input
			 */
			ltPropHeaderYield : Lyte.attr( bool, { default : default_values.headerYield || false, input : true } ),
			/**
			 * @typedef boundDef
			 ...
			 * @input
			 */
			ltPropBoundary : Lyte.attr( obj, { default : default_values.boundary || {}, input : true } ),
			/**
			 * @typedef offDef
			 * @property {number} left
			 * @property {number} right
			 ...
			 * @input
			 */
			ltPropOffset : Lyte.attr( obj, { default : default_values.offset || {}, input : true } ),
			/**
			 * @componentProperty {number} ltPropInterval=30
			 * @version 3.44.0
			 * @input
			 */
			ltPropInterval : Lyte.attr( 'number', { default : default_values.interval || 30, input : true } ),
			/**
			 * @componentProperty { top | bottom } ltPropPosition=bottom
			 * @version 3.44.0
			 * @input
			 */
			ltPropPosition : Lyte.attr( str, { default : default_values.position || "bottom", input : true } ),
			/**
			 * @componentProperty {boolean} ltPropPreventEmpty=true
			 * @version 3.44.0
			 * @input
			 */
			ltPropPreventEmpty : Lyte.attr( bool, { default : default_values.preventEmpty == false ? false : true, input : true } ),
			/**
			 * @componentProperty {boolean} ltPropAllowKeys=true
			 * @version 3.44.0
			 * @input
			 */
			ltPropAllowKeys : Lyte.attr( bool, { default : default_values.allowKeys == false ? false : true, input : true } ),
			/**
			 * @componentProperty {boolean} ltPropI18n=false
			 * @version 3.44.0
			 * @input
			 */
			ltPropI18n : Lyte.attr( bool, { default : default_values.i18n || false, input : true } ),
			/**
			 * @componentProperty { flat | box } ltPropAppearance="box"
			 * @version 3.44.0
			 * @input
			 */
			ltPropAppearance : Lyte.attr( str, { default : default_values.appearance || "box", input : true } ),
			/**
			 * @componentProperty {boolean} ltPropDisabled=false
			 * @version 3.44.0
			 * @input
			 */
			ltPropDisabled : Lyte.attr( bool, { default : default_values.disabled || false, input : true } ),
			/**
			 * @componentProperty {boolean} ltPropReadonly=false
			 * @version 3.44.0
			 * @input
			 */
			ltPropReadonly : Lyte.attr( bool, { default : default_values.readonly || false, input : true } ),
			/**
			 * @componentProperty {boolean} ltPropAria=false
			 * @version 3.44.0
			 * @input
			 */
			ltPropAria : Lyte.attr( bool, { default : default_values.aria || false, input : true } ),
			/**
			 ...
			 * @input
			 */
			ltPropDateAriaAttributes : Lyte.attr( obj, { default : default_values.dateAriaAttributes || {}, watch : true, input : true } ),
			/**
			 ...
			 * @input
			 */
			ltPropTimeAriaAttributes : Lyte.attr( obj, { default : default_values.timeAriaAttributes || {}, watch : true, input : true } ),
            ...
            * @input
            */
            ltPropAriaLabel : Lyte.attr( obj, { default : default_values.ariaLabel || { modal : "Choose date", button : "Change date" }, input : true } ), 
		   /**
            * @componentProperty {string} ltPropTabindex="0"
            * @version 3.98.0
            * @input
            */
			ltPropTabindex : Lyte.attr( str, { default : default_values.tabindex || "0", input : true } ),
		   /**
            * @componentProperty {string} ltPropDataTabindex=""
            * @version 3.98.0
            * @input
            */
			ltPropDataTabindex : Lyte.attr( str, { default : default_values.dataTabindex || "", input : true } ),
			...
			ltPropTimeZone : Lyte.attr( str, { default : default_values.timeZone, input : true } ),
	...
	disabled_obs : function( arg ){
		...
		if( arg ){
			...
			/**
			 * This method is called after the datetime input is rendered.
			 * @method afterRender
			 * @author ponkarthikeyan.t@zohocorp.com
			 * @version 3.44.0
			 * @param { object } datetimeInputElement
	...
	const_drop : function(){
		...
		/**
		 * This method is called while constructing the options for the dropdown.
		 * @method onDropOptionsConstruct
		 * @author ponkarthikeyan.t@zohocorp.com
		 * @version 3.44.0
	...
	obs : function( arg ){
		...
		/**
		 * This method is called when the date or time is changed in the datetime input.
		 * @method onDateChange
		 * @author ponkarthikeyan.t@zohocorp.com
		 * @version 3.44.0
		 * @param { object } changeValue
		 * @param { object } datetimeInputElement
		 */
	...
	validate : function( return_moment, from_input ){
		...
		/**
		 * This method is called before validating the input value.
		 * @method onBeforeValidate
		 * @author ponkarthikeyan.t@zohocorp.com
		 * @version 3.44.0
		 * @param { string } finalModifiedValue
		 * @param { string } date
		 * @param { string } time
		 * @param { boolean } isFromInput
		 * @param { object } datetimeInputElement
		 */
	...
	methods : {
		...
		navigate : function( cb, evt ){
			...
			/**
			 * This method is called whenever the calendar view is changed.
			 * @method onViewChange
			 * @author ponkarthikeyan.t@zohocorp.com
			 * @version 3.44.0
			 * @param { object } event
			...
			/**
			 * This method is called whenever the calendar view is changed to one month from another month.
			 * @method onNavigate
			 * @author ponkarthikeyan.t@zohocorp.com
			 * @version 3.44.0
			 * @param { object } event
		...
		beforeShow : function( event ){
			...
			/**
			 * This method is called before the time dropdown is opened.
			 * @method onBeforeTimeOpen
			 * @author ponkarthikeyan.t@zohocorp.com
			 * @version 3.44.0
			 * @param { object } event
			 * @param { object } datetimeInputElement
		...
		beforeHide : function( event ){
			/**
			 * This method is called before the time dropdown is closed.
			 * @method onBeforeTimeClose
			 * @author ponkarthikeyan.t@zohocorp.com
			 * @version 3.44.0
			 * @param { object } event
			 * @param { object } datetimeInputElement
	...
	hideDate : function(){
		...
		/**
		 * This method is called after the calendar is closed.
	...
	showDate : function( evt ){
		...
		if( $elem.hasClass( hiddenClass ) ){
			...
			/**
			 * This method is called before opening the calendar.
		...
		/**
		 * This method is called after opening the calendar.
		...
		_this.__fd = fastdom.measure( function(){
			...
			obj[ __left ] = bcr[ __left ] + x_scroll;
			 ...
			 fastdom.mutate( function(){
				...
				/**
				 * This method is called after positioning the calendar.
				 * @method onPosition
				 * @author ponkarthikeyan.t@zohocorp.com
				 * @version 3.44.0
				 * @param { object } calendarElement
