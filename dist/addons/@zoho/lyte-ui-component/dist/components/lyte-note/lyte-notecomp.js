...
_template:"<template tag-name=\"lyte-notecomp\"> <template is=\"if\" value=\"{{expHandlers(ltPropAddNewComment,'&amp;&amp;',expHandlers(ltPropNotePosition,'===','top'))}}\"><template case=\"true\"> <div class=\"lyteNoteMainComment\"> <template is=\"if\" value=\"{{ltPropAvatar}}\"><template case=\"true\"> <img src=\"{{ltPropAvatar}}\" class=\"lyteNoteMainCommentAvatar\"> </template></template> <lyte-note-editor from-main=\"true\" lt-prop-text-editor=\"{{ltPropTextEditor}}\" lt-prop-edit-mode=\"{{lbind(ltPropEditMode)}}\" lt-prop-tabindex=\"{{ltPropTabindex}}\" lt-prop-buttons=\"{{ltPropButtons}}\" lt-prop-footer-icons=\"{{ltPropFooterIcons}}\" on-trigger=\"{{method('onTrigger')}}\" lt-prop-editor-panel=\"{{ltPropEditorPanel}}\" lt-prop-file-upload=\"{{ltPropFileUpload}}\" lt-prop-editor-animation=\"{{ltPropEditorAnimation}}\" lt-prop-tooltip-config=\"{{ltPropTooltipConfig}}\" lt-prop-text=\"{{ltPropText}}\" close-comment=\"{{method('close_comment')}}\" sanitizer=\"{{sanitizer}}\" lt-prop-editor-props=\"{{ltPropEditorProps}}\" lt-prop-title-yield=\"{{ltPropTitleYield}}\" lt-prop-title=\"{{ltPropTitle}}\" on-file-reject=\"{{method('fileReject','onFileUploadFailure')}}\" on-undo-redo-queue-update=\"{{method('onUndoRedoQueueUpdate')}}\" after-render=\"{{method('afterRender')}}\" on-before-paste=\"{{method('onBeforePaste')}}\" on-before-emoji-close=\"{{method('onBeforeEmojiClose')}}\" on-shortcut-apply=\"{{method('onShortcutApply')}}\" on-anchor-show=\"{{method('onAnchorShow')}}\" on-before-input=\"{{method('onBeforeInput')}}\"> <template is=\"registerYield\" yield-name=\"lyte-comment-title\" from-parent=\"\"></template> <template is=\"registerYield\" yield-name=\"lyte-editor-footer\" from-parent=\"\"></template> </lyte-note-editor> </div> </template></template><template is=\"if\" value=\"{{ltPropCommentsCommonHeaderYield}}\"><template case=\"true\"> <lyte-yield yield-name=\"common-header\"></lyte-yield> </template></template> <div class=\"lyteNoteCommentWrapper\"> <template is=\"for\" items=\"{{ltPropPinnedComments}}\" item=\"item\" index=\"index\"> <lyte-comment lt-prop-pinned-comment=\"true\" id=\"pinned_{{item.id}}\" data-index=\"pin_{{index}}\" lt-prop-title=\"{{item.title}}\" lt-prop-tabindex=\"{{ltPropTabindex}}\" class=\"lyteNotePinnedComment\" onclick=\"{{action('pinned',event,this,item)}}\" onmouseenter=\"{{action('pinEnter',this,event)}}\" lt-prop-value=\"{{lbind(item.value)}}\" sanitizer=\"{{sanitizer}}\" lt-prop-title-yield=\"{{ltPropTitleYield}}\" lt-prop-image-text=\"{{item.imageText}}\" lt-prop-track-changes=\"{{ltPropTrackChanges}}\" on-before-comment-download=\"{{method('onBeforeCommentDownload')}}\"> <template is=\"registerYield\" yield-name=\"lyte-pinned-note\" from-parent=\"\" item=\"{{item}}\"></template> <template is=\"registerYield\" yield-name=\"lyte-comment-title\" from-parent=\"\"></template> <template is=\"registerYield\" yield-name=\"lyte-editor-footer\" from-parent=\"\"></template> <template is=\"registerYield\" yield-name=\"lyte-header-item\" from-parent=\"\"></template> </lyte-comment> </template><template is=\"for\" items=\"{{ltPropComments}}\" item=\"item\" index=\"index\"> <lyte-comment id=\"{{item.id}}\" class=\"lyteNoteComment {{item.class}}\" lt-prop-tabindex=\"{{ltPropTabindex}}\" lt-prop-title=\"{{item.title}}\" lt-prop-image=\"{{item.image}}\" lt-prop-created-time=\"{{item.createdTime}}\" lt-prop-edit=\"{{item.edit}}\" lt-prop-delete=\"{{item.delete}}\" lt-prop-value=\"{{lbind(item.value)}}\" on-time-conversion=\"{{method('timeConversion')}}\" data-index=\"{{concat(index)}}\" lt-prop-reply=\"{{item.reply}}\" lt-prop-header=\"{{item.header}}\" lt-prop-footer=\"{{item.footer}}\" lt-prop-emoji=\"{{item.emoji}}\" lt-prop-edit-mode=\"{{lbind(item.editmode)}}\" lt-prop-track-changes=\"{{ltPropTrackChanges}}\" lt-prop-buttons=\"{{ltPropButtons}}\" on-trigger=\"{{method('onTrigger')}}\" lt-prop-text-editor=\"{{ltPropTextEditor}}\" lt-prop-editor-panel=\"{{ltPropEditorPanel}}\" lt-prop-file-upload=\"{{ltPropFileUpload}}\" lt-prop-attachments=\"{{item.attachments}}\" lt-prop-style=\"{{item.style}}\" lt-prop-editor-animation=\"{{ltPropEditorAnimation}}\" lt-prop-tooltip-config=\"{{ltPropTooltipConfig}}\" lt-prop-text=\"{{ltPropText}}\" lt-prop-voice-note=\"{{item.voiceNote}}\" lt-prop-pin=\"{{item.pin}}\" sanitizer=\"{{sanitizer}}\" lt-prop-reply-yield=\"{{ltPropReplyYield}}\" lt-prop-editor-props=\"{{ltPropEditorProps}}\" lt-prop-title-yield=\"{{ltPropTitleYield}}\" lt-prop-image-text=\"{{item.imageText}}\" on-before-comment-download=\"{{method('onBeforeCommentDownload')}}\"> <template is=\"registerYield\" yield-name=\"lyte-note-checkin\" from-parent=\"\"></template> <template is=\"registerYield\" yield-name=\"lyte-reply-header\" from-parent=\"\"></template> <template is=\"registerYield\" yield-name=\"lyte-reply-footer\" from-parent=\"\"></template> <template is=\"registerYield\" yield-name=\"lyte-comment-title\" from-parent=\"\"></template> <template is=\"registerYield\" yield-name=\"lyte-header-item\" from-parent=\"\"></template> </lyte-comment> </template><template is=\"if\" value=\"{{ltPropPinnedComments.length}}\"><template case=\"true\"> <lyte-menu lt-prop-yield=\"true\" lt-prop-query=\"#{{id}} .lyteNoteUnpinIcon\" on-menu-click=\"{{method('unpinSelect')}}\" lt-prop-wrapper-class=\"lyteNoteUnpinMenu\"> <template is=\"registerYield\" yield-name=\"yield\"> <lyte-menu-body> <lyte-menu-item data-value=\"unpin\" class=\"lyteNoteUnpinOption\">{{ltPropText.unpin}}</lyte-menu-item> </lyte-menu-body> </template> </lyte-menu> <lyte-hovercard lt-prop-class=\"lyteNotePinTooltipWrapper\" lt-prop-show=\"{{lbind(pinShow)}}\" lt-prop-origin-elem=\"#{{id}} .lyteNotePinOrigin\" on-hovercard-hide=\"{{method('pinHide')}}\" lt-prop-hide-on-click=\"true\" lt-prop-keep-alive=\"true\"> <template is=\"registerYield\" yield-name=\"hoverCardYield\"> <lyte-hovercard-content> <span class=\"lyteNotePinMessage\">{{unescape(pin.message)}}</span> <span class=\"lyteNotePinnedTime\">{{pin.time}}</span> </lyte-hovercard-content> </template> </lyte-hovercard> </template></template> </div> <template is=\"if\" value=\"{{ltPropCommentsCommonFooterYield}}\"><template case=\"true\"> <lyte-yield yield-name=\"common-footer\"></lyte-yield> </template></template><template is=\"if\" value=\"{{ltPropEditorProps.emoji}}\"><template case=\"true\"> <lyte-popover class=\"lyteNoteEmojiPopover\" lt-prop=\"{{stringify(ltPropPopover)}}\" lt-prop-origin-elem=\"#{{id}} .lyte_note_origin_elem\" lt-prop-show=\"{{lbind(popoverShow)}}\"> <template is=\"registerYield\" yield-name=\"popover\"> <lyte-emoji lt-prop=\"{{stringify(ltPropEmojiProps)}}\" on-emoji-select=\"{{method('emojiselect')}}\" lt-prop-tooltip-config=\"{{ltPropTooltipConfig}}\"></lyte-emoji> </template> </lyte-popover> </template></template><template is=\"if\" value=\"{{expHandlers(ltPropColors,'!')}}\"><template case=\"true\"> <lyte-colorpicker lt-prop=\"{{stringify(ltPropColorPicker)}}\" lt-prop-origin-element=\".lyte_note_bgswitch_elem\" lt-prop-show=\"{{lbind(bgSwitch)}}\" on-select=\"{{method('colorPickerSelect')}}\" lt-prop-wrapper-class=\"lyteNoteBgSwitcherPopover\"></lyte-colorpicker> </template></template> <lyte-messagebox lt-prop=\"{{ltPropMessageBoxProps}}\" lt-prop-show=\"{{lbind(messageShow)}}\" lt-prop-message=\"{{message}}\"></lyte-messagebox> <lyte-menu lt-prop=\"{{stringify(ltPropOptionsMenuProperties)}}\" lt-prop-aria=\"true\" lt-prop-wrapper-class=\"lyteNoteOptionsMenu\" lt-prop-yield=\"true\" lt-prop-query=\"#{{id}} .lyteNoteCommentMoreOptions\" on-menu-click=\"{{method('optionsMenuSelect')}}\" on-before-open=\"{{method('beforeOpenOptionsMenu')}}\" on-before-close=\"{{method('beforeCloseOptionsMenu')}}\"> <template is=\"registerYield\" yield-name=\"yield\"> <lyte-menu-body> <lyte-menu-item data-value=\"delete\" class=\"{{if(isDelete,'lyteNoteDeleteOption','lyteNoteDeleteOption lyteEditorHide')}}\">{{ltPropText.delete}}</lyte-menu-item> <lyte-menu-item data-value=\"pin\" class=\"{{if(isPin,'lyteNotePinOption','lyteNotePinOption lyteEditorHide')}}\">{{if(isPinned,ltPropText.unpin,ltPropText.pin)}}</lyte-menu-item> <lyte-menu-item data-value=\"view\" class=\"{{if(isReact,'lyteNoteViewReactionsOption ','lyteNoteViewReactionsOption lyteEditorHide')}}\">{{ltPropText.viewReactions}}</lyte-menu-item> <lyte-menu-item data-value=\"edit\" class=\"{{if(isEdit,'lyteNoteViewEditOption ','lyteNoteViewEditOption lyteEditorHide')}}\">{{ltPropText.edit}}</lyte-menu-item> </lyte-menu-body> </template> </lyte-menu> <template is=\"if\" value=\"{{renderView}}\"><template case=\"true\"> <lyte-reaction-view lt-prop-show=\"{{lbind(showViewArray)}}\" lt-prop-comment=\"{{lbind(currentComment)}}\" lt-prop-tooltip-config=\"{{ltPropTooltipConfig}}\" lt-prop-text=\"{{ltPropText}}\" on-time-conversion=\"{{method('timeConversion')}}\" lt-prop=\"{{ltPropReaction}}\"></lyte-reaction-view> </template></template><template is=\"if\" value=\"{{editAlertRender}}\"><template case=\"true\"> <lyte-alert lt-prop=\"{{ltPropAlert}}\" lt-prop-top=\"0\" lt-prop-yield=\"true\" lt-prop-wrapper-class=\"lyteNoteAlert\" lt-prop-show=\"{{lbind(alertShow)}}\"> <template is=\"registerYield\" yield-name=\"alert\"> <lyte-alert-header>{{ltPropText.editAlertHeader}}</lyte-alert-header> <lyte-alert-content>{{ltPropText.editAlertMessage}}</lyte-alert-content> <lyte-alert-footer> <lyte-button class=\"lyteNoteKeepEditingButton\" onclick=\"{{action('keepedit')}}\"> <template is=\"registerYield\" yield-name=\"text\"> {{ltPropText.keepEditing}} </template> </lyte-button> <lyte-button class=\"lyteNoteContinueButton\" lt-prop-appearance=\"failure\" onclick=\"{{action('continue')}}\"> <template is=\"registerYield\" yield-name=\"text\"> {{ltPropText.continue}} </template> </lyte-button> </lyte-alert-footer> </template> </lyte-alert> </template></template><template is=\"if\" value=\"{{ltPropEditorProps.emoji}}\"><template case=\"true\"> <lyte-hovercard lt-prop-class=\"lyteNoteEmojiTooltipWrapper\" lt-prop-show=\"{{lbind(hovercardShow)}}\" lt-prop-origin-elem=\"#{{id}} .lyteNoteHoverOrigin\" on-hovercard-hide=\"{{method('hoverHide')}}\" lt-prop-hide-on-click=\"true\" lt-prop-keep-alive=\"true\"> <template is=\"registerYield\" yield-name=\"hoverCardYield\"> <lyte-hovercard-content> <div class=\"lyteNoteEmojiTooltipTitle\">{{hoverEmoji.name}}</div> <ul class=\"lyteNoteEmojiTooltipNames\"> <template is=\"for\" items=\"{{hoverEmoji.reacted}}\" item=\"item\" index=\"index\"> <li class=\"lyteNoteEmojiIndividualName\">{{item}}</li> </template> </ul> </lyte-hovercard-content> </template> </lyte-hovercard> </template></template><template is=\"if\" value=\"{{ltPropEditorProps.attachment}}\"><template case=\"true\"> <lyte-colorbox lt-prop-yield=\"true\" on-before-open=\"{{method('cboxBeforeOpen')}}\" on-navigate=\"{{method('cboxNavigate')}}\" on-close=\"{{method(&quot;cboxClose&quot;)}}\"> <template is=\"registerYield\" yield-name=\"colorBoxYield\"> <div id=\"lyteColorbox\" class=\"lyteColorbox lyteCBox lyteNoteComponentColorbox\"> <div class=\"lyteColorboxFreezeLayer lyteCBoxOverlay\"></div> <div class=\"lyteColorboxWrapper\"> <div class=\"lyteColorboxUtilDiv {{if(isImage,'','lyteCBoxDNImp')}}\"> <span class=\"lyteCBoxZoomOut lyteColorboxZoomOut lyteColorboxDisabled\"></span> <span class=\"lyteCBoxReset lyteColorboxReset lyteColorboxDisabled\"></span> <span class=\"lyteCBoxZoomIn lyteColorboxZoomIn\"></span> </div> <div class=\"lyteColorboxContent lyteCBoxContent\" style=\"position: unset;\"> <span class=\"lyteColorboxLoadingImg\"></span> <template is=\"if\" value=\"{{isNoPreview}}\"><template case=\"true\"> <div class=\"lyteNoteComponentNoPreviewWrap\"> <span class=\"lyteNoteComponentNoPreviewIcon {{previewType}}\"></span> <span class=\"lyteNoteComponentNoPreviewMessage\">{{ltPropText.noPreviewMessage}}</span> </div> </template></template> </div> <div class=\"lyteColorboxHeader\"> <div class=\"lyteNoteComponentFileDetailWrapper\"> <div class=\"lyteColorboxTitle lyteCBoxTitle\" onmouseenter=\"{{action('enter',this)}}\" lt-prop-tooltip-title=\"lyteNoteColorBoxTooltip\" lt-prop-tooltip-config=\"{{ltPropTooltipConfig}}\"></div> <div class=\"lyteNoteComponentFileDetail\"> <span class=\"lyteNoteComponentFileDate\" lt-prop-title=\"{{previewDate.tooltip}}\" lt-prop-tooltip-config=\"{{ltPropTooltipConfig}}\" lt-prop-tooltip-class=\"lyteNoteColorboxTooltip\">{{previewDate.display}}</span> <span class=\"lyteNoteComponentFileSize\">{{fileSize}}</span> </div> </div> <div class=\"lyteColorboxDownloadDiv lyteCBoxDownload\"> <span class=\"lyteColorboxDownloadImg\"></span> </div> </div> </div> <div class=\"lyteColorboxCloseIcon lyteCBoxClose\"></div> <div class=\"lyteColorboxIconDiv lyteCBoxPrevious {{prevIconClass}}\"> <div class=\"lyteColorboxPreviousIcon\"></div> </div> <div class=\"lyteColorboxIconDiv lyteCBoxNext {{nextIconClass}}\"> <div class=\"lyteColorboxNextIcon\"></div> </div> <div class=\"lyteColorboxThumbInnerWrapper\"> <template is=\"for\" items=\"{{thumbnails}}\" item=\"item\" index=\"index\"> <div class=\"lyteColorboxThumb {{if(ifEquals(index,thumbIndex),'thumb-on','')}}\" data-thumb-val=\"{{thumbnailValue}}\" onclick=\"{{action('thumbClick',index)}}\"> <template is=\"if\" value=\"{{expHandlers(item.ctype,'==',&quot;photo&quot;)}}\"><template case=\"true\"> <img class=\"lyteNoteColorboxImg\" src=\"{{item.src}}\"> </template><template case=\"false\"> <div class=\"lyteCBoxIframeWrap\"> <div class=\"lyteCBoxIframeIcon\"></div> <div class=\"lyteCBoxIframeLabel\">{{item.fileType}}</div> </div> </template></template> </div> </template> </div> </div> </template> </lyte-colorbox> </template></template> <template is=\"if\" value=\"{{expHandlers(ltPropAddNewComment,'&amp;&amp;',expHandlers(ltPropNotePosition,'===','bottom'))}}\"><template case=\"true\"> <div class=\"lyteNoteMainComment\"> <template is=\"if\" value=\"{{ltPropAvatar}}\"><template case=\"true\"> <img src=\"{{ltPropAvatar}}\" class=\"lyteNoteMainCommentAvatar\"> </template></template> <lyte-note-editor from-main=\"true\" lt-prop-text-editor=\"{{ltPropTextEditor}}\" lt-prop-edit-mode=\"{{lbind(ltPropEditMode)}}\" lt-prop-tabindex=\"{{ltPropTabindex}}\" lt-prop-buttons=\"{{ltPropButtons}}\" lt-prop-footer-icons=\"{{ltPropFooterIcons}}\" on-trigger=\"{{method('onTrigger')}}\" lt-prop-editor-panel=\"{{ltPropEditorPanel}}\" lt-prop-file-upload=\"{{ltPropFileUpload}}\" lt-prop-editor-animation=\"{{ltPropEditorAnimation}}\" lt-prop-tooltip-config=\"{{ltPropTooltipConfig}}\" lt-prop-text=\"{{ltPropText}}\" close-comment=\"{{method('close_comment')}}\" sanitizer=\"{{sanitizer}}\" lt-prop-editor-props=\"{{ltPropEditorProps}}\" lt-prop-title-yield=\"{{ltPropTitleYield}}\" lt-prop-title=\"{{ltPropTitle}}\" on-file-reject=\"{{method('fileReject','onFileUploadFailure')}}\" on-undo-redo-queue-update=\"{{method('onUndoRedoQueueUpdate')}}\" after-render=\"{{method('afterRender')}}\" on-before-paste=\"{{method('onBeforePaste')}}\" on-before-emoji-close=\"{{method('onBeforeEmojiClose')}}\" on-shortcut-apply=\"{{method('onShortcutApply')}}\" on-anchor-show=\"{{method('onAnchorShow')}}\" on-before-input=\"{{method('onBeforeInput')}}\"> <template is=\"registerYield\" yield-name=\"lyte-comment-title\" from-parent=\"\"></template> <template is=\"registerYield\" yield-name=\"lyte-editor-footer\" from-parent=\"\"></template> </lyte-note-editor> </div> </template></template> </template>",
_dynamicNodes : [{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1,1]},{"type":"if","position":[1,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]}]}},"default":{}},{"type":"attr","position":[1,3]},{"type":"registerYield","position":[1,3,1],"dynamicNodes":[]},{"type":"registerYield","position":[1,3,3],"dynamicNodes":[]},{"type":"componentDynamic","position":[1,3]}]}},"default":{}},{"type":"attr","position":[2]},{"type":"if","position":[2],"cases":{"true":{"dynamicNodes":[{"type":"insertYield","position":[1]}]}},"default":{}},{"type":"attr","position":[4,1]},{"type":"for","position":[4,1],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,1]},{"type":"registerYield","position":[1,1],"dynamicNodes":[]},{"type":"registerYield","position":[1,3],"dynamicNodes":[]},{"type":"registerYield","position":[1,5],"dynamicNodes":[]},{"type":"registerYield","position":[1,7],"dynamicNodes":[]},{"type":"componentDynamic","position":[1]}]},{"type":"attr","position":[4,2]},{"type":"for","position":[4,2],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"registerYield","position":[1,1],"dynamicNodes":[]},{"type":"registerYield","position":[1,3],"dynamicNodes":[]},{"type":"registerYield","position":[1,5],"dynamicNodes":[]},{"type":"registerYield","position":[1,7],"dynamicNodes":[]},{"type":"registerYield","position":[1,9],"dynamicNodes":[]},{"type":"componentDynamic","position":[1]}]},{"type":"attr","position":[4,3]},{"type":"if","position":[4,3],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"registerYield","position":[1,1],"dynamicNodes":[{"type":"text","position":[1,1,0]},{"type":"componentDynamic","position":[1,1]},{"type":"componentDynamic","position":[1]}]},{"type":"componentDynamic","position":[1]},{"type":"attr","position":[3]},{"type":"registerYield","position":[3,1],"dynamicNodes":[{"type":"text","position":[1,1,0]},{"type":"text","position":[1,3,0]},{"type":"componentDynamic","position":[1]}]},{"type":"componentDynamic","position":[3]}]}},"default":{}},{"type":"attr","position":[6]},{"type":"if","position":[6],"cases":{"true":{"dynamicNodes":[{"type":"insertYield","position":[1]}]}},"default":{}},{"type":"attr","position":[7]},{"type":"if","position":[7],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"registerYield","position":[1,1],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"componentDynamic","position":[1]}]},{"type":"componentDynamic","position":[1]}]}},"default":{}},{"type":"attr","position":[8]},{"type":"if","position":[8],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"componentDynamic","position":[1]}]}},"default":{}},{"type":"attr","position":[10]},{"type":"componentDynamic","position":[10]},{"type":"attr","position":[12]},{"type":"registerYield","position":[12,1],"dynamicNodes":[{"type":"attr","position":[1,1]},{"type":"text","position":[1,1,0]},{"type":"componentDynamic","position":[1,1]},{"type":"attr","position":[1,3]},{"type":"text","position":[1,3,0]},{"type":"componentDynamic","position":[1,3]},{"type":"attr","position":[1,5]},{"type":"text","position":[1,5,0]},{"type":"componentDynamic","position":[1,5]},{"type":"attr","position":[1,7]},{"type":"text","position":[1,7,0]},{"type":"componentDynamic","position":[1,7]},{"type":"componentDynamic","position":[1]}]},{"type":"componentDynamic","position":[12]},{"type":"attr","position":[14]},{"type":"if","position":[14],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"componentDynamic","position":[1]}]}},"default":{}},{"type":"attr","position":[15]},{"type":"if","position":[15],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"registerYield","position":[1,1],"dynamicNodes":[{"type":"text","position":[1,0]},{"type":"componentDynamic","position":[1]},{"type":"text","position":[3,0]},{"type":"componentDynamic","position":[3]},{"type":"attr","position":[5,1]},{"type":"registerYield","position":[5,1,1],"dynamicNodes":[{"type":"text","position":[1]}]},{"type":"componentDynamic","position":[5,1]},{"type":"attr","position":[5,3]},{"type":"registerYield","position":[5,3,1],"dynamicNodes":[{"type":"text","position":[1]}]},{"type":"componentDynamic","position":[5,3]},{"type":"componentDynamic","position":[5]}]},{"type":"componentDynamic","position":[1]}]}},"default":{}},{"type":"attr","position":[16]},{"type":"if","position":[16],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"registerYield","position":[1,1],"dynamicNodes":[{"type":"text","position":[1,1,0]},{"type":"attr","position":[1,3,1]},{"type":"for","position":[1,3,1],"dynamicNodes":[{"type":"text","position":[1,0]}]},{"type":"componentDynamic","position":[1]}]},{"type":"componentDynamic","position":[1]}]}},"default":{}},{"type":"attr","position":[17]},{"type":"if","position":[17],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"registerYield","position":[1,1],"dynamicNodes":[{"type":"attr","position":[1,3,1]},{"type":"attr","position":[1,3,3,3]},{"type":"if","position":[1,3,3,3],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1,1]},{"type":"text","position":[1,3,0]}]}},"default":{}},{"type":"attr","position":[1,3,5,1,1]},{"type":"attr","position":[1,3,5,1,3,1]},{"type":"text","position":[1,3,5,1,3,1,0]},{"type":"text","position":[1,3,5,1,3,3,0]},{"type":"attr","position":[1,7]},{"type":"attr","position":[1,9]},{"type":"attr","position":[1,11,1]},{"type":"for","position":[1,11,1],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,1]},{"type":"if","position":[1,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]}]},"false":{"dynamicNodes":[{"type":"text","position":[1,3,0]}]}},"default":{}}]}]},{"type":"componentDynamic","position":[1]}]}},"default":{}},{"type":"attr","position":[19]},{"type":"if","position":[19],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1,1]},{"type":"if","position":[1,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]}]}},"default":{}},{"type":"attr","position":[1,3]},{"type":"registerYield","position":[1,3,1],"dynamicNodes":[]},{"type":"registerYield","position":[1,3,3],"dynamicNodes":[]},{"type":"componentDynamic","position":[1,3]}]}},"default":{}}],
_observedAttributes :["ltPropComments","ltPropEditMode","ltPropPopover","ltPropColorPicker","ltPropButtons","ltPropTooltipConfig","ltPropAvatar","ltPropTextEditor","ltPropEditorPanel","ltPropColors","ltPropFileUpload","ltPropEditorAnimation","ltPropEmojiProps","ltPropUploadInfoMessage","ltPropEmptyInfoMessage","ltPropText","ltPropScrollDuration","ltPropReaction","ltPropEditAlert","ltPropUserId","ltPropMaxTooltipNames","ltPropPinnedComments","ltPropAddNewComment","ltPropReplyYield","ltPropEditorProps","ltPropTitleYield","ltPropFooterIcons","ltPropAlert","ltPropCommentsCommonHeaderYield","ltPropCommentsCommonFooterYield","ltPropOptionsMenuProperties","ltPropMessageBoxProps","ltPropYield","ltPropCurrentComment","ltPropShowReactionView","ltPropKeywords","ltPropDateFormats","ltPropHandlePastedImage","ltPropTabindex","ltPropTrackChanges","ltPropNotePosition","ltPropTitle","pastedFileName","popoverShow","bgSwitch","messageShow","message","fileDate","fileTime","fileSize","isImage","isNoPreview","previewType","thumbnails","thumbnailValue","thumbIndex","prevIconClass","nextIconClass","renderView","currentComment","showViewArray","previewDate","editAlertRender","alertShow","hovercardShow","hoverEmoji","isDelete","isPin","isEdit","isReact","isPinned","pinShow","pin","sanitizer","id"],
_observedAttributesType :["array","boolean","object","object","string","object","string","object","object","array","object","string","object","string","string","object","number","string","boolean","string","number","array","boolean","boolean","object","boolean","array","string","boolean","boolean","object","string","boolean","string","boolean","object","array","boolean","number","boolean","string","boolean","string","boolean","boolean","boolean","string","string","string","string","boolean","boolean","string","array","string","number","string","string","boolean","object","boolean","object","boolean","boolean","boolean","object","boolean","boolean","boolean","boolean","boolean","boolean","object","object","string"],
	...
	data: function() {
			return {
				...
				/*
				* @componentProperty {array} ltPropFooterIcons
				* @version 3.107.0
				*/ 
				...
				ltPropNotePosition : Lyte.attr( 'string', { default : 'top' } ),
	...
	methods : {
		...
		onUndoRedoQueueUpdate : function(){},

		afterRender : function(){},

		onBeforePaste : function(){},

		onBeforeEmojiClose : function(){},

		onShortcutApply : function(){},

		onAnchorShow : function(){},
	...
	*/
	...
	actions : {
		...
		common_action : function( name ){
			...
			switch( name ){
				case 'onPreviewClick' : {
					this.preview_click.apply( this, arguments );
				}
				// case 'onCommentEdit' : {
				// 	if( this.close_all_comments() || this.make_main_draft() ){
	...
	should_prevent : function( editor, notecomp, success, uploading ){
		...
		if( this.data.ltPropTitleYield && this.data.ltPropTitle ){
			return false;
		}
