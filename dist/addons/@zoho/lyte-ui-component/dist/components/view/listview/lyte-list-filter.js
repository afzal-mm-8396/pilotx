...
_observedAttributes :["ltPropModal","ltPropFields","ltPropContent","ltPropShow","ltPropAny","ltPropReset","ltPropFormat","ltPropTimeFormat","ltPropConditions","ltPropNoResult","ltPropFilteredContent","ltPropModalProperties","ltPropFilterElementProperties","ltPropHiddenRows","ltPropGroupOrder","ltPropNestedGrouping","fields","finalStatus","noResult"],
_observedAttributesType :[null,null,null,null,null,null,null,null,"object",null,null,"object","object","array","array",null,null,null,null],
	...
	data : function(){
		...
		return {
			...
			ltPropNestedGrouping : Lyte.attr( __boolean, { default : false } ),
	...
	reset : function( fields ){
		...
		if( __data.ltPropNestedGrouping && __data.ltPropGroupOrder.length ){
			$L( this.$node ).closest( 'lyte-listview1' )[0].component.reset_table( this.data.ltPropContent );
		}else{
