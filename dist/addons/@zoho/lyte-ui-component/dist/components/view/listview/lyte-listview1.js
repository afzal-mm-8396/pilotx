...
_template:"<template tag-name=\"lyte-listview1\"> <template is=\"if\" value=\"{{expHandlers(ltPropCustomUtils,'!')}}\"><template case=\"true\"> <div class=\"lyteListUtils\"> <template is=\"if\" value=\"{{ltPropSearch}}\"><template case=\"true\"> <lyte-input lt-prop=\"{{ltPropInput}}\" lt-prop-type=\"search\" lt-prop-value=\"{{lbind(ltPropSearchValue)}}\"></lyte-input> </template></template><template is=\"if\" value=\"{{ltPropFilters}}\"><template case=\"true\"> <lyte-button onclick=\"{{action('showFilter')}}\" class=\"lyteListviewFilterLyteBtn\" lt-prop-class=\"lyteListviewFilter\"> <template is=\"registerYield\" yield-name=\"text\"> Show filters </template> </lyte-button> </template></template><template is=\"if\" value=\"{{ltPropInlineFilter}}\"><template case=\"true\"> <lyte-listview-filter lt-prop-nested-grouping=\"{{ltPropNestedGrouping}}\" lt-prop-format=\"{{ltPropFormat}}\" on-condition-change=\"{{method('filter')}}\" on-inline-filter-change=\"{{method('filterchange')}}\" on-filter-close=\"{{method('onFilterClose')}}\" lt-prop-header=\"{{ltPropHeader}}\" lt-prop-time-format=\"{{ltPropTimeFormat}}\" lt-prop-search-value=\"{{lbind(ltPropSearchValue)}}\" lt-prop-search-content=\"{{lbind(ltPropSearchContent)}}\" lt-prop-filter-content=\"{{lbind(ltPropFilterContent)}}\" on-picklist-construct=\"{{method('picklistData')}}\" lt-prop-grouped-row=\"{{lbind(ltPropGroupedRow)}}\" lt-prop-filter-grouped=\"{{lbind(ltPropFilterGrouped)}}\" lt-prop-content=\"{{lbind(ltPropContent)}}\" lt-prop-render-content=\"{{lbind(ltPropRenderContent)}}\" lt-prop-filtered-content=\"{{lbind(ltPropFilteredContent)}}\" lt-prop-navigator=\"{{ltPropNavigator}}\" lt-prop-multiple-filter=\"{{ltPropMultipleFilter}}\" lt-prop-prev-group-index=\"{{lbind(ltPropPrevGroupIndex)}}\" lt-prop-trigger-event=\"{{lbind(ltPropTriggerEvent)}}\"> </lyte-listview-filter> </template></template> <template is=\"if\" value=\"{{ltPropColumnChooser}}\"><template case=\"true\"> <div class=\"lyteListColumnChooser {{randomClass}}\"> <lyte-button id=\"columnChooser\" onclick=\"{{action('showPop')}}\"> <template is=\"registerYield\" yield-name=\"text\"> Choose column </template> </lyte-button> </div> </template></template> </div> </template></template><template is=\"if\" value=\"{{ltPropColumnChooser}}\"><template case=\"true\"> <lyte-popover lt-prop=\"{{ltPropPopover}}\" lt-prop-wrapper-class=\"lyteListviewManageColumnPopover\" lt-prop-header-padding=\"\" lt-prop-content-padding=\"\" lt-prop-origin-elem=\"{{columnChooserSelector}}\" lt-prop-show=\"{{lbind(ltPropColumnChooserShow)}}\"> <template is=\"registerYield\" yield-name=\"popover\"> <lyte-popover-header>{{ltPropText.columnChooser}}</lyte-popover-header> <lyte-popover-content> <lyte-column-chooser lt-prop-yield=\"{{ltPropColumnChooserYield}}\" lt-prop-header=\"{{ltPropHeader}}\" lt-prop-sortable=\"{{ltPropColumnChooserSortable}}\" on-checked=\"{{method('checked')}}\" on-unchecked=\"{{method('unchecked')}}\" on-before-drop=\"{{method('columnDrop')}}\" on-before-select=\"{{method('columnSelect')}}\" on-render=\"{{method('columnRender')}}\"> <template is=\"registerYield\" yield-name=\"columnChooser\" from-parent=\"\"></template> </lyte-column-chooser> </lyte-popover-content> </template> </lyte-popover> </template></template><template is=\"if\" value=\"{{ltPropDisplayFilters}}\"><template case=\"true\"> <div class=\"lyteListFilters\" style=\"{{showConditions}}\"> <template is=\"forIn\" object=\"{{ltPropConditions}}\" value=\"value\" key=\"key\"><template is=\"if\" value=\"{{value.isValid}}\"><template case=\"true\"> <div class=\"lyteListFilterItem\"> <span class=\"lyteListFilterKey\">{{expHandlers(value.filterName,'||',key)}}:</span> <div class=\"lyteListFilterValueWrap\"> <span class=\"lyteListFilterValue\">{{value.label}}</span> <template is=\"if\" value=\"{{value.input}}\"><template case=\"true\"> <span class=\"lyteListFilterSelectedValue\">{{value.input}}</span> </template><template case=\"false\"><template is=\"if\" value=\"{{expHandlers(value.type,'==',&quot;multiselect&quot;)}}\"><template case=\"true\"> <div class=\"lyteListFilterMultiSelect\"> <template is=\"for\" items=\"{{value.value}}\" item=\"item\" index=\"index\"> <span class=\"lyteListMultipleSelected\">{{item}}</span> </template> </div> </template></template></template></template> <span class=\"lyteListRemoveFilter\" onclick=\"{{action('reset_filter',key)}}\"></span> </div> </div> </template></template></template> </div> </template></template> <template is=\"if\" value=\"{{expHandlers(expHandlers(ltPropNavigator,'&amp;&amp;',expHandlers(ltPropTable.infiniteScroll,'!')),'&amp;&amp;',expHandlers(ltPropNavPosition,'==','top'))}}\"><template case=\"true\"> <div class=\"{{if(ltPropNavigator,'lyteListviewHeader lyteListviewNavigator','lyteListviewHeader')}}\"> <template is=\"if\" value=\"{{expHandlers(ltPropPerPageArray.length,'>',0)}}\"><template case=\"true\"> <div class=\"lyteListviewPerPageContainer\"> <template is=\"if\" value=\"{{expHandlers(ltPropNavigatorProperties.type,'==',&quot;simple&quot;)}}\"><template case=\"true\"> <p class=\"lyteListviewPerPageLabel\">Showing {{navStartRecord}} - {{navEndRecord}} of {{ltPropRecords}}</p> </template></template> <p class=\"lyteListviewPerPageLabel\"> Records per page : </p> <lyte-dropdown lt-prop-selected=\"{{lbind(ltPropPerPage)}}\"> <template is=\"registerYield\" yield-name=\"yield\"> <lyte-drop-box> <lyte-drop-body> <template is=\"for\" items=\"{{ltPropPerPageArray}}\" item=\"item\" index=\"index\"> <lyte-drop-item data-value=\"{{item}}\">{{item}}</lyte-drop-item> </template> </lyte-drop-body> </lyte-drop-box> </template> </lyte-dropdown> </div> </template></template> <lyte-navigator start-record=\"{{lbind(navStartRecord)}}\" end-record=\"{{lbind(navEndRecord)}}\" on-select=\"{{method('navSelect')}}\" lt-prop=\"{{stringify(ltPropNavigatorProperties)}}\" on-next=\"{{method('navigatorNext')}}\" on-previous=\"{{method('navigatorPrev')}}\" on-home=\"{{method('navigatorHome')}}\" on-end=\"{{method('navigatorEnd')}}\" lt-prop-yield=\"false\" lt-prop-value=\"{{ltPropValue}}\" lt-prop-records=\"{{ltPropRecords}}\" lt-prop-perpage=\"{{ltPropPerPage}}\"> <template is=\"if\" value=\"{{expHandlers(ltPropNavigatorProperties.type,'==',&quot;simple&quot;)}}\"><template case=\"true\"> <lyte-nav-arrow> </lyte-nav-arrow> <lyte-nav-arrow> </lyte-nav-arrow> <lyte-nav-arrow> </lyte-nav-arrow> <lyte-nav-arrow> </lyte-nav-arrow> </template></template> </lyte-navigator> </div> </template></template> <div class=\"{{if(ltPropSubHeaders,'lyteListviewSubHeaderPresent lyteListviewWrapper','lyteListviewWrapper')}}\"> <lyte-table lt-prop=\"{{stringify(ltPropTable)}}\" lt-prop-yield=\"true\" lt-prop-content=\"{{ltPropRenderContent}}\" lt-prop-header=\"{{headerData}}\" lt-prop-from-listview=\"true\" lt-prop-data=\"{{lbind(ltPropData)}}\" lt-prop-width=\"{{overallWidth}}\" on-fix=\"{{method('fix')}}\" on-un-fix=\"{{method('unfix')}}\" onscroll=\"{{action('scroll')}}\" scroll-end=\"{{method('scrollEnd')}}\" onclick=\"{{action('yield_click',event)}}\" on-fake-column-create=\"{{method('fakeCreate')}}\" on-before-select=\"{{method('beforeselect')}}\" on-select=\"{{method('onselect')}}\" on-before-drop=\"{{method('beforeDrop')}}\" on-before-inter-change=\"{{method(&quot;interchange&quot;)}}\" from-list-view=\"true\" fixed-column-status=\"{{fixedColumnStatus}}\"> <template is=\"registerYield\" yield-name=\"yield\"> <template is=\"if\" value=\"{{ltPropSubHeaders}}\"><template case=\"true\"> <div class=\"lyteListFakeHeader\" style=\"width:{{overallWidth}}\"> <template is=\"for\" items=\"{{fakeHeaderData}}\" item=\"item\" index=\"index\"> <div class=\"lyteListFakeCell {{if(item.data.pin,'lyteListFixed','')}}\" parent_index=\"{{index}}\" style=\"{{listStyle(item,item.width)}}\"> <template is=\"if\" value=\"{{item.data.name}}\"><template case=\"true\"><template is=\"if\" value=\"{{ltPropFakeHeaderYield}}\"><template case=\"true\"> <lyte-yield yield-name=\"fakeHeaderYield\" cell-data=\"{{item.data}}\"></lyte-yield> </template><template case=\"false\"> <span>{{item.data.name}}</span> </template></template></template></template><template is=\"if\" value=\"{{item.resizable}}\"><template case=\"true\"> <div class=\"lyteListResizeHandler\" onmousedown=\"{{action('resize',event)}}\" ontouchstart=\"{{action('resize',event)}}\"></div> </template></template> </div> </template> </div> </template></template><template is=\"if\" value=\"{{ltPropEdit}}\"><template case=\"true\"> <lyte-edit-element class=\"lyteListEditElement {{isActive}}\" style=\"{{editStyle}}\" tabindex=\"1\" onkeydown=\"{{action('keydown',event,this)}}\" ondblclick=\"{{action('dblclick')}}\" lt-prop-edit-mode=\"{{lbind(ltPropEditMode)}}\" lt-prop-edit-yield=\"{{ltPropEditYield}}\" lt-prop-cell-data=\"{{cellData}}\" lt-prop-row-data=\"{{rowData}}\" on-picklist-construct=\"{{method('picklistData')}}\" on-blur=\"{{method('editBlur')}}\" lt-prop-format=\"{{ltPropFormat}}\" lt-prop-time-format=\"{{ltPropTimeFormat}}\" lt-prop-cell-index=\"{{selectedCell}}\" lt-prop-row-index=\"{{originalRow}}\" onclick=\"{{action('edit_elem_click',event)}}\"> <template is=\"registerYield\" yield-name=\"edit\" from-parent=\"\"></template> <template is=\"registerYield\" yield-name=\"lyte-custom-edit-yield\" from-parent=\"\"></template> </lyte-edit-element> </template></template> <lyte-table-structure> <lyte-thead> <lyte-tr> <template is=\"for\" items=\"{{headerData}}\" item=\"cell\" index=\"index\"> <lyte-th tabindex=\"{{ltPropTabindex}}\" index=\"{{index}}\" class=\"{{cell.data.class}}\" parent_index=\"{{cell.parentIndex}}\" fixed=\"{{cell.data.pin}}\" sticky-position=\"{{cell.data.position}}\" style=\"{{listStyle(cell.data,cell.data.width,this)}}\"> <span class=\"lyteListHeaderName {{cell.data.sortStatus}}\" onclick=\"{{action('sort',index,undefined,event)}}\"> <template is=\"if\" value=\"{{ltPropHeaderYield}}\"><template case=\"true\"> <lyte-yield yield-name=\"headerYield\" cell-data=\"{{cell.data}}\" cell-index=\"{{index}}\"></lyte-yield> </template><template case=\"false\"> <span class=\"lyteListViewHeaderLabel\">{{cell.data.name}}</span> </template></template> </span> <template is=\"if\" value=\"{{cell.sortStatus}}\"><template case=\"true\"> <span class=\"lyteListSortReset\" onclick=\"{{action('reset_sort',cell)}}\"></span> </template></template><template is=\"if\" value=\"{{cell.data.resizable}}\"><template case=\"true\"> <div class=\"lyteListResizeHandler\" onmousedown=\"{{action('resize',event)}}\" ontouchstart=\"{{action('resize',event)}}\"></div> </template></template> </lyte-th> </template> </lyte-tr> </lyte-thead> <template is=\"if\" value=\"{{expHandlers(expHandlers(ltPropGroupedRow,'!'),'&amp;&amp;',expHandlers(ltPropFilterGrouped,'!'))}}\"><template case=\"true\"> <lyte-tbody onmousedown=\"{{action('mousedown',event)}}\" ontouchstart=\"{{action('touchstart',event)}}\" id=\"lyteTableBody\" body-index=\"0\"> <template is=\"if\" value=\"{{ltPropTable.infiniteScroll}}\"><template case=\"true\"> <template is=\"for\" items=\"{{ltPropData}}\" item=\"item\" index=\"index\"> <lyte-tr index=\"{{item.index}}\" actual_index=\"{{item.body.rowIndex}}\" class=\"{{item.body.data.class}}\" id=\"{{item.body.id}}\" onclick=\"{{action('row_click',item,this,event)}}\"> <template is=\"for\" items=\"{{headerData}}\" item=\"cell\" index=\"cellIndex\"> <lyte-td tabindex=\"{{ltPropTabindex}}\" class=\"{{cell.data.class}}\" row-index=\"{{item.index}}\" index=\"{{cellIndex}}\"> <template is=\"if\" value=\"{{cell.data.multiYield}}\"><template case=\"true\"> <div class=\"lyteListViewMultiYield\"> <template is=\"for\" items=\"{{cell.data.multiYield}}\" item=\"yieldItem\" index=\"index\"> </template> </div> </template><template case=\"false\"> <lyte-yield yield-name=\"{{expHandlers(cell.data.yield,'||',&quot;yield&quot;)}}\" row-data=\"{{item.body.data}}\" cell-data=\"{{cell.data}}\" actual-index=\"{{item.index}}\" cell-index=\"{{cellIndex}}\" row-index=\"{{index}}\"></lyte-yield> </template></template> </lyte-td> </template> </lyte-tr> </template> </template><template case=\"false\"> <template is=\"for\" items=\"{{ltPropRenderContent}}\" item=\"item\" index=\"index\"> <lyte-tr index=\"{{index}}\" actual_index=\"{{index}}\" class=\"\" id=\"{{item.body.id}}\" onclick=\"{{action('row_click',item,this,event)}}\"> <template is=\"for\" items=\"{{headerData}}\" item=\"cell\" index=\"cellIndex\"> <td tabindex=\"{{ltPropTabindex}}\" class=\"{{cell.data.class}}\" colspan=\"{{item.data.colspan[cell.data.prop]}}\" rowspan=\"{{item.data.rowspan[cell.data.prop]}}\" style=\"{{item.data.style[cell.data.prop]}}\" row-index=\"{{index}}\" index=\"{{cellIndex}}\"> <lyte-yield yield-name=\"{{expHandlers(cell.data.yield,'||',&quot;yield&quot;)}}\" row-data=\"{{item.data}}\" cell-data=\"{{cell.data}}\" actual-index=\"{{index}}\" cell-index=\"{{cellIndex}}\" row-index=\"{{index}}\"> </lyte-yield> </td> </template> </lyte-tr> <template is=\"if\" value=\"{{item.data.expand_data}}\"><template case=\"true\"> <lyte-tr expanded-row=\"\"> <template is=\"if\" value=\"true\"><template case=\"true\" depth=\"3\"><table><tbody><tr> <th colspan=\"{{getObjectLenght(item.data)}}\"> <lyte-yield yield-name=\"expanded-row\" data=\"{{item.data.expand_data}}\"></lyte-yield> </th> </tr></tbody></table></template></template> </lyte-tr> </template></template> </template> </template></template> </lyte-tbody> </template><template case=\"false\"><template is=\"if\" value=\"{{ltPropNestedGrouping}}\"><template case=\"true\"> <lyte-tbody> <lyte-tr> <template is=\"if\" value=\"true\"><template case=\"true\" depth=\"3\"><table><tbody><tr> <td colspan=\"{{headerData.length}}\" tabindex=\"{{ltPropTabindex}}\" class=\"sortable-ignore lyteGroupHeadingData\"> <lyte-nested-table lt-prop-header=\"{{headerData}}\" lt-prop-content=\"{{ltPropRenderContent}}\" lt-prop-header-yield=\"{{ltPropNestedGroupHeaderYield}}\" lt-prop-width-map=\"{{widthMap}}\" top-level=\"true\" fixed-column-status=\"{{fixedColumnStatus}}\"> <template is=\"registerYield\" yield-name=\"yield\" from-parent=\"true\"></template> <template is=\"for\" items=\"{{headerData}}\" item=\"item\" index=\"index\"> <template is=\"if\" value=\"{{item.data.yield}}\"><template case=\"true\"><template is=\"registerYield\" yield-name=\"{{item.data.yield}}\" from-parent=\"true\"></template></template></template> <template is=\"if\" value=\"{{item.data.groupYield}}\"><template case=\"true\"><template is=\"registerYield\" yield-name=\"{{item.data.groupYield}}\" from-parent=\"true\"></template></template></template> </template> </lyte-nested-table> </td> </tr></tbody></table></template></template> </lyte-tr> </lyte-tbody> </template><template case=\"false\"> <template is=\"for\" items=\"{{ltPropRenderContent}}\" item=\"groupItem\" index=\"bodyIndex\"> <lyte-tbody onmousedown=\"{{action('mousedown',event)}}\" ontouchstart=\"{{action('touchstart',event)}}\" id=\"{{expHandlers('lyteTableBody','+',bodyIndex)}}\" class=\"{{if(ltPropGroupInitiallyClosed,'lyteListViewRowHidden sortableTableBody','sortableTableBody')}}\" body-index=\"{{bodyIndex}}\"> <lyte-tr class=\"lyteGroupHeading\"> <template is=\"if\" value=\"true\"><template case=\"true\" depth=\"3\"><table><tbody><tr> <td tabindex=\"{{ltPropTabindex}}\" class=\"sortable-ignore lyteGroupHeadingData\" onclick=\"{{action('bodyHeadClick',this)}}\"> <span class=\"lyteListViewTableAccordionIcon\"></span> <template is=\"if\" value=\"{{ltPropGroupHeaderYield}}\"><template case=\"true\"> <lyte-yield yield-name=\"row-heading\" cell-data=\"{{groupItem}}\" cell-index=\"{{bodyIndex}}\"></lyte-yield> </template><template case=\"false\"> <span>{{groupItem.name}}</span> </template></template> </td> <td class=\"sortable-ignore lyteListViewIgnore\" colspan=\"{{ltPropHeader.length}}\" onclick=\"{{action('bodyHeadClick',this)}}\"></td> </tr></tbody></table></template></template> </lyte-tr> <template is=\"for\" items=\"{{groupItem.rows}}\" item=\"item\" index=\"index\"> <lyte-tr style=\"{{if(ltPropGroupInitiallyClosed,'display:none;')}}\" index=\"{{index}}\" actual_index=\"{{index}}\" class=\"lyteListViewTableContent\" id=\"{{item.body.id}}\" onclick=\"{{action('row_click',item,this,event)}}\"> <template is=\"for\" items=\"{{headerData}}\" item=\"cell\" index=\"cellIndex\"> <td tabindex=\"{{ltPropTabindex}}\" class=\"{{cell.data.class}}\" colspan=\"{{item.data.colspan[cell.data.prop]}}\" rowspan=\"{{item.data.rowspan[cell.data.prop]}}\" style=\"{{item.data.style[cell.data.prop]}}\" row-index=\"{{index}}\" index=\"{{cellIndex}}\"> <lyte-yield yield-name=\"{{expHandlers(cell.data.yield,'||',&quot;yield&quot;)}}\" row-data=\"{{item.data}}\" cell-data=\"{{cell.data}}\" actual-index=\"{{index}}\" cell-index=\"{{cellIndex}}\" row-index=\"{{index}}\"></lyte-yield> </td> </template> </lyte-tr> <template is=\"if\" value=\"{{item.data.expand_data}}\"><template case=\"true\"> <lyte-tr expanded-row=\"\"> <template is=\"if\" value=\"true\"><template case=\"true\" depth=\"3\"><table><tbody><tr> <th colspan=\"{{getObjectLenght(item.data)}}\"> <lyte-yield yield-name=\"expanded-row\" data=\"{{item.data.expand_data}}\"></lyte-yield> </th> </tr></tbody></table></template></template> </lyte-tr> </template></template> </template> </lyte-tbody> </template> </template></template></template></template> </lyte-table-structure> </template> </lyte-table> </div> <template is=\"if\" value=\"{{expHandlers(expHandlers(ltPropNavigator,'&amp;&amp;',expHandlers(ltPropTable.infiniteScroll,'!')),'&amp;&amp;',expHandlers(ltPropNavPosition,'==','bottom'))}}\"><template case=\"true\"> <div class=\"{{if(ltPropNavigator,'lyteListviewFooter lyteListviewNavigator','lyteListviewFooter')}}\"> <template is=\"if\" value=\"{{expHandlers(ltPropPerPageArray.length,'>',0)}}\"><template case=\"true\"> <div class=\"lyteListviewPerPageContainer\"> <template is=\"if\" value=\"{{expHandlers(ltPropNavigatorProperties.type,'==',&quot;simple&quot;)}}\"><template case=\"true\"> <p class=\"lyteListviewPerPageLabel\">Showing {{navStartRecord}} - {{navEndRecord}} of {{ltPropRecords}}</p> </template></template> <p class=\"lyteListviewPerPageLabel\"> Records per page : </p> <lyte-dropdown lt-prop-selected=\"{{lbind(ltPropPerPage)}}\"> <template is=\"registerYield\" yield-name=\"yield\"> <lyte-drop-box> <lyte-drop-body> <template is=\"for\" items=\"{{ltPropPerPageArray}}\" item=\"item\" index=\"index\"> <lyte-drop-item data-value=\"{{item}}\">{{item}}</lyte-drop-item> </template> </lyte-drop-body> </lyte-drop-box> </template> </lyte-dropdown> </div> </template></template> <lyte-navigator start-record=\"{{lbind(navStartRecord)}}\" end-record=\"{{lbind(navEndRecord)}}\" on-select=\"{{method('navSelect')}}\" lt-prop=\"{{stringify(ltPropNavigatorProperties)}}\" on-next=\"{{method('navigatorNext')}}\" on-previous=\"{{method('navigatorPrev')}}\" on-home=\"{{method('navigatorHome')}}\" on-end=\"{{method('navigatorEnd')}}\" lt-prop-yield=\"false\" lt-prop-value=\"{{ltPropValue}}\" lt-prop-records=\"{{ltPropRecords}}\" lt-prop-perpage=\"{{ltPropPerPage}}\"> <template is=\"if\" value=\"{{expHandlers(ltPropNavigatorProperties.yield,'==',true)}}\"><template case=\"true\"> <template is=\"registerYield\" yield-name=\"navigatorYield\" from-parent=\"\"></template> </template></template> <template is=\"if\" value=\"{{expHandlers(ltPropNavigatorProperties.type,'==',&quot;simple&quot;)}}\"><template case=\"true\"> <lyte-nav-arrow> </lyte-nav-arrow> <lyte-nav-arrow> </lyte-nav-arrow> <lyte-nav-arrow> </lyte-nav-arrow> <lyte-nav-arrow> </lyte-nav-arrow> </template></template> </lyte-navigator> </div> </template></template> <template is=\"if\" value=\"{{expHandlers(ltPropFilters,'&amp;&amp;',renderFilter)}}\"><template case=\"true\"> <lyte-list-filter lt-prop=\"{{ltPropFilter}}\" lt-prop-group-order=\"{{ltPropGroupOrder}}\" lt-prop-nested-grouping=\"{{ltPropNestedGrouping}}\" lt-prop-format=\"{{ltPropFormat}}\" lt-prop-conditions=\"{{lbind(ltPropConditions)}}\" lt-prop-any=\"{{lbind(ltPropAny)}}\" lt-prop-show=\"{{lbind(ltPropShowFilters)}}\" lt-prop-fields=\"{{headerData}}\" lt-prop-content=\"{{ltPropContent}}\" lt-prop-filtered-content=\"{{lbind(ltPropFilteredContent)}}\" lt-prop-render-content=\"{{lbind(ltPropRenderContent)}}\" lt-prop-modal-properties=\"{{ltPropModalProperties}}\" lt-prop-filter-element-properties=\"{{ltPropFilterElementProperties}}\" on-condition-change=\"{{method('filter')}}\" on-picklist-construct=\"{{method('picklistData')}}\" on-filter-construct=\"{{method('onFilterConstruct')}}\" lt-prop-hidden-rows=\"{{hiddenRows}}\" fetch-more-data=\"{{method('fetchData')}}\" on-custom-filter-reset=\"{{method('customReset')}}\" on-before-filter-open=\"{{method('beforeOpen')}}\" on-before-filter-close=\"{{method('beforeClose')}}\" on-modal-filter-apply=\"{{method('onModalApply')}}\" on-modal-filter-remove=\"{{method('onModalFilterRemove')}}\" on-reset=\"{{method('onBeforeReset')}}\" on-apply=\"{{method('onBeforeApply')}}\" on-cancel=\"{{method('onBeforeCancel')}}\"> <template is=\"registerYield\" yield-name=\"lyte-custom-filter\" from-parent=\"\"></template> </lyte-list-filter> </template></template> </template>",
_dynamicNodes : [{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1,1]},{"type":"if","position":[1,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"componentDynamic","position":[1]}]}},"default":{}},{"type":"attr","position":[1,2]},{"type":"if","position":[1,2],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"registerYield","position":[1,1],"dynamicNodes":[]},{"type":"componentDynamic","position":[1]}]}},"default":{}},{"type":"attr","position":[1,3]},{"type":"if","position":[1,3],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"componentDynamic","position":[1]}]}},"default":{}},{"type":"attr","position":[1,5]},{"type":"if","position":[1,5],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,1]},{"type":"registerYield","position":[1,1,1],"dynamicNodes":[]},{"type":"componentDynamic","position":[1,1]}]}},"default":{}}]}},"default":{}},{"type":"attr","position":[2]},{"type":"if","position":[2],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"registerYield","position":[1,1],"dynamicNodes":[{"type":"text","position":[1,0]},{"type":"componentDynamic","position":[1]},{"type":"attr","position":[3,1]},{"type":"registerYield","position":[3,1,1],"dynamicNodes":[]},{"type":"componentDynamic","position":[3,1]},{"type":"componentDynamic","position":[3]}]},{"type":"componentDynamic","position":[1]}]}},"default":{}},{"type":"attr","position":[3]},{"type":"if","position":[3],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1],"attr":{"style":{"name":"style","dynamicValue":"showConditions"}}},{"type":"attr","position":[1,1]},{"type":"forIn","position":[1,1],"dynamicNodes":[{"type":"attr","position":[0]},{"type":"if","position":[0],"cases":{"true":{"dynamicNodes":[{"type":"text","position":[1,1,0]},{"type":"text","position":[1,3,1,0]},{"type":"attr","position":[1,3,3]},{"type":"if","position":[1,3,3],"cases":{"true":{"dynamicNodes":[{"type":"text","position":[1,0]}]},"false":{"dynamicNodes":[{"type":"attr","position":[0]},{"type":"if","position":[0],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1,1]},{"type":"for","position":[1,1],"dynamicNodes":[{"type":"text","position":[1,0]}]}]}},"default":{}}]}},"default":{}},{"type":"attr","position":[1,3,5]}]}},"default":{}}]}]}},"default":{}},{"type":"attr","position":[5]},{"type":"if","position":[5],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,1]},{"type":"if","position":[1,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1,1]},{"type":"if","position":[1,1],"cases":{"true":{"dynamicNodes":[{"type":"text","position":[1,1]},{"type":"text","position":[1,3]},{"type":"text","position":[1,5]}]}},"default":{}},{"type":"attr","position":[1,5]},{"type":"registerYield","position":[1,5,1],"dynamicNodes":[{"type":"attr","position":[1,1,1]},{"type":"for","position":[1,1,1],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,0]},{"type":"componentDynamic","position":[1]}]},{"type":"componentDynamic","position":[1,1]},{"type":"componentDynamic","position":[1]}]},{"type":"componentDynamic","position":[1,5]}]}},"default":{}},{"type":"attr","position":[1,3]},{"type":"attr","position":[1,3,1]},{"type":"if","position":[1,3,1],"cases":{"true":{"dynamicNodes":[{"type":"componentDynamic","position":[1]},{"type":"componentDynamic","position":[3]},{"type":"componentDynamic","position":[5]},{"type":"componentDynamic","position":[7]}]}},"default":{}},{"type":"componentDynamic","position":[1,3]}]}},"default":{}},{"type":"attr","position":[7]},{"type":"attr","position":[7,1]},{"type":"registerYield","position":[7,1,1],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1],"attr":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'width:'","overallWidth"]}}}},{"type":"attr","position":[1,1]},{"type":"for","position":[1,1],"dynamicNodes":[{"type":"attr","position":[1],"attr":{"style":{"name":"style","helperInfo":{"name":"listStyle","args":["item","item.width"]}}}},{"type":"attr","position":[1,1]},{"type":"if","position":[1,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[0]},{"type":"if","position":[0],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"insertYield","position":[1]}]},"false":{"dynamicNodes":[{"type":"text","position":[1,0]}]}},"default":{}}]}},"default":{}},{"type":"attr","position":[1,2]},{"type":"if","position":[1,2],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]}]}},"default":{}}]}]}},"default":{}},{"type":"attr","position":[2]},{"type":"if","position":[2],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1],"attr":{"style":{"name":"style","dynamicValue":"editStyle"}}},{"type":"registerYield","position":[1,1],"dynamicNodes":[]},{"type":"registerYield","position":[1,3],"dynamicNodes":[]},{"type":"componentDynamic","position":[1]}]}},"default":{}},{"type":"attr","position":[4,1,1,1]},{"type":"for","position":[4,1,1,1],"dynamicNodes":[{"type":"attr","position":[1],"attr":{"style":{"name":"style","helperInfo":{"name":"listStyle","args":["cell.data","cell.data.width","this"]}}}},{"type":"attr","position":[1,1]},{"type":"attr","position":[1,1,1]},{"type":"if","position":[1,1,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"insertYield","position":[1]}]},"false":{"dynamicNodes":[{"type":"text","position":[1,0]}]}},"default":{}},{"type":"attr","position":[1,3]},{"type":"if","position":[1,3],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]}]}},"default":{}},{"type":"attr","position":[1,4]},{"type":"if","position":[1,4],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]}]}},"default":{}},{"type":"componentDynamic","position":[1]}]},{"type":"componentDynamic","position":[4,1,1]},{"type":"componentDynamic","position":[4,1]},{"type":"attr","position":[4,3]},{"type":"if","position":[4,3],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,1]},{"type":"if","position":[1,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"for","position":[1],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,1]},{"type":"for","position":[1,1],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,1]},{"type":"if","position":[1,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1,1]},{"type":"for","position":[1,1],"dynamicNodes":[]}]},"false":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"insertYield","position":[1]}]}},"default":{}},{"type":"componentDynamic","position":[1]}]},{"type":"componentDynamic","position":[1]}]}]},"false":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"for","position":[1],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,1]},{"type":"for","position":[1,1],"dynamicNodes":[{"type":"attr","position":[1],"attr":{"style":{"name":"style","dynamicValue":"item.data.style[cell.data.prop]"}}},{"type":"attr","position":[1,1]},{"type":"insertYield","position":[1,1]}]},{"type":"componentDynamic","position":[1]},{"type":"attr","position":[3]},{"type":"if","position":[3],"cases":{"true":{"dynamicNodes":[{"type":"if","position":[1,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,1]},{"type":"insertYield","position":[1,1]}]}},"default":{}},{"type":"componentDynamic","position":[1]}]}},"default":{}}]}]}},"default":{}},{"type":"componentDynamic","position":[1]}]},"false":{"dynamicNodes":[{"type":"attr","position":[0]},{"type":"if","position":[0],"cases":{"true":{"dynamicNodes":[{"type":"if","position":[1,1,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,1]},{"type":"registerYield","position":[1,1,1],"dynamicNodes":[]},{"type":"attr","position":[1,1,3]},{"type":"for","position":[1,1,3],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[0]},{"type":"registerYield","position":[0],"dynamicNodes":[]}]}},"default":{}},{"type":"attr","position":[3]},{"type":"if","position":[3],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[0]},{"type":"registerYield","position":[0],"dynamicNodes":[]}]}},"default":{}}]},{"type":"componentDynamic","position":[1,1]}]}},"default":{}},{"type":"componentDynamic","position":[1,1]},{"type":"componentDynamic","position":[1]}]},"false":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"for","position":[1],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"if","position":[1,1,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,3]},{"type":"if","position":[1,3],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"insertYield","position":[1]}]},"false":{"dynamicNodes":[{"type":"text","position":[1,0]}]}},"default":{}},{"type":"attr","position":[3]}]}},"default":{}},{"type":"componentDynamic","position":[1,1]},{"type":"attr","position":[1,3]},{"type":"for","position":[1,3],"dynamicNodes":[{"type":"attr","position":[1],"attr":{"style":{"name":"style","helperInfo":{"name":"if","args":["ltPropGroupInitiallyClosed","'display:none;'"]}}}},{"type":"attr","position":[1,1]},{"type":"for","position":[1,1],"dynamicNodes":[{"type":"attr","position":[1],"attr":{"style":{"name":"style","dynamicValue":"item.data.style[cell.data.prop]"}}},{"type":"attr","position":[1,1]},{"type":"insertYield","position":[1,1]}]},{"type":"componentDynamic","position":[1]},{"type":"attr","position":[3]},{"type":"if","position":[3],"cases":{"true":{"dynamicNodes":[{"type":"if","position":[1,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,1]},{"type":"insertYield","position":[1,1]}]}},"default":{}},{"type":"componentDynamic","position":[1]}]}},"default":{}}]},{"type":"componentDynamic","position":[1]}]}]}},"default":{}}]}},"default":{}},{"type":"componentDynamic","position":[4]}]},{"type":"componentDynamic","position":[7,1]},{"type":"attr","position":[9]},{"type":"if","position":[9],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,1]},{"type":"if","position":[1,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1,1]},{"type":"if","position":[1,1],"cases":{"true":{"dynamicNodes":[{"type":"text","position":[1,1]},{"type":"text","position":[1,3]},{"type":"text","position":[1,5]}]}},"default":{}},{"type":"attr","position":[1,5]},{"type":"registerYield","position":[1,5,1],"dynamicNodes":[{"type":"attr","position":[1,1,1]},{"type":"for","position":[1,1,1],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,0]},{"type":"componentDynamic","position":[1]}]},{"type":"componentDynamic","position":[1,1]},{"type":"componentDynamic","position":[1]}]},{"type":"componentDynamic","position":[1,5]}]}},"default":{}},{"type":"attr","position":[1,3]},{"type":"attr","position":[1,3,1]},{"type":"if","position":[1,3,1],"cases":{"true":{"dynamicNodes":[{"type":"registerYield","position":[1],"dynamicNodes":[]}]}},"default":{}},{"type":"attr","position":[1,3,3]},{"type":"if","position":[1,3,3],"cases":{"true":{"dynamicNodes":[{"type":"componentDynamic","position":[1]},{"type":"componentDynamic","position":[3]},{"type":"componentDynamic","position":[5]},{"type":"componentDynamic","position":[7]}]}},"default":{}},{"type":"componentDynamic","position":[1,3]}]}},"default":{}},{"type":"attr","position":[11]},{"type":"if","position":[11],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"registerYield","position":[1,1],"dynamicNodes":[]},{"type":"componentDynamic","position":[1]}]}},"default":{}}],
_observedAttributes :["ltPropContent","ltPropRenderContent","ltPropHeader","ltPropTable","ltPropText","ltPropCustomUtils","ltPropData","ltPropSubHeaders","ltPropColumnChooser","ltPropPopover","ltPropFilter","ltPropFormat","ltPropEdit","ltPropEditMode","ltPropEditYield","ltPropSortProperty","ltPropFilters","ltPropShowFilters","ltPropDisplayFilters","ltPropCaseSensitive","ltPropSearch","ltPropInput","ltPropSearchValue","ltPropMinlength","ltPropMethod","ltPropColumnChooserShow","ltPropHeaderYield","ltPropFakeHeaderYield","ltPropExternalSearch","ltPropColumnChooserSortable","ltPropColumnChooserYield","ltPropInlineFilter","ltPropGroupedRow","ltPropNavigator","ltPropRecords","ltPropValue","ltPropPerPage","ltPropTableNavigator","ltPropFilteredContent","ltPropNavPosition","ltPropMultipleFilter","ltPropFilterGrouped","ltPropGroupInitiallyClosed","ltPropPerPageArray","ltPropRowSortable","ltPropPrevGroupIndex","ltPropTriggerEvent","ltPropSearchContent","ltPropFilterContent","ltPropGroupHeaderYield","ltPropTimeFormat","ltPropAny","tableDataTag","ltPropConditions","ltPropModalProperties","ltPropNavigatorProperties","ltPropFilterElementProperties","ltPropExpandedRow","ltPropTabindex","ltPropNestedGrouping","ltPropGroupOrder","ltPropSeparateHeader","ltPropNestedGroupHeaderYield","sortableClass","doSort","headerData","fakeHeaderData","overallWidth","editStyle","isActive","navContentLastIndex","cellData","rowData","selectedRow","selectedCell","selectedBody","originalRow","rowElement","renderFilter","conditions","showConditions","groupableColumn","navStartRecord","navEndRecord","randomClass","hiddenRows","fixedColumnStatus","widthMap","columnChooserSelector"],
_observedAttributesType :[null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"string","boolean","boolean","boolean","array","boolean","object","boolean","array","array","boolean","string","boolean","string","object","object","object","object","boolean","number","boolean","array","boolean","boolean","string","boolean",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null],
	...
	init : function( isInitial ){
		...
		if( this.construct_fake() && isInitial == undefined  || hasConditions ){
			...
			if( !this.is_nested_grp() ){
				setTimeout( function(){
					this.call_modify(void 0, void 0, true);
				}.bind(this), 0 );
			} 
		...
		this.setData( "columnChooserSelector", this.data.ltPropCustomUtils ? "#columnChooser" : ( "." + this.data.randomClass + " #columnChooser" ) );
	},
	...
	filterContentObs : function(fromPerpage){
		...
		if( ret && ret.then ){
			...
			if( isGroup && !data.ltPropNavigator ){
			...
			}else if( ( isGroup || data.ltPropNestedGrouping ) && data.ltPropNavigator ){
				if( !data.ltPropNestedGrouping ){
					if( fromPerpage ){
				...
				} else if( fromPerpage && ( data.ltPropGroupOrder || [] ).length ){
					this.change_page( data.ltPropValue );
				}
			}else{
				if( this.data.ltPropNavigator ){
				...
				}else if( !this.containsData( data.ltPropFilteredContent ) ){
					...
					this.setData( 'ltPropRenderContent', data.ltPropFilteredContent );
				}
	...
	call_modify : function( __bool, fromSearch, fromInit ){
		var __data = this.data;
		this.modify_content( __data.ltPropConditions , __data.ltPropAny, __bool, fromSearch, fromInit );
	},
	...
	setWidth : function(table){
		...
		header.forEach( function( item, index ){
			...
			width_map.push( {
				width : cells[index].style.width,
				minWidth : item.data.minWidth
			} );
		} )

		if( width_map.length !== this.data.widthMap.length ){
			this.setData( "widthMap", width_map );
		}else{
			width_map.forEach( function( item, index ){
				Lyte.objectUtils( __this.data.widthMap[index], 'add', 'width', item.width );
				Lyte.objectUtils( __this.data.widthMap[index], 'add', 'minWidth', item.minWidth );
			} );
		}
		// this.setData( "widthMap", width_map );
		...
		if( this._fd ){
			$L.fastdom.clear( this._fd );
		}

		this._fd = $L.fastdom.measure( function(){
			...
			$L.fastdom.mutate( function(){
				width_map.forEach( function( item, indx ){
					item.cell.style.width = item.width + "px";
					Lyte.objectUtils( __this.data.widthMap[indx], 'add', 'width', _widthMap[indx].width );
					Lyte.objectUtils( __this.data.widthMap[indx], 'add', 'minWidth', _widthMap[indx].minWidth );
				});

				// __this.setData( "widthMap", _widthMap );
	...
	content_obs : function( arg ){
		...
		if( this.__ignore_all ){
			return;
		}

		if( arg.item == 'ltPropContent' && !arg.insertedItems && !arg.removedItems && this.data.ltPropNavigator ){
			this.setData( 'ltPropValue', 0);
		}

		if( !(this.data.ltPropExternalSearch && arg.item === 'ltPropSearchValue') ){ 
			this.setData( 'ltPropFilteredContent' , undefined );
		}

		if( !this.data.ltPropExternalSearch && this.is_nested_grp() ){ 
			this.setData({
				ltPropRenderContent : [],
				ltPropFilterGrouped : false
			});
		}
	...
	}.observes( 'ltPropContent', 'ltPropSearchValue', 'ltPropContent.[]' ),
	...
	construct_content : function( ){
		...
		final = __data.ltPropNestedGrouping && ( __data.ltPropGroupOrder || [] ).length ? content : this.addIndex( content );

		if( this.__ignore_obs || this.is_nested_grp() ){
	...
	construct_fake : function( from_nested_grp ){
		var __data = this.data,
		...
		header.forEach( function( item, index ){
			...
			for( var i = 0, appended = 0; i < item.children.length; i++ ){
				...
				if( from_nested_grp && group.indexOf( cur.prop ) + 1 ){
					continue;
				}
		...
		if( group.length && __data.ltPropSeparateHeader ){
			fake.unshift({
				width : 200
			});
			overall += 200;
	...
	data : function(){
		...
		return {
			...
			ltPropNestedGrouping : Lyte.attr( "boolean", { default :false } ),

			ltPropGroupOrder : Lyte.attr( 'array', { default : [] } ),

			ltPropSeparateHeader : Lyte.attr( 'boolean', { default : true } ),

			ltPropNestedGroupHeaderYield : Lyte.attr( 'boolean' ),
			...
			fixedColumnStatus : Lyte.attr( __object, { default : {} } ),
			widthMap : Lyte.attr( __array, { default : [] } ),

			columnChooserSelector : Lyte.attr( __string, { default : "" } )
		}
	},
	...
	fix_unfix : function( cell, __add ){
		...
		if( __data.ltPropNestedGrouping ){
			Lyte.objectUtils( __data.fixedColumnStatus, __add == 'add' ? __add : "delete", 'fixed_' + parseInt( cell.getAttribute( 'index' ) ), true );
		}
	...
	removeHeader : function( item, ingore_scroll ){
		...
		Lc( fakeHeaderData, removeAt, remove_index + is_nested_grp, 1 );
		Lc( headerData, removeAt, index, remove_length );
		

		if( ingore_scroll ){
			var __count = 0,
			is_nested_grp = this.is_nested_grp();
			...
			actual_header.every( function( __item ){
				...
				if( is_nested_grp ){
					...
					grouped_count = __children.filter( function( __child ){
						return __data.ltPropGroupOrder.indexOf( __child.prop ) + 1;
					}).length;

					if( __children.length == grouped_count ){
						__count++;
					}
				}
	...
	addHeader : function( item, index, ingore_scroll ){
		...
		Lc = Lyte.arrayUtils,
		__insertAt = 'insertAt',
		is_group = this.is_nested_grp(),
		group_order = is_group ? __data.ltPropGroupOrder : [],
		group_count = 0,
		__filter_fn = function( item ){
			return group_order.indexOf( item.prop ) + 1;
		},
		already_grouped = false;

		for( var i = 0; i < index; i++ ){

			var __item = ltPropHeader[ i + group_count ];
			...
			if( is_group ){
				var __children = __item.children || [],
				filter = __children.filter( __filter_fn );

				if( __children.length == filter.length ){
					group_count++;
					i--;
					continue;
				}
		...
		Lc( fakeHeaderData, __insertAt, fake_insert + ( is_group ? 1 : 0 ), obj );
		Lc( header, __insertAt, insertAt + ( is_group ? 1 : 0 ), inner );
		
		ingore_scroll && Lc( ltPropHeader, __insertAt, fake_insert + group_count, obj.data );

		var __length = header.length,
		ns = "overallWidth";

		for( var i = insertAt + inner.length + ( is_group ? 1 : 0 ); i < __length; i++ ){
			var cur = header[ i ];
			Lyte.objectUtils( cur, 'add', 'parentIndex', cur.parentIndex + 1 );
		}
	...
	call_modification : function( conditions, any, search_value, headerData, event, fromSearch, fromInit ){
		var cb = "onModification",
		ret;

		if( this.getMethods( cb ) ){
			ret = this.executeMethod( cb, conditions, any, search_value, headerData, this.$node, event, fromSearch, fromInit );
		}
		...
		if( ret ){
			...
			if( this.is_nested_grp() ){
				this.reset_table( this.data.ltPropContent );
			}
		}
	},
	...
	group_obs : function(){
		...
		this.setData( {
			ltPropFilteredContent : void 0,
			ltPropRenderContent : [],
			ltPropFilterGrouped : false
		} );

		this.modify_content( this.data.ltPropConditions , this.data.ltPropAny, void 0, void 0, arguments.length > 0 ? false : true );
		
	}.observes( 'ltPropGroupOrder' ).on( 'init' ),

	modify_content : function( conditions, any, maintain_scroll, fromSearch, fromInit ){
		...
		if( __data.ltPropExternalSearch ){
			this.call_modification( conditions, any, __data.ltPropSearchValue, ( headerData || {} ).data, undefined, fromSearch, fromInit );
		} else {
			if( headerData ){
	...
	duration_filter : function( __cur, caseSensitive, modified ){
		return true;
	},
	...
	do_filter : function( content, conditions, any ){
		...
		recordsLength = 0,
		nestedGrp = __this.is_nested_grp();
	...
	call_select : function( cb, args ){
		...
		if( cb == "onBeforeSelect" && $L( args[ 1 ] ).hasClass( 'lyteListviewGroupColTh' ) ){
			return false;
		}
	...
	bef_drop : function( selectedCell, next, startIndex, endIndex, header, evt, frm_column_chooser ){
		...
		if( $L( next ).hasClass( 'lyteListviewGroupColTh' ) ){
			return false;
		}
		...
		// if( __data.ltPropSubHeaders ){
			...
			__fn2 = function(){
				var is_nested = this.is_nested_grp(),
				removed_data = this.removeHeader( fakeHeaderData[ parent_index + ( is_nested ? 1 : 0 ) ].data, true );
	...
	methods : {
		...
		onFilterConstruct : function(){},

		interchange : function( evt, col1, col2 ){
			return !$L( col2 ).hasClass( 'lyteListviewGroupColTh' );
		},

		navSelect : function( val ){

			if( this.change_page( val, 'Select' ) ){
				return;
			}
		...
		navigatorNext : function ( new_value ){

			if( this.change_page( new_value, "Next" ) ){
				return;
			}
		...
		navigatorPrev : function ( new_value ){
			 
			if( this.change_page( new_value, "Prev" ) ){
				return;
			}
		...
		navigatorHome : function ( new_value ){

			if( this.change_page( new_value, "Home" ) ){
				return;
			}
		...
		navigatorEnd : function ( new_value ){

			if( this.change_page( new_value, "End" ) ){
				return;
			}
		...
		filterchange : function( conditions, apply, remove ){
			var group = conditions.group || [],
			sort = conditions.sort || [],
			filter = conditions.filter || [],
			contains = ( conditions.contains || [] ).map( function( item ){
				return item.condition;
			} ),
			cb = apply ? 'onInlineFilterApply' : ( remove ? 'onInlineFilterRemove' : void 0 ),
			original_conditions = this.data.ltPropConditions,
			__headerData = this.data.headerData;

			this.__ignore_all = true;

			this.setData({
				ltPropRenderContent : [],
				ltPropFilterGrouped : false,
				ltPropGroupOrder : group,
				ltPropSearchValue : contains.length > 1 ? JSON.stringify( contains ) : ( contains[ 0 ] || "" )
			});

			for( var key in original_conditions ){
				Lyte.objectUtils( original_conditions, "add", key, filter[ key ] || {} );
			}
			...
			sort.forEach( function( item ){
				var prop = item.column,
				to_be = item.condition == "Ascending" ? "lyteListAsc" : "lyteListDes";
				__headerData.forEach( function( cell ){
					var __new_value = "",
					cell_data = cell.data;

					if( cell_data.prop == prop && cell_data.sortable ){
						__new_value = to_be;
					} 
					Lyte.objectUtils( cell_data, 'add', "sortStatus", __new_value );
				} );
			} )

			setTimeout( function(){
				delete this.__ignore_all;
				this.modify_content( original_conditions );
				if( cb && this.getMethods( cb ) ){
					this.executeMethod( cb, conditions, this.$node );
				}
			}.bind( this ), 0 );
		},
	...
	resize_move : function( evt ){
		...
		if( this.is_nested_grp() ){
			var grps = Array.from( this.$node.getElementsByTagName( 'colgroup' ) ),
			__index = parseInt( cell.getAttribute( 'index' ) );

			grps.forEach( function( item ){
				item.children[ __index ].style.width = cell.style.width;
			} );
		}
	...
	resize_up : function( evt ){ 
		...
		__cell.classList.remove( 'lyteListResizeSelect' );
	...
	reset_table : function( arr, __value ){
		...
		data = this.data,
		group_order = data.ltPropGroupOrder || [],
		nested_grp = data.ltPropNestedGrouping;
		...
		if( nested_grp ){
			this.construct_fake( true );
			this.$node.style.setProperty( '--lyte-listview-nested-total-level', group_order.length );
		}

		if( group_order.length && nested_grp ){
			this.setData( 'ltPropFilteredContent', [] );
			
			var grouped_arr = this.do_grouping( data.headerData, arr, group_order ),
			pagination = this.check_for_pagination( grouped_arr, 0 ),
			records = this.data.ltPropRecords || 0;

			!records && grouped_arr.forEach( function( item ){
				records += item.overall_count;
			});

			this.setData({
				fixedColumnStatus : {},
				ltPropRecords : records,
				ltPropValue : __value || 0,
				ltPropFilterGrouped : data.ltPropNestedGrouping,
				ltPropFilteredContent : grouped_arr,
				ltPropRenderContent : pagination
			});
		} else {

			this.setData( {
				ltPropRenderContent : [],
				ltPropFilteredContent : [],
				fixedColumnStatus : {}
			});
			
			// need to verify this case. He is adding one entry to the ltPropContent. will this is the correct one ?

			var __value = data.ltPropValue,
			per_page = data.ltPropPerPage,
			count = arr.length,
			__end = Math.min( __value + per_page, count );
			
			this.setData({
				ltPropFilterGrouped : false,
				ltPropFilteredContent : arr,
				ltPropRenderContent : this.construct_navContent( data.ltPropNavigator ? arr.slice( __value , __end ) : arr )
			});
			
			// this.construct_navContent( data.ltPropNavigator ? arr.slice( 0 , data.ltPropPerPage ) : arr );
		}
	...
	change_page : function( value, ns ){

		var __data = this.data,
		arr = __data.ltPropFilteredContent;

		if( __data.ltPropNestedGrouping && ( __data.ltPropGroupOrder || [] ).length ){
			var __handled;
			if( ns ){
				var method = "onNavigator" + ns,
				ret,
				__fn = function( __arr ){
					this.reset_table( __arr, value );
				}.bind( this );

				if( this.getMethods( method ) ){
					ret = this.executeMethod( method, value, this.$node );
				}
			...
			if( !__handled ){
				var pagination = this.check_for_pagination( arr, value );
				this.setData({
					ltPropValue : value,
					ltPropFilterGrouped : __data.ltPropNestedGrouping,
					ltPropRenderContent : pagination
				});
			}
	...
	check_for_pagination : function( arr, __value ){
		var __data = this.data;
		if( this.data.ltPropNavigator ){
			var per_page = __data.ltPropPerPage,
			new_arr = [],
			__count = 0,
			__fn = function( obj, src ){
				
				var cur_count = obj.count;

				if( __value >= cur_count ){
					__value -= cur_count;
					return true;
				}

				var is_group = obj.isGroup,
				__rows = obj.rows || [],
				new_obj = {
					isGroup : obj.isGroup,
					level : obj.level,
					...
					parent_data : obj.parent_data
				};
				src.push( new_obj );
				if( is_group ){
					__rows.every( function( item ){
						return __fn( item, new_obj.rows );
					} ); 
				}
				
				if( !is_group ){
					var __len = __rows.length,
					limit = Math.min( __len - __value, per_page - __count );

					if( limit ){
						new_obj.rows.push.apply( new_obj.rows, __rows.slice( __value, limit + __value ) );
						__count += limit;
						__value = 0;
					}
				}

				return per_page > __count;
			};

			arr.every( function( item ){
				return __fn( item, new_arr );
			} );
	...
	call_row_click : function( item, _this, evt, __cellData ){
		var cb = "onRowClick",
		__this = this;
		
		_this && __this.getMethods( cb ) && __this.executeMethod( cb, item, _this, evt, __this.$node, __cellData || this.data.cellData );
	},
	...
	is_nested_grp : function(){
		var __data = this.data;
		
		return __data.ltPropNestedGrouping && ( __data.ltPropGroupOrder || [] ).length;
	},

	actions : {

		nestedRowClick : function( row_data, row, evt, cell_data ){
			this.call_row_click( row_data, row, evt, cell_data );
			return false;
		},
		...
		intersectionSet : function( cell, left, accumulatedWidth ){
			...
			if( this.is_nested_grp() ){
				var fixedColumnStatus = __data.fixedColumnStatus,
				index = parseInt( cell.getAttribute( 'index' ) ),
				obj = {};
				obj[ left ] = accumulatedWidth + 'px';

				Lyte.objectUtils( fixedColumnStatus, 'add', index, obj );
			}
		},
		...
		resize : function( evt ){
			...
			this.__cell.classList.add( 'lyteListResizeSelect' );
...
}, { mixins : [ "lyte-nested-grouping" ] });

Lyte.Component.registerHelper( 'listStyle', function( __data, width, _this ){
	var str = '',
	__width = __data.width,
	__minWidth = __data.minWidth || 50;

	if( _this ){
		for( let i = 0; i < _this.style.length; i++ ){
			if( [ 'width', 'min-width', 'max-width' ].indexOf( _this.style[ i ] ) === -1 ){
				str += _this.style[ i ] + ':' + _this.style[_this.style[ i ] ] + ';';
			}
		}
	}
	...
	if( __data.maxWidth != void 0 ){
		str += ( "max-width:" + __data.maxWidth + ( /^[0-9]+$/.test( __data.maxWidth ) ?  'px;' : ';') );
	}
