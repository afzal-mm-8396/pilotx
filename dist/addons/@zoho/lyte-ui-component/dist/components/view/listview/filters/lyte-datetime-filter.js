Lyte.Component.register("lyte-datetime-filter", {
_template:"<template tag-name=\"lyte-datetime-filter\"> <lyte-dropdown lt-prop-selected=\"{{lbind(selected)}}\" lt-prop-placeholder=\"{{ltPropPlaceholder}}\"> <template is=\"registerYield\" yield-name=\"yield\"> <lyte-drop-box class=\"lyteDateFilterDropdown\"> <template is=\"if\" value=\"{{isSearch}}\"><template case=\"true\"> <lyte-search lt-prop-query-selector=\"{ &quot;scope&quot; : &quot;.lyteDateFilterDropdown:not(.lyteDropdownHidden)&quot;, &quot;search&quot; : &quot;lyte-drop-item&quot; }\" on-search=\"{{method('search')}}\"></lyte-search> </template></template> <lyte-drop-body> <template is=\"forIn\" object=\"{{ltPropOptions}}\" value=\"value\" key=\"key\"> <lyte-drop-item data-value=\"{{key}}\">{{value}}</lyte-drop-item> </template><template is=\"if\" value=\"{{isSearch}}\"><template case=\"true\"> <div class=\"{{if(noResult,'lyteDateFilterNoResult','lyteDateFilterNoResult lyteSearchHidden')}}\">{{ltPropNoMatch}}</div> </template></template> </lyte-drop-body> </lyte-drop-box> </template> </lyte-dropdown> <div class=\"lyteDateTimeFilterWrapper\"> <template is=\"if\" value=\"{{renderFirst}}\"><template case=\"true\"> <lyte-datetime-input lt-prop=\"{{stringify(ltPropFilterElementProperties.dateTime)}}\" lt-prop-appearance=\"box\" class=\"lyteDateEditElement lyteListviewEditElement\" lt-prop-dropdown=\"true\" lt-prop-value=\"{{lbind(first)}}\"></lyte-datetime-input> </template></template><template is=\"if\" value=\"{{renderSecond}}\"><template case=\"true\"> <lyte-datetime-input lt-prop=\"{{stringify(ltPropFilterElementProperties.dateTime)}}\" lt-prop-appearance=\"box\" class=\"lyteDateEditElement lyteListviewEditElement\" lt-prop-dropdown=\"true\" lt-prop-value=\"{{lbind(second)}}\"></lyte-datetime-input> </template></template><template is=\"if\" value=\"{{display}}\"><template case=\"true\"> <div class=\"lyteDateFilterDisabledElement\">{{display}}</div> </template></template> </div> </template>",
...
_observedAttributes :["ltPropCondition","ltPropTempSelected","ltPropPlaceholder","ltPropOptions","ltPropFormat","ltPropNoMatch","ltPropSearchCount","ltPropReset","selected","renderFirst","renderSecond","display","noResult","isSearch","first","second","isNeg","hideFirst","hideSecond"],
_observedAttributesType :[null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null],
	...
	init : function(){
		...
		if(_lyteUiUtils.lyteUiIsEmpty(__data.ltPropCondition)){
			this.setData( 'ltPropCondition', { input : "", start : -Infinity, end : Infinity, isNeg : false, isValid : false, value : "", label : "", type : "dateTime" } );
		}else{
	...
	selected_obs : function( arg ){
		...
		Lc( condition, 'add', 'type', 'dateTime' );
	...
	start_end_obs : function( arg ){
		...
		if( value ){
			var moment = $L.moment( new Date(value), format );
