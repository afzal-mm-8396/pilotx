...
_observedAttributesType :["array","array","array","array","string","array","boolean","number","boolean","boolean","object","boolean","object","boolean","boolean"],
			...
			function MouseUp(event) {
				...
				if(event.target.tagName=='TH'){
						...
						if(target_start<=div_mid){
							...
							var isEqual = function(element){if(element.body == target){
								return element;
							}};

							var source=function(element){if(element.body == divcontent){
								return element;
							}};
