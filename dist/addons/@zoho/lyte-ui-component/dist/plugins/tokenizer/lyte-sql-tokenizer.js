(function () {
    $L.snippets.registerLanguage('sql', {
        tokenConfig: [
            ...
            {
                'token': 'dataType',
                'regex': /\b(?:bit|tinyint|bool|boolean|smallint|mediumint|int|integer|bigint|decimal|dec|float|double|precision|date|datetime|timestamp|time|year|set|char|varchar|binary|varbinary|enum|json)\b/i,
                'class': 'sqlDataTypes'
            },
            {
                'token': 'punctuator',
