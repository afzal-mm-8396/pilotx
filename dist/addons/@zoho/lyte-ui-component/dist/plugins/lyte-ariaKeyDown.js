(function () {
  document.addEventListener("keydown",
    function (e) {
      ...
      if (_lyteUiUtils.ignoreAriaKeydown) { return; }
      ...
      if (elem && (isKeyDownEvent = checkKeyDownEvent(elem)) && elem.hasAttribute("role")) {
        ...
        if (e.key === "Enter" && elem.getAttribute("role").toLowerCase() !== "combobox" && (!e.altKey && !e.ctrlKey && !e.shiftKey && !e.metaKey)) { 
          elem = checkForMenuItem(document.activeElement);
          if (elem && elem.hasAttribute("haspopup") && elem.getAttribute("haspopup") === "menu"
              && elem.hasAttribute("aria-expanded") && elem.getAttribute("aria-expanded") === "true") {
                return;
          } else if (elem && elem.hasAttribute('aria-controls') && elem.getAttribute('aria-controls')
                    && elem.hasAttribute("aria-expanded") && elem.getAttribute("aria-expanded") === "true") {
              let popUp = document.querySelector("#" + elem.getAttribute('aria-controls'));
            if (popUp && (popUp.tagName === 'LYTE-MENU' || popUp.tagName === 'LYTE-MENU-BOX' ||
                popUp.tagName === 'LYTE-DROPBOX' || popUp.tagName === 'LYTE-DROPDOWN')) {
                return;
          }
        ...
        switch (elem.getAttribute("role").toLowerCase()) {
          ...
          case "combobox":
            {
              if (e.key === "Enter" && elem.getAttribute("aria-expanded") === "false" && (!e.altKey && !e.ctrlKey && !e.shiftKey && !e.metaKey)) {
                if (!continuePropagation) { 
                  e.stopImmediatePropagation();
                }
                e.preventDefault();
