;(function(){
    ...
    class LyteBarcode_Rss{
        ...
        dataBarExpanded( options ){
            ...
            if( vlf.length != 0 ){
             ...
             this.draw_in_canvas( typeof document == "undefined" ? void 0 : ( options.canvas || document.createElement('canvas') ), options, options.text || "" ); 
    ...
    if( typeof $L != "undefined" ){
        ...
        __window.LyteBarcode_Rss = LyteBarcode_Rss;
    }
