	...
	data:function(){
		return {
			...
			*/
			 ...
			 */
			"ltPropTransition":Lyte.attr("object",{"default":_lyteUiUtils.resolveDefaultValue('lyte-banner', 'transition', {animation:"slideFromTop",duration:"0.5"})}),
			/**
			 ...
			 * @suffix px
			 */
			"ltPropInitialSpacing":Lyte.attr("string",{"default":_lyteUiUtils.resolveDefaultValue( 'lyte-banner', 'initialSpacing', "0px")}),
			/** 
			 ...
			 */
			"ltPropWidth":Lyte.attr("string",{"default":_lyteUiUtils.resolveDefaultValue( 'lyte-banner', 'width', "100%")}),
			/** 
			 * @componentProperty {string} ltPropHeight=auto
			 */
			"ltPropHeight":Lyte.attr("string",{"default":_lyteUiUtils.resolveDefaultValue( 'lyte-banner', 'height', "auto")}),
			/** 
