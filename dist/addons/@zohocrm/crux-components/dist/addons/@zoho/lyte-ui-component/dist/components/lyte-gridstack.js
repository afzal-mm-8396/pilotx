...
// after rendering properties
    ...
    data : function(){
        ...
        return {
            ...
            * @version 1.0.0
            */
            ltPropScope : Lyte.attr("string",{"default": default_values.scope || ''}), 
           /**
            * @componentProperty {string} ltPropHandler=''
            * @version 1.0.0
            */
            ltPropHandler : Lyte.attr("string",{"default":default_values.handler || ''}),
           /**
            * @componentProperty {number} ltPropMarginLeft=10
            * @version 1.0.0
            */ 
            ltPropMarginLeft : Lyte.attr("number",{"default": default_values.marginLeft || 10}), 
           /**
            * @componentProperty {number} ltPropMarginTop=10
            * @version 1.0.0
            */ 
            ltPropMarginTop : Lyte.attr("number",{"default":default_values.marginTop || 10}), 
           /**
            * @componentProperty {number} ltPropUnitX=50
            * @version 1.0.0
            */
            ltPropUnitX : Lyte.attr("number",{"default":default_values.unitX || 50}), 
           /**
            * @componentProperty {number} ltPropUnitY=50
            * @version 1.0.0
            */
            ltPropUnitY : Lyte.attr("number",{"default": default_values.unitY || 50}), 
           /**
            * @componentProperty {string[]} ltPropResizeDirection
            * @version 1.0.0
            * @default ["left","right","bottom","bottomRight","bottomLeft","top","topLeft","topRight"]
            */
            ltPropResizeDirection : Lyte.attr("array",{"default": default_values.resizeDirection || ['top', 'topRight', 'right', 'bottomRight', 'bottom', 'bottomLeft', 'left', 'topLeft']}), 
           /**
            * @componentProperty {boolean} ltPropFloat=false
            * @version 1.0.0
            */
            ltPropFloat : Lyte.attr("boolean",{"default": default_values.float || false}), 
           /**
            ...
            * @version 1.0.0
            */
            ltPropUndo : Lyte.attr("boolean",{"default": default_values.undo == false ? false : true}), 
           /**
            * @componentProperty {boolean} ltPropResize=true
            * @version 1.0.0
            */
            ltPropResize : Lyte.attr("boolean",{"default": default_values.resize == false ? false : true}), 
           /**
            * @componentProperty {boolean} ltPropBestfit=true
            * @version 1.0.0
            */
            ltPropBestfit : Lyte.attr("boolean",{"default": default_values.bestfit == false ? false : true}), 
           /**
            * @componentProperty {number} ltPropMinUnitX=0
            * @version 1.0.0
            */
            ltPropMinUnitX : Lyte.attr('number',{default : default_values.minUnitX || 0}),
           /**
            * @componentProperty {number} ltPropMinMarginLeft=0
            * @version 1.0.1
            */
            ltPropMinMarginLeft : Lyte.attr('number',{default : default_values.minMarginLeft || 0}),
           /**
            * @componentProperty {string} ltPropBestfitClass=''
            * @version 1.0.1
            */
            ltPropBestfitClass : Lyte.attr('string', {default : default_values.bestfitClass || ''}),
           /**
            * @componentProperty {boolean} ltPropFreezeMode=false
            * @version 1.0.1
            */
            ltPropFreezeMode : Lyte.attr('boolean', {default : default_values.freezeMode || false}),
           /**
            * @componentProperty {string} ltPropDefaultLength=2
            * @version 1.0.1
            */
            ltPropDefaultLength : Lyte.attr('string',{default : default_values.defaultLength || '2'}),
           /**
            * @componentProperty {string} ltPropDefaultHeight=2
            * @version 1.0.1
            */
            ltPropDefaultHeight : Lyte.attr('string',{default : default_values.defaultHeight || '2'}),
           /**
            * @componentProperty {string} ltPropDefaultMinLength=1
            * @version 1.0.1
            */
            ltPropDefaultMinLength : Lyte.attr('string',{default : default_values.defaultMinLength || '1'}),
           /**
            * @componentProperty {string} ltPropDefaultMinHeight=1
            * @version 1.0.1
            */
            ltPropDefaultMinHeight : Lyte.attr('string',{default : default_values.defaultMinHeight || '1'}),
           /**
            * @componentProperty {string} ltPropDefaultMaxHeight=0
            * @version 1.0.1
            */
            ltPropDefaultMaxHeight : Lyte.attr('string',{default : default_values.defaultMaxHeight || '0'}),
           /**
            * @componentProperty {string} ltPropDefaultMaxLength=0
            * @version 1.0.1
            */
            ltPropDefaultMaxLength : Lyte.attr('string',{default : default_values.defaultMaxLength || '0'}),
           /**
            * @componentProperty {boolean} ltPropColumnMode=false
            * @version 1.0.1
            */
            ltPropColumnMode : Lyte.attr('boolean', {default : default_values.columnMode || false}),
           /**
            * @componentProperty {number} ltPropColumn=false
            * @version 1.0.1
            */
            ltPropColumn : Lyte.attr('number', {default : default_values.column || 3}),
            /**
            ...
            * @version 1.0.2
            */
            ltPropPrevent : Lyte.attr('object', { default : default_values.prevent || { horizontal : false, vertical : false }}),
           /**
            * @componentProperty {number} ltPropGridLength
            * @version 1.0.2
            */
            ltPropGridLength : Lyte.attr('number', {default : default_values.gridLength }),
           /**
            * @componentProperty {default | grid } ltPropBestfitType=default
            * @version 1.0.2
            */
            ltPropBestfitType : Lyte.attr('string', { default : default_values.bestfitType || 'default'}),
           /**
            * @componentProperty {boolean} ltPropForcedReposition=false
            * @version 1.0.2
            */
            ltPropForcedReposition : Lyte.attr('boolean', { default : default_values.forcedReposition || false}),
           /**
            * @componentProperty {boolean} ltPropSquareGrid=false
            * @version 1.0.2
            */
            ltPropSquareGrid : Lyte.attr('boolean', { default : default_values.squareGrid || false}),
           /**
            * @componentProperty {string} ltPropGridSpaceColor=#f8f8f8
            * @version 1.0.2
            */
            ltPropGridSpaceColor : Lyte.attr('string', { default : default_values.gridSpaceColor || '#f8f8f8' }),
           /**
            * @componentProperty {boolean} ltPropHitBottom=false
            * @version 1.0.2
            */
            ltPropHitBottom : Lyte.attr('boolean', { default : default_values.hitBottom || false}),
           /**
            * @componentProperty {string} ltPropGridSelectionClass=lyteGridFocused
            * @version 1.0.4
            */
            ltPropGridSelectionClass: Lyte.attr( 'string', { default : default_values.gridSelectionClass || 'lyteGridFocused' } ),
           /**
            ...
            * @version 2.2.6
            */
            ltPropCheckCurrentPosition : Lyte.attr( 'boolean', { default : default_values.checkCurrentPosition || false } ),
           /**
            * @componentProperty {boolean} ltPropContainment=false
            * @version 2.2.6
            */
            ltPropContainment : Lyte.attr( 'boolean', { default : default_values.containment || false } ),

            /**
             * @componentProperty {number} ltPropMaxGridHeight=Infinity
             * @version 3.45.0
             */
            ltPropMaxGridHeight : Lyte.attr( 'number', { default : default_values.maxGridHeight || Infinity } ),

            /**
             * @componentProperty {string} ltPropScrollElement
             * @version 3.53.0
             */
            ltPropScrollElement : Lyte.attr( "string", { default : default_values.scrollElement || void 0 } ),

            /**
             * @componentProperty {string} ltPropIgnoreDrag
             * @version 3.53.0
             */
            ltPropIgnoreDrag : Lyte.attr( "boolean", { default : default_values.ignoreDrag || false } ),

            /**
             * @componentProperty {string} ltPropMaintainOrder
             * @version 3.56.0
             */
            ltPropMaintainOrder : Lyte.attr( 'boolean', { default : default_values.maintainOrder || false } ),
            ...
            ltPropScrollValue : Lyte.attr( 'number', { default : default_values.scrollValue || 10 } ),
            ...
            ltPropUpdateParentHeight : Lyte.attr( 'boolean', { default : default_values.updateParentHeight == void 0 ? true : default_values.updateParentHeight } ),
            ...
            ltPropIgnoreEmptyBottomMove : Lyte.attr( 'boolean', { default : default_values.ignoreEmptyBottomMove || false } ),

            /**
             * @experimental ltPropPreventScroll
             */

            ltPropPreventScroll : Lyte.attr( "boolean", { default : default_values.preventScroll || false } ),
            ...
            /**
             * @componentProperty {ariaobject} ltPropAriaAttributes
             * @version 3.103.0
             */
