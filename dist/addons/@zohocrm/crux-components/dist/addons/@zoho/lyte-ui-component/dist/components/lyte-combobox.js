...
_observedAttributesType :["object","array","string","string","array","boolean","string","string","string","number","object","string","string","boolean","object","object","object","object","number","number","boolean","boolean","string","string","boolean","boolean","string","string"],
	...
	data : function(){
		return {
			...
			'ltPropAriaDropButton': Lyte.attr('object', { 'default': {}, watch: true }),

			// Keeping this property hidden for now because we don't know if we need it.
			'ltPropAriaDropBox': Lyte.attr('object', { 'default': {}, watch: true }),

			'ltPropAriaDropBody': Lyte.attr('object', { 'default': {}, watch: true }),
			'ltPropAriaInput': Lyte.attr('object', { 'default': {}, watch: true }),
