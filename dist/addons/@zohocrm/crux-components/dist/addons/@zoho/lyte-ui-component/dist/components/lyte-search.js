     ...
     data : function (){
        ...
        __value;
          ...
          return {
             ...
             ltPropDataTabindex : Lyte.attr( __string, { default : default_values.dataTabindex || "0" } ),
             /**
     ...
     actions : {
        ...
        accfilter : function( vis, hid, value, clear ){
            ...
            $L.fastdom.mutate( function(){
               ...
               var is_exclusive = scope.get( 0 ).ltProp( 'exclusive' ),
          ...
          fn = function( item ){
             ...
             if( elem.length ){
                 ...
                 if( elem.hasClass( search_class ) ){
                    ...
                    if( elem.nextAll( '.' + query + ":not(." + search_class + ")" ).length ){
                        fn_name = "removeClass";
                    }
                 }
