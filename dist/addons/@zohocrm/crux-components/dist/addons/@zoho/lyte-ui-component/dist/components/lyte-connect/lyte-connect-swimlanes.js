...
_observedAttributes :["ltPropData","ltPropSwimNodes","ltPropScrollLeft","ltPropScrollTop","ltPropSelectors","ltPropConnectionType","ltPropConnectorRadius","ltPropAvoidWithModule","ltPropCheckLineBreak","ltPropElbowArc","ltPropCurveOffset","ltPropAvoidLine","ltPropLineMarker","ltPropBoundary","ltPropContextualWheel","ltPropScale","ltPropCenter","ltPropSwimlaneOnDrop","ltPropTextBox","ltPropCheckLineBreak","ltPropTextBoxAvoidance","ltPropWidth","ltPropHeight","viewBox","textBoxArray","styleValue","cornerConnect","details","atLimit","out_range","onDrop"],
_observedAttributesType :["array","boolean","number","number","object","string","number","boolean","boolean","boolean","number","boolean","array","object","boolean","number","object","boolean","boolean","boolean","boolean","number","number","string","array","string","object","object","object","object","boolean"],
