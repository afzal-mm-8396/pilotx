...
_observedAttributesType :["boolean","boolean","boolean","boolean","string","boolean","array","boolean","boolean","boolean","object","string","string","string","object","boolean","boolean","boolean","string","string","boolean","boolean","array","string","string","string","string","array","number","string","array","boolean","string","number","string","boolean","array","string","string","string","number","number","number","object","number","number","object","number","number","number","boolean","object","number","number","number","string","object","boolean","object","object","boolean","boolean","number","number","number","number","number","number","boolean","number","array","boolean","boolean","object","boolean","object"],
	...
	didConnect : function(){
		...
		this.$node.selectColor = function( selectedColor ){
			if(selectedColor){
				if( !(selectedColor.rgb && selectedColor.rgb.length) && !(selectedColor.hex && selectedColor.hex.length)  &&  !(selectedColor['hex-alpha'] && selectedColor['hex-alpha'].length) && !(selectedColor.cmyk && selectedColor.cmyk.length)   ){
	...
	initializeBasicColorPicker : function(event,ele){
		...
		$L.fastdom.mutate(function(){
			...
			if(selectColor && !selectColor.nofill && Object.keys(selectColor).length){
				...
				if(selectColor.hex + alpha !== selectColor['hex-alpha'] || !ele){	
					ele = _this.$node.querySelector('[lt-prop-title="'+selectColor['hex-alpha'].toUpperCase()+'"]');
				}
				else if (selectColor.hex + alpha === selectColor['hex-alpha'] && _this.getData('opacity') < 100){
					ele = _this.$node.querySelector('[lt-prop-title="'+selectColor['hex-alpha'].toUpperCase()+'"]');
				}
		...
		$L.fastdom.mutate(function(){
			setTimeout(function(){
				...
				if(selectColor && !selectColor.nofill && Object.keys(selectColor).length){
					...
					if(!ele || color + alpha !== selectColor['hex-alpha']  ){
					
						ele = _this.$node.querySelector('[lt-prop-title="'+selectColor['hex-alpha'].toUpperCase()+'"]');

					}else if (color + alpha === selectColor['hex-alpha']  &&  _this.getData('opacity') < 100 ){
						ele = _this.$node.querySelector('[lt-prop-title="'+selectColor['hex-alpha'].toUpperCase()+'"]');
					}
					ele && ele.classList.add('lyteCPSelectedColor');
				}
...
_observedAttributesType :["boolean","boolean","boolean","boolean","boolean","string","boolean","boolean","boolean","object","string","string","string","object","boolean","boolean","string","string","boolean","array","string","string","string","string","array","number","string","string","object","number","array","number","boolean","boolean","array","string","boolean","boolean","boolean","boolean","array","array","object","string","boolean"],
...
//# sourceMappingURL=lyte-colorpicker.js.map