...
_observedAttributesType :["string","boolean","string","string","string","string","boolean","boolean","number","number","string","number","boolean","boolean","string","boolean","number","number","string","number","string","string","string","array","boolean","boolean","number","boolean","number","number","boolean","number","object","boolean","number","object","boolean","boolean","boolean","boolean","boolean","string","boolean","boolean","array","array","array","array","string","number","boolean","array","array","array","number","array","boolean","boolean","number","number","string","object","string","string"],
	...
	data : function(){
		return {
			...
			*/
			ltPropFileLimit : Lyte.attr( 'number', { "default" : _lyteUiUtils.resolveDefaultValue( 'lyte-fileupload', 'fileLimit', undefined ) } ),
			/** 
			 * @componentProperty {number} ltPropMinimumFileSize=0
			 * @version 2.2.11
			*/
			ltPropMinimumFileSize : Lyte.attr( 'number',{"default": _lyteUiUtils.resolveDefaultValue( 'lyte-fileupload', 'minimumFileSize', 0 ) } ),
			/** 
            ...
            * @version 3.93.0
			*/
			ltPropPreventDuplicate : Lyte.attr("boolean",{ default : false}),
