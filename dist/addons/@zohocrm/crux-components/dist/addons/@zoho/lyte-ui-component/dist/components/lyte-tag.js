...
_observedAttributes :["ltPropOptions","ltPropUserValue","ltPropSystemValue","ltPropDescriptionValue","ltPropSearchKeys","ltPropSelectedList","ltPropDelimiters","ltPropNoResult","ltPropDropdown","ltPropPlaceholder","ltPropEvent","ltPropCaseSensitive","ltPropAddNewItems","ltPropBoxYield","ltPropButtonYield","ltPropExternalSearch","ltPropPreventDuplicate","ltPropType","ltPropDisabled","ltPropAutoComplete","ltPropDuplicateClass","ltPropOpenWhenEmpty","ltPropPreventInputFocus","standardizedList","standardizedOptions","randId"],
_observedAttributesType :["array","string","string","string","array","array","array","string","object","string","string","boolean","boolean","boolean","boolean","boolean","boolean","string","boolean","boolean","string","boolean","boolean","array","array","number"],
