		...
		return {
			...
			*/
			/**
						 ...
						 * @default MM/DD/YYYY
						 */
			"ltPropFormat": Lyte.attr("string", { "default": default_values.format || "MM/DD/YYYY" }),
			/**
			 * @typedef {
			 * 'MMMM YYYY' |
			 * 'MMM YYYY' 
			...
			/**
						 ...
						 */
			"ltPropMonthHeaderFormat": Lyte.attr("string", { "default": default_values.monthheaderFormat || "MMM YYYY" }),
			...
			/**
						 ...
						 * @default 1900
						 */
			"ltPropStartYear": Lyte.attr("number", { "default": default_values.startYear || 1900 }),
			...
			/**
						 ...
						 * @default 2100
						 */
			"ltPropEndYear": Lyte.attr("number", { "default": default_values.endYear || 2100 }),
			...
			/**
						 ...
						 * @default []
						 */
			"ltPropDisabledDates": Lyte.attr("array", { "default": default_values.disabledDates || [] }),

			/**
						 * @componentProperty {dateString} ltPropMinDate
						 * @version 1.0.0
						 */
			"ltPropMinDate": Lyte.attr("string", { "default": default_values.minDate || "" }),

			/**
						 * @componentProperty {dateString} ltPropMaxDate
						 * @version 1.0.0
						 */
			"ltPropMaxDate": Lyte.attr("string", { "default": default_values.maxDate || "" }),
			...
			/**
						 ...
						 * @default continuous
						 */
			"ltPropSelectionType": Lyte.attr("string", { "default": default_values.selectionType || "continuous" }),
			...
			/**
						 ...
						 * @default left
						 */
			"ltPropPosition": Lyte.attr("string", { "default": default_values.position || "left" }),
			...
			/**
						 ...
						 * @default dropdown
						 */
			"ltPropHeaderType": Lyte.attr("string", { "default": default_values.headerType || "dropdown" }),
			...
			/**
						 ...
						 * 
						 */
			"ltPropFillRows": Lyte.attr("boolean", { "default": default_values.fillRows || false }),
			...
			ltPropMaxDiff : Lyte.attr( 'number', { default : default_values.maxDiff } ),
			...
			ltPropTabindex : Lyte.attr( 'string', { default : default_values.tabindex || "2" } ),
			/**
			 * @componentProperty {boolean} ltPropDisableCheck
			 * @default false
			 * @version 3.50.0
			 */
			ltPropDisableCheck : Lyte.attr( 'boolean', { default : default_values.disableCheck || false } ),
			/**
			 * @componentProperty {number} ltPropStartWeekDay
			 * @default 1
			 * @version 3.80.0
			 */
			ltPropStartWeekDay : Lyte.attr( 'number', { default : default_values.startWeekDay || 1 } ),

			ltPropCalendar : Lyte.attr( "string", { default : default_values.calendar || '{}' } ),

			ltPropYear : Lyte.attr( 'boolean', { default : false } ),

			ltPropAllowOtherMonthSelection : Lyte.attr( "boolean", { default : default_values.allowOtherMonthSelection || false } ),

			ltPropTransitMonthOnDateSel : Lyte.attr( "boolean", { default : default_values.transitMonthOnDateSel || false } ),
