     ...
     data : function (){
      ...
      var default_values = _lyteUiUtils.getDefault( 'lyte-autocomplete' );
            ...
            return {
               ...
               ltPropMaxlength : Lyte.attr("number",{"default" : default_values.maxlength || 25}),
               ltPropReadonly : Lyte.attr("boolean",{"default" : false}),
               ltPropId : Lyte.attr("string",{"default" : default_values.id || 'inputId'}),
               ltPropClass : Lyte.attr("string",{"default" : default_values.class || ''}),
               ltPropType : Lyte.attr("string",{"default" : default_values.type || 'text'}),
               ...
               */
               ...
               ltPropAppearance : Lyte.attr("string",{"default" : default_values.appearance || 'flat'}),
               ltPropDirection : Lyte.attr("string",{"default" : default_values.direction || 'vertical'}),
               ltPropExternalSearch : Lyte.attr("boolean",{"default" : default_values.externalSearch || false}),
              /**
               ...
               * @version 1.0.0
               */
               ltPropHighlight : Lyte.attr("boolean",{"default" : default_values.highlight || false}),
              /**
               * @componentProperty {string} ltPropHighlightClass=lyteautocompleteHighlight
               * @condition ltPropHighlight true
               * @version 1.0.0
               */
               ltPropHighlightClass : Lyte.attr("string",{"default" : default_values.highlightClass || 'lyteautocompleteHighlight'}),
              /**
               * @componentProperty {string} ltPropKeyWords=''
               * @version 1.0.0
               */
               ltPropKeyWords : Lyte.attr("string",{"default" : default_values.keyWords || ''}),
              /**
               * @componentProperty {number} ltPropMinLength=1
               * @version 1.0.0
               */
               ltPropMinLength : Lyte.attr('number',{'default' : default_values.minLength == void 0 ? 1 : default_values.minLength }),
              /**
               * @componentProperty {string} ltPropErrorClass=lyteautocompleteError
               * @condition ltPropErrorMessage =!undefined
               * @version 1.0.5
               */
               ltPropErrorClass : Lyte.attr('string',{'default' : default_values.errorClass || 'lyteautocompleteError'}),
              /**
               * @componentProperty {string} ltPropDropdownWidth=auto
               * @version 1.0.0
               */
               ltPropDropdownWidth : Lyte.attr('string',{'default' : default_values.dropdownWidth || 'auto'}),
              /**
               * @componentProperty {string} ltPropDropdownHeight=300px
               * @version 1.0.0
               * @suffix px,pt,cm,mm,vh,vm,em
               */
               ltPropDropdownHeight : Lyte.attr('string',{'default' : default_values.dropdownHeight || '300px'}),
              /**
               * @componentProperty {string} ltPropDropdownClass=''
               * @version 1.0.0
               */
               ltPropDropdownClass : Lyte.attr('string', {'default' : default_values.dropdownClass || ''}),
              /**
               ...
               * @version 1.0.0
               */
               ltPropMethod : Lyte.attr('string',{'default' : default_values.method || 'contains'}),
               ltPropWrapperStyle : Lyte.attr('string', {'default' : default_values.wrapperStyle || ''}),
               ...
               ltPropFreeze : Lyte.attr('boolean', { default: default_values.freeze || false}),
               ...
               ltPropHover : Lyte.attr('boolean', { default : default_values.hover || false}),
               ...
               * @version 1.0.0
               */
               ltPropDropType : Lyte.attr('string', { default : default_values.dropType || 'default'}),
               ltPropSetPos : Lyte.attr('boolean', { default : default_values.setPos || false}),
               ...
               * @version 1.0.2
               */
               ltPropValueSet : Lyte.attr('boolean', { default : default_values.valueSet == false ? false : true }),
              /**
               ...
               * @version 1.0.2
               */
               ltPropExtSearchOpen :Lyte.attr('boolean', { default : default_values.extSearchOpen || false }),
               ltPropInputTitle : Lyte.attr('string', { default : default_values.inputTitle || '' }),
              /**
               * @componentProperty {string} ltPropErrorMessage=''
               * @version 1.0.5
               */
               ltPropErrorMessage : Lyte.attr( 'string',{ default : default_values.errorMessage || '' } ),
               ltPropAnimate : Lyte.attr( 'boolean', { default : default_values.animate || false } ),
               ltPropSelected : Lyte.attr( 'string', { default : default_values.selected || '' } ),
              /**
               * @componentProperty {boolean} ltPropTrim=false
               * @version 2.2.6
               */
               ltPropTrim : Lyte.attr( 'boolean', { default : default_values.trim || false } ),
               ltPropFocus : Lyte.attr( 'boolean', { default : default_values.focus || false } ),
               ...
               */
               ...
               ltPropDiacritic : Lyte.attr( 'boolean', { default : default_values.diacritic || false } ),
               ...
               ltPropInput : Lyte.attr( 'object', { default : default_values.input || {} } ),
               ...
               ltPropActiveElement : Lyte.attr( 'string', { default : default_values.activeElement || "input,textarea" } ),
                /**
               ...
               ltPropDataTabindex : Lyte.attr( "string", { default : default_values.dataTabindex || "0" } ),
                 ...
                 * @version 3.95.0
                 */
               ltPropOpenOnFocus : Lyte.attr( 'boolean', { default : default_values.openOnFocus || false } ),

               ltPropInputYield : Lyte.attr( "boolean", { default : default_values.inputYield || false } ),
