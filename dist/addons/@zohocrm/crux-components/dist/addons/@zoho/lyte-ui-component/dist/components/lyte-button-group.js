...
_observedAttributes :["ltPropType","ltPropAlignment","ltPropAppearance","ltPropSelectedValues","ltPropSelected","ltPropSelectedClass","ltPropWidth","ltPropFireOnInit","ltPropAllowUnselect","preventSelect"],
_observedAttributesType :["string","string","string","array","string","string","string","boolean","boolean","boolean"],
	...
	data : function(){
		return {
			 ...
			 * @default auto
			 */
			ltPropWidth : Lyte.attr("string",{"default" : _lyteUiUtils.resolveDefaultValue( 'lyte-button-group', 'width', "auto" )}),
			/** 
	...
	removeClass: function(nodes){
		...
		if(className){
			nodes.forEach(function(node){
				...
				curClass = curClass.replace(curClass, "");
