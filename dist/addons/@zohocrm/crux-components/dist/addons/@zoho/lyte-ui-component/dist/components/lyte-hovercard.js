...
_observedAttributesType :["boolean","boolean","string","string","string","string","string","string","string","number","number","number","boolean","boolean","string","object","boolean","boolean","boolean","boolean","object","boolean","string","string","object","string","boolean","object","boolean","boolean","array","boolean","string","string"],
 ...
 setMouseMove : function(){
  ...
  removeHoverCard : function( popover, originElem, event, popoverWormhole ) {
    ...
    if( res && (!event || ( this.prevHoverCardNode  && this.isNode(event.target) && ( event.target == this.prevHoverCardNode || this.prevHoverCardNode.contains( event.target ) ) ) || ( popoverWormhole  && this.isNode(event.target) && ( event.target == popoverWormhole || popoverWormhole.contains( event.target ) ) ) ) ){
            this.removeTimeout( popover )
