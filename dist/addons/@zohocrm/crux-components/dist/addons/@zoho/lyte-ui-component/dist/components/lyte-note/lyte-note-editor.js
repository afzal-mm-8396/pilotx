		...
		// if( data.ltPropEditorProps.attachment ){
			...
			this._disable = setTimeout( function(){
				...
				if( button ){
					...
					Lyte.objectUtils( button.properties, 'add', 'disabled', data.isEmpty && (fileUpload ? ( !queueList.length && !predefined.length) : true) );
				}
			}.bind( this ), 10 );
		// }
	},
