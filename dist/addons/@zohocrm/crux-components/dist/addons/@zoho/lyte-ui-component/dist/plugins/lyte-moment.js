	...
	if( $L.moment ) {
		...
		function i18N( format, callBack, convert_numbers ){
			if( this.validate() ){
				...
				if( convert_numbers ){
					convert_numbers = _lyteUiUtils ? _lyteUiUtils.i18n( "1" ) != "1" : false;
				}
				...
				parsed.forEach( function( item ){
					...
					i18ned = window._lyteUiUtils && !/^[0-9]$/.test( formatted || "" ) ? _lyteUiUtils.i18n( mapped_value ) : formatted,
					index = item.index;
...
//# sourceMappingURL=lyte-moment.js.map