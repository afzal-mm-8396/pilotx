		...
		__this.___fdom = fastdom.measure( function(){
			...
			fastdom.mutate( function(){
				...
				if( width_perc > 100 ){
					...
					obj.width = '100%';
					obj.left = 0;
					// extra_style += "left:" + ( sL * ( 1 - overall_scale_x ) * scale ) + "px;";
				}
				...
				if( height_perc > 100 ){
					...
					obj.height = '100%';
					obj.top = 0;
					// extra_style += "top:" + ( sT * ( 1 - overall_scale_x ) * scale ) + "px;";
				}
 ...
 * </lyte-connect>
 */
//# sourceMappingURL=lyte-connect.js.map