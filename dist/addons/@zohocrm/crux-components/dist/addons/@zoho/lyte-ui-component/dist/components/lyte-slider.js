...
_observedAttributes :["divLength","scaleVal","ltPropMin","ltPropMax","ltPropScaleInterval","ltPropStep","ltPropHandler","ltPropDirection","ltPropWidth","ltPropFillColor","ltPropNonFillColor","ltPropHeight","ltPropValue","ltPropDiscrete","ltPropContent","ltPropRangeHandler","ltPropMinValue","ltPropMaxValue","ltPropDisabled","ltPropSelectedValue1","ltPropSelectedValue2","ltPropYield","ltPropTooltipStyle","ltPropTooltip","ltPropScaleUnit","ltPropTooltipClass","ltPropTooltipConfig","ltPropMinDiff","ltPropDigits","ltPropAria","ltPropTabIndex","ltPropHandlerTabIndex","ltPropAriaLabel","ltPropMinDiscrete","preventObs","orientation"],
_observedAttributesType :["array","array","string","string","string","string","string","string","string","string","string","string","string","string","array","boolean","string","string","boolean","string","string","boolean","string","boolean","string","string","object","number","number","boolean","number","number","string","number","boolean","string"],
        ...
        data:function(){
            ...
            return {
                 ...
                 * @version 1.0.0
                 */
                ltPropMin:Lyte.attr("string",{"default": default_values.min || '0'}),
                /**
                 * @componentProperty {string} ltPropMax=''
                 * @condition ltPropContent []
                 * @version 1.0.0
                 */
                ltPropMax:Lyte.attr("string",{"default": default_values.max || ''}),
                /**
                 ...
                 * @version 1.0.0
                 */
                ltPropScaleInterval:Lyte.attr("string",{"default": default_values.scaleInterval || ''}),
                /**
                 * @componentProperty {string} ltPropStep=''
                 * @version 1.0.0
                 */
                ltPropStep:Lyte.attr("string",{"default": default_values.step || ''}),
                /**
                 * @componentProperty {lyteArrow | lyteArrowLeft | lyteCircle | lyteSquare} ltPropHandler=lyteArrow
                 * @version 1.0.0
                 */
                ltPropHandler:Lyte.attr("string",{"default": default_values.handler || 'lyteArrow'}),
                /**
                 * @componentProperty {lyteHorizontal | lyteVertical} ltPropDirection=lyteHorizontal
                 * @version 1.0.0
                 */
                ltPropDirection:Lyte.attr("string",{"default": default_values.direction || 'lyteHorizontal'}),
                /**
                 * @componentProperty {string} ltPropWidth=''
                 * @version 1.0.0
                 */
                ltPropWidth:Lyte.attr("string",{"default" : default_values.width || ''}),
                /**
                 * @componentProperty {colorString} ltPropFillColor=''
                 * @version 1.0.0
                 */
                ltPropFillColor:Lyte.attr("string",{"default": default_values.fillColor || ''}),
                /**
                 * @componentProperty {colorString} ltPropNonFillColor=''
                 * @version 1.0.0
                 */
                ltPropNonFillColor:Lyte.attr("string",{"default": default_values.nonFillColor || ''}),
                /**
                 * @componentProperty {string} ltPropHeight=''
                 * @version 1.0.0
                 */
                ltPropHeight:Lyte.attr("string",{"default": default_values.height || ''}),
                /**
                 * @componentProperty {string} ltPropValue=''
                 * @version 1.0.0
                 */
                ltPropValue:Lyte.attr("string",{"default": default_values.value || ''}),
                /**
                 * @componentProperty {string} ltPropDiscrete=''
                 * @condition ltPropContent []
                 * @version 1.0.0
                 */
                ltPropDiscrete:Lyte.attr("string",{"default": default_values.discrete || ''}),
                /**
                 ...
                 * @version 1.0.0
                 */
                ltPropRangeHandler:Lyte.attr("boolean",{"default": default_values.rangeHandler || false}),
                /**
                 * @componentProperty {string} ltPropMinValue=''
                 * @version 1.0.0
                 */
                ltPropMinValue:Lyte.attr("string",{"default": default_values.minValue || ''}),
                /**
                 * @componentProperty {string} ltPropMaxValue=''
                 * @version 1.0.0
                 */
                ltPropMaxValue:Lyte.attr("string",{"default": default_values.maxValue || ''}),
                /**
                 ...
                 * @version 1.0.2
                 */
                ltPropTooltipStyle : Lyte.attr('string', { default : default_values.tooltipStyle || ''}),
                /**
                 * @componentProperty {boolean} ltPropTooltip=true
                 * @version 1.0.2
                 */
                ltPropTooltip : Lyte.attr( 'boolean', { default : default_values.tooltip == false ? false : true}),
                /**
                 * @componentProperty {string} ltPropScaleUnit=''
                 * @condition ltPropYield false
                 * @version 1.0.2
                 */
                ltPropScaleUnit : Lyte.attr( 'string' , { default : default_values.scaleUnit || '' } ),
                /**
                 ...
                 * @version 1.0.2
                 */
                ltPropMinDiff : Lyte.attr( 'number', { default : default_values.minDiff || 0 } ),
                /**
                 * @componentProperty {number} ltPropDigits=2
                 * @version 1.0.8
                 */
                ltPropDigits : Lyte.attr( 'number', { default : default_values.digits == void 0 ? 2 : default_values.digits } ),

                ltPropAria : Lyte.attr( 'boolean', { default : default_values.aria } ),
                ltPropTabIndex : Lyte.attr( 'number', { default : default_values.ltPropTabIndex || 0 } ),
                ltPropHandlerTabIndex : Lyte.attr( 'number', { default : default_values.ltPropHandlerTabIndex || 0 } ),
                ltPropAriaLabel : Lyte.attr( 'string', { default : default_values.ariaLabel || '' } ),

                /**
                 * @componentProperty {number} ltPropMinDiscrete=0.1
                 * @version 3.107.0
                 */
                ltPropMinDiscrete : Lyte.attr( "number", { default : default_values.minDiscrete == void 0 ? 0.1 : default_values.minDiscrete } ),
