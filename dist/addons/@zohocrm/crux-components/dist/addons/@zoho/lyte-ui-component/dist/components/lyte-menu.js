...
_observedAttributes :["ltPropContent","ltPropId","ltPropClass","ltPropQuery","ltPropEvent","ltPropYield","ltPropUserValue","ltPropSystemValue","ltPropCallout","ltPropPosition","ltPropDescription","ltPropTabIndex","ltPropFreeze","ltPropShow","ltPropWidth","ltPropHeight","ltPropQueryClass","ltPropBoundary","ltPropScope","ltPropPreventInsideClick","ltPropAnimate","ltPropSetCss","ltPropWrapperClass","ltPropWrapperId","ltPropBindToBody","ltPropAria","ltPropAriaAttributes","ltPropOffset","ltPropActiveElement","ltPropHeightResetOnScroll","ltPropPreventKeyEvents","ltPropForceClick","pos","parIndex","lyteUnbound","randomId","customPosition"],
_observedAttributesType :["array","string","string","string","string","boolean","string","string","boolean","string","string","number","boolean","boolean","string","string","string","object","string","boolean","boolean","boolean","string","string","boolean","boolean","object","object","string","boolean","boolean","boolean","string","number","boolean","string","string"],
    ...
    init: function () {
        ...
        if (!_lyteUiUtils._lyteMenu) {
            ...
            origin_elem[ ns ]('click', lyteCloseMenu, true);
    ...
    keydownCheck: function (event) {
        ...
        if( __target && !document.contains( __target ) ){
            return;
        }
    ...
    data: function () {
        ...
        return {
            ...
            */
             ...
             * @version 1.0.0
             */
            ltPropQuery: Lyte.attr('string', { 'default': default_values.query || '' }),
            /**
             * @componentProperty {string} ltPropEvent=click
             * @version 1.0.0
             */
            ltPropEvent: Lyte.attr('string', { 'default': default_values.event || 'click' }),
            /**
             ...
             * @version 1.0.0
             */
            ltPropCallout: Lyte.attr('boolean', { 'default': default_values.callout || false }),
            /**
             ...
             * @condition ltPropSetCss true
             * @version 1.0.0
             */
            ltPropPosition: Lyte.attr('string', { 'default': default_values.position || 'down' }),
            /**
             * @componentProperty {string} ltPropDescription=''
             * @condition ltPropYield false
             * @version 1.0.0
             */
            ltPropDescription: Lyte.attr('string', { 'default': default_values.description || '' }),
            /**
             ...
             * @version 1.0.0
             */
            ltPropFreeze: Lyte.attr('boolean', { 'default': default_values.freeze || true }),
            /**
             ...
             * @version 1.0.0
             */
            ltPropWidth: Lyte.attr('string', { 'default': default_values.width || 'auto' }),
            /**
             * @componentProperty {string} ltPropHeight=auto
             * @version 1.0.0
             */
            ltPropHeight: Lyte.attr('string', { 'default': default_values.height || 'auto' }),
            /**
             * @componentProperty {string} ltPropQueryClass=lyteMenuSelected
             * @version 1.0.0
             */
            ltPropQueryClass: Lyte.attr('string', { 'default': default_values.queryClass || 'lyteMenuSelected' }),
            /**
             * @componentProperty {object} ltPropBoundary
             * @default {}
             * @version 1.0.0
             */
            ltPropBoundary: Lyte.attr('object', { 'default': default_values.boundary || {} }),
            /**
             ...
             * @version 1.0.0
             */
            ltPropPreventInsideClick: Lyte.attr('boolean', { default: default_values.preventInsideClick || false }),
            /**
             * @componentProperty {boolean} ltPropAnimate=false
             * @version 1.0.3
             */
            ltPropAnimate: Lyte.attr('boolean', { default: default_values.animate || false }),
            /**
             * @componentProperty {boolean} ltPropSetCss=true
             * @version 1.0.4
             */
            ltPropSetCss: Lyte.attr('boolean', { default: default_values.setCss == false ? false : true }),
            /**
             * @componentProperty {string} ltPropWrapperClass=''
             * @version 1.0.4
             */
            ltPropWrapperClass: Lyte.attr('string', { 'default': default_values.wrapperClass || '' }),
            /**
             * @componentProperty {string} ltPropWrapperId=''
             * @version 1.0.4
             */
            ltPropWrapperId: Lyte.attr('string', { default: default_values.wrapperId || "" }),
            /**
             * @componentProperty {boolean} ltPropBindToBody=true
             * @version 2.1.0
             */
            ltPropBindToBody: Lyte.attr('boolean', { default: default_values.bindToBody == false ? false : true }),
            /**
             ...
             * @version 3.1.0
             */
            ltPropAriaAttributes: Lyte.attr('object', { default: default_values.ariaAttributes || { role: "menu" }, watch : true }),
            /**
             ...
             * @version 2.2.11
             */
            ltPropOffset: Lyte.attr('object', { default: default_values.offset || {} }),

            ltPropActiveElement : Lyte.attr( 'string' ),
            /**
    ...
    */
    ...
    setCss: function (onlyScroll, _pos, maintainPos ) {
        ...
        if (parseFloat(body.style.top) - y + bodyHeight > wheight && offsets.top <= wheight) {
            ...
            if( bottom - y + bodyHeight > wheight && offsets.top <= wheight ){
                this.menuBody.style.height = (wheight - bottom + y - padding) + 'px';
                bodyHeight = parseFloat(this.menuBody.style.height);
                this._dont_modify = true;
            }else if( (bottom < 0) && y + bottom + bodyHeight > wheight && offsets.top <= wheight ){
                this.menuBody.style.height = wheight - (y + bottom) - padding + 'px';
                bodyHeight = parseFloat(this.menuBody.style.height);
                this._dont_modify = true;
            }
        }
...
var lyteCloseMenu = function( evt, element, flag, close_submenu_alone ){
    if( _lyteUiUtils._lyteMenu.preventClick != false || element ){
        if( ( evt && evt.button != 2 ) || element || flag ){
            ...
            if( target && target.offsetParent && !document.contains( target ) ){
                return;
            }
