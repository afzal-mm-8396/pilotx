...
_observedAttributes :["ltPropMin","ltPropMax","ltPropValue","ltPropDirection","ltPropHandler","ltPropWidth","ltPropFillColor","ltPropNonFillColor","ltPropHeight","ltPropContent","ltPropScaleInterval","ltPropDiscrete","ltPropScaleAppend","ltPropScalePrepend","ltPropColor","ltPropTooltipStyle","ltPropTooltipConfig","ltPropTooltip","ltPropDigits","ltPropMinDiff","ltPropYield","ltPropTabindex","ltPropAria","ltPropRerender","ltPropCssDirection","ltPropPromiseHandling","ltPropDisabled","ltPropDataTabindex","divLength","scaleVal","secArr","orientation"],
_observedAttributesType :["number","number","array","string","string","string","string","string","string","array","number","number","string","string","array","string","object","boolean","number","number","boolean","number","boolean","boolean","string","boolean","boolean","string","array","array","array","string"],
    ...
    data : function(){
        ...
        return {
             ...
             * @version 1.0.8
             */
            ltPropMin : Lyte.attr( 'number', { default : default_values.min || 0 } ),
            /**
             ...
             * @version 1.0.8
             */
            ltPropScaleInterval : Lyte.attr( 'number', { default : default_values.scaleInterval } ),
            /**
             * @componentProperty {number} ltPropDiscrete
             * @version 1.0.8
             */
            ltPropDiscrete : Lyte.attr( 'number', { default : default_values.discrete } ),
            /**
             * @componentProperty {string} ltPropScaleAppend ''
             * @condition ltPropYield false
             * @version 1.0.8
             */
            ltPropScaleAppend : Lyte.attr( 'string', { default : default_values.scaleAppend || "" } ),
            /**
             * @componentProperty {string} ltPropScalePrepend ''
             * @condition ltPropYield=false
             * @version 1.0.8
             */
            ltPropScalePrepend : Lyte.attr( 'string', { default : default_values.scalePrepend || "" } ),
            /**
             * @componentProperty {string[]} ltPropColor
             * @default []
             * @version 1.0.8
             */
            ltPropColor : Lyte.attr( 'array', { default : default_values.color || [ ] } ),
            /**
             ...
             * @condition ltPropTooltip true
             */
            ltPropTooltipConfig : Lyte.attr( 'object', { default : default_values.tooltipConfig || { margin : 5, position : "top" } } ),
            /**
             * @componentProperty {boolean} ltPropTooltip=false
             * @condition ltPropTooltip true
             * @version 1.0.8
             */
            ltPropTooltip : Lyte.attr( 'boolean', { default : default_values.tooltip || false } ),
            /**
             * @componentProperty {number} ltPropDigits=2
             * @version 1.0.8
             */
            ltPropDigits : Lyte.attr( 'number', { default : default_values.digits || 2 } ),
            /**
             ...
             * @version 3.80.0
             */
            ltPropCssDirection : Lyte.attr( 'string', { default : default_values.cssDirection } ),
            /**
             * @componentProperty { boolean } ltPropPromiseHandling = false
             * @version 3.91.1
             */
            ltPropPromiseHandling : Lyte.attr( 'boolean', { default : default_values.promiseHandling || false } ),
            /**
