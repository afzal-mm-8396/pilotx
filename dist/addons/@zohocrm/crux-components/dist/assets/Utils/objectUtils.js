...
objectUtils.getMatchedObject = function(jsonArray, key, value) {
	 ...
	 * @returns {String} - This returns the corresponding key for the value that is passed-in.
	 * @example
...
objectUtils.getMatchedKey = function(json, value) {
	 ...
	 * @returns {Object} - It returns the shallow copy or deep copy the passed in object.
	 * @example
...
objectUtils.deepClone = function(value, refFrom, refTo, deep) {
	 ...
	 * @returns {Object} - It returns the pattern as RegExp. That is an exact copy.
	 * @example
